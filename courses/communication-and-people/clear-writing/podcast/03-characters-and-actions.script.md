---
source: courses/communication-and-people/clear-writing/lessons/03-characters-and-actions.md
...
checked: >-
  ...
  NITS, and all the findings were fixed in this file before rendering. The script had called Gopen
  and Swan independent of Williams, which the lesson explicitly refuses; it had asserted Williams's
  two principles flatly where the lesson has them at second hand; and "put the period back" read as
  a full stop to the ear, so it now says the consultation period. The script was also shortened
...
about: >-
  ...
  Writing Clearly. The intro and sign-off name the hosts and the lesson and assert nothing
  factual beyond that.
speakers: 2
approx_minutes: 6
---
...
S1: That work you just did is the subject of the lesson, and you shouldn't have had to do it. Here's the same event in eleven words. Officers with delegated authority decided the application after reading the responses.

S2: What got lost?

S1: One thing: the consultation period. Put it back in and it's fourteen words. So nothing was really cut. What changed is that somebody is now doing something.

S2: And that's the principle.

S1: Joseph Williams built his book Style around two principles, by every account of it, and Gopen and Swan reach the same place from the reader's side, where they're numbers three and five of their seven. Put together: make the main character of your sentence its grammatical subject, and put that character's action in the verb.

S2: Before I take that as a rule.

S1: Take their own warning with it. The same paper says none of these reader expectation principles should be considered rules. They're describing what readers expect, not issuing prohibitions.
...
S1: There was a failure of communication between the two departments. Character, the two departments. Action, not telling each other. Now, the implementation of the new policy will take place in April.

S2: Character, somebody unnamed?

S1: And that isn't a failure of the diagnosis. It is the diagnosis. The sentence never says who is implementing, and you can't put a character in the subject slot until you decide who it is.

S2: There's a harder one in the lesson about waiting times.
...
S1: GOV.UK's guidance gives that as a cheap detector. Watch words ending in ion and ment, it says, because they tend to make sentences longer and more complicated. But it's a place to look, not a verdict.

S2: Because government ends in ment.
...
S1: Was made is passive, was surveyed is passive, and neither names who did the surveying. So whatever Strunk objected to, it wasn't the passive voice, even though that passage sits inside the rule headed use the active voice.

S2: Then what changed?

S1: Survey stopped being a noun and became the verb. The action moved into the verb slot, and the limp was made disappeared, because it was only ever there to hold the sentence together. His other pair does the same thing. Mobilization of the army was rapidly effected, against, the army was rapidly mobilized.

S2: So a lot of advice labelled avoid the passive is really about buried actions.

S1: And the two get confused because they show up together. Separate problems, separate fixes, and if you only know the passive rule you'll fix the wrong one. The lesson is fair to the other side: the same GOV.UK page tells writers to use the active voice, because it is more direct and puts the focus on the user. Whether that survives as a general rule is lesson eight's question.

S2: You mentioned a harder example.

S1: Reports about things that went wrong are full of this. Following identification of the discrepancy, escalation was delayed pending clarification of the reporting requirements. Three nominalisations, no character anywhere.

S2: And you can't rewrite it.

S1: You hit a wall at once, because you can't write X delayed escalating without knowing who X is. It's arranged so the question doesn't come up. Compare, the duty manager knew about the discrepancy on Tuesday and did not escalate it until Friday, because the reporting rules were unclear.

S2: Now there's a person, two dates and a reason.

S1: Every one checkable, and one of them may be wrong, which is exactly what the original protected.
...
S1: Thanks for listening. Go and find out who is doing what in your own sentences.
