...
objectives:
  ...
  - Test a usage rule against evidence yourself, using a corpus and a count
quiz:
  - q: Which of these is a passive clause?
    options:
      - A bus exploded outside the station shortly after nine in the morning
      - The reason he left college was that his health became impaired that year
      - There were a great number of dead leaves lying on the ground by then
      - At dawn the crowing of a rooster could be heard from across the valley
    answer: 3
    explain: D has a form of be with a past participle, heard, and you could add by someone, which is the test. That is a passive. A names no agent and many people call it passive for that reason, but it is a plain active clause. B has become plus an adjective, and become cannot take a passive. C is an existential there sentence with no passive anywhere in it.
  - q: What is Pullum's central charge against the book, in his own account of it?
    options:
      - That writing tutors overinterpret its advice and red-circle anything resembling a passive
      - That its authors condemn constructions they are not themselves able to identify correctly
      - That its style advice is vapid, tautologous and useless to any novice writer who reads it
      - That its brevity forces it into rules that a longer treatment would have properly qualified
    answer: 1
    explain: Pullum names the tutors' overinterpretation and then says plainly that it is not what he is most concerned about, so A is the half he sets aside. His concern is B. C misstates his position, since he calls the style advice mostly harmless and says it does not hurt to put such maxims before novices. D is an argument he never makes.
  - q: Which two of Pullum's specific charges turn out to land on White rather than on Strunk?
    options:
      - The rule that none takes a singular verb, and the ban on which in restrictive clauses
      - The bias against the passive, and the instruction to omit every needless word from a draft
      - The claim about split infinitives, and the rule against however at the start of a sentence
  ...
  - q: What does this lesson conclude about the dispute over The Elements of Style?
    options:
      ...
      - That its critics are unfair, because its rules hold up whenever they are properly tested
      - That opening the primary text moved the argument in both directions rather than one
      - That the question cannot be settled, so a writer may follow whichever side they prefer
    answer: 2
...
"The window was old" is not passive. *Old* is an adjective and you cannot add *by someone*. This is the same trap as *his health became impaired*: *impaired* looks like a participle and is working as an adjective, and *become* cannot take a passive at all.
:::
...
## The book, and the attack

**The book.** *The Elements of Style* began as a slim volume William Strunk printed privately for his Cornell students in 1918. E. B. White, who had taken the class in 1919, revised and expanded it for commercial publication in 1959. It has sold millions.

Its defenders hold that it is a compact set of maxims that has demonstrably helped generations of novices, that its brevity is precisely its virtue, and that a beginner who follows it writes better than a beginner who follows nothing. That case is not silly, and nothing below refutes it.

**Strunk's own aim**, from [the 1918 text](https://www.gutenberg.org/cache/epub/37134/pg37134.txt), is modest: the book "aims to give in brief space the principal requirements of plain English style", concentrating on "essentials, the rules of usage and principles of composition most commonly violated". It does not claim to be a grammar.

**The attack.** Pullum's essay marked the book's fiftieth anniversary in 2009. He is head of linguistics and English language at the University of Edinburgh and co-author of *The Cambridge Grammar of the English Language*.

> "The Elements of Style does not deserve the enormous esteem in which it is held by American college graduates. Its advice ranges from limp platitudes to inconsistent nonsense. Its enormous influence has not improved American students' grasp of English grammar; it has significantly degraded it."

:::callout Two things Pullum says that are usually cut
Quote the paragraph above alone and you get a cruder argument than the one he made.
...
So take the half that can be checked. Strunk's 1918 rule 10 is out of copyright and available in full.

Read it and the first thing you find is that Pullum has read it too, and says so:
...
Notice what moved the argument. Not authority, not intuition, not asking which writer is more distinguished. The text, opened, by someone willing to publish what they found.

Pullum uses the same move on the *none* rule. He searches three books by writers publishing while Strunk was teaching and finds plural agreement in each: Wilde's *The Importance of Being Earnest* has "None of us are perfect"; Stoker's *Dracula* has "I think that none of us were surprised when we were asked to see Mrs. Harker a little before the time of sunset"; Montgomery's *Anne of Avonlea* has "None of us ever do". His question is the one to steal: "Is the intelligent student supposed to believe that Stoker, Wilde, and Montgomery didn't know how to write?"
...
2. **Find its source.** Where did you get it, and where did they get it? Often the trail ends in somebody's memory of a rule, which is itself a finding.

3. **Choose a corpus and search it.** Project Gutenberg for older writing, or a body of contemporary writing you respect. Pick writers nobody would call careless.

4. **Count, both ways.** How often is the rule followed, and how often broken? By whom?

5. **Write your verdict in one paragraph**, and say which of three things you found: a rule of English, a house style, or a superstition. All three are real categories and only the third is worthless.

6. **Report anything that went against you.** If you set out to debunk and found the rule holds, say so. A method that only ever debunks is not a method, and this lesson's own case study turned up a finding against the critic.
:::

## Where this goes next

You now have the craft this course teaches, and a way of judging advice you meet later, including advice from here.

One thing remains, and almost no writing course includes it. Everything so far has been about producing a better document. The last lesson is about finding out whether it worked, which is a different activity with different tools, and it involves another person.
