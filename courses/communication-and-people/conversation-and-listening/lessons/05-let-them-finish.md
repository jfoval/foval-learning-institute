...
objectives:
  ...
  - >-
    Explain how conversational style can make the same overlap feel engaged to one person and
    domineering to another
  - >-
    State what the studies of gender and interruption found, with their sizes, settings and
    definitions, and why the question is contested
  - >-
    Apply the medical findings on interruption and the practitioners' advice on silence to an
...
quiz:
  ...
  - q: >-
    ...
    options:
      - Say the name for him, since finishing the word for him saves him effort and embarrassment
      - Tell him to slow down and take a breath before trying the name again, so he can relax
      - Look away until he's done, so that he doesn't feel watched while he gets the word out
      - Wait, keep natural eye contact, and let him say it himself, however long it takes him
    answer: 3
    explain: >-
      STAMMA says people who stammer want the time to say what they want to say, and to keep
      natural eye contact. It asks people not to finish sentences, which people who stammer "often
      find it intrusive rather than helpful". It also says not to suggest slowing down or relaxing,
      which shows you're focused on how he speaks rather than what he's saying. Looking away is the
      kind of uncomfortable reaction it asks you to avoid.
  - q: >-
    ...
    explain: >-
      ...
      silence. That's practitioner advice, not a tested finding. On this course's reading, waiting
      leaves her the chance to carry on, which is lesson 1's rule 1c. A pause can be a transition
...
then the tiredness, and then... and the doctor cuts in with a question about the cough. In one set
of recorded American consultations, when doctors asked for the patient's concerns at all, they cut
in two times out of three, after a median of 11 seconds.[1] In a Swiss clinic where doctors were
trained to wait, most patients were finished within two minutes, and the few who talked for more than
five were, in the doctors' judgement, all saying something that mattered.[2]

Interrupting was the one listening failure lesson 4, "How listening goes wrong", left for this
...
Lesson 1, "What a conversation is made of", gave you the numbers. In 348 English phone calls, about
30% of changes of speaker happened in overlap, but overlap took up under 4% of the time, and 73% of
...
- **Continuers**: "mm hm", "uh huh", "yeah", the small sounds of someone following along. They do not
  claim the turn.
- **Terminal overlaps**: a next speaker starting just as the current one is finishing, a syllable or
  two early.
- **Help with a word**: someone searching for a word, and the listener supplying it. Schegloff calls
  this conditional access to the turn: you're let in to help, and the turn stays theirs.
- **Choral talk**: two people laughing, greeting or exclaiming together.

What's left is the kind people complain about. This course calls it an **intrusive interruption**:
someone starting well inside another person's unit, far from any place where the turn could end,
and taking the floor. You can say it in lesson 1's terms. At a transition-relevance place, rule 1b
lets anyone self-select. An intrusive interruption is a self-selection where no transition place
was, which is **this course's reading** of the textbook rules rather than anyone's formal
definition. The researchers whose work you'll meet below drew the line in much the same place:
Zimmerman and West counted an overlap as starting at or very near a possible end of a turn and an
interruption as cutting in earlier,[5] and the 1998 meta-analysis treats as "intrusive" the
interruptions aimed at taking the floor.[6]

:::predict Before the transcript. Of the overlaps in ordinary conversation, how many would you guess the people talking actually treat as interruptions?

The recordings don't give a single rate for this, but they point one way: most overlaps are backchannels, terminal overlaps, help and laughter, and people carry on as if nothing happened. In the phone calls from lesson 1, nearly three quarters of overlaps involved a backchannel.[3] If you guessed "most of them", you were counting overlap and interruption as the same thing, which is the confusion this section is about.
:::

### A campsite at midnight

Three friends, Idris, Delphine and Emeric. Square brackets mark where two people's talk overlaps, as
in lesson 1.

```
1  Idris:     So we got to the campsite at mid[night and
2  Delphine:                                  [mm
3  Idris:     the gate was locked, so we had to (0.5) um,
              what's the word, get over the-
4  Emeric:    The fence?
5  Idris:     The fence, yeah, with all the ba[gs.
6  Delphine:                                  [Oh no!
7  Emeric:                                    [Oh no!
8  Idris:     And then the warden turned up and [he
9  Delphine:                                    [Wait, was
              this the trip where you lost the car keys?
10 Idris:     No, that was the year after. Anyway, the
              warden...
```
...
**Lines 6 and 7: a terminal overlap, and choral talk.** Both start on the last syllable of "bags", as the unit ends, and they say the same thing together.

**Line 9: an intrusive interruption.** "The warden turned up and he" is nowhere near a possible end: the listener can hear that more is coming. Delphine starts there and changes the topic. Idris gives up the floor for a turn and then takes it back with "Anyway".

If you called line 4 an interruption because Emeric spoke before the sentence was finished: the sentence had stopped, and Idris invited help with "what's the word". If you called line 9 harmless because Idris got his story back, that's a fair point about the damage, and it's the next section's question: whether an interruption is a problem depends partly on the people in it.
:::
...
Tannen draws a further argument from it. If overlap is counted as dominance, then high-involvement
speakers get labelled pushy for what they meant as warmth, so she argues that interruption has to be
judged by intentions and effects in context, not by counting.[7] Hold on to that argument; it
returns in the gender section as one of three positions.

### Two colleagues, and a third
...
it went down fine. Here it does not.

[STAMMA](https://stamma.org/about-stammering/conversation-someone-stammers), the British Stammering Association, is plain about it: "It can be tempting to try and help by
finishing someone's sentences. Try not to do this. People who stammer often find it intrusive rather
...
This is one of the most repeated claims about conversation, and it is **contested**: serious researchers
disagree about the answer and about whether the question is well posed. There are three positions,
and each deserves its own case.
...
in other contexts are exercised in their conversational interaction with women."[5] That is the
**dominance view**. They also marked its limit themselves: "We are not claiming" that conversations
between men and women always show the pattern, and they called the conditions under which it appears
a task for further research.[5]
...
Kristin Anderson and Campbell Leaper, at the University of California, Santa Cruz, combined [43 published studies](https://escholarship.org/uc/item/5ws13704) of adult women's and men's interruptions, most of them with
middle-class European American samples, and most watching conversations of only 10 to 15
minutes.[6] Because the studies defined interruption so differently, they sorted the definitions into
...
gap "potentially reflects some form of researcher bias", in which some women researchers may be
...
the older figure you may have met: a 1984 study, as Singh Ospina and colleagues describe it, found
doctors interrupting in 69% of visits, after a mean of 18 seconds.[1] This course has not read the
1984 paper itself.

:::predict Now the other side. Doctors in a Swiss clinic were trained to wait and told not to ask questions until the patient had finished their opening. How long do you think the average patient talked before handing over? And how many do you expect went past five minutes?

The mean was 92 seconds, and the median 59 seconds. Of 335 patients, 78% had finished within two minutes, and seven talked for more than five. The doctors judged that all seven were giving important information.[2]
:::
...
patients."[2] Older patients talked longer (108 seconds on average for those aged 50 to 87, against 77
for 17 to 29). This clinic took referrals of complicated cases, and the authors expected patients
elsewhere might need even less time.
...
a patient who never stops, came up for seven people in 335, and the doctors thought each of them had
something worth hearing.

What transfers to a friend telling you about their week? The numbers don't. Nobody is timing you, no
agenda is being cleared, and a friend is not a patient reporting to someone with authority. What
might transfer, on **this course's reading**, is the shape: the first thing someone says may not be
the whole of what they came to say, and the fear behind cutting in (that they'll go on forever) is
the fear the Basel study tested and didn't find borne out, in its setting.
...
- **Samaritans**, the UK and Ireland listening charity, in [its advice](https://www.samaritans.org/how-we-can-help/if-youre-worried-about-someone-else/how-support-someone-youre-worried-about/what-do-if-you-think-someone-struggling/) for someone supporting a person who's
  struggling: "If the other person has paused in their response, wait a moment", and "remember, you
  don't have to fill every silence."[9]
- **R U OK?**, in its Australian guide to checking on someone: "If they need time to think, sit patiently
  with the silence."[10]
- **The Calgary-Cambridge guide**, a widely used framework for teaching doctors to consult:
  "allowing patient to complete statements without interruption and leaving space for patient to
  think before answering or go on after pausing".[11]
- **Interviewers.** The Smithsonian's oral-history guide: "Don't worry about silences. Let the
  interviewee think and take time before they answer."[12] Poynter's list for journalists: "Be
  patient. Don't break the silence with a new question."[13]
- **Essential Partners**, which runs structured dialogues on divisive issues, builds pauses into its
  groups on purpose, and gives a reason: pauses "promote better listening, because most listeners can
  concentrate better when they know there will be a pause during which they can gather their
  thoughts".[14] This is their account from experience, not a measured finding.

Why would a pause help? **This course's reading**, from lesson 1's rules: when someone stops at a
transition-relevance place and you don't self-select at once, rule 1c is still open, and they can
carry on. Coming in straight away closes that option. A pause is how you hand the turn back without
saying anything.

:::checkpoint Lesson 2, "Why 'no' comes late", showed that a long silence before a reply is often heard as reluctance. Doesn't that contradict the advice to leave silences?

No, because they're different silences in different places. Lesson 2's silence comes after a question or a request, where an answer is due from the person who stays quiet, so the silence is heard as that answer being held back. The practitioners' silence comes after the other person stops in the middle of telling something, where nothing is due from you, and your pause leaves them room to go on.

Lesson 2 also set this advice beside Templeton and colleagues' finding that quick replies went with feeling in sync in get-to-know-you talk. On that lesson's reading they aren't rivals either: one describes easy chat, the other what to do when someone may not have finished.
:::
...
interrupt more on average, and in some settings the difference wasn't small.[6] Both slogans skip the
part the evidence is actually about: when and where.

**"Overlap is interruption, and interruption is always rude."** Most overlap is continuers, terminal
overlaps, help and laughter,[3][4] and even an intrusive interruption is judged by the people in the
conversation: Idris got his story back, and a friend who cuts in with "Wait, is she all right?" may be
doing what the moment needs.

**"A pause means they've finished."** Sometimes. A pause at a possible end of a turn leaves rule 1c
...
**"Some cultures just talk over each other."** Lesson 1's ten-language study found the Italian
recordings ordinary, and the differences between languages small.[3] Lesson 15 takes this further.

## Practice

:::exercise Wait a breath
This is a **try one move** exercise, in conversations you were going to have anyway. Take 10 minutes in total, spread over two days: a few seconds during each conversation, and five minutes afterwards for each journal note.

1. In two ordinary, low-stakes conversations, each time the other person stops talking, wait one slow breath before you reply. Don't announce it and don't make it a long, meaningful silence: one breath.
2. Afterwards, write in your journal how many times the other person went on during your breath, and whether what they added was new.
3. Write one honest line on how it felt. "Awkward, and nothing happened" is a real result.

Don't practise this on someone who's upset and needs a response, and don't turn it into a test of the other person.
:::

:::exercise Three overlaps
This is a **notice** exercise. Take 10 minutes, within an hour of an ordinary conversation. From memory, write down three moments when you and someone else talked at once, and classify each: continuer, terminal overlap, help with a word, choral talk or intrusive interruption. For any intrusive one, note who got the floor back, and how, and whether either of you seemed to mind. Name nobody. If you'd like more practice, do the same with five minutes of a published panel discussion, and ask of your count what Tannen asks: did any overlap you left out feel pushy, or any you counted feel friendly?
:::

## For your journal

Add overlaps to what you note from now on, classified by kind, and write down any time you waited a
breath and the other person went on. The course project asks you to practise one habit for two weeks
and measure it; waiting a breath is one of the options, and the two conversations from the first
exercise are your starting point.

## Connections

Lesson 1, "What a conversation is made of", gave you the overlap figures and the rules; an intrusive
interruption is a self-selection where no transition place was. Lesson 4, "How listening goes wrong",
named interrupting as a failure and left it here. Lesson 2's point about silence after a question
sits beside this lesson's point about silence after a speaker stops.

This lesson is about ordinary conversation. Talk with someone who is angry or threatening is a
different situation, and Personal Safety lesson 8, "Talking it down", covers it. Next, lesson 6,
"Asking better questions", is about what to put into the space once you've left it. Lesson 15,
"Different habits: culture, autism, age and hearing", comes back to style, to cultural differences in
timing, and to stammering.

## Go deeper

- **Wolf Langewitz and colleagues, ["Spontaneous talking time at start of consultation in outpatient
  clinic"](https://pmc.ncbi.nlm.nih.gov/articles/PMC126654/), *BMJ*, 2002.** Free and one page long,
  with the distribution drawn as a chart. This course read the full text.
- **Naykky Singh Ospina and colleagues, ["Eliciting the patient's agenda"](https://pmc.ncbi.nlm.nih.gov/articles/PMC6318197/),
  *Journal of General Internal Medicine*, 2019.** Free. The introduction is a short history of the
  interruption studies; the discussion gives the counter-view. This course read the full text.
- **Kristin Anderson and Campbell Leaper, ["Meta-analyses of gender effects on conversational
  interruption"](https://escholarship.org/uc/item/5ws13704), *Sex Roles*, 1998**, free on
  eScholarship. The discussion section is readable without the statistics, and fair to every side.
...
- **STAMMA, ["In conversation with someone who stammers"](https://stamma.org/about-stammering/conversation-someone-stammers).**
  Short, practical, and written for the listener. Read in full.

## Sources

1. Singh Ospina, N., Phillips, K. A., Rodriguez-Gutierrez, R., and colleagues (2019). Eliciting the
   patient's agenda: secondary analysis of recorded clinical encounters. *Journal of General Internal
   Medicine*, 34(1), 36–40. [PMC6318197](https://pmc.ncbi.nlm.nih.gov/articles/PMC6318197/).
   **Read: full text**, re-read 26 September 2026. Single study, 112 recorded US consultations. The
   1984 figure is as this paper reports it; the 1984 paper was not read. <!-- SOURCES Part E §2.2; G5 fallback; lesson 05/06 gate closures -->
2. Langewitz, W., Denz, M., Keller, A., Kiss, A., Rüttimann, S., and Wössmer, B. (2002). Spontaneous
   talking time at start of consultation in outpatient clinic: cohort study. *BMJ*, 325(7366),
   682–683. [PMC126654](https://pmc.ncbi.nlm.nih.gov/articles/PMC126654/). **Read: full text**,
   re-read 26 September 2026. Single study, 335 patients, 14 doctors, Basel. <!-- SOURCES Part E §2.2; lesson 05/06 gate closures -->
3. Levinson, S. C., and Torreira, F. (2015), *Frontiers in Psychology*, 6, 731, and Stivers, T., and
   colleagues (2009), *PNAS*, 106(26), 10587–10592: the figures as lesson 1 gives them. **Read: full
   texts.** <!-- SOURCES Part B §2.1, §2.2 -->
4. Schegloff, E. A. (2000). Overlapping talk and the organization of turn-taking for conversation.
   *Language in Society*, 29(1), 1–63. **Read: the abstract and the sections on unproblematic
   overlap and on resolution** (ISCA archive PDF). Observed in recordings. <!-- SOURCES Part B §1.5 -->
5. Zimmerman, D. H., and West, C. (1975). Sex roles, interruptions and silences in conversation. In
   B. Thorne and N. Henley (eds), *Language and Sex: Difference and Dominance*, pp. 105–129. Newbury
   House. **Read: full chapter, as an OCR of the scanned PDF, with the quotations, Table 2 and the
   98% sentence checked against the page images** on 26 September 2026. Single study, 31
   conversational segments. <!-- SOURCES Part B §3.2; G4 closed, lesson 05/06 gate closures -->
6. Anderson, K. J., and Leaper, C. (1998). Meta-analyses of gender effects on conversational
   interruption: who, what, when, where, and how. *Sex Roles*, 39(3–4), 225–252.
   [eScholarship](https://escholarship.org/uc/item/5ws13704). **Read: full text**, re-read 26
   September 2026. Meta-analysis of 43 published studies. <!-- SOURCES Part B §3.3; lesson 05/06 gate closures -->
7. Tannen, D. (1989). Interpreting interruption in conversation. In *Papers from the 25th Annual
   Regional Meeting of the Chicago Linguistic Society, Part Two*, pp. 266–287. **Read: full text**
   (scanned PDF with a text layer, from the author's site). Her 1984 book is described as she
   summarises it here; the book was not read. Observed in recordings. <!-- SOURCES Part B §3.1 -->
8. STAMMA (British Stammering Association), ["In conversation with someone who stammers"](https://stamma.org/about-stammering/conversation-someone-stammers).
   **Read: the page**, re-read 26 September 2026. Advocacy body's advice. <!-- SOURCES Part E §6.7; lesson 05/06 gate closures -->
...
10. R U OK?, ["How to ask R U OK?"](https://www.ruok.org.au/how-to-ask). **Read: the page**, re-read
    26 September 2026. Australia; practitioner advice. <!-- SOURCES Part E §1.4; lesson 05/06 gate closures -->
11. Calgary-Cambridge Guide, communication process skills list (73 items), [PDF](https://doctorsspeakup.com/sites/default/files/CCG%20Process.pdf).
    **Read: the full list**, re-read 26 September 2026; the book behind it was not read. Medical
    teaching framework. <!-- SOURCES Part E §2.1; lesson 05/06 gate closures -->
12. Smithsonian Institution Archives, [*How to Do Oral History*](https://siarchives.si.edu/sites/default/files/pdfs/How_to_Do_Oral_History_Guide_2020.pdf)
    (2020). **Read: full guide**, re-read 26 September 2026. <!-- SOURCES Part E §5.2; lesson 05/06 gate closures -->
13. R. P. Clark, ["12 basics of interviewing, listening and note-taking"](https://www.poynter.org/reporting-editing/2015/12-basics-of-interviewing-listening-and-note-taking/),
    Poynter, 2015. **Read: full text**, re-read 26 September 2026 from an Internet Archive capture
    (the live page refused an automated reader). <!-- SOURCES Part E §5.4; lesson 05/06 gate closures -->
14. Essential Partners, [*Fostering Dialogue Across Divides*](https://whatisessential.org/sites/default/files/inline-images/FDAD/FDAD-EssentialPartners-2018.pdf)
    (2018). **Read: the agreements, go-round and pause sections**, the pause section re-read 26
