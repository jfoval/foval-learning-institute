---
title: Why "no" comes late
minutes: 75
objectives:
  - >-
    Identify adjacency pairs in talk and explain why a missing second part is noticed and acted on
  - >-
    Predict the shape of a preferred and a dispreferred reply, including the reversal after someone
    runs themselves down
  - >-
    Explain what a pause before a reply does and does not tell you, with the English-language
    thresholds and their limits
  - >-
    Apply the preference for self-repair to correcting someone in conversation
quiz:
  - q: >-
      At work, Teodor asks a colleague, "Could you cover my shift on Thursday?" A second and a half
      of silence follows, then: "Thursday..." On the recordings research, what does the silence
      most likely mean?
    options:
  ...
  - q: >-
    ...
    options:
      - A quick, plain "No, it wasn't, the middle part was clear", with no pause before it
      - A pause, then "Well... it had its moments", as the gentle way to disagree with her
      - A quick "Yes, a bit, but it wasn't your fault", since agreeing is what's preferred
      - A long pause and then a plain "No", so that the disagreement sounds properly considered
    answer: 0
    explain: >-
      After someone runs themselves down, the usual preference reverses: disagreeing supports
      them, so it comes fast and plain, and agreeing becomes the reluctant, delayed option. "Yes,
      a bit" agrees with the criticism. The pause-then-"well" reply is the dispreferred shape, and
      so is a long pause before "No": the delay itself can be heard as partial agreement.
  - q: >-
      Senna is telling a story: "The film started at nine, and we..." You're sure it started at
      eight. Going by what the repair research found in recorded talk, which is the most usual way
      the correction gets done?
    options:
  ...
  - q: >-
      A manager reads that listeners hear reluctance in a "yes" that comes after less than a
      second's delay, and plans to train her team, spread over four countries, to answer faster.
  ...
  - q: >-
    ...
    options:
      - 'A refusal in the dispreferred shape: a delay, an appreciation, an account, no "no"'
      - An acceptance, since it opens by agreeing that the quiz team sounds like fun to join
      - A dishonest reply, since the refusal is hidden instead of being stated plainly as "no"
      - An unfinished reply, since no answer of any kind has actually been given to the invitation
    answer: 0
    explain: >-
...
Some turns come in pairs. A question makes an answer due; a greeting, a greeting back; an
invitation, an acceptance or a refusal. Emanuel Schegloff and Harvey Sacks gave this a name in 1973,
the **adjacency pair**, and defined it by three features: "(1) two utterance length, (2) adjacent
positioning of component utterances, (3) different speakers producing each utterance".[1] The first
...
conversation analysts found by close study of recorded English talk, not a measured rate. The paper
...
```
A:  D'they have a good cook there?
    (1.7)
A:  Nothing special?
B:  No. Every- everybody takes their turns.
```

The (1.7) is a silence of 1.7 seconds. Nobody has said no. But A has heard one coming, and rewrites
the question so that "no" becomes the easy, agreeing answer. Kendrick and Torreira's reading is that
the speaker treats the silence as a sign that an unwelcome answer is on its way, and acts on it before
it arrives.[3]
...
- **Agreements** filled the turn, were stated outright, and came with little or no gap.
- **Disagreements** were often delayed, within the turn or over several turns. They were often
  prefaced ("well", "uh"), often partial ("yes, but..."), and sometimes never stated at all.
- **Silence**, and requests for clarification such as "what?", were heard as disagreement that
...
### Two replies to a film

Birgit asks Emrys: "Do you want to see a film on Friday?" Here are two replies.

**Reply 1:** "Yes! What time?"

**Reply 2:** "Oh... well... Friday's a bit... I'd love to, but it's my sister's birthday."

Reply 1 is the preferred shape. It starts at once, says yes outright, fills the turn with nothing
...
the recordings show, with at least four of the six parts.

:::checkpoint Compare your rewrite with this one.
...
The shapes were first described from careful listening. Later work counted them.

**Kendrick and Torreira, 2015** (a single study) took 195 responses to invitations, offers, requests
and similar from English telephone recordings, and timed them.[3] The [submitted version is
free](https://eprints.whiterose.ac.uk/id/eprint/116177/1/Kendrick_and_Torreira_2015_.pdf). Of the
195, 63% were preferred and 37% dispreferred. The prefaces mattered: when a response began with
...
authors put the result in one sentence worth reading twice: "we do not find that long delays are
...
descriptions in these two papers, found the same direction: rated willingness fell as the gap before
"Sure!" grew.[3][5]
...
Conversations go wrong in small ways all the time: a word misheard, a name mixed up, a sentence that
comes out wrong. Schegloff, Gail Jefferson and Sacks called the ways people deal with it **repair**,
and in a 1977 paper, [free from the same archive](https://www.conversationanalysis.org/schegloff-publication-archive/),
they separated two questions: who notices the trouble, and who fixes it.[6] Their finding, observed
in recordings of English talk, is "a strong empirical skewing in which self-repair predominates over
other-repair".[6] People fix their own trouble far more often than others fix it for them.

On their account, the system gives the speaker the first chances. The speaker can fix it within the
same turn ("We went on the Tuesday, no, the Wednesday"), just after the turn ends, or in the turn
...
narrow?", which Lori takes up: "They're awfully narrow".[6] The correction arrives as a check
on what she meant, and she gets to accept it. That form comes back in lesson 8, where saying back
what you heard is taught as a check, not a performance.

The authors noted one exception. In talk between adults and children, correction by the adult seems
less rare, and they suggest it is part of how children learn to monitor and fix their own talk.[6]

:::checkpoint A colleague, mid-sentence, says: "When we spoke to the supplier on Monday, sorry, Tuesday..." and later, "they said the order would ship in six weeks", when you're sure it was four. Using the repair research, what is the usual way each of these gets handled?
...
free on PubMed Central](https://pmc.ncbi.nlm.nih.gov/articles/PMC8794835/).[7] In their first study,
66 undergraduates in same-gender groups each had ten-minute unstructured conversations with the
others in their group, mostly strangers, 322 conversations in all. The faster a partner replied, the
more connected people said they felt, across conversations and moment to moment. Twenty-two of them
came back with three close friends each, and the same held among friends. In a third study, which was
preregistered, 450 online participants listened to short clips from those conversations with the
gaps shortened, lengthened or left alone, and rated the sped-up versions as more connected.
...
1. **Notice.** Over the week, write three journal entries, each about a dispreferred reply you
   heard or gave, your own included. For each, write the reply as closely as you can remember it and
   mark its parts: delay, preface, qualification, appreciation, account, and whether the "no" was ever said.
   Name nobody, and include nothing that would identify the other person.
2. **Rewrite on paper.** Rewrite each of these five blunt replies in the shape the recordings show,
   before you open the checkpoint below:
   - (a) A neighbour asks to borrow your drill this afternoon. "No."
...
3. **Try one move.** Once this week, when you ask someone for something and hear a delayed,
   ...
   reading of the research, not a tested finding: the recordings show that people hear the "no"
   coming, and no study this course read tested whether offering the way out helps.
:::

:::checkpoint Compare your five rewrites with these. Yours will differ in wording; check the shape.

(a) "Oh, today... I'm using it myself this afternoon, sorry. Tomorrow any good?" A delay, an account, an apology and an offer, and no "no".

(b) "Mm, is it? I've not been blown away by it, to be honest." A delay, then a partial and softened disagreement. A plain "It isn't" gives a disagreement the fast, bare shape agreements take, and on this course's reading it lands hard.

(c) "Sunday, wasn't it?" A correction put as a check, the modulated form the repair research found. If your friend was mid-story, leave room for them to catch it first.

(d) "No, you're not. That curry last week was brilliant." After a self-deprecation, disagreeing is the preferred reply, so it comes fast and plain. If yours began with "well", you gave your disagreement the delayed shape, which after a self-deprecation is the shape agreement takes.

(e) "Hmm... I think the blue one suited you better." A delay, then the disagreement carried by an alternative. This one is genuinely hard: the question is built for a "yes", and anything else will be heard as the dispreferred reply, however it is shaped.
:::

## For your journal

This lesson adds dispreferred replies to what the journal notices: three entries this week with the
parts of each reply marked. From now on, whenever an entry records a pause before a reply, note what
came after it, so you can see for yourself how often a long pause was followed by a "no" and how often
by nothing of the kind.

## Connections

This lesson leans on lesson 1's timing: a delay is only heard against a baseline of answers that
...
- **Kobin Kendrick and Francisco Torreira, ["The timing and construction of
  preference"](https://eprints.whiterose.ac.uk/id/eprint/116177/1/Kendrick_and_Torreira_2015_.pdf),
  *Discourse Processes*, 2015.** The submitted version is free. Read the abstract and the section on
  turn-initial practices for how the old descriptions held up when counted. This course read the full
  text.
- **Emanuel Schegloff, Gail Jefferson and Harvey Sacks, "The preference for self-correction in the
  organization of repair in conversation", *Language*, 1977**, free from the [ISCA
  archive](https://www.conversationanalysis.org/schegloff-publication-archive/). Section 6, on
  corrections by others, is short and full of real examples. This course read the full text.
- **Emma Templeton and colleagues, ["Fast response times signal social connection in
  conversation"](https://pmc.ncbi.nlm.nih.gov/articles/PMC8794835/), *PNAS*, 2022.** Free. Read the
  discussion's paragraph on limitations alongside the headline. This course read the full text.

## Sources

1. Schegloff, E. A., and Sacks, H. (1973). Opening up closings. *Semiotica*, 8(4), 289–327. **Read:
   full text** (ISCA archive PDF), re-read 26 September 2026 for the definition and the basic rule.
   Observed in recordings. <!-- SOURCES Part B §1.2; lesson 01/02 gate closures -->
2. Stivers, T., and colleagues (2009). Universals and cultural variation in turn-taking in
   conversation. *PNAS*, 106(26), 10587–10592.
   [PMC2705608](https://pmc.ncbi.nlm.nih.gov/articles/PMC2705608/). **Read: full text**, re-read 26
   September 2026. <!-- SOURCES Part B §2.1; lesson 01/02 gate closures -->
3. Kendrick, K. H., and Torreira, F. (2015). The timing and construction of preference: a
   quantitative study. *Discourse Processes*, 52(4), 255–289. **Read: full text** of the submitted
   version (White Rose repository), re-read 26 September 2026. Single study, 195 responses from
   English telephone corpora. The earlier listening experiment by Roberts and colleagues is cited as
   described here and in source 5, not read. <!-- SOURCES Part B §2.3; lesson 01/02 gate closures -->
4. Pomerantz, A. (1984). Agreeing and disagreeing with assessments: some features of
   preferred/dispreferred turn shapes. In J. M. Atkinson and J. Heritage (eds), *Structures of Social
   Action*, pp. 57–101. Cambridge University Press. **Read: full chapter, as an OCR of the scanned
...
7. Templeton, E. M., Chang, L. J., Reynolds, E. A., Cone LeBeaumont, M. D., and Wheatley, T. (2022).
   Fast response times signal social connection in conversation. *PNAS*, 119(4), e2116915119.
   [PMC8794835](https://pmc.ncbi.nlm.nih.gov/articles/PMC8794835/). **Read: full text**, re-read 26
   September 2026. Three studies, Dartmouth undergraduates and online listeners. <!-- SOURCES Part B §2.4; lesson 01/02 gate closures -->
