...
objectives:
  - >-
    ...
    about suicide, in the services' own words
  - >-
    Explain what the evidence shows about asking someone directly about suicide, in which settings,
    and what it hasn't tested
  - >-
    Decide what to say when asked to keep a plan to self-harm secret, and explain why that advice
    differs from the services' advice after a disclosure of abuse or assault
  - >-
    Identify what this course doesn't teach about suicide, and where each of those things is taught
    or done
quiz:
  - q: >-
      A housemate tells you she has thought about how she would hurt herself, then says, "You can't
      tell anyone. Promise me." What do 988, #BeThe1To and R U OK? advise about the promise?
    options:
      - Promise, so she keeps talking, and keep it unless she seems to be getting worse
      - Promise for now, then tell her family later without saying anything to her
      - Keep it to yourself, since telling anyone would break the trust she has shown
      - Don't agree to keep it secret, and look for support with her, such as a line
    answer: 3
    explain: >-
  ...
  - q: >-
      ...
      lesson read show?
    options:
      - In research, screening and clinical settings, asking hasn't been found to raise it
      - Asking has been proven to prevent suicide, so the question should always be included
      - Asking raises suicidal thinking in a sizeable minority, so the item should be cut
      - Nobody has studied questionnaires, so there's no evidence either way on the worry
    answer: 0
    explain: >-
  ...
  - q: >-
    ...
    options:
      ...
      - Your job is support and connection; a crisis line can advise you if you're unsure
  ...
  - q: >-
    ...
    options:
      - A finding from trials of friends asking friends, which is why charities repeat it
      - A myth, since the evidence shows asking makes no difference in either direction
      - An established fact, since two reviews found that asking prevents suicide outright
...
may be thinking about suicide. It's a hard conversation to start, and one fear often named is that
...
directly."[4] 988's list opens: "Be direct. Talk openly and matter-of-factly about suicide."[1]
#BeThe1To gives the question in words, "Are you thinking about suicide?"[2] R U OK?'s page on
immediate safety offers a longer form, "People in situations like this may be thinking about suicide.
Have you thought about killing yourself?", and says plainly, "Asking the question does not lead to
suicide."[6]
...
**Follow up.** R U OK?: "Pop a reminder in your diary to call them in a couple of weeks. If they're
really struggling, follow up with them sooner."[5] Samaritans asks you to be persistent without
forcing anyone to open up.[3]

**Look after yourself.** 988's page for helpers opens: "It's important to take care of yourself when
you are supporting someone through a difficult time, as this may bring up difficult emotions."[1]
Samaritans goes further than you might expect: "Remember that it's okay to decide that you are no
longer able to help someone and to let them know you won't be contactable for a while."[3]

988 also gathers its advice into five steps, which it calls "evidence-based action steps", without
naming the evidence on that page: "Ask. Be there. Help keep them safe. Help them connect. Follow
up."[1] Those are the service's exact words, and the third step is where this course stops, for
reasons the next section gives.

:::predict Lesson 6, "Asking better questions", pushed you towards open questions, and Samaritans' own listening tips do the same. Yet the question every service here suggests, "Are you thinking about suicide?", can be answered with one word. Why would they want it closed?

Lesson 6 also said closed questions have their own job, and this is the clearest case of it in the course. The services give their reasons. Samaritans: "By asking someone directly about suicide, you give them permission to tell you how they feel, and let them know that they are not a burden."[3] #BeThe1To: asking "communicates that you're open to speaking about suicide in a non-judgmental and supportive way."[2] Those are the services' accounts from experience; no study this course read tested them.

On this course's reading there is a practical side too: a plain word leaves nothing to decode, for either of you. Once the question has been asked, the open questions come back, for the listening that follows.
:::

## A friend's job, and what is not a friend's job

Each service is careful about what it is asking of you. Mental Health First Aid USA: "your role is not
...
What researchers have tested is the fear in the opening paragraph: that asking plants the idea.

:::predict Suppose you wanted to find out whether asking about suicide puts the idea into people's heads. Where could researchers ethically study that, and what kind of conversation would those studies be unable to tell you about?
...
In 2014 Dazzi and three colleagues set out to answer the question
...
Dazzi and colleagues report them:

- Biddle and colleagues (2013) pooled four interview studies of 63 people with a history of
  self-harm or suicidal thoughts, rating their emotional state before and after being asked about it.
...
A **meta-analysis**, which lesson 9 met, pools the numbers from many studies into one estimate. In 2018 Caroline Blades and three colleagues at the University of Western
Australia pooled 18 studies from 2000 to 2017, with 13,192 participants aged 13 to 92: high-school
and college students, service members, people seen in primary care, and people with a history of
suicidal behaviour.[9] This course read the authors' accepted manuscript in full.
...
- **OR = .714** is an odds ratio from four studies that did have a comparison group: 1 would mean no
  ...
  education programme and a telephone call to people after a suicide attempt, so "exposure" here is
  wider than being asked a question.[8][9]

When exposed groups were compared directly with unexposed groups on suicidal thinking, seven studies,
there was no difference either way (an odds ratio of .973, not significant).[9] Distress did not change
overall, and fell a little when the questions came in a one-to-one interview.[9]

Their own summary is careful: "evidence to date suggests that asking research participants about
...
advice, extended from that evidence to a setting nobody has measured.[8][9]

Two positions follow from that gap.

**Ask directly, in plain words.** Samaritans, 988, #BeThe1To and R U OK? all say it, and they have the
strongest evidence available behind them on the core worry: across the studies in two reviews,
including comparisons with groups who were not asked, being asked has not been found to raise
...
who were not, following what the people they talked to thought and did afterwards, including whether
they sought help.
...
## Fenella asks you to promise

Fenella is a close friend. One evening, after a long silence, she says: "If I tell you something, you
have to promise you won't tell anyone." You say, "Of course." Then she tells you she has been
thinking about ending her life, and that she has thought about how.

You might feel two things at once: the weight of what she has said, and the promise. Three of
the services speak to the promise directly. 988: "Never keep it a secret if a friend tells you about
a plan to hurt themselves." It goes on: "Contact 988 so that you can find out what resources are
...
domestic abuse services tell helpers to believe the person, not to tell them to leave, not to confront
the abuser, and that decisions about their life are theirs to make; Refuge adds that in an emergency,
...
course's reading** of why they differ is that immediate danger to life is what separates them: the
suicide services are describing a risk to the person's life now, and even the abuse services make an
exception for an emergency. No service this course read states that rule in those words, so treat it
as a way of remembering the difference, not as a test to apply to a friend.

:::checkpoint Cosmo tells you that his partner reads his messages, controls the money, and last week shoved him into a door. He asks you to keep it between the two of you. Is this Fenella's case again?

No. Nothing he has said is about suicide or a plan to harm himself, so the advice that applies is the domestic abuse services', in Personal Safety lesson 7: believe him, do not tell him what to do or confront his partner, leave the decisions with him, and make sure he knows help exists. That lesson reports the Men's Advice Line giving the same advice for men.

If he later said something that made you worried for his life, this lesson's advice would apply to that.
:::

## What people get wrong

**"Asking will put the idea in their head."** It is a common fear, and a third of
one sample of family doctors shared it.[8] Two reviews of research, screening and clinical settings
found no increase in suicidal thinking after people were asked, and small reductions in pooled
data.[8][9]
...
The practice for this lesson is on paper and with the lines only. **Do not role-play this
conversation with anyone who may be struggling, and do not raise suicide with anyone as practice.**

:::exercise Find the lines, for two places
Take 10 minutes.

Find the crisis line for where you live, from the box at the top or from findahelpline.com, and check the number on the service's own page. Do the same for one place where a friend or relative lives, if it is different. Store both in your phone under names you will recognise in a hurry, with your emergency number, and note whether each line takes calls, texts or chats and whether it takes calls from people worried about someone else.
:::

:::exercise Opening lines, on paper
Take 10 minutes. This is a **rewrite on paper** exercise.

A neighbour you know well has stopped answering the door, and when you do see her she says she is "just tired of everything". In your own words, write (a) the sentence that names what you have noticed, without a conclusion; (b) the direct question, if what she says next worries you; (c) what you would say if she did not want to talk; and (d) the sentence that suggests calling a line together.

Then check each against the services' words in this lesson. She is invented: do not practise these on a real neighbour.
:::

:::exercise If there is someone you are worried about
Take 5 minutes. Optional, and only if there is a real person on your mind.

On paper, work through R U OK?'s readiness questions from Leopold's case for that person, and where and when you might talk.[5] If the honest answer is that you are not the right person, write down who else in their life might be.

This is not an assessment of them, and nothing here tells you how worried to be. If you think they may be in danger now, stop and use the box at the top of this lesson.
:::
...
- **988 Lifeline, ["Help Someone Else"](https://988lifeline.org/help-someone-else/).** The do's and
  don'ts, the five steps and a short guide to listening, on one page. This course read the page in
  full.
- **R U OK?, ["How to ask"](https://www.ruok.org.au/how-to-ask).** The readiness questions and the four
...
1. 988 Suicide & Crisis Lifeline, ["Help Someone Else"](https://988lifeline.org/help-someone-else/).
   **Read: the page, in full**, 26 September 2026. US; practitioner advice. <!-- SOURCES Part E §1.2; lesson 11 gate closure -->
2. #BeThe1To (created by the 988 Suicide & Crisis Lifeline), ["How and Why the 5 Steps Can Help"](https://www.bethe1to.com/bethe1to-steps-evidence/).
   **Read: the page, in full**, 26 September 2026. US; practitioner advice. The page cites no study
   for its sentence about asking. <!-- SOURCES Part E §1.3; lesson 11 gate closure -->
3. Samaritans, ["Supporting someone with suicidal thoughts"](https://www.samaritans.org/how-we-can-help/if-youre-worried-about-someone-else/supporting-someone-suicidal-thoughts/).
   **Read: sections 1, 2, 5, 6 and 7 in full**, 26 September 2026; section 3 (the safety plan) and
   section 4 were not read. UK and Ireland; practitioner advice. <!-- SOURCES Part E §1.1; lesson 11 gate closure -->
4. Samaritans, ["What to do if you think someone is struggling"](https://www.samaritans.org/how-we-can-help/if-youre-worried-about-someone-else/how-support-someone-youre-worried-about/what-do-if-you-think-someone-struggling/).
   **Read: the page**, re-read 26 September 2026. UK and Ireland; practitioner advice. <!-- SOURCES Part E §1.1; lesson 11 gate closure -->
5. R U OK?, ["How to ask: Are you OK?"](https://www.ruok.org.au/how-to-ask). **Read: the page, in full**,
   26 September 2026. Australia; practitioner advice. <!-- SOURCES Part E §1.4; lesson 11 gate closure -->
6. R U OK?, ["What should I do if I'm worried about someone's immediate safety"](https://www.ruok.org.au/what-should-i-do-if-i-m-worried-about-someone-s-immediate-safety)
   (2020). **Read: the page, in full**, 26 September 2026. Australia; practitioner advice. <!-- lesson 11 gate closure -->
7. Mental Health First Aid USA, ["MHFA Action Plan: How ALGEE Helps in Mental Health Challenges"](https://mentalhealthfirstaid.org/news/algee-how-mhfa-helps-you-respond-in-crisis-and-non-crisis-situations/)
   (24 September 2025). **Read: the page, in full**, re-read 26 September 2026. US; practitioner
   advice, one national version of the steps. <!-- SOURCES Part E §1.5; lesson 11 gate closure -->
8. Dazzi, T., Gribble, R., Wessely, S., and Fear, N. T. (2014). Does asking about suicide and related
   behaviours induce suicidal ideation? What is the evidence? *Psychological Medicine*, 44(16),
   3361–3363. [Cambridge Core](https://www.cambridge.org/core/journals/psychological-medicine/article/does-asking-about-suicide-and-related-behaviours-induce-suicidal-ideation-what-is-the-evidence/FCAEE9E5BC840D76CF10AEBECD921AC9).
   **Read: the full text**, re-read 26 September 2026. A short narrative review of 13 papers, not a
   meta-analysis. Biddle et al. (2013), Reynolds et al. (2006) and the doctor surveys are as this
   review reports them; their own papers were not read. <!-- SOURCES Part E §1.6; lesson 11 gate closure -->
9. Blades, C. A., Stritzke, W. G. K., Page, A. C., and Brown, J. D. (2018). The benefits and risks of
   asking research participants about suicide: a meta-analysis of the impact of exposure to
   suicide-related content. *Clinical Psychology Review*, 64, 1–12.
   [DOI](https://doi.org/10.1016/j.cpr.2018.07.001); [authors' accepted manuscript](https://api.research-repository.uwa.edu.au/ws/files/33499098/Full_text.pdf).
   **Read: the full text of the authors' accepted manuscript**, 26 September 2026; the tables and
   forest plots were read only through their captions and the text. Meta-analysis of 18 studies,
   13,192 participants, research settings. <!-- lesson 11 gate closure G8 -->
10. Rape Crisis England & Wales, ["Supporting a survivor"](https://rapecrisis.org.uk/get-help/supporting-a-survivor/).
    **Read: the page, in full**, 26 September 2026. England and Wales; practitioner advice. <!-- lesson 11 gate closure -->
11. The crisis lines' own pages: [988lifeline.org](https://988lifeline.org/), [988.ca](https://988.ca/),
