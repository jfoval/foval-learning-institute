...
objectives:
  ...
  - >-
    Identify which purpose a conversation calls for (understanding information, judging a claim,
    supporting a person) and what changes with it
  - >-
    Trace a stock listening statistic to its source and state what the source can support
  - >-
    Explain why your own rating of your listening is weak evidence, and what better evidence would be
quiz:
  - q: >-
      A careers website says: "Research proves office workers spend most of the working day
      listening." Following it back, you reach a table of self-reported diary studies from several
      decades, with listening between about a fifth and three fifths of communication time. What can
      that table support?
    options:
      - That nothing can be said at all, since self-report makes every such study worthless
      - That office workers do listen most of the day, since the studies all point the same way
      - That listening is often reported as a large share of talk, with no stable percentage
      - That the true figure is near the middle of the range, the fair average across studies
    answer: 2
    explain: >-
      Diary and survey studies from the 1920s on have found listening at or near the top of what
      people report doing, and that direction is reasonably settled. The percentages move with who
      was asked and what counted as listening, so "most of the day" claims more than the table
      holds. Averaging the range treats different definitions as one measurement. And calling the
      studies worthless throws away the one thing they agree on.
  - q: >-
      A colleague reads out the cancellation terms of a phone contract she's about to sign and asks,
      "Is that clause as reasonable as the salesman made out?" Which purpose is your listening
      serving now, and what changes?
    options:
      - Supporting a person, so you acknowledge how stressful contracts can be before anything else
      - Understanding information, so you simply make sure you've got each clause word for word
      - All three equally, since the textbooks say every conversation serves every purpose
      - Judging a claim, so you weigh the clause against the salesman's version and say so
    answer: 3
    explain: >-
      She's asked you to evaluate something, which is the textbooks' judging purpose: you need the
      clause exactly (the understanding purpose comes first), but the question is whether it matches
      what she was told. Nothing she said asks for support, so leading with reassurance answers a
      question she didn't ask. The textbooks list the purposes to help you pick among them, not to
      say every exchange needs all three at once.
  - q: >-
      A manager scores himself 6.8 out of 7 on a self-report listening questionnaire and puts it in
      his annual review as evidence he's a strong listener. What does this lesson say about that
      evidence?
    options:
      - It's weak on its own, and his team's ratings and checked restatements would tell you more
      - It's good evidence, since he knows his own listening habits better than anyone else could
      - It's useless, because the questionnaire items were written for salespeople, not managers
    ...
    explain: >-
      ...
      history doesn't make it useless.
  - q: >-
      A training company sorts every new employee into one of four fixed "listening types" from a
      short questionnaire and prints the type on their badge. What is the strongest objection from
      this lesson?
    options:
    ...
    explain: >-
      ...
      sound measurement.
  - q: >-
      A friend who read a listening textbook says: "Scholars have finally agreed what listening is.
      It's the five stages: hearing, attending, understanding, responding, remembering." What is the
      accurate reply?
    options:
  ...
  - q: >-
    ...
    options:
      ...
      - As settled for the second view, since a modern study showed that listening to win is useless
      - As settled for the first view, since research finds that people like being listened to
      - As a question the evidence will settle once someone runs a large enough experiment on it
    answer: 0
    explain: >-
...
by "listening" changes from one source to the next. What a listener is for changes from one
conversation to the next. And the evidence people give for how well they listen, their own
included, is often much weaker than it sounds.

## Two words for two things

Every interpersonal communication textbook this course looked at separates **hearing** from
**listening**. Hearing is the physical part: sound reaches you. Listening is what you do with it:
attending, making sense of it, responding, remembering. Adler, Proctor and Manning's *Looking Out,
Looking In* opens its listening chapter on "Hearing vs. listening" and then lists five elements,
from hearing through attending, understanding and responding to remembering.[2] This course read
that book's chapter outline (from its 13th edition) and its current table of contents, not the
...
And none of them is what most people mean. When "the average individual" talks about listening,
Worthington and Bodie write, they mean "a state of interpersonal connection with and presence of
others".[3] That gap between the scholars' word and yours is worth keeping in mind all through this
course: a study that measured recall of a recorded talk and a friend who says "you never listen to
me" are using the same word for different things.
...
Charles Duhigg's popular book *Supercommunicators* offers a similar three-way split: practical
conversations ("what is this really about?"), emotional ones ("how do we feel?") and social ones
("who are we?"), as Kirkus's review summarises it.[6] Treat it as a heuristic, a handy way to ask
yourself what is going on, not a finding. A review by Yeomans, Schweitzer and Brooks makes a related
point in research terms: people bring **informational** goals (getting or giving accurate
information) and **relational** goals (building the relationship) to a conversation, and often
hold both at once, sometimes in conflict.[7] It is a theoretical review with no new data.

Here's why the purpose matters. Fintan rings you about his roof.

> "The roofer came round. He says eleven tiles need replacing and the flashing round the chimney's
> gone. He wants it done before the weather turns."

So far you're listening to **understand**: what's wrong, what's proposed, by when. If you mishear
"eleven" or miss the flashing, nothing else you do will help. Then he says:

> "He's quoted just under two thousand. Does that sound right to you?"

Now he's asked you to **judge** a claim. Understanding is still needed, but the question has
changed: is the quote fair, and what would you need to know to say? Then:

> "I honestly don't know how I'll pay it this month. I've had a terrible few weeks."

That's a third purpose, **supporting** a person, and the best reply to the second message is a poor
reply to the third. Launching into what roofers usually charge answers a question he's stopped
asking. If a conversation like this turns from money worries to something more serious, lesson 11,
"When it's serious", and Mental Fitness lesson 1, "Where ordinary ends", are where this course and
the institute deal with it.

:::checkpoint Name the purpose each opener calls for. (a) "Can you go over what the doctor said about the dose again?" (b) "My brother says electric cars cost more to run. Is that true?" (c) "I didn't get the job."
(a) Understanding information: the speaker wants the content back accurately. (b) Judging a claim: she's asking you to weigh her brother's statement. (c) Most likely supporting a person, although it could turn into a practical conversation about the next application if he takes it there.

Notice (c) could go either way, which is the point: the purpose is something you find out by listening, not something you assign in advance. Lesson 7, "Ask, don't guess", is about how.
:::

## Where the 45% came from

Now the number. What follows is the chain, link by link, with what each link could and could not
support. It is the most useful thing in this lesson, because every stock statistic you will meet in
...
Nichols and Leonard Stevens's 1957 book [*Are You Listening?*](https://archive.org/details/areyoulistening00ralp), Rankin "had selected 68 adults of
...
that adults spend about 45 percent of their time listening", citing a later textbook, and adds 55%
...
The second stock number is harder, because it does come from real tests.

Nichols tested listening at the University of Minnesota. In *Are You Listening?* he describes
testing "several thousand students" and "hundreds of business and professional people": each
...
Almost nothing directly. The material is different (a prepared talk against a story told to you), the task is different (multiple-choice questions against remembering what matters to the person), and the relationship is different. Worthington and Bodie say it themselves: "recall of lecture material is qualitatively different from recall in an interpersonal context, where emotional overtones may affect retention."[3]

The lecture figure did not even hold steady within Nichols's own work: about half in his later account, 68% in his 1948 study. A number that moves that much on its home ground should not be carried to someone else's.
:::

The same chain has a third link you can trace yourself. Nichols argued that listening is hard
because we think faster than people talk, so attention has spare time to wander. The idea is
...
on short talks and lectures, and even there they moved from about half to 68%. They say nothing
...
:::exercise Rate yourself, then ask
Take 10 minutes now, and a few more when your partner has rated you.

1. Rate yourself from 1 (never true of me) to 7 (always true of me) on these five items from Bodie's scale: "I am aware of what others imply but do not say." "I listen for more than just the spoken words." "I keep track of points others make." "I summarize points of agreement and disagreement when appropriate." "I ask questions that show my understanding of others’ positions."[14] Write the numbers down before step 2.
2. Ask one person who knows you well and has agreed to help to rate you on the same five items, thinking of how you are with them. Tell them first that they can decline, and that they do not have to say anything kind. Do not show them your numbers.
3. Compare the two sets item by item. Write down the biggest gap, and one recent conversation that might explain it.
4. Keep both sets private. Nothing here gets posted, and the other person's ratings stay between you.

If nobody is willing, do step 1, then write down for each item one moment from the last week that supports your rating and one that does not.
:::
...
Take 5 minutes at the end of a day.

1. Pick three ordinary conversations from today or yesterday. Choose low-stakes ones.
2. For each, write in your journal which purpose it called for (understanding information, judging a claim, supporting a person), or where it changed from one to another.
3. For each, write one sentence on whether you listened for that purpose, and one reply you'd change.

Write from memory, and do not name anyone or write anything that would identify them.
:::

## For your journal

This lesson adds two things. First, a purpose line to each journal entry: which purpose the
conversation called for, and whether you noticed in time. Second, a habit for the project's "one
claim checked" part: when you meet a number about listening, write down where it says it came from,
and how many links back you can follow it before the trail stops.
...
Lesson 4, "How listening goes wrong", names the ways listening fails. Lesson 9, "Does active
listening work?", comes back to definitions, because the studies of active listening each meant
something different by it. And lesson 17, "A famous talk, checked", runs this lesson's tracing on a
whole talk.
...
- **Nichols and Stevens, [*Are You Listening?*](https://archive.org/details/areyoulistening00ralp)
  ...
  in their own words.
- **Bodie, Worthington and Gearhart, ["The Listening Styles Profile-Revised"](https://static1.squarespace.com/static/5633a3ade4b02b1547969346/t/572d1bdb40261d2ef97f3eb2/1462574044157/LSPR+CQ+FINAL+PUBLISHED.pdf)**
  (2013), the authors' copy. This course read the abstract, opening and discussion; the opening is where the
  correction to the old four styles is made.
- **Rogers and Farson, [*Active Listening*](https://wholebeinginstitute.com/wp-content/uploads/Rogers_Farson_Active-Listening.pdf)**,
  a five-page 1987 excerpt of the 1957 booklet, read in full here. Short, and the source of the
  phrase.

## Sources

1. Acas, [*Challenging conversations and how to manage them*](https://www.acas.org.uk/sites/default/files/2021-04/challenging-conversations-and-how-to-manage-them.pdf),
   July 2014. **Read: the question and listening sections**; the listening page re-read 26
   September 2026. <!-- SOURCES Part E §4.4; lesson 03/04 gate closures -->
2. Adler, Proctor and Manning, *Looking Out, Looking In*, 16th edition (Cengage). **Read: the
   ...
   edition; the chapter text was not read.** <!-- SOURCES Part A §1.1 -->
3. D. L. Worthington and G. D. Bodie, "Defining listening: A historical, theoretical, and pragmatic
...
6. C. Duhigg, *Supercommunicators* (Random House, 2024). **Read: the publisher's free sample and
   Kirkus's review**; the three kinds of conversation as Kirkus summarises them. <!-- SOURCES Part A §6.3 -->
7. M. Yeomans, M. E. Schweitzer and A. W. Brooks, "The conversational circumplex", *Current Opinion
   in Psychology* 44 (2022), 293 to 302, [doi:10.1016/j.copsyc.2021.10.001](https://doi.org/10.1016/j.copsyc.2021.10.001).
...
9. S. Usera, *Communicating to Connect*, section ["7.1 The Fundamentals of Listening"](https://socialsci.libretexts.org/Bookshelves/Communication/Introduction_to_Communication/Communicating_to_Connect_-_Interpersonal_Communication_for_Today_(Usera)/07:_Listening/7.01:_The_Fundamentals_of_Listening)
   ...
   abstract, which gives 24%. <!-- SOURCES Part A §3.1, §4.2; lesson 03/04 gate closures -->
10. L. A. Janusik and A. D. Wolvin, "24 Hours in a Day: A Listening Update to the Time Studies",
    *International Journal of Listening* 23(2) (2009), 104 to 120. **Read: the abstract only**
    (ERIC), re-read 26 September 2026. <!-- SOURCES Part A §3.1; lesson 03/04 gate closures -->
11. University of Minnesota Libraries, *Communication in the Real World*, chapter 5,
    ["Listening"](https://open.lib.umn.edu/communication/part/chapter-5-listening/) (2016, CC
    BY-NC-SA). **Read: sections 5.1 to 5.3 at Stage 1**; section 5.2 re-read 26 September 2026 from
    Internet Archive capture 20241228174458. <!-- SOURCES Part A §4.1, §3.1, §3.3; lesson 03/04 gate closures -->
12. C. Headlee, ["10 ways to have a better conversation"](https://www.ted.com/talks/celeste_headlee_10_ways_to_have_a_better_conversation/transcript),
    TEDxCreativeCoast, 2015. **Read: full transcript**, re-read 26 September 2026. <!-- SOURCES Part A §6.1, §3.3; lesson 03/04 gate closures -->
