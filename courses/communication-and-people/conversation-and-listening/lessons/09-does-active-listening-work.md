---
title: Does active listening work?
minutes: 90
objectives:
  - >-
    Explain why "active listening" has meant different things in different studies, and why a
    result for one meaning doesn't carry to another
  - >-
    Compare what the paraphrase experiments and the high-quality listening experiments found,
    including what each compared its listeners against
  - >-
    State what the four-lab test and the workplace meta-analysis add, and what a correlation of .39
    does and does not mean
  - >-
    Explain the controversy over active listening in couples' conflict in both sides' own terms,
    and say what evidence would settle it
quiz:
  - q: >-
      A company's newsletter reports that staff whose line managers took a listening course felt
      more listened to than staff whose managers were on a waiting list for it. Which follow-up
      question does most to tell you what the course itself achieved?
    options:
      - Whether the staff who were surveyed liked their managers before the course started
      - Whether the survey was sent out before the course, after it, or on both occasions
      - Whether the staff knew which of the managers had been on the listening course
      - Whether the managers on the course were chosen at random from those who applied
    answer: 3
    explain: >-
      If managers chose themselves, the keenest listeners may have signed up first, and the gap is
      partly who they were rather than what they learned. Random assignment is what lets the
      comparison say something about the course. Whether staff knew who went matters too, since
      they might rate expectations rather than behaviour, but it comes second. Earlier liking and
      survey timing are worth knowing, and neither rules out self-selection.
  - q: >-
      Two studies both report that "active listening" helped. In one, a listener was told to give
      full, warm attention and was compared with a listener who kept checking a phone. In the
      other, a listener restated each point and was compared with one who said only "right" and
      "OK" with the same eye contact. What can you conclude?
    options:
    ...
    explain: >-
      ...
      attention steady and varies only the restating. They answer different questions, which is
      the point of asking what the other group got. The phone study doesn't show restating works,
      because restating wasn't what varied. And different outcomes don't make both worthless: each
      tells you about its own comparison.
  - q: >-
      A meta-analysis of hospital studies finds that patients' ratings of how well nurses listened
    ...
    answer: 3
    explain: >-
      A correlation says two measures move together; it isn't a percentage of anything, of people
      or of improvement. Pooling studies makes the estimate more precise but doesn't turn a
      correlation into a cause. And when the same patients rate both things, a general good or bad
...
2010 paper by listing training in it for nurses, crisis counsellors, therapists, teachers, salespeople and
couples, and suggested that perhaps no communication skill is named as often in training.[1]
...
When researchers say they tested active listening, check what they put in the box. Across the
studies this course read, there are at least four different things under that name; the list is
this course's reading of those studies, not any one paper's.

- **Paraphrase alone.** One 2010 experiment deliberately tested only restating the speaker's point
  in the listener's own words, with everything else held steady.[1]
- **A bundle of behaviours.** A 2015 study coded open questions, paraphrases, reflections of
  feeling, checks of assumptions, and nonverbal signs of attention such as eye contact.[3]
- **Any warm response to a partner's upset.** A 1998 study of newlyweds counted any moment where
  one spouse's negative feeling was met by the other's interest, affection, humour or
  validation.[10]
...
"Hearing is not listening", showed that listening is measured three ways (your own rating, the
speaker's rating, and coded behaviour) and that your own rating is weak evidence. Add four definitions to three
measures and it's no surprise the headlines conflict.

## Paraphrase on its own

### An experiment, read as a design
...
### Strangers, with advice as a rival

Four years later, Weger and three colleagues ran [a second experiment](https://doi.org/10.1080/10904018.2013.813234), and this course read the full
text of that too.[2] Here 115 undergraduates at a large south-eastern US university each talked for
about five minutes with a stranger who was, unknown to them, one of ten trained student
confederates. The pair took turns answering two prompts: "Please discuss your plans for this
weekend," and "What has been your biggest disappointment with (university name) since you began
attending school here."[2]

The confederates responded in one of three ways, chosen by a roll of a die:

- **Active listening:** "paraphrasing the participant's message and, when appropriate, asking the
  participant to elaborate on what they said".
- **Advice:** suggesting what to do at the weekend, or solutions to the problem the participant
  named.
...
:::checkpoint The 2010 experiment found paraphrase didn't make people feel more understood; the 2014 one found active listening did. Using the two designs, list at least two differences that could explain the split.

Several, and the studies can't tell you which matters:
...
The third study went nearer to what people mean by listening to a friend. Graham Bodie, Andrea
Vickery, Kaitlin Cannava and Susanne Jones had undergraduates at Louisiana State University tell a
partner about a recent upsetting problem, mostly everyday student stresses such as exams, break-ups
and roommates, in a five-minute conversation.[3] In 41 of the pairs the listener was a trained
active listener: one of eight counselling master's students in the final year of their programme,
seven of them women. In the other 130, the listener was another undergraduate with no training.
This course read the full text in [Bodie's own copy](http://www.grahambodie.com/s/The-Role-of-Active-Listening-WJC_PUBLISHED.pdf).

The trained listeners were there, the authors say, to make sure the study saw plenty of variety in
listening behaviour. The analysis didn't simply compare trained with untrained; it coded what every
listener did (open questions, paraphrases, reflections of feeling, checks, eye contact, facial
expression and so on) and asked how much of the variation in the disclosers' ratings those
behaviours accounted for.[3]

The answers were modest. The behaviours together accounted for about 14% of the variation in how
emotionally aware the disclosers felt the listener was (R² = .14), and about 13% of the variation in
how much better they felt afterwards (R² = .13). They did nothing detectable for whether the
conversation helped solve the problem, or for the discloser's sense of the relationship.[3] For
feeling emotionally understood, paraphrasing carried almost half of that 14%. For feeling better,
no single behaviour carried much. The authors' summary: "the magnitude of effects was relatively
small, suggesting that the enactment of active listening behaviors is not a panacea."[3] It's a
**single study**, with the limits the authors name: strangers only, and seven of the eight trained
listeners women.[3]
...
Now a different box. Itzchakov, Kluger and their colleagues study what happens to a speaker when
someone listens to them with full attention, trying to understand and not judging. It is **one
group's programme**, with many experiments, several of them preregistered (the plan published in
advance, so the analysis can't be bent to fit the result), mostly from the same research network.

This course read two of its main journal papers only as abstracts, because the publisher's site was
closed to it. In four laboratory experiments published in 2017, high-quality listening reduced
speakers' social anxiety, made them more aware of the contradictions in their own attitudes, and
made those attitudes less extreme; the abstract's phrase is that attitude structure could be changed
by "merely providing high quality listening".[4] In five experiments published in 2018, one
preregistered, high-quality listening made speakers clearer about their attitudes (not more
correct) and more willing to express them, but not more eager to persuade others.[5] The abstracts
give no effect sizes, so this course gives none.

What were those listeners compared with? Lesson 4, "How listening goes wrong", described one
...
## A test across four labs

The obvious next question is practical. If being listened to well helps, can you get people to do
it by asking them to? In 2026, Kenneth DeMarree, Itzchakov and five colleagues [posted the results](https://doi.org/10.31234/osf.io/b9e2s_v2) of
a large preregistered experiment that tried, in Israel, Singapore, the UK and the US.[8] It is a
preprint, which means it had not yet been through peer review when this course read the full text.

Two strangers who disagreed about a topic (in the US lab, subjects such as remote classes, requiring
a college degree for most professions, or parents monitoring a teenager's messages) talked over video for ten minutes. Before
the conversation, one of them was given a goal. Half of these got a learning goal: "we ask that you
attempt to learn about their perspective on the issue." The other half got a goal of persuading the
other person. Each then wrote about why the goal was worth pursuing and how they would pursue it.
The partner got no goal at all. After the conversation, both rated how well the other had
listened, and reported how open-minded they felt and how they now saw the topic and each
other.[8] After exclusions, 1,407 people took part, most of them university students.
...
about the impact of learning goals."[8] The persuasion instruction did register with the people who
got it, but their partners didn't notice any difference. In the authors' words, "simply trying to
learn or persuade does not immediately translate into behavior that one's partner recognizes as an
instance of goal pursuit."[8]

So the four-lab test doesn't show that trying to understand someone is useless. It shows that a
short written instruction didn't change how people behaved in a live disagreement with a stranger,
as their partners saw it. The authors suggest why, as possibilities rather than findings: in a real
back-and-forth, people also want to explain themselves and make a good impression, and those aims
may crowd a learning goal out.[8]

Two more things in the paper matter here. First, in all four countries, people who felt better
listened to reported more psychological safety, the sense that they could say what they thought
without bad consequences, and more safety went with less negative views of the other person on most
...
difficult to induce, interpersonal behavior".[8]
...
managers, salespeople and healthcare staff. Of the studies, 46% were run in the United States.[9]

Across everything, perceived listening correlated with good work outcomes at an average of **r =
...
scores, fairly consistently, with plenty of exceptions.

Logic and Argument lesson 5, "Inductive strength", gave the four readings of any correlation between
A and B: A causes B, B causes A, something else causes both, or chance. Run them here. With this
much data, chance is the weakest. But good performers may be the ones managers listen to (B causes
A), and a good working relationship may produce both the feeling of being listened to and the good
outcomes (a common cause).

The authors raise that last possibility themselves, in a sharper form. Three quarters of the effects
came from studies where one person filled in one questionnaire rating both the listening and the
outcome, and the abstract says the reliance on self-report raises "concerns about discriminant
validity", meaning the measures may not be telling different things apart.[9] When the same person
rated both, the average was .43; when different sources were used, .26.[9] If the listening scales
are mostly picking up a good relationship, then, in their words, "the results reported above may
reflect the benefits of good relationships for performance, affect, and cognition instead of the
...
The loudest argument about active listening isn't about strangers or workplaces. It's about couples
in conflict. The full science of couples belongs to Relationships and Family and Conflict Resolution,
later courses. This section covers only the dispute over listening, which is **contested**.

### What Gottman's team found
...
negative feeling was followed by the other's interest, affection, humour or validation.

:::predict Out of fifteen minutes (900 seconds) of arguing, how much time do you think those listening sequences took up, on average? And did couples who used more of them do better?

About 4 seconds out of 900. And no, they didn't predict who stayed married or who was happy. "These active listening exchanges hardly ever occurred, and they were not predictive of differential marital outcomes."[10]
:::
...
Their interpretation is phrased as a hypothesis: "we are led to the hypothesis that the active
listening model may be expecting a form of emotional gymnastics from people who, at that moment in
that relationship, are somewhat emotionally disabled by conflict."[10] They point out a difference
...
challenge.[12] Whether the reply conceded anything on active listening, the abstract doesn't say.
...
course found no retraction, only a later exercise that uses restating.[10][11][13]

**"A correlation of .39 means listening improves performance by 39%."** A correlation isn't a
percentage or a cause, and the authors call causation a possibility their review couldn't
test.[9]

**"The four-lab study shows trying to understand people is pointless."** The instruction didn't
change how much people tried, by their own report, so the authors say the idea wasn't really
tested.[8]

**"Advice is always worse than listening."** In the 2014 experiment, advice satisfied strangers as
much as active listening did. Lesson 10 takes advice up properly.[2]

## Practice

:::exercise Five questions for a listening claim
This is a **rewrite on paper** exercise. Take 10 minutes. The claim below is invented by this course, for practice; it is not from any study.
...
5. **Replicated where?** One workshop, one company, one year. Nothing independent.

An honest rewrite on the weakest plausible answers: "After some managers chose to attend a two-hour workshop, the company recorded fewer complaints in those managers' teams than the year before." That may still be worth knowing. It isn't what the original claimed.
:::

:::exercise Stance or words?
This is a **notice** exercise. Take 5 minutes, within an hour of an ordinary conversation this week in which you restated what someone said.

Write, from memory, what you said back and how the other person responded. Then write your own judgement on one question: did the restating do the work, or was it the attention behind it, or can't you tell? Nobody named or identifiable, and no recording.
:::
...
Lesson 8, "Saying it back", taught the practice this lesson weighs, and the studies here give
...
experiment than the listening tradition would predict. Lesson 16, "Listening to someone who
disagrees with you", returns to the four-lab study and to the programme's experiments on
disagreement, which found that high-quality listening reduced polarisation.[14] The couples'
controversy continues in Relationships and Family and Conflict Resolution, later courses.
...
1. Weger, H., Jr., Castle, G. R., and Emmett, M. C. (2010). Active listening in peer interviews: the
   influence of message paraphrasing on perceptions of listening skill. *International Journal of
   Listening*, 24(1), 34–49. [DOI](https://doi.org/10.1080/10904010903466311). **Read: the full
   text**, on the publisher's free-access page in a browser, 26 September 2026. Single study, 180
   undergraduates. <!-- lesson 09 gate closure G1; SOURCES Part C §2.1 -->
2. Weger, H., Jr., Castle Bell, G., Minei, E. M., and Robinson, M. C. (2014). The relative
   ...
   text**, on the publisher's free-access page in a browser, 26 September 2026. Single study, 115
   undergraduates; Markman et al. 2001 as reported there. <!-- lesson 09 gate closure G1; SOURCES Part C §2.2 -->
3. Bodie, G. D., Vickery, A. J., Cannava, K., and Jones, S. M. (2015). The role of "active
   listening" in informal helping conversations. *Western Journal of Communication*, 79(2),
   151–173. [Author's copy](http://www.grahambodie.com/s/The-Role-of-Active-Listening-WJC_PUBLISHED.pdf).
   **Read: the full text**, the author's self-archived publisher PDF, re-read 26 September 2026. <!-- SOURCES Part C §2.3; lesson 09 gate closure -->
4. Itzchakov, G., Kluger, A. N., and Castro, D. R. (2017). I am aware of my inconsistencies but can
   tolerate them. *Personality and Social Psychology Bulletin*, 43(1), 105–120.
   [DOI](https://doi.org/10.1177/0146167216675339). **Read: the abstract only**, and the 2017
   corrigendum (a sign error in one figure). <!-- SOURCES Part C §4.1; lesson 09 gate closure -->
5. Itzchakov, G., DeMarree, K. G., Kluger, A. N., and Turjeman-Levi, Y. (2018). The listener sets
   the tone. *Personality and Social Psychology Bulletin*, 44(5), 762–778.
   [DOI](https://doi.org/10.1177/0146167217747874). **Read: the abstract only.** <!-- SOURCES Part C §4.2 -->
6. Itzchakov, G., and Kluger, A. N. (2018, 17 May). The power of listening in helping people change.
   *Harvard Business Review*.
   [Article](https://hbr.org/2018/05/the-power-of-listening-in-helping-people-change). **Read: the
   full text**, the authors' hosted copy. The studies as the article describes them; the journal
   papers behind them are not identified there. <!-- SOURCES Part C §4.4; lesson 03/04 gate closures -->
7. Itzchakov, G., and Bodie, G. D. (2026). Puzzles of interpersonal listening: conflicting findings,
   theories, and future research. *Social and Personality Psychology Compass*, 20.
   [Open access](http://www.grahambodie.com/s/ItzchakovBodie2026.pdf). **Read: the full text**,
   re-read 26 September 2026. A narrative review; its account of other studies is theirs. <!-- SOURCES Part C §2.5; lesson 09 gate closure -->
8. DeMarree, K. G., Itzchakov, G., See, Y. H. M., Weinstein, N., Lee, T., Turjeman-Levi, Y., and
   Venezia, A. (2026). Learning goals and listening in polarized conversations: a test across four
   labs. PsyArXiv preprint. [DOI](https://doi.org/10.31234/osf.io/b9e2s_v2). **Read: the full
   text** of the preprint (version 2), 26 September 2026. Not peer reviewed at the time of
   reading. <!-- lesson 09 gate closure G1; SOURCES Part C §4.6 -->
9. Kluger, A. N., Lehmann, M., Aguinis, H., Itzchakov, G., and others (2024). A meta-analytic
   systematic review and theory of the effects of perceived listening on work outcomes. *Journal of
   Business and Psychology*, 39(2), 295–344. [Open access](https://doi.org/10.1007/s10869-023-09897-5).
   **Read: the full text**, on the publisher's open-access page in a browser, 26 September 2026;
   the tables were not read. <!-- lesson 09 gate closure G1; SOURCES Part C §4.5 -->
10. Gottman, J. M., Coan, J., Carrère, S., and Swanson, C. (1998). Predicting marital happiness and
    stability from newlywed interactions. *Journal of Marriage and the Family*, 60(1), 5–22.
    [Scan on the author's site](https://www.johngottman.net/wp-content/uploads/2011/05/Predicting-Marital-Happiness-and-Stability-from-Newlywed-Interactions.pdf).
    **Read: an OCR of the scanned paper, checked against the page image** for every quotation,
    26 September 2026. <!-- SOURCES Part C §3.1; lesson 09 gate closure G4 -->
11. Stanley, S. M., Bradbury, T. N., and Markman, H. J. (2000). Structural flaws in the bridge from
    basic research on marriage to interventions for couples. *Journal of Marriage and the Family*,
    62(1), 256–264. **Read: the abstract only.** <!-- SOURCES Part C §3.2; lesson 09 gate closure -->
12. Gottman, J., Carrère, S., Swanson, C., and Coan, J. A. (2000). Reply to "From basic research to
    interventions". *Journal of Marriage and the Family*, 62(1), 265–273. **Read: the abstract
    only.** <!-- SOURCES Part C §3.3 -->
13. The Gottman Institute (2016). [Money Conflict Blueprint](https://www.gottman.com/wp-content/uploads/2016/09/Money-Conflict-Blueprint.pdf),
    including the Gottman-Rapoport Conflict Blueprint. **Read: the full handout**, re-read 26
    September 2026. Practitioner material. <!-- SOURCES Part C §3.5; lesson 09 gate closure -->
14. Itzchakov, G., Weinstein, N., Leary, M., Saluk, D., and Amar, M. (2024). Listening to
    understand: the role of high-quality listening on speakers' attitude depolarization during
    disagreements. *Journal of Personality and Social Psychology*, 126(2), 213–239. **Read: the
    article's one-page abstract only.** <!-- SOURCES Part C §4.6 -->
