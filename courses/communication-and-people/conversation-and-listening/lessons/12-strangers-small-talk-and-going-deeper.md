...
objectives:
  - >-
    ...
    what actually happened, and where the London study located the barrier
  - >-
    Explain what the deep-talk experiments found, the reason their authors propose, and which of
    their results were inconsistent
  - >-
    State what the 2010 small-talk study found, what its pooled replication found, and what that
    teaches about trusting a single finding
  - >-
    Identify who was studied in each of this lesson's studies and in what setting, and say what that
    limits
quiz:
  - q: >-
      Mungo read about a study in 2011 saying happier people have less small talk, and since then
      he has avoided chatting at the office kettle. What did the pooled replication find about small
      talk?
    options:
      - It confirmed the link, so keeping small talk to a minimum is a sensible habit
      - It found that small talk makes people happier, so he should chat far more often
      - It found no reliable link between small talk and life satisfaction either way
      - It couldn't test the link, because the new samples used a different recorder
    answer: 2
    explain: >-
      Pooling four samples, the replication found small talk unrelated to life satisfaction, whether
      counted as a share of all recordings or of conversations, while substantive conversation still
      went with it. That isn't evidence that small talk makes people happier either: a null result
      and a correlation both say nothing about cause, so advising him to chat far more goes past the
      data. The claim that the link was confirmed is the part that failed, and the replication used
      the same kind of recorder and coding scheme, so it was a fair test.
  - q: >-
      Suppose the pattern from the London rail study held in a dentist's waiting room, which nobody
      has tested. What would most likely keep two strangers there from talking?
    options:
      - Each expects a conversation, once it's going, to be dull and to drag on too long
      - Each expects the other won't want to talk, so trying to start one feels risky
      - Each has found before that talking makes a wait feel longer than sitting quietly
      - Each knows most attempts to talk to a stranger in public end in being rebuffed
    answer: 1
    explain: >-
      The London commuters expected a conversation, once started, to be pleasant; what they dreaded
      was starting one, because they guessed only about a quarter of fellow passengers would be
      willing. That is the barrier this answer names. The London commuters didn't expect talk to be
      dull, and a later set of experiments found enjoyment held up as conversations went on. Talking
      didn't make the commute worse in either rail study. And in the Chicago study nobody who returned
      a survey reported being rebuffed, so frequent rejection isn't what the evidence shows.
  - q: >-
      Dorcas is meeting a new colleague for lunch and has copied out some deep questions from a
      magazine. Which statement do the deep-talk experiments support?
    options:
      - People tend to expect deep talk with a stranger to be more awkward than it is
      - Deep talk with a stranger reliably leaves both people happier than small talk
      - Deep questions work best when they're asked before any small talk at all
      - Deep talk with a stranger feels about as awkward as people expect it will
    answer: 0
    explain: >-
      The finding that held across the experiments was the gap between expectation and experience:
      people expected deep conversations with strangers to be much more awkward than they turned out
      to be. The claim that depth reliably makes people happier than small talk goes further than the
      authors' own results, which they call "somewhat inconsistent" across experiments. Nothing
      tested asking deep questions before any small talk, and the authors themselves suggest shallow
      questions may be a gateway to deeper ones. And the claim that deep talk is as awkward as
      expected is the opposite of what they found.
  - q: >-
      A headline says: "Science shows talking to strangers makes everyone happier." Which correction
      is most accurate to the studies in this lesson?
    options:
  ...
  - q: >-
    ...
    options:
      - A survey asking a large sample whether they prefer small talk or deeper talk
      - Following the same people over weeks, comparing lighter days with deeper ones
      - Another lab session with strangers given a set of deep or shallow questions
...
Nicholas Epley and Juliana Schroeder's [nine experiments](https://cdn.prod.website-files.com/699728903166dd3429c6b4fd/699728903166dd3429c6b5c3_EpleySchroederJEPG2014.pdf)
began at the Homewood, Illinois, station of the Metra commuter rail.[1] Research assistants
...
The same group then ran [a version of the study](https://cdn.prod.website-files.com/699728903166dd3429c6b4fd/699728903166dd3429c6b683_SchroederLyonsEpley%20Hello%20Stranger.pdf)
on trains in and out of London, recruiting 466 commuters at Liverpool Street, Cambridge, Chelmsford
and Colchester stations, of whom 383 completed the survey.[2] Again, those assigned to talk to a
stranger reported a more positive commute, and said they had learned more, than those assigned to
solitude or to travel as usual. About 78% of the talking group reported actually having a
conversation.[2]
...
pleasant conversations with strangers because of miscalibrated concerns about starting them."[2] And
the talkers who didn't manage it, the authors report, "were not rejected by others but instead seemed
more likely to infer that others did not want to talk and hence did not try".[2]
...
The first experiment was run on 25 pairs of financial services executives at a management
conference. Each pair discussed four questions for about ten minutes, among them "For what in your
life do you feel most grateful?" and a request to describe a time they had cried in front of another
person. Before talking, they badly underestimated how interested the other person would be in their
answers, and overestimated how awkward it would feel.[3] Asked afterwards, the same executives said
they wished they had deep conversations with strangers much more often than they did. They also
wished for a little more small talk, though that result was only marginal.[3]

Experiment 2 added a comparison. Eighty-nine pairs of master's students at a campus wellness event
were given either five shallow questions ("How did you celebrate last Halloween?") or five deep ones,
and predicted, then reported, how awkward and how connected they felt.[3]

:::predict Both groups expected some awkwardness. Which group, deep or shallow, do you think overestimated it more? And when the deep conversations did turn out a little more awkward than the shallow ones, how did that real difference compare with the difference people had expected?
...
experiments, run online, changed what people expected about others' interest, people chose deeper
questions to discuss.[3] That's the authors' mechanism, tested within their designs.
The abstract puts the conclusion this way: "Misunderstanding others can encourage overly shallow
interactions."[3]
...
Second, the clearest comparison came when the same people had both kinds of conversation. Before two
...
Several of the deep questions came from a procedure published in 1997 by Arthur Aron and four colleagues, now
...
45 minutes: 4.06 against 3.25 on a combined closeness measure, d = .88.[6] On Mental Fitness lesson
...
Now the study from the start of the lesson. In 2010 Matthias Mehl, Simine Vazire and two colleagues
had 79 undergraduates wear the Electronically Activated Recorder, a small device that switched itself
on for 30 seconds every 12.5 minutes for four days.[7] Coders then sorted the recorded conversations.
**Small talk** was an uninvolved, banal exchange of trivial information; a **substantive**
conversation was involved and exchanged meaningful information. Each student's well-being was
measured by their own ratings and by people who knew them.

The headline result: well-being went with less small talk (r = −.33) and more substantive
...
In 2018 Anne Milek and seven colleagues, [Mehl and Vazire among them](https://pmc.ncbi.nlm.nih.gov/articles/PMC6139582/),
pooled the original data with three new samples: people being treated for cancer and their spouses,
healthy working adults at the start of a meditation trial, and adults who had recently divorced or
separated.[8] That gave 486 people in all, with the same kind of recorder, a coding scheme adapted from the
original, and a measure of life satisfaction.

Before you look at the result, notice something about the 2010 number. The −.33 was small talk
counted as a **share of each person's conversations**, against a well-being index that combined life
satisfaction with happiness. The 2010 paper also counted small talk as a share of all the recordings,
and on that measure the link was close to zero even then (−.07, not significant).[7] So a fair
comparison with the replication has to line up the same measures.

:::predict The 2018 study checked four links from 2010: time alone, time talking, small talk and substantive talk. Which do you think held, and which didn't?

Time alone and time talking held, though smaller than in 2010: life satisfaction went with less time alone (r = −.19) and more time talking (r = .22).[8]

Substantive conversation held: r = .23 as a share of all recordings, and .15 as a share of conversations.[8]
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 300" role="img" aria-labelledby="cl12-st-title cl12-st-desc" style="width:100%;height:auto;font-family:inherit">
  ...
  <desc id="cl12-st-desc">Horizontal bars showing correlations with life satisfaction on a scale from minus 0.3 to plus 0.3. Small talk as a share of conversations: 2010 minus 0.25, pooled minus 0.08. Small talk as a share of all recordings: 2010 minus 0.03, pooled plus 0.05. Substantive talk as a share of all recordings: 2010 plus 0.26, pooled plus 0.23. From Mehl and colleagues 2010, 79 undergraduates, and Milek and colleagues 2018, four samples pooled.</desc>
  <text x="10" y="22" font-size="15" fill="var(--text, #111418)">Small talk, share of conversations</text>
  <text x="10" y="47" font-size="15" fill="var(--text-2, #4a5260)">2010</text>
  <rect x="170" y="32" width="100" height="20" fill="var(--navy, #0f2a4a)"/>
  <text x="164" y="47" font-size="15" text-anchor="end" fill="var(--text, #111418)">−.25</text>
  <text x="10" y="73" font-size="15" fill="var(--text-2, #4a5260)">Pooled</text>
  <rect x="238" y="58" width="32" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="232" y="73" font-size="15" text-anchor="end" fill="var(--text, #111418)">−.08</text>
  <text x="10" y="104" font-size="15" fill="var(--text, #111418)">Small talk, share of all recordings</text>
  <text x="10" y="129" font-size="15" fill="var(--text-2, #4a5260)">2010</text>
  <rect x="258" y="114" width="12" height="20" fill="var(--navy, #0f2a4a)"/>
  <text x="252" y="129" font-size="15" text-anchor="end" fill="var(--text, #111418)">−.03</text>
  <text x="10" y="155" font-size="15" fill="var(--text-2, #4a5260)">Pooled</text>
  <rect x="270" y="140" width="20" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="296" y="155" font-size="15" fill="var(--text, #111418)">+.05</text>
  <text x="10" y="186" font-size="15" fill="var(--text, #111418)">Substantive talk, share of all recordings</text>
  <text x="10" y="211" font-size="15" fill="var(--text-2, #4a5260)">2010</text>
  <rect x="270" y="196" width="104" height="20" fill="var(--navy, #0f2a4a)"/>
  <text x="380" y="211" font-size="15" fill="var(--text, #111418)">+.26</text>
  ...
  <text x="390" y="272" font-size="15" text-anchor="middle" fill="var(--text-2, #4a5260)">+.3</text>
  <text x="10" y="294" font-size="15" fill="var(--text-2, #4a5260)">Correlation with life satisfaction</text>
</svg>
...
About her: neither study tested what happens when someone changes their habits. Whether she wants to go back to chatting at the bins is her call, and the evidence no longer gives her a reason not to.
:::

## Small talk or depth: two positions

So is small talk worth having, or should you go deeper? Researchers disagree about the empirical part,
and part of the question is about values, so this course sets out both positions and gives no verdict.

**The depth position.** Kardas, Kumar and Epley argue that people are "overly shallow" in the literal
sense of their title: they stop short of deeper conversation because they wrongly expect it to be
awkward and unwelcome, and "Misunderstanding others can encourage overly shallow interactions."[3]
Their best case is twelve experiments, several with real strangers outside a lab, a consistent gap
between expectation and experience, and the within-person comparison in which people who had both
kinds of conversation preferred the deep one.[3] Mehl and colleagues' 2010 discussion raised the
...
introverted pairs became less close than extraverted pairs when nobody mentioned closeness, and as
...
Run the course's question over this lesson's evidence: finding or advice, who was studied, where, and
compared with what?

| Study | Who, and where | Compared with what | Label |
|---|---|---|---|
| Commuters, 2014 | Rail commuters near Chicago; taxi riders; a lab waiting room | Told to sit in solitude, or travel as usual | One group's programme |
| Commuters, 2022 | Rail commuters at four stations near London | Solitude, or travel as usual | Same group, conceptual replication |
...
**"Small talk makes you unhappy."** That was the part of the 2010 finding that failed to replicate.
Small talk was unrelated to life satisfaction in the pooled data.[8]

**"Depth is what counts, and small talk is a waste."** The replication found small talk harmless, the
deep-talk experiments found deep conversations weren't consistently more enjoyable than shallow ones
when people had only one, and the researchers on the depth side suggest small talk may lead to
depth.[3][8]
...
**"Conversations get duller the longer they go."** In five preregistered experiments, enjoyment held
steady or rose.[4]

**"These findings describe everyone, everywhere."** They describe mostly US and UK commuters, students
and professionals, in short conversations, mostly from one network of labs.[1][2][3]

## Practice

:::exercise One stranger, with a prediction first (optional)
This is a **try one move** exercise, and it's entirely optional. Skip it if you'd rather not, and skip it on any day it does not feel right. Take 10 minutes for the writing, before and after.
...
:::exercise One question a level deeper
This is a **try one move** exercise with a friend, someone you already talk to easily. Take 5 minutes for the journal afterwards.

In an ordinary conversation you'd be having anyway, ask one question a level deeper than you usually would, from this list or one like it, and make it easy to pass: "You don't have to answer that."

- "What's something you've been looking forward to lately?"
- "What did you want to be when you were ten?"
- "Is there something you've been meaning to do for ages and haven't?"
- "What's a small thing that made your week better?"

Don't choose a question about loss, fear or anything painful: those belong in conversations the other person starts. If a question opens something that sounds like real distress, stop practising and listen; lesson 11, "When it's serious", and Mental Fitness lesson 1, "Where ordinary ends", are where the institute deals with that. Afterwards, write what you asked, whether they took it up or passed, and what happened next, naming nobody.
:::
...
1. Epley, N., and Schroeder, J. (2014). Mistakenly seeking solitude. *Journal of Experimental
   Psychology: General*, 143(5), 1980–1999. [Author's copy](https://cdn.prod.website-files.com/699728903166dd3429c6b4fd/699728903166dd3429c6b5c3_EpleySchroederJEPG2014.pdf).
   **Read: the full text**, re-read 26 September 2026. Nine experiments, Chicago-area trains, buses,
   taxis and a lab waiting room. <!-- SOURCES Part B §7.2; lesson 12 gate closure -->
2. Schroeder, J., Lyons, D., and Epley, N. (2022). Hello, stranger? Pleasant conversations are preceded
   by concerns about starting one. *Journal of Experimental Psychology: General*, 151(5), 1141–1153.
   [Author's copy](https://cdn.prod.website-files.com/699728903166dd3429c6b4fd/699728903166dd3429c6b683_SchroederLyonsEpley%20Hello%20Stranger.pdf).
   **Read: the full text**, re-read 26 September 2026. Two experiments with London-area rail
   commuters. <!-- SOURCES Part B §7.2; lesson 12 gate closure -->
3. Kardas, M., Kumar, A., and Epley, N. (2022). Overly shallow?: Miscalibrated expectations create a
   barrier to deeper conversation. *Journal of Personality and Social Psychology*, 122(3), 367–398.
   [Author's copy](https://cdn.prod.website-files.com/699728903166dd3429c6b4fd/699728903166dd3429c6b685_OverlyShallowKardasKumarEpley.pdf).
   **Read: the full text**, re-read 26 September 2026. Twelve experiments, US samples. <!-- SOURCES Part B §7.1; lesson 12 gate closure -->
4. Kardas, M., Schroeder, J., and O'Brien, E. (2022). Keep talking: (Mis)understanding the hedonic
   trajectory of conversation. *Journal of Personality and Social Psychology*, 123(4), 717–740.
   [DOI](https://doi.org/10.1037/pspi0000379). **Read: the abstract and introduction.** Five
   preregistered experiments, N = 1,093. <!-- SOURCES Part B §7.3 -->
5. Atir, S., Wald, K. A., and Epley, N. (2022). Talking with strangers is surprisingly informative.
   *PNAS*, 119(34), e2206992119. [DOI](https://doi.org/10.1073/pnas.2206992119). **Read: the abstract
   (author manuscript).** <!-- SOURCES Part B §7.3 -->
6. Aron, A., Melinat, E., Aron, E. N., Vallone, R. D., and Bator, R. J. (1997). The experimental
   generation of interpersonal closeness: a procedure and some preliminary findings. *Personality and
   Social Psychology Bulletin*, 23(4), 363–377. [DOI](https://doi.org/10.1177/0146167297234003).
   **Read: the full text**, 26 September 2026, from a scanned copy of the published article. Three
   studies with students in psychology classes. <!-- SOURCES Part B §7.5; lesson 12 gate closure G20 -->
7. Mehl, M. R., Vazire, S., Holleran, S. E., and Clark, C. S. (2010). Eavesdropping on happiness:
   well-being is related to having less small talk and more substantive conversations. *Psychological
   Science*, 21(4), 539–541. [PubMed Central](https://pmc.ncbi.nlm.nih.gov/articles/PMC2861779/).
   **Read: the full text**, re-read 26 September 2026, including Table 1. Single study, 79
   undergraduates. <!-- SOURCES Part B §7.4; lesson 12 gate closure -->
8. Milek, A., Butler, E. A., Tackman, A. M., Kaplan, D. M., Raison, C. L., Sbarra, D. A., Vazire, S.,
   and Mehl, M. R. (2018). "Eavesdropping on happiness" revisited: a pooled, multisample replication of
...
10. Sandstrom, G. M., Boothby, E. J., and Cooney, G. (2022). Talking to strangers: a week-long
    ...
    description of the sample, the rejection results and the limitations**, 26 September 2026. <!-- lesson 12 gate closure -->
11. Transparent Replications and Metskas, A. (2023). Report #7: replication of a study from "The
    surprise of reaching out: appreciated more than we think". Clearer Thinking.
    [Report](https://replications.clearerthinking.org/replication-2023jpsp124-4/). **Read: the report
    page**, re-read 26 September 2026; the original paper by Liu and colleagues was not read, and is
    described as the report describes it. <!-- SOURCES Part B §7.3; lesson 12 gate closure -->
12. Szala, A., Wacewicz, S., Placiński, M., and others (2025). How much conversation content is
    actually social: human conversational behaviour revisited. *Language and Cognition*, 17.
