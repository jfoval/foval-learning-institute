...
objectives:
  ...
  - >-
    ...
    from your own threat model
quiz:
  - q: >-
      Google's documentation says an archive expires in about seven days and can be downloaded five
      times. What does that tell you about what is inside it?
    options:
      - That the contents are small enough to be downloaded repeatedly without difficulty
      - That the archive is a copy rather than the original, which is why it can lapse
      - Nothing at all, because those facts describe the delivery rather than the contents
      - That Google expects the data to change enough in a week to make it worth refreshing
    answer: 2
    explain: >-
      Expiry, download limits and file formats are all facts about how the parcel is sent, and a
      reader who knows them still knows nothing about what is in it. The other three are guesses
      about Google's reasoning that the page does not state.
  - q: >-
  ...
  - q: >-
      ...
      this course say?
    options:
      - That the right of access is European, and US readers have a patchwork of state laws
      - That the right applies to any company large enough to have a privacy policy
      - That the right exists everywhere but is only enforced in the European Union
      - That no such right exists in the United States under any circumstances
    answer: 0
    explain: >-
      The course names the jurisdiction every time it says what somebody can demand, and for a US
      reader the answer depends on their state. It is not a universal right, not merely an
      enforcement gap, and not uniformly absent in the United States.
  - q: >-
      A survey found that looking at a privacy dashboard made people significantly more likely to be
      less concerned about data collection. Why does this lesson tell you that?
    options:
      - Because it shows dashboards work, by reassuring people who were needlessly worried
      - Because it is evidence against the very thing this lesson asks you to do
      - Because it means the dashboards were hiding the most alarming categories of data
      - Because the survey was too small at 153 participants to change anybody's practice
    answer: 1
    explain: >-
      The lesson's whole method is to send you to look, and the best evidence it has says looking
      often leaves people calmer and changes what only a quarter of them do. Nothing in the finding
      says the reassurance was warranted or that anything was hidden.
  - q: >-
...
keeps about you is the thinnest-evidenced thing in this course**, not because nobody has studied it but because what any particular company holds is visible only to
that company. So this lesson does something narrower than the others. It doesn't tell you what is
kept. **It teaches you to look, and
then tells you honestly what people find when they do.**

## What people believe, and what they cannot say

Start with the finding this course keeps coming back to. In 2015 [researchers sat twenty-eight people
down](https://www.usenix.org/conference/soups2015/proceedings/presentation/kang) and asked them to
draw the internet on paper.[1] **This course read that paper in full.**
...
How long, in their words: "Depending on the amount of information in your account, this process could
...
they note "You may need additional software to open these files on Windows."[2] If it is big it comes
in pieces: "Archives that are larger than the size limit you selected are split into multiple
files."[2]
...
company with every incentive to be reassuring. The gap isn't a criticism of the page. Documentation describes the service, and what's in your
archive depends on you.

But it does mean something for how you read the promise. **If you want to know what a service holds,
the documentation cannot tell you and the archive can.** That asymmetry is this lesson.
:::
...
The same abstract records something else, and leaving it out would make this lesson a hit piece rather than a report: participants' annotations "documented their excitement at finding data records
that triggered nostalgia, but also shock and anger about the privacy implications of other data they
saw".[3] **One archive, both reactions, in the same sitting.** And afterwards, "many participants
hoped to request the company erase some, but not all, of the data", which is a more interesting result than either camp in the 2015 study would've predicted.
...
**Four dimensions of variation**, which is exactly what no single export could've told you, and which is why this lesson is built on
published work rather than on one archive.
...
**Removed from your view.** The item stops appearing in your account. This is the one you can see, and it's the only one you ever get direct evidence of.

**Removed from the company's active systems.** The row is gone from the database the product runs
on. You can't observe this, and a service that has done the first hasn't necessarily done the second.

**Removed from backups.** Lesson 12 was about why you keep backups. The same logic applies on their
side: a company that can restore last month can restore what you deleted this month, until those
backups age out.

**Removed from everyone they already shared it with.** If a copy went to another company before you deleted it, your deletion is a request about their
systems that has to travel, if it travels at all.
...
**The right of access and the right to erasure are European rights.** If you're in the European Union or the United Kingdom, you can require a company to give you a copy
of what it holds and, in defined circumstances, to erase it.
...
in California has rights a reader in Ohio may not.

**And the export button is not the same thing as the legal right.** Google, Apple and Meta all offer
exports to everybody, everywhere, as a product feature. That's convenient and it isn't a right, and a feature offered voluntarily can be changed.
...
A 2021 survey of **153 participants** studied Google's My Activity dashboard.[5] **This course read
the abstract and not the paper.** Participants found the volume and detail of collected data surprising, as you'd expect. Then the
counterintuitive part: exposure to the dashboard made them
...
Because of what the alternative is. The 2015 participants who had never looked held confident beliefs
in both directions and could not say who held copies.[1] **Looking replaces a guess with a fact about
your own account**, and this course's position is that knowing is worth having even where the
evidence that it changes behaviour is weak. **That's a judgement rather than a finding**, and you should know it is one.

What the dashboard study does change is the instruction. **Looking is not the exercise. Writing down
what you will do differently, before the reassurance sets in, is the exercise**, and that is how the
...
to true, and a course that pretended otherwise would lose the argument with the readers it most needs. The honest version is narrower: **it matters in proportion to your threat model from lesson
1.** Somebody whose ex-partner is trying to find them, somebody whose employer is hostile, and
somebody who is simply tired of advertising have three different answers, and only the first is
urgent.
...
**"Private browsing means the service doesn't have it."** Lesson 8 has the mechanism. A private window changes what your own machine keeps, and the service on the other end sees what it
always saw.
...
**The third line is the one that matters and it must be written before the archive lands.** The
dashboard study is the reason: looking tends to leave people calmer, and a change you decide on
afterwards is a change made by somebody who has just been reassured.

When it arrives, use lessons 2 and 3 to find and open it. **If that sentence sounds easy, notice that it wouldn't have been twelve lessons ago**, which is the quietest argument this course makes for
itself.
:::
...
**This course doesn't tell you which way to decide.** It has given you the mechanism, the four
senses of deletion, and the rights that apply where you live. The weighing is yours, and doing it deliberately once is worth more than a rule somebody else
wrote.
:::

## Connections

**Back, and this lesson needs more of the course than any other.** Lesson 1 is the threat model, and without it the question "does this matter?" has no answer. Lessons 2 and 3 are how you find and open
...
- **[Download your data](https://support.google.com/accounts/answer/3024190)**, Google. **Read on 19
  September 2026**, and worth reading yourself because it is short, it is primary, and **it'll have changed** by the time you read this, which is a lesson in itself.
- **["Data Subjects' Reactions to Exercising Their Right of
  ...
  colleagues, USENIX Security 2024. **This course read the abstract only.** If you read one thing
  after this lesson, read the part about what people annotated as creepy.
...
5. Maximiliane Farke, David Balash, Maximilian Golla, Markus Dürmuth and Adam Aviv, "Are Privacy
   ...
   Activity", USENIX Security 2021. **Read at abstract level; the paper was not opened.** Supports:
...
6. **The course's own constructions, each labelled where it appears in the body.** The four senses
   ...
   understands it and is not drawn from a legal source read for this file**, which is why the lesson
   sends a reader to their own jurisdiction rather than telling them what they can demand. **And the
