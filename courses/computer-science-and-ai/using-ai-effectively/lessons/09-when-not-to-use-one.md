...
objectives:
  ...
  - >-
    ...
    cost you
  - >-
    Decide, for one task of your own, to stop or to redesign how you use it, with the reason written
    down and a replacement named
quiz:
  - q: >-
      A study gave nearly a thousand high school maths students access to a system during practice.
      Which pair of results does an honest account have to carry together?
    options:
      - Practice grades rose 48% with the plain interface, and fell 17% below the no-access group once it was taken away
      - Practice grades rose 48% with the plain interface and 127% with a tutor designed to give hints rather than answers
      - Practice grades rose with both interfaces, and the guarded one produced no measurable harm afterwards
      - Practice grades rose 127% with the guarded tutor, and the unguarded group matched students who never had access
    answer: 0
    explain: >-
      Those two are the pair, because one is the benefit people quote and the other is the cost they
      do not. The 48-and-127 pair is real and answers a different question, which is how much the
      design of the tutor matters. The no-measurable-harm answer overstates what the study found,
      which is that the guarded design largely mitigated the harm. And the matching answer inverts
      the result that makes the study worth reading.
  - q: >-
      A trainee accountant uses a system to produce the first draft of every set of management
      accounts she prepares, reads each draft carefully, and corrects what looks wrong. Where is the
      cost, on this lesson's reasoning?
    options:
      - In her employer's compliance position, since work she did not produce is being signed as hers
      - There is no cost; reading carefully and correcting is how anybody learns a format
      - In her judgement, which is built by producing the accounts and is not built by reading them
      - In the accuracy of the accounts, which will be worse than if she had produced them herself
    answer: 2
    explain: >-
  ...
  - q: >-
    ...
    options:
      - Asking for the answer, then asking the system to explain each step of it in more detail
      - Asking for the answer first and then attempting the problem yourself to see whether you agree
      - Asking for three answers and choosing between them, which forces you to engage with each one
      - Asking for a hint that gets you to the next step, and attempting that step yourself
    answer: 3
    explain: >-
      The guarded condition gave teacher-designed hints rather than answers, so the student still did
      the work and got help getting unstuck. Explaining a finished answer in more detail leaves the
      retrieval undone. Attempting after seeing the answer is not attempting, because you have the
...
3. Redesign the request so that you do that part and the system does the rest. The usual shape is: attempt first, then ask what you missed and why, rather than asking for the answer.
...
1. Hamsa Bastani, Osbert Bastani, Alp Sungu, Haosen Ge, Özge Kabakcı and Rei Mariman, ["Generative AI Without Guardrails Can Harm Learning: Evidence from High School Mathematics"](https://hamsabastani.github.io/education_llm.pdf), *PNAS*, 2025. Abstract read in full and verbatim; the body was not read. Supports: nearly a thousand high school mathematics students; the two conditions, GPT Base and GPT Tutor; the quoted figures of 48% and 127% improvement during practice and 17% reduction for GPT Base once access was removed; the quoted "crutch" explanation; and the statement that the negative effects were largely mitigated by the safeguards. **The scope is high school mathematics practice problems with GPT-4, and every use of these figures carries it.**
2. [NIST AI 600-1, *Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile*](https://doi.org/10.6028/NIST.AI.600-1), July 2024, section 2.7. Read in part. Supports: the quoted description of automation bias as excessive deference to automated systems, and the quoted sentence about experts being unnecessarily averse and depriving themselves of beneficial uses.
