...
objectives:
  - >-
    ...
    settle it
  - >-
    Identify what a memory claim was measured on, and say what a small or specific sample licenses
  - >-
    Decide what to do about one remembered event of your own, with what each option costs
quiz:
  - q: >-
      A podcast says "your memory rewrites itself every time you recall something". Sort it.
    options:
      - Unmeasurable as stated, because rewriting is not defined as anything anybody counts
      - Measurable, and this course reported the study that has already settled it
      - False, because the course's own lessons show remembered events surviving unchanged
      - Measurable, but only with the brain-imaging equipment this course did not read about
    answer: 0
    explain: >-
      Nothing in the sentence says what would count as a rewrite or by how much, so no study either
      confirms or refutes it. Lesson 4 measured one specific thing, which is whether a question's
      wording changed a later answer. Nothing read here shows memories surviving unchanged. And the
      obstacle is the wording rather than the equipment.
  - q: >-
      Which of this course's five sources rests on the largest body of data, and what does that buy
      it?
    options:
      - The forgetting curve replication, which bought the shape of the curve
      - The eyewitness synthesis, and it bought the strongest claim anywhere in the course
      - The memory-technique training study, and it bought a durability finding
      - The retrieval-induced forgetting meta-analysis, and it bought the narrowest claim
    answer: 3
    explain: >-
      The pooled review is the one source built on many studies, and what it supports is a small
      effect on neighbouring items under laboratory conditions. The curve replication is one subject.
      The eyewitness synthesis is a review of a literature rather than a pooled effect. And the
      training study is about fifty people.
  - q: >-
      Somebody asks this course whether an argument they remember from ten years ago really happened
...
Work two. "Memory is reconstructive, so your memories are not recordings." Measurable in the
second half and almost content-free in the first. Nothing in the sentence says what a
...
remove and on a hundred and fifty undergraduates with a week between viewing and questioning.[3] The
first is advice about your own life, and the study underneath it wasn't about your life. **The two
halves need separate verdicts**, and a reader who accepts or rejects both together has done neither.

## Habit two: ask how many people, and who
...
:::predict Before the next section. One subject, a hundred and fifty students, fifty trainees. Does a finding from a sample that small tell you anything at all?
Yes, and saying exactly what takes a sentence rather than a shrug.

A small sample is bad at one specific job: telling you how big an effect is in a population. It is
much better at a different one, which is showing that something happens at all. One subject
relearning lists over thirty-one days cannot tell you how fast *you* forget. It can show that
savings on relearning falls steeply and then flattens, and that the shape is regular enough to fit
an equation.[1]

So the sample question isn't a way of dismissing things. It's a way of reading a finding for what
it is: a demonstration, an estimate, or a claim about everyone, and those three want very different
amounts of trust.
...
What this course read, what each rests on, and what it supports. The first three columns are the
sources'; the last is this course's own reading of what each one licenses.[6]
...
You will meet this subject mostly through three very widely read books: Schacter's *The Seven Sins
of Memory*, Loftus's own writing for general readers, and Foer's *Moonwalking with Einstein*.

**This course has opened none of them.**[6] They sit on the unread line of its research file, the
...
Here's the refusal, and it's sharper than the ones ending the two courses before this.

**This course cannot tell you whether a particular thing you remember happened the way you remember
it.** Not the argument, not the childhood scene, not what somebody said to you last year. Nothing in
seven lessons is a test you can run on one recollection.

What it can tell you is what memory does in general, under conditions somebody arranged and
measured. That is a different question, and **the difference is the last thing the course teaches**.

Both directions of overreach are the same mistake. A reader who takes lesson 4 and concludes that a
person contradicting them has been led by a question has gone past the evidence.[3] So has a reader
who finishes the course and decides to stop trusting anything they remember: that is a verdict on
particular memories too, reached from general findings, and it costs them something real in exchange
for a confidence that isn't more justified than the one it replaced.
...
thing this course read, and its usefulness outlives the particular numbers.

**Hold loosely: the specific figures.** Lesson 2's curve is one subject.[1] Lesson 4's numbers come
to you at one remove through a teaching summary, which the lesson says at the point of use.[3]
...
a synthesis that overturned a consensus by making it conditional, and a training study on fifty
...
3. **How many people, and who?** Students, adults, a single subject, somebody's customers.
...
Take 30 minutes. This is the last thing the course asks, and it needs the file you wrote in lesson
1.

Read your first account again, now, for the first time since you wrote it. Then decide what to do
with that memory. **Three endings, and all three are legitimate.** Write whichever you choose in
four lines.
...
what you will do if it contradicts you, **before you look**, because deciding that afterwards is the
thing this whole course is about.

Then one line, whichever you chose: **what would have to be true for this to have been the wrong
call?**

**The course doesn't recommend one of the three.** That is decision 6 and it holds here: the
evidence covers what memory does in general and doesn't reach your particular event, so the choice
is yours and the reasoning is what is being asked for.
:::
...
1. Jaap M. J. Murre and Joeri Dros, ["Replication and Analysis of Ebbinghaus' Forgetting
   ...
   10(7), 2015. **Read in part: the abstract verbatim and the summary statements of method and
   result.** Supports: one subject, seventy hours, six delays, and savings on relearning as the
...
3. Elizabeth Loftus and John Palmer, "Reconstruction of automobile destruction", *Journal of Verbal
   Learning and Verbal Behavior* 13, 1974. **The original was not opened. The figures reach this
   course through a published teaching summary**, which lesson 4 says at the point of use and this
   lesson repeats. Supports: a hundred and fifty participants in the second experiment, and a week
   between viewing and the later question.
4. John Wixted and Gary Wells, ["The Relationship Between Eyewitness Confidence and Identification
   Accuracy: A New Synthesis"](https://journals.sagepub.com/doi/10.1177/1529100616686966),
   *Psychological Science in the Public Interest* 18(1), 2017. **Read in part: the Summary verbatim,
   one box, the section introducing the five recommendations, and one field-study passage.**
   Supports: that the pessimistic view was reasonable for the procedures that produced it, and that
   the claim holds for adults, for initial identifications, under five named conditions. Lesson 5
   carries the full account and the qualifications.
5. Isabella C. Wagner and colleagues, ["Durable memories and efficient neural coding through
