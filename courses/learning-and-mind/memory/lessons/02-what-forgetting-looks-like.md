...
quiz:
  - q: >-
    ...
    explain: >-
      ...
      commonest error about this curve. No alternative percentage is available from what this course
      read. And the nonsense-syllable point is a real limit that comes after the units are right.
  - q: >-
    ...
    explain: >-
      ...
      instruments measuring different things, which is lesson 1's point. And repetitions to mastery
      is a third thing again.
  - q: >-
      A teacher wants to use the 2015 replication to argue that her students will lose most of a
      lesson by the next morning. What should stop her?
    options:
...
it measures, and the two things that fall off before it reaches you.
...
**The authors' own conclusion, verbatim:** "We conclude that the Ebbinghaus forgetting curve has
...
:::exercise Measure savings on yourself
...
you can. **Count them. That is your recall figure.**

**Sitting three, immediately after, about 5 minutes.** Relearn the list to the same standard, and
time it. **Your savings figure is the original time minus the relearning time, over the original
time.**
...
:::exercise Find the curve in the wild
Take 20 minutes.

Find the forgetting curve being used somewhere: a study app, a training deck, a blog post, a poster
in a school.
...
4. **What number the piece wants you to take away**, and where that number appears in anything you
   can check.
...
**Back.** Lesson 1's reconstructive account is why a savings measure makes sense at all: material
that can't be produced on demand can still be partly there. **Focus and Deep Work** lesson 1 is the
...
- **[Replication and Analysis of Ebbinghaus' Forgetting
  ...
  2015). Open access, read in part by this course: the abstract and the summary statements of method
  and result. **Read the second sentence of the abstract**, which is where the sample is, and then
  look at how the curve is presented anywhere else you have met it.
- **[Forgetting as a Consequence of Retrieval: A Meta-Analytic Review of Retrieval-Induced
  ...
  University of Reading repository and read in part by this course. Lesson 3's subject. Read it
  beside this one: a one-subject study and a pooling of 472 samples, on the same question of why
  things become hard to reach.
...
1. Jaap M. J. Murre and Joeri Dros, ["Replication and Analysis of Ebbinghaus' Forgetting
   ...
   and result. The curve fits and the serial-position analysis were not opened**, and the body says
   so where the shape is discussed. Supports: the quoted design sentence with its one subject,
   seventy hours and six relearning intervals; the quoted conclusion about replication and the jump
