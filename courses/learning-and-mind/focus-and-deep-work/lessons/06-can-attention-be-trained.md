...
minutes: 85
audio: https://pub-f7bdc2ace9904917a8238f1557b7f247.r2.dev/learning-and-mind/focus-and-deep-work/06-can-attention-be-trained.mp3
objectives:
  - >-
    Distinguish near, intermediate and far transfer, and say why the distinction decides the
    question
  - >-
    State what the working-memory training meta-analysis found, including what it says about the
    evidential value of the studies it pooled
  - >-
    Design one working hour from what survives this course, and say which parts are evidence and
    which are the course's own judgement
quiz:
  - q: >-
  ...
  - q: >-
    ...
    explain: >-
      ...
      Recommending it and ruling it out both claim more than this course read. And attention is
      measured throughout this course, which is what lesson 1 was about.
  - q: >-
      In the lesson's designed hour, which element is presented as evidence rather than as the
    ...
    explain: >-
      ...
      are both marked as the course's own judgement. And lesson 5 found the phone evidence too thin
      to support a recommendation either way.
---

Three lessons have taken three famous claims apart. This one asks the question all three were really
about: **can you get better at this?**

It is also the only lesson in the course with something constructive in it, and the constructive
part comes last and is smaller than you want it to be.

## The word that decides the question

**Transfer** is what a psychologist calls the thing you actually want when you train. You practise
one task, and the question is what else improves.
...
support. Reasoning. Reading comprehension. Arithmetic. **This is the only level anybody is buying**,
and it is the level the advertising implies.

:::predict Before the evidence. Imagine a training programme that produces large near transfer, real intermediate transfer, and no far transfer at all. What would that pattern mean, and would it be worth paying for?
The pattern is the one the evidence actually shows, and thinking it through before you see the
numbers is worth five minutes.

**It would mean the training works exactly as advertised on its own terms and does nothing you
wanted.** You get better at the game. You get somewhat better at similar tests. Your reading, your
work and your reasoning are untouched.

**And it is a coherent thing for the world to be like**, which is the part worth sitting with. There
is no law that practising a component improves the system that contains it. Getting better at
scales doesn't straightforwardly make you a better musician, and getting better at a
number-sequence task need not make you better at anything you do with numbers.

**Whether it is worth paying for** is then a question about what you wanted. If you enjoy the game,
fine. If you bought it to think more clearly, you bought the wrong thing, and no amount of
improvement at level one is the thing you were sold.
:::
...
working memory). For measures of far transfer (nonverbal ability, verbal ability, word decoding,
...
**That is awkward for the whole idea.** If training works by strengthening a system, and a stronger
system is what carries improvement outwards, then people who improved most on the trained measure
should show the most far transfer. They did not.

**And then the sentence that is unusually blunt for a meta-analysis:** "analysis of publication bias
...
**Third, and this is the point: this course hasn't read those papers**, so it isn't going to put a
figure in your hands as though it had.[2] **What it can tell you is the direction and the read
level**, which is: reported effects are small, the syntheses exist, and somebody who wants an answer
should read them rather than take this course's word for it.

:::checkpoint Somebody objects that this is defeatist. Three lessons said the famous claims don't hold up, and now the training doesn't work either. What is the course actually for?
It is a fair question and the answer is not a consoling one, so here it is straight.

**The course is for reading this subject**, and that is a skill with a use. Three of the best-known
claims about attention have been re-examined and none came out where it went in. A person who knows
that, and knows why, will not spend money on the next thing, will not conclude that their attention
is broken on the strength of a headline, and will not pass any of it on.

**And the course is not empty of things that hold.** Lesson 2's finding is real, measured, and
inverts what people expect. Lesson 3's measurement is real. Lessons 4 and 5 both found something,
and were careful about what. **What the course lacks is a method**, because the evidence doesn't
...
## The hour, and what is holding it up
...
a
work block. An hour is long enough to get into something and short enough to protect, and if
somebody tells you ninety minutes is optimal, ask them what measured it.

**Four: the same hour each day.** **The course's own judgement**,[3] extending element one by
analogy: a fixed time is easier to make a reliable context out of. **Habits** lesson 3's own
misconception list says a clock time is a weak context on its own, so this is weaker than element
one and depends on the hour having something else attached to it.

**Five: one measure, written down.** **The course's own judgement**,[3] and the reason is lesson 1:
a self-report and a count answer different questions, so keep one of each if you can. Whatever
you got through, and an effort rating.

**Six: the phone.** **Not evidence.** Lesson 5 found the pooled effect small, in memory rather than
...
**"Focus is a muscle."** The training literature's own meta-analysts say there is no evidential
value in the treated-control studies of working-memory training, and that improvement on the trained
task doesn't predict improvement anywhere else.

**"Brain training was debunked, so nothing helps."** Two different claims. What failed is that
practising a component improves the system. Arranging your situation is a separate proposition and
lesson 2 and Habits lesson 3 both bear on it.

**"Meditation is proven to improve attention."** The syntheses report small effects and **this
course hasn't read them**, which is a statement about this course rather than about meditation.
...
:::exercise Sort a training claim
Take 20 minutes.

Find a product, app or course that claims to improve focus, attention, memory or concentration.
Write its claim down word for word.
...
worth noting rather than treating as a failed exercise.
:::

## Connections

**Back.** Lesson 1's instruments, lesson 2's finding, lesson 3's measurement and lessons 4 and 5's
pooled evidence all feed the hour. **Habits and Self-Discipline** lesson 3 supplies element one and
is the strongest thing in the design. **How to Learn Anything** taught deliberate practice, which is
...
- **[Working Memory Training Does Not Improve Performance on Measures of Intelligence or Other
  ...
  Psychological Science*, 2016). **This course has read the abstract verbatim and not the body.**
...
1. Monica Melby-Lervåg, Thomas S. Redick and Charles Hulme, ["Working Memory Training Does Not
   Improve Performance on Measures of Intelligence or Other Measures of 'Far Transfer': Evidence
   From a Meta-Analytic Review"](https://pmc.ncbi.nlm.nih.gov/articles/PMC4968033), *Perspectives on
   Psychological Science* 11(4), 2016, pages 512 to 534. **Abstract read verbatim; the body of the
...
3. **Elements three, four and five of the hour are this course's own judgement**, each labelled
   ...
   explicitly weaker than element one**, and the lesson says so by pointing at Habits lesson 3's own
   misconception about clock times.
