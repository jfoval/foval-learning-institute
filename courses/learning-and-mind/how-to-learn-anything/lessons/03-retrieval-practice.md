...
quiz:
  - q: >-
      Ana studies 40 flashcards once, then tests herself without checking any answers: 25 right, 15 wrong. Ben studies the same 40 cards twice. Tested the next morning, Ben scores higher. Using the bifurcation model, what should you expect a week later?
    options:
      - Ben stays ahead. Two exposures gave every card a boost, and Ana's 15 misses were never corrected, so those errors are now part of what she knows
      - Ana pulls ahead on all 40 cards, since the effort of trying to recall strengthens a memory whether or not the attempt succeeds
      - They end up level. Testing and restudy strengthen a memory by about the same amount; testing only looks worse on day one because it is tiring
      - Ana pulls ahead on the 25 cards she retrieved; her 15 misses got nothing, because there was no feedback to turn them into a learning event
    answer: 3
    explain: >-
      D. The bifurcation model says a test gives a large boost to the items you retrieved and nothing to the ones you did not, while restudy gives a small boost to everything. Small boosts to all 40 win on day one and have faded by the week; the large boosts to Ana's 25 are still there. A is right that her misses were wasted, but wrong that the errors stick: Kornell, Hays and Bjork 2009 found wrong guesses did not persist. B is the version of "failed attempts help" that drops the condition; failed attempts help when the answer follows, and Ana never looked. C is the checker's assumption that the day-one score tells you what happened to storage, which is what lesson 1 warned against.
  - q: >-
      A tutor quizzes a student the day after teaching a topic. The student scores 60% and says, "See, quizzing me didn't work. I should have just reread." What is the best response?
    options:
      - Agree. Roediger and Karpicke found restudying ahead on the first test, 81% to 75%, so rereading would have scored higher today and stayed higher
      - The 60% is the practice, not the verdict. What matters is what he can recall a week from now, and there the tested material tends to win
      - Quizzing works for lists and definitions, but this topic needed understanding, so rereading was the right call for material like this
      - A 60% score means the quiz was too hard to be useful; only quizzes you would mostly pass strengthen memory, so the tutor should have eased it
    answer: 1
    explain: >-
      B. A score during practice is a measure of retrieval strength now, not of what will still be there later. Roediger and Karpicke 2006 found restudy ahead at five minutes (81% versus 75%) and testing ahead at a week (56% versus 42%), so A quotes the short-term result as if it held at a week. C is the "facts only" misconception; Karpicke and Blunt 2011 found retrieval won on inference questions too. D gets it backwards. Effortful retrieval with feedback is what helps, and a 60% quiz with the misses corrected is doing its job.
  - q: >-
      A biology teacher splits a class. Half draw a concept map of the nitrogen cycle with the textbook open. The other half close the book and write out everything they remember, twice. The test a week later asks every student to draw the nitrogen cycle as a concept map from memory. What does the evidence predict?
    options:
    ...
    answer: 1
    explain: >-
      B. In Karpicke and Blunt's second experiment this was the test, and the text learned by retrieval still won, d = 1.01. A and D both apply the format-match rule from Yang and colleagues, but that rule compares two kinds of retrieval; it does not rescue an activity that has the source open in front of it, because copying from a book is recognition whichever shape you copy it into. C assumes the two effects are the same kind and size, and they are not: mapping with the text open was doing very little retrieval at all.
  - q: >-
      Marco has 40 Spanish verb conjugations to know for a test in three weeks. Which plan matches the schedule this lesson recommends?
    options:
      - "Day 1: test each verb until he gets it right three times. Days 6, 12 and 18: test each until right once"
      - "Day 1: test each verb until he gets it right once. Days 6, 12 and 18: test each until right once"
      - "Day 1: test each verb until he gets it right once. Days 6, 12 and 18: test each until right three times"
      - "Day 1: test each verb until he gets it right three times. Day 20: test each until right three times again"
    answer: 0
    explain: >-
      A. Rawson and Dunlosky's successive relearning is a criterion of three correct recalls in the first session, then relearning to one correct recall in three spaced sessions. B stops at one recall on day 1, the dropping-too-early mistake Karpicke 2009 measured. C has the criteria the wrong way round: the heavy lifting belongs in the first session, and later sessions only need to confirm the item is still there. D has the right first day but collapses three spaced returns into one, and a single relearning session the day before the exam is the crammer's schedule; lesson 4 shows why three returns beat one.
  - q: >-
      Four learners each quiz themselves on a chapter. Which one is self-testing to learn rather than only to check?
    options:
      - Dana quizzes herself the night before the exam, sees 70%, decides that is enough to pass, and spends the rest of the evening on a different subject
      - Lee quizzes himself, gets six of ten wrong, rereads the whole chapter from the beginning, and moves on to the next one
      - Sam quizzes himself, writes down the four questions he missed, retests those the next day, and rereads only the sections they came from
      - Jo rereads until the chapter feels familiar, then takes one quiz to confirm it went in
    answer: 2
    explain: >-
      C. The tell is what happens after the score. Sam (C) uses the test to decide what to restudy and then tests again, which is retrieval as learning. Dana (A) and Jo (D) both treat the quiz as a thermometer taken once, at the end, and Jo's "feels familiar" is the fluency illusion from lesson 1. Lee (B) throws away the information the test gave him and returns to the low-utility technique. In Kornell and Bjork's 2007 survey, 68% of students said they self-test to find out what they know, which is Dana's reason; only 18% said they do it because testing teaches.
---
...
:::checkpoint Which of the three accounts predicts that a harder cue produces a bigger testing effect, and why?
...
:::checkpoint You take a multiple-choice practice test and never check the answers. Which study in this section predicts what happens next, and what does it predict?
...
<svg viewBox="0 0 420 321" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:420px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="kb-title kb-desc">
  ...
  <text x="14.4" y="288.0" font-size="15" fill="var(--text-2, #4a5260)">Karpicke and Blunt (2011), experiment 2, Table 1.</text>
  <text x="14.4" y="307.0" font-size="15" fill="var(--text-2, #4a5260)">Each student learned one text by each method.</text>
</svg>
...
:::predict Guess the share who said they self-test because testing teaches more than restudying. Then guess the share who said they do it to find out how well they've learned the material.
...
:::checkpoint You scored 90% the night after studying. Name two reasons that number tells you less than a 60% scored two days later would.
...
:::exercise Write the test first, from memory
...
:::exercise Set up one retrieval routine
...
:::callout The site's Review page does part of this for you
...
2. Roediger, H. L., & Karpicke, J. D. (2006). "Test-Enhanced Learning." *Psychological Science*, 17, 249–255. Supports: Experiment 1 within-subjects; 81% vs 75% at five minutes, 68% vs 54% at two days, 56% vs 42% at one week; 61% vs 40% at one week for study-test-test-test vs study-study-study-study, with higher confidence in the repeated studiers (Experiment 2).
3. Yang, C., Luo, L., Vadillo, M. A., Yu, R., & Shanks, D. R. (2021). "Testing (quizzing) boosts classroom learning." *Psychological Bulletin*, 147, 399–435. Supports: 222 classroom studies, 48,478 students, g = 0.499; larger with feedback (0.537 vs 0.374), with test-format match, and with more repetitions.
4. Agarwal, P. K., Nunes, L. D., & Blunt, J. R. (2021). "Retrieval Practice Consistently Benefits Student Learning." *Educational Psychology Review*, 33, 1409–1453. Supports: 50 classroom experiments from 37 studies, n = 5,374; 57% medium or large; 6% from non-WEIRD countries; nearly every format worked.
5. Adesope, O. O., Trevisan, D. A., & Sundararajan, N. (2017). "Rethinking the Use of Tests: A Meta-Analysis of Practice Testing." *Review of Educational Research*, 87(3), 659–701. Supports: g = 0.61 vs all comparisons, 0.51 vs restudy; multiple-choice 0.70, short-answer 0.48.
6. Little, J. L., Bjork, E. L., Bjork, R. A., & Angello, G. (2012). "Multiple-choice tests exonerated, at least of some charges: Fostering test-induced learning and avoiding test-induced forgetting." *Psychological Science*, 23(11), 1337–1344. Supports: multiple-choice items with competitive alternatives prompt retrieval of why the alternatives are wrong and improve later recall of related information.
7. Carpenter, S. K. (2009). "Cue strength as a moderator of the testing effect: The benefits of elaborative retrieval." *Journal of Experimental Psychology: Learning, Memory, and Cognition*, 35(6), 1563–1569. Supports: the elaborative retrieval account; larger testing effects with weaker cues.
8. Karpicke, J. D., Lehman, M., & Aue, W. R. (2014). "Retrieval-based learning: An episodic context account." *Psychology of Learning and Motivation*, 61, 237–284. Supports: the episodic context account.
9. Kornell, N., Bjork, R. A., & Garcia, M. A. (2011). "Why tests appear to prevent forgetting: A distribution-based bifurcation model." *Journal of Memory and Language*, 65(2), 85–97. Supports: the bifurcation model and its explanation of the short-delay reversal.
10. van Gog, T., & Sweller, J. (2015). "Not new, but nearly forgotten: The testing effect decreases or even disappears as the complexity of learning materials increases." *Educational Psychology Review*, 27, 247–264; and Karpicke, J. D., & Aue, W. R. (2015). "The testing effect is alive and well with complex materials." *Educational Psychology Review*, 27, 317–326. Supports: the complexity debate as contested, and its cognitive-load rationale.
11. Kornell, N., Hays, M. J., & Bjork, R. A. (2009). "Unsuccessful retrieval attempts enhance subsequent learning." *Journal of Experimental Psychology: Learning, Memory, and Cognition*, 35(4), 989–998. Supports: failed attempts followed by the answer beat reading the answer in five of six experiments; errors did not persist.
12. Butler, A. C., & Roediger, H. L. (2008). "Feedback enhances the positive effects and reduces the negative effects of multiple-choice testing." *Memory & Cognition*, 36(3), 604–616. Supports: feedback as the condition for multiple-choice testing to help.
13. Roediger, H. L., & Marsh, E. J. (2005). "The positive and negative consequences of multiple-choice testing." *Journal of Experimental Psychology: Learning, Memory, and Cognition*, 31(5), 1155–1159. Supports: a net benefit of multiple-choice testing alongside some lures learned as facts when no feedback is given.
14. Rawson, K. A., & Dunlosky, J. (2011). "Optimizing schedules of retrieval practice for durable and efficient learning." *Journal of Experimental Psychology: General*, 140, 283–302. Supports: 533 students; successive relearning prescription of three initial correct recalls followed by relearning to one correct recall in three spaced sessions.
15. Karpicke, J. D., & Blunt, J. R. (2011). "Retrieval Practice Produces More Learning than Elaborative Studying with Concept Mapping." *Science*, 331, 772–775. Supports: Experiment 1, four conditions, 20 per cell, 276-word text, mappers had the text and an example map; one-week test with verbatim and inference questions; retrieval 0.67 vs concept mapping 0.45, d = 1.50; students' predictions during learning ranked repeated study best and retrieval worst. Experiment 2, within-subjects N = 120, 84% better after retrieval; 90 of 120 predicted mapping would be as good as or better (49% better, 26% same); concept-map final test for half the sample, d = 1.01.
...
17. Kornell, N., & Bjork, R. A. (2007). "The promise and perils of self-regulated study." *Psychonomic Bulletin & Review*, 14(2), 219–224. Supports: 472 UCLA students; of the whole sample, 18% self-test because it teaches more, 68% to check, 4% because it is enjoyable, 9% do not self-test.
18. Karpicke, J. D., Butler, A. C., & Roediger, H. L. (2009). "Metacognitive strategies in student learning: Do students practise retrieval when they study on their own?" *Memory*, 17, 471–479. Supports: 177 undergraduates; 84% listed rereading; 11% listed self-testing.
19. Dunlosky, J., & Rawson, K. A. (2012). "Overconfidence produces underachievement: Inaccurate self evaluations undermine students' learning and retention." *Learning and Instruction*, 22, 271–280. Supports: overconfident self-judgements led students to stop practising early and retain less.
20. Karpicke, J. D. (2009). "Metacognitive control and strategy selection: Deciding to practice retrieval during learning." *Journal of Experimental Psychology: General*, 138(4), 469–486. Supports: students given control of their study dropped items after one correct recall, and retained less as a result.
