...
about: >-
  ...
  work day, and the provenance of the twenty-three minutes figure.
speakers: 2
approx_minutes: 7
---
...
S1: And I'm John. Today we're in Time Management, on the fifth lesson. What a working day actually looks like.

S1: And it has two halves. The first is what somebody measured. The second is the most quoted number in this whole subject, which turns out to have no printed source anybody has been able to produce.
...
S1: It describes that office. Three findings, in the authors' order. People had about a dozen pieces of work on the go. Each informant worked in an average of eleven point seven different working spheres.
...
S1: And read the bracket as well as the figure, because the paper gives a standard deviation of eighteen minutes nine seconds. That's a measure of how spread out the individual stretches were around the average, and it's larger than the average. So it isn't a tidy day of eleven-minute blocks. It's a day with a great many very short pieces and a few long ones.
...
S1: Time spent is time exposed. Every extra minute you're in a piece of work is another minute in which the phone can ring, and the longer you've been at something the more visibly involved in it you are. Involvement is legible to other people. They can see you're working, and for a colleague with a question that makes you findable rather than protected.

S2: What does that do to the advice about protecting a long block?

S1: And here the lesson is careful to say this part is the course's own reading and not a finding of the study. The advice assumes a block is something you can declare. On this evidence a long stretch is partly a thing that happens to you, and its length is one of the conditions that attracts an interruption. So protect two hours isn't a plan. It's a description of the outcome you want.

S2: Does anything survive?

S1: Something narrower. Protecting a block works where you can change what other people can see. A different room, a shut door, a shift nobody else is on, hours when the building is empty. It works much less well where your visibility is the thing that cannot change, which is most open offices, most shop floors, most wards, and most homes with small children in them.

S2: Now the second half. The number.

S1: You've almost certainly met the claim that an interruption costs you twenty-three minutes and fifteen seconds. It's on slides in corporate training rooms and in more articles than anybody has counted, and it's normally attributed to one of two papers. This course went looking in both.

S2: And?

S1: The two thousand and five field study, the one every measured figure above comes from. This course has read its abstract, its research setting, and its results on fragmented work. The figure isn't in what this course read, and the paper's finding about resumption is about something else entirely. The abstract says most interrupted work is resumed on the same day, but that more than two intervening activities occur before it is. That's a count of activities, not a number of minutes.

S2: And the other paper.

S1: A two thousand and eight laboratory experiment. This course has read its abstract and its design. The figure isn't there either, and that paper's actual finding is close to the opposite of the popular one.
...
S1: It is not, and it says so. She's the researcher who's done more than anybody to measure how a working day is actually spent, every good figure in the first half of this episode is hers, and a number said in an interview isn't a fabricated finding. What the lesson says is narrower. A figure repeated ten thousand times, always given to the second and never with a page number, has come loose from whatever produced it. The precision is doing rhetorical work rather than measuring anything.
...
S1: If you've ever come out of a heavily interrupted day having got everything done and feeling as though you'd been hit by a bus, that combination is the measured one.
