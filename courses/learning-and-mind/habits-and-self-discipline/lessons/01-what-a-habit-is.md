...
objectives:
  - >-
    ...
    behaviour you simply repeat
  - >-
    Identify, in a described case, whether a behaviour is habitual in that sense, and name the cue
    where there is one
  - >-
    Say what this course promises and what it refuses to promise, and identify a claim about habits
    that the course could not support
quiz:
  - q: >-
      A woman has gone swimming on Tuesday evenings for three years. She thinks about it most
    ...
    explain: >-
      ...
      the word and is what the definition exists to separate out. A cue is necessary and is not
      sufficient, since hers is not firing the behaviour on its own. And the rate is beside the
      point: something done once a week for years can be entirely deliberate.
  - q: >-
    ...
    explain: >-
      ...
      imports a value the research does not carry. The duration answer is right that habits are
      learned by repetition and wrong that a behaviour meeting the definition now is disqualified.
      And wanting to stop is what makes unwanted habits a problem, not what makes them not habits.
  - q: >-
  ...
  - q: >-
    ...
    explain: >-
      ...
      what a habit removes rather than what builds it. And no fixed number of days settles it, which
      is lesson 4's subject.
  - q: >-
...
and almost every confusion in the subject comes from that.

So this lesson does one thing. It gets the definition right, shows you what it rules in and out, and
says what this course is for. Nothing here will help you build one yet. Lesson 3 does that, and it
will not work if you're aiming at the wrong target.

## The definition, and it is not the everyday one

In ordinary speech a habit is something you do a lot. Biting your nails, checking your phone, a
glass of wine on a Friday.

That is not what the word means in the literature this course is built on. Gardner, Lally and Wardle
put the distinction plainly in a piece written for [general
practitioners](https://pmc.ncbi.nlm.nih.gov/articles/PMC3505409/): "While often used as a synonym
for frequent or customary behaviour in everyday parlance, within psychology, 'habits' are defined as
actions that are triggered automatically in response to contextual cues that have been associated
with their performance".[1]

Their two examples are worth having, because both are things you do without ever having set out to
learn them at all. "[A]utomatically washing hands (action) after using the toilet (contextual cue),
or putting on a seatbelt (action) after getting into the car (contextual cue)".[1]

**Read the definition slowly, because it has three parts and each one does work.**

There is a **cue**, which is a context. A place, a time of day, an event, the end of another
behaviour. There is a **response**, which is the action. And there is an **association** between
them, which is the thing that was built and the thing that does the triggering.
...
door before the question of whether to go has properly formed.

Same behaviour. Same frequency. **Only the second one is a habit in the sense that makes any of this
research apply**, because only for the second one has the decision dropped out.

:::predict Before you read on, try this on yourself. Pick one thing you do most days and ask: on a typical morning, does the question of whether to do it actually arise? Not whether you enjoy it, and not whether you could stop. Whether you consult yourself about it.
Most people, doing this honestly for the first time, find that far fewer of their regular behaviours
are habits in this sense than they expected, and that the ones which are tend not to be the ones they
are proud of.

Brushing your teeth usually is. The gym usually isn't, even after years. Making coffee is. Reading
before bed, for most people who do it, is not: it survives on a decision every night, which is why
it is the first thing to go in a bad week.

**And that last observation is the reason any of this matters**, which the next section is about.
Something that needs a decision every time is exposed to every bad week you ever have. Something that doesn't, is not.
:::

## What a habit buys you

Two things, and the first is much larger than the second.

**A habit doesn't depend on your wanting to do it.** The same paper puts the mechanism in one
sentence: "Once initiation of the action is 'transferred' to external cues, dependence on conscious
attention or motivational processes is reduced. Therefore habits are likely to persist even after
conscious motivation or interest dissipates."[1]
...
mechanism does not require your consent, only your repetition.

**And it says nothing about how you feel while doing it.** A habit can be enjoyable, tedious, or
unnoticed. What it can't be is deliberated about each time, because then it is something else.

:::checkpoint Somebody objects that this is word games. They do the same things whatever you call them, so who cares whether their running counts as a habit?
It's a fair challenge and there is a real answer.
...
check which one is true of you. That isn't a word game; it is the difference between a description
and a claim.
...
years and notices only when they are not there. Cue, coming through the door. Response, keys in the
bowl. And the association is doing the work, because he did not decide today. **A habit.**

**Two. A woman does the household accounts on the first Saturday of the month.** She has done this
for six years without missing one. She puts it in the calendar, she is glad when it is done, and on
the morning itself she gets herself to the desk. Cue, arguably the first Saturday. Response, the
accounts. **But the association isn't what gets her there**, and she knows it, because when the
first Saturday is awkward she moves it and does it anyway. **Not a habit**, and she is more reliable
than most people's habits. **Reliability and automaticity are different achievements.**

**Three. A teenager opens a particular app whenever he unlocks his phone.** He does it while waiting
for a kettle, between sentences, on the stairs. He often could not tell you he'd done it. Cue,
unlocking. Response, the app. Association, plainly. **A habit**, and one nobody chose.

**Notice that the sorting has nothing to do with which of the three you would want.** Case two is
the admirable one and it is the one that fails the definition.

## What this course promises

**It won't make you more disciplined**, and that is a statement about what the research is rather
than modesty.
...
cue at a time. **Both of those are true at once**, which is what makes it a question rather than a
...
Most people find it is fewer than they expected, and that the ones which are habits are not the ones
they would have nominated. Keep the sheet. Lesson 2 asks you to do this across a whole day, and
lesson 3 works on the cues.
:::

:::exercise Find one you never chose
...
**Forward.** Lesson 2 measures how much of an ordinary day meets this definition, and traces the
figure everybody quotes for it. Lesson 3 is what the cue is doing, and it is the first lesson with a
technique in it. Lesson 4 is how long a habit takes and what happens when you miss a day. Lessons 5
and 6 are self-control. Lesson 7 comes back to the question this lesson declined.
...
- **[Making health habitual: the psychology of 'habit-formation' and general
  ...
  Practice*, 2012). Three pages, free, and this course has read all of it. Written for doctors
  rather than for readers of self-help, which is why it is the clearest short statement of this
...
1. Benjamin Gardner, Phillippa Lally and Jane Wardle, ["Making health habitual: the psychology of
   ...
   *British Journal of General Practice* 62(605), December 2012, pages 664 to 666. **Read in full**,
   open access. Supports: the quoted definition and both of its examples; the quoted sentence about
   initiation transferring to external cues and habits persisting after motivation dissipates. **Two
   of its three authors are authors of the study lesson 4 rests on.**
2. Wendy Wood, Jeffrey M. Quinn and Deborah A. Kashy, ["Habits in Everyday Life: Thought, Emotion,
   and
   ...
   *Journal of Personality and Social Psychology* 83(6), 2002, pages 1281 to 1297. Read in part: the
   abstract and the diary-study results. Supports the quoted finding about thoughts unrelated to the
   behaviour and the lower reported stress. **Scope: two hourly-diary studies of students.**
