...
quiz:
  - q: >-
    ...
    answer: 1
    explain: >-
      The psalm names the river, the captors, and the memory of Jerusalem, and it is the standard exile psalm. Placing it in the exile (B) makes it the grief of people who watched the Temple burn in 586 BC, which is what the words say. Option A puts it in David's day, when nobody had been to Babylon. Option C turns a real river into a symbol, which is a way of not reading the text. Option D borrows Revelation's use of Babylon and imports it into a book written six centuries earlier; the basic rule of lesson 3 will say why that cannot be the first meaning.
  - q: >-
      You are reading Haggai for the first time. It opens with a date in "the second year of Darius the king" and tells people to stop panelling their own houses and rebuild the LORD's house. Without a study Bible, where does the timeline put it, and what should you expect the book to be about?
    options:
    ...
    answer: 0
    explain: >-
      Darius is a Persian king, and a Persian king ruling the Jews means the exile has happened and the return has begun. That places Haggai in the last part of Act 3, with Ezra, Nehemiah, Zechariah, and Malachi, and a ruined Temple is exactly the problem those books face (A). Option B has a Persian king in the wrong century. Option C is tempting because Haggai is near the end of the Old Testament, but the gap is after Malachi, not before; no Old Testament book is written inside it. Option D ignores the name entirely.
  - q: >-
      A speaker tells a room of new graduates, "Deuteronomy 28 says if you obey God you will be blessed in the city and blessed in the field, and your barns will be full. Claim it." Using this lesson's method, what is the most accurate thing to say about that reading?
    options:
      - "It is right. A promise God made in the Old Testament still stands for anyone who obeys him, and the words have not changed since"
      - "It is wrong. Deuteronomy is law and the New Testament is grace, so nothing in Deuteronomy can apply to a Christian at all today"
      - "It skips a step. These are Sinai covenant terms given to Israel entering its land; ask how they reach us through the new covenant"
      - "It is wrong. Deuteronomy was written centuries after Moses, so the blessings describe what had happened rather than promise anything"
    answer: 2
    explain: >-
      Deuteronomy 28 sits at Sinai's end, as the blessings and curses of a national covenant with Israel about land, harvest, and war. The lesson's method asks first who this was said to and under which covenant, and only then what reaches a Christian and how (C). Option A lifts the sentence out of its covenant, which is the Jeremiah 29:11 mistake. Option B is Marcion's move, which the church rejected in the second century, and it throws away a book Jesus quoted. Option D drags in the dating dispute about the Pentateuch, which lesson 10 will treat as a real argument, but even on the critical dating the text presents itself as covenant terms, so the placement question is the same.
  - q: >-
      Someone objects that the book of Esther never mentions God, so it cannot be part of "God's plan" and should be read only as a Persian court drama. Using the three levels of narrative, which reply is best?
    options:
      - "The objection stands. Without God's name the top level is missing, so Esther can only be read on the bottom level, as a story of individuals"
      - "Esther is set after the return, among Jews still in Persia; the middle level is Israel's survival, the top level is Abraham's promise kept unnamed"
      - "Esther sits among the Writings in the Tanakh, so it has no place on the Christian timeline and the three levels simply do not apply to it"
      - "The top level is always there because every book is about Jesus, so read Esther as a prediction of the cross with Mordecai as a type of Christ"
    answer: 1
    explain: >-
  ...
  - q: >-
    ...
    options:
      ...
      - "It is better. The notice keeps the setting in view, a people living where they did not choose, and asks what that asks of them now"
      - "It is better. Verse 7 comes earlier in the chapter than verse 11, and earlier verses always set the context for the later ones"
    answer: 2
    explain: >-
      The difference is not which verse but whether the reader has kept the situation. The notice reads verse 7 as a word to a displaced people about how to live where they are, and asks how that reaches Christians who are also, in the New Testament's own picture, living away from home (C). Option A over-corrects; the lesson said a Christian may take comfort from Jeremiah 29, through the covenant it belongs to, and the same is true of its instruction. Option B invents a rule about commands that lesson 4 will show no Christian tradition holds. Option D is about verse numbers, which lesson 1 said are medieval and carry no meaning of their own.
  - q: >-
      You open 2 Kings 17. The northern kingdom falls to Assyria and the writer explains at length that this happened because Israel broke the covenant. Reading on all three levels, which statement is correct?
    options:
      - "Bottom: King Hoshea's reign. Middle: Israel losing the land the covenant tied to obedience. Top: God keeping his word, curse and promise both"
      - "Bottom: Assyria's campaign. Middle: a warning aimed at Judah. Top: the promise to Abraham failing when the ten northern tribes were lost"
      - "It is history rather than narrative, so only the bottom level applies, and the covenant explanation is the writer's own opinion added later"
      - "Samaria fell before Judah's exile, so the chapter belongs to the gap between the testaments and the three levels do not apply to it"
    answer: 0
    explain: >-
...
Christians have been drawing the shape of the Bible for a long time, and the drawings differ. The one this course uses comes from Craig Bartholomew and Michael Goheen's *The Drama of Scripture*, which is the most widely assigned "big story" textbook in Christian colleges. They lay the Bible out as a drama in six acts:[2]

1. **Creation.** God makes a good world and puts people in it to rule it under him (Genesis 1 and 2).
2. **Fall.** People rebel, and the damage spreads from a garden to a whole world (Genesis 3 to 11).
3. **Israel.** God chooses one family and makes it a nation so that the rescue can begin (Genesis 12 to the end of the Old Testament). Bartholomew and Goheen call this "redemption initiated".
4. **Jesus.** The rescue is accomplished in one man (the four Gospels).
5. **Church.** The news goes out to the world (Acts and the letters).
6. **New creation.** The rescue is completed and the world is remade (Revelation 21 and 22, with the whole of Revelation looking toward it).

Between acts 3 and 4 the authors put an interlude, "the intertestamental period", and they say why it matters: "four hundred years of Israel's history between Malachi and Matthew" that the Bible itself passes over in silence.[2]

I want to say two honest things about this scheme before you lean on it. First, it is a teaching device. Scripture does not number its own acts. Other good teachers cut the story differently: Vaughan Roberts, in *God's Big Picture*, uses eight stages built on one definition of the kingdom of God, "God's people in God's place under God's rule and blessing", from "the pattern of the kingdom" in Eden to "the perfected kingdom" in Revelation; Graeme Goldsworthy's *According to Plan* organises the same material around the same kingdom theme.[3][4] They all agree on the shape. They differ on where to draw the lines, and none of the lines is inspired.

Second, notice how lopsided the six acts are. Act 3 is about three quarters of the whole book. Fee and Stuart point out that the Old Testament is "three-quarters of the bulk of the Bible" and that "over 40 percent of the Old Testament is narrative".[5] So most of what you will ever read sits inside one act, the story of Israel, and that is the act that needs a map of its own. We will build it in a minute.

:::predict Before you look at the timeline, place the four-hundred-year gap yourself. Which is the last Old Testament book written before it, and which New Testament events come first after it? And where does Esther fall: before the gap or inside it?
The gap runs from Malachi to the first pages of the Gospels, roughly from the last prophet to John the Baptist. Every Old Testament book sits before it, including Esther, which is set in Persia after the return and belongs to the last part of Act 3, not inside the silence. Most people put one or two of the late books on the wrong side; the usual candidates are Esther, Daniel, and Malachi. If you got all three, you already know more of the shape than most readers.
:::

## The spine: five covenants

A six-act summary tells you the order. It does not tell you what holds the story together. For that you need the covenants.
...
A covenant is not a contract between equals, and it is not a deal God can be talked out of. In each of the five, God binds himself first. The terms that follow (be fruitful, walk before me, keep my commandments) are the response, not the price. If you read Sinai as Israel earning the exodus, you have the order backwards: Exodus 19 comes after Exodus 14.
:::

## The map of Act 3

Here is the act most readers get lost in, laid out so you can find your place. Read it top to bottom, then keep it open while you read the rest of the lesson. Only the dates history has fixed are marked; the rest are labelled by period, not by year, because for the early periods the year is argued and this lesson has no need of it.

<svg viewBox="0 0 360 700" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="tl-title tl-desc" style="max-width:100%;height:auto;font-family:system-ui,sans-serif">
  <title id="tl-title">The six acts of the Bible's story, with the books of Act 3 in order</title>
  <desc id="tl-desc">A vertical timeline. Act 1 Creation and Act 2 Fall at the top (Genesis 1 to 11). Act 3 Israel runs from Genesis 12 through the patriarchs, Egypt and Sinai, conquest and judges, the united kingdom, the divided kingdom, the exile in 586 BC, and the return under Persia, ending with Malachi. A four-hundred-year gap follows. Act 4 Jesus (the four Gospels, around AD 30). Act 5 Church (Acts and the letters). Act 6 New creation (Revelation 21 and 22).</desc>
...
Only two dates are printed. The fall of Jerusalem in 586 BC is one of the fixed points of ancient history; Christine Hayes, teaching the Hebrew Bible at Yale from the critical side, gives the same year.[12] The Tel Dan stele, a broken inscription found in 1993 and dated to the ninth century BC, names the "House of David", which is why history establishes that a king David existed even while scholars argue about the size of his kingdom.[13] The dates of Abraham, the exodus, and the conquest are argued, and this course will say how in lesson 10, and hand the detail to *Hard Questions*. You do not need those dates to read; you need the order.
...
The gap is real and the Bible is silent about it. Between Malachi and the Gospels, Persia gives way to Alexander's Greece, Greece to the Maccabean revolt and a short-lived Jewish kingdom, and that to Rome. The Pharisees, the synagogue as the Gospels know it, and the Greek translation of the Old Testament all take shape in those centuries. Catholic and Orthodox Bibles carry books from this period (1 and 2 Maccabees among them), which is one reason their Old Testaments are longer; lesson 8 gives that case in full. If you open Matthew straight from Malachi and wonder why everyone is suddenly speaking Greek and paying taxes to Caesar, the gap is the answer.

:::video https://www.youtube-nocookie.com/embed/7_CGP-12AE0 | The Story of the Bible (BibleProject)
BibleProject's five-minute animation of the whole story, from the garden to the new creation. Watch it after you have read the map above and see whether you can name the act and the covenant at each point as the drawing goes past. The animation cuts the story differently from our six acts, which is a useful reminder that the lines are ours.
:::

## Three levels at once

Now the tool that makes the map useful. Fee and Stuart, in the chapter on Old Testament narrative that lesson 3 will use in full, say that every biblical story is being told on three levels at the same time.[5]
...
Ruth is four chapters long and you can read it in twenty minutes, which is why I want you to have it open. Here is how it is usually read, and here is how the map reads it.
...
:::predict You have read four chapters about Naomi, Ruth, and Boaz. How do you expect the book to end? Write one sentence.
...
Yes. But watch how. Not by lifting the sentence off the page and addressing it to yourself; that route ignores who "you" is and makes the verse promise something it never promised anyone. The route that works goes through the story. Jeremiah 29 is a promise to God's people in exile that he has not abandoned his covenant. Two chapters later the same prophet announces the new covenant.[11] The New Testament says that covenant has been made in Christ, that the church is now the people of that promise, and that Christians too live, in Peter's phrase, as exiles (1 Peter 1:1). So what reaches a Christian from Jeremiah 29:11 is what reached the exiles: God's plans for his people include the hard stretch, and the hard stretch is not the end. What does not reach you is a guarantee that your own plans will prosper, because it never said that to them either.
...
You have now seen the mechanism twice, so let me state it plainly.

Meaning depends on position in the story. A promise given to exiles carries the exile with it. A law given at Sinai carries the covenant it belongs to. A psalm sung in the rebuilt Temple carries the memory of the ruined one. When you lift a sentence out of its act, the words stay and the meaning goes, and what you put back in its place is usually your own situation. That is why the card reading of Jeremiah 29:11 feels so natural: the sentence, emptied of Babylon, fills up with you.

The reader who knows where they are can ask the one question that stops most misreadings before they start: what did this mean *then*? Lesson 3 will give that question its formal name, Fee and Stuart's basic rule, that a text cannot mean what it never could have meant to its author or readers.[5] Everything in this lesson is that rule in its simplest form: you cannot know what it could have meant to them until you know where on the map they were standing.
...
**"The timeline is the order of the books."** Said above, and worth repeating because it is the mistake that puts Amos after Nehemiah and Job somewhere near the end. The Old Testament's shelf order is by kind of writing. The timeline is a separate thing you carry in your head, and this lesson has just handed it to you.

**"The Old Testament is Judaism's Bible with a Christian sequel."** Careful here. The same twenty-four books are, for Jews, the Tanakh: a complete Scripture with its own order and its own ending (Chronicles, and the call to go up to Jerusalem, as lesson 1 showed), read on its own terms by a living community today. Hayes tells her Yale students that she will avoid the phrase "Old Testament" because it "sort of suggests the doctrine that the New Testament has somehow fulfilled or surpassed or antiquated the Bible of ancient Israel", and she is right that the phrase carries that claim.[12] This course uses "Old Testament" because we hold the claim: we read the whole as pointing to Christ because Jesus did, and we say so as our faith. But we also say plainly that a Jewish reader reads the same books as a different story with its own integrity, ending not in Bethlehem but in the return to Zion, and that when this course describes that reading it will try to describe it as a Jewish reader would.
...
**Part 2: Jeremiah 29 whole.** Read Jeremiah 29:1 to 14, all of it, in your own Bible. Then write three things:
...
3. One sentence on what a Christian may take from the passage, and one on what a Christian may not, using the covenant route from the second worked example.

**Part 3: one more.** Open 2 Chronicles 36:22 and 23, the last two verses of the Tanakh. Say which act and which period they belong to, which covenant promise they are answering, and why a Jewish Bible would choose to end here.
:::

## Connections

Lesson 1 gave you the shelves; this lesson gives you the timeline behind them, and you have now seen twice (Daniel last time, Ruth this time) that which shelf a book sits on is already a reading of it.

Every genre lesson from here on will start by asking where a passage sits on this map, because "what did it mean then?" cannot be answered without it. Lesson 3 turns the three levels into a full method for reading narrative. Lesson 4 comes back to the covenants in detail, Sinai above all, and shows the prophets enforcing it. Lesson 7 gives the Jeremiah 29 move its proper name. Lesson 10 returns to the dates this lesson left unmarked, and to the question of who wrote the early books, as a real argument with two sides.

*The Story of Scripture*, later in this school, walks the six acts one at a time. This lesson is the map in a single sitting so that you never again read a verse without knowing where it lives.
...
- Christine Hayes, [RLST 145, lecture 1, "The Parts of the Whole"](https://oyc.yale.edu/religious-studies/rlst-145/lecture-1) (Open Yale Courses, 2006). Fifty minutes, free, with transcript. The Hebrew Bible as a library and as Israel's own story, from a scholar who is not asking you to believe anything. Hear the other reading from its own teacher.
