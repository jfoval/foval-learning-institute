...
objectives:
  ...
  - >-
    Describe NICE's step-2 self-help as it is specified, and say how an ordinary book or app differs
    from it
quiz:
  - q: >-
      A workbook for anxiety says it is "based on CBT" and suggests dipping into whichever chapter
      feels useful. Against NICE's specification of non-facilitated self-help, what is missing?
    options:
...
materials over a period of at least 6 weeks"; and "usually involve minimal therapist contact, for
example an occasional short telephone call of no more than 5 minutes."[1]

Guided self-help, under 1.2.14, should "be supported by a trained practitioner, who facilitates the
...
:::exercise Hold a book up to the specification
...
:::exercise What you'd ask for

Take 15 minutes.

Write down what you would ask a doctor, or in England an NHS Talking Therapies service, if you wanted
the guided version of self-help. Use NG222's definition to phrase it: who would support you, how
often, and how progress would be reviewed.
