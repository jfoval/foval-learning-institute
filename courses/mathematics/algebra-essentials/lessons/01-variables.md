...
:::predict Same plan as before, twelve dollars and five cents a minute, and this month the bill was $44. How many minutes did you talk? You can work this out without any algebra at all, and it is worth doing that way once.
...
:::predict Say `a = 2` and `b = 3`. Work out each side before you open this. Are they equal?
...
Four of these and they cover nearly everything you'll meet. [OpenStax's *Elementary Algebra*](https://openstax.org/books/elementary-algebra-2e/pages/1-2-use-the-language-of-algebra) sets out the same conventions with more examples, free, if you want a second telling.
...
:::exercise Practice
Work these on paper, and write the substitution line before you compute. If you want more of the same afterwards, [Khan Academy's algebra basics](https://www.khanacademy.org/math/algebra-basics) has an unlimited supply.
