...
It's worth saying why this particular hour is a good bet. The same meta-analysis of 76 randomised trials from lesson 1 found that financial education's strongest effects land exactly here, on budgeting and saving behaviour ([Kaiser, Lusardi, Menkhoff and Urban, 2022](https://www.nber.org/papers/w27057)).[1] Of everything this course teaches, the budget is the piece most likely to actually change what you do.
...
:::predict Maya could have "fixed" her month harder: eating out $0, everything else $100, savings $683. Predict what that version of the budget looks like in week three.
...
:::checkpoint Dan lands a $4,900 month. His salary is $2,800. What happens to the other $2,100?
...
The standard answer is: build a cash cushion before anything else, and here you should know the difference between what's evidence and what's convention. The most-followed plan in America, Dave Ramsey's [Baby Steps](https://www.ramseysolutions.com/dave-ramsey-7-baby-steps), says $1,000 first, then attack debt, then grow the cushion to 3 to 6 months of expenses; millions have used it and its results are real. Critics answer that $1,000 no longer covers many common emergencies, and the 3-to-6-month range, though it carries expert consensus, has thin direct evidence behind those particular numbers. What the data support firmly is a low threshold effect: Vanguard's research found that having even about $2,000 set aside is associated with a 21-point difference in financial well-being, with a further boost from reaching 3 to 6 months ([Vanguard, "In case of emergency, break glass", 2023](https://corporate.vanguard.com/content/corporatesite/us/en/corp/vemo.html)).[9] So the calibrated version is: the first couple of thousand dollars of cushion buys you the most per dollar of anything in this course, the right full size scales with how volatile your income is and who depends on you, and the exact figures in anyone's plan are convention, not law.
...
:::exercise Do it now: build the budget
...
The CFPB's [Your Money, Your Goals toolkit](https://www.consumerfinance.gov/consumer-tools/educator-tools/your-money-your-goals/) has a free public-domain budget worksheet if you'd rather fill in a form than build a table.
...
- [CFPB, Your Money, Your Goals](https://www.consumerfinance.gov/consumer-tools/educator-tools/your-money-your-goals/): the free, public-domain budget and bill worksheets. The practical companion to this lesson's exercise.
- [Khan Academy, Budgeting and Saving](https://www.khanacademy.org/college-careers-more/financial-literacy): the budgeting unit of the free full course; a second walkthrough of the same ground with videos and practice.
- Thaler, R. and Benartzi, S., ["Save More Tomorrow" (2004)](https://www.journals.uchicago.edu/doi/10.1086/380085): the field study behind "automate it"; readable and one of the most influential papers in behavioural economics.
...
1. Kaiser, T., Lusardi, A., Menkhoff, L. and Urban, C., ["Financial Education Affects Financial Knowledge and Downstream Behaviors"](https://www.nber.org/papers/w27057), *Journal of Financial Economics* 145(2), 255-272 (2022). Meta-analysis of 76 randomised controlled trials; strongest behavioural effects on budgeting, saving, and credit.
2. C+R Research, ["Subscription Service Statistics and Costs"](https://www.crresearch.com/blog/subscription-service-statistics-and-costs/) (2022). Average estimated monthly subscription spend $86 against an actual $219; covered in lesson 1.
3. Consumer Financial Protection Bureau, ["Financial well-being: The goal of financial education"](https://files.consumerfinance.gov/f/201501_cfpb_report_financial-well-being.pdf) (2015). The four-element definition, including the freedom to enjoy life.
4. JPMorgan Chase Institute, ["Weathering Volatility"](https://www.jpmorganchase.com/institute). Bank transaction data showing large month-to-month income volatility is normal for typical households.
...
7. Thaler, R. H. and Benartzi, S., ["Save More Tomorrow: Using Behavioral Economics to Increase Employee Saving"](https://www.journals.uchicago.edu/doi/10.1086/380085), *Journal of Political Economy* 112(S1) (2004). Automatic escalation raised average contribution rates from 3.5% to 13.6% over about four years.
8. Prelec, D. and Simester, D., ["Always Leave Home Without It"](https://link.springer.com/article/10.1023/A:1008196717017), *Marketing Letters* 12(1), 5-12 (2001). Willingness to pay for the same goods was substantially higher, up to roughly double, when paying by credit card rather than cash.
9. Vanguard, ["In case of emergency, break glass"](https://corporate.vanguard.com/content/corporatesite/us/en/corp/vemo.html) (2023). Having even $2,000 in emergency savings is associated with a 21-point difference in financial well-being scores, with a further gain at 3 to 6 months of expenses; correlational.
10. Ramsey Solutions, [The 7 Baby Steps](https://www.ramseysolutions.com/dave-ramsey-7-baby-steps). Primary statement of the $1,000 starter fund and 3-to-6-month sequence discussed as contested guidance above.
