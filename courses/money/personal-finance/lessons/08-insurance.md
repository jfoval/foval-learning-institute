...
quiz:
  ...
  - q: Sydnor's study of 50,000 home insurance policies found that 83% of customers bought a lower deductible than they had to, and that the largest group of them paid about five times more in premium than the extra coverage was worth. What does that study support, and what does it not?
    options:
...
And the standing note, which matters more here than anywhere else in the course, because this lesson gives more direct answers than any other. **This is education, not personalised advice.** What follows is the arithmetic and the vocabulary, and the weighting depends on facts about your life no course can know. For anything binding, your [state insurance department](https://content.naic.org/state-insurance-departments) regulates these products, publishes consumer guides, and handles complaints.
...
:::predict A friend says "I've paid car insurance for twelve years and never claimed. That's thousands of dollars wasted." What is wrong with that sentence, and what would have to be true for it to be right?
...
<svg viewBox="0 0 584 352" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:584px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="pool-title pool-desc">
  ...
  <desc id="pool-desc">Two pictures of one person's possible year, not drawn to scale: the rare year is drawn large enough to see. Uninsured, there is a very tall bar at a cost of zero, covering 99 percent of years, and a small bar far to the right at a cost of 50,000 dollars. Insured, there is a tall bar at 650 dollars covering most years, and a short bar a little to the right at 650 dollars plus the policy's own limit, which is the bad year you still pay for. The average cost is lower uninsured; the worst case is the point of the difference.</desc>
  ...
  <text x="112" y="232" font-size="15" fill="var(--navy, #0f2a4a)">most years cost $650</text>
  <rect x="200" y="264" width="26" height="20" fill="none" stroke="var(--navy, #0f2a4a)" stroke-width="1.5"/>
  <text x="232" y="279" font-size="15" fill="var(--navy, #0f2a4a)">a bad year still costs you the excess</text>
...
[8] David Himmelstein and Steffie Woolhandler's reply to Dobkin et al., published by Physicians for a National Health Program, an organisation that campaigns for single-payer health care; quoted here for the authors' own statement of their case. https://pnhp.org/news/again-medical-bankruptcy-is-not-a-myth/
