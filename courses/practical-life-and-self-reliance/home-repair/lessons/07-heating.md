...
objectives:
  - >-
    ...
    boiler or heat pump; a storage or tankless water heater) and explain what its main parts do
  - >-
    Diagnose a cold radiator as air or sludge, and describe bleeding it and restoring the pressure
    to the figure in the boiler's own instructions
  - >-
    Explain why turning the thermostat up doesn't heat a home faster, what a TRV does, and what an
...
quiz:
  ...
  - q: >-
    ...
    options:
      ...
      - The pressure is normal for a boiler that is cold, so she should leave it well alone
      - Bleed every radiator in the flat first, because letting the air out raises the pressure
      - Top it up past 2.75 bar, since the pressure drops back once the heating comes on
    answer: 0
    explain: >-
  ...
  - q: >-
      In a semi in Cambridgeshire, every bedroom radiator's TRV is turned up to 6. The room
      thermostat is in the hall, set at 19°C. The bedrooms are stuffy at night while the hall stays
      cool. On the Energy Saving Trust's account of TRVs, which change fits?
    options:
      - Turn the hall thermostat down to 17°C, so that the boiler runs for less time overall
      - Turn every bedroom TRV to 0, since a TRV only ever works fully open or fully closed
      - Turn the boiler's flow temperature up, so the hall reaches its 19°C before the bedrooms
      - Turn the bedroom TRVs down, since each closes a little once its room is warmer than it
    answer: 3
    explain: >-
      EST says a TRV senses the air around it and closes a little when the room is warmer than its
      setting, and suggests 2 to 3 for bedrooms. On 6 the bedroom valves stay fully open, so those
      rooms keep taking heat. Turning the hall thermostat down makes the cool hall cooler and does
      nothing to share the heat differently. EST gives 0 as off, not as the only other setting, so
  ...
  - q: >-
      ...
      spring. On DOE's archived advice, what should change?
    options:
      - Set it back further at night, so that the backup heat has less time to run
      - Stop the night setback if it brings the backup heat on, and see to the filter
      - Keep the setback, since a heat pump's filter needs changing only once a year
      - Leave both alone, since a heat pump has an annual professional service anyway
    answer: 1
    explain: >-
...
isn't yours at all. This lesson shows you how to tell which system you have, what the pressure
gauge is telling you, how to bleed a radiator and top the pressure back up, what the thermostat
and the radiator valves actually do, and which parts of a furnace or heat pump are yours to look
after. How hot the water from your taps should be is the question for lesson 8, "Hot water:
scalds, legionella and the tank".
...
You can't use the right advice until you know which system you're standing in front of, and the
sources for each country describe different equipment.

### In the UK: three kinds of boiler

In the British homes these sources describe, the heating is wet central heating: a boiler heats
water, a pump sends it round radiators, and the same boiler often makes the hot water too. The [Energy Saving
Trust](https://energysavingtrust.org.uk/advice/boilers/) (EST), the UK's government-funded energy
advice body, sorts the boilers into three kinds.[1]

- **Combi.** "Combi boilers don’t use a hot water cylinder", EST says; the boiler heats water as
  you run the tap. EST says they suit smaller homes and are less suited to houses with several
  bathrooms.
...
### In the US: furnaces, boilers and heat pumps

The US Department of Energy's Energy Saver pages, which were taken down and are cited here as
archived copies, put the main difference in two sentences: "Furnaces heat air and distribute the
heated air through the house using ducts. Boilers heat water, and provide either hot water or
steam for heating."[11] A furnace's ducts carry a filter in the air path, which is the part of it
that's yours. The third kind is the heat pump, which DOE says can cut electricity use for heating by up
to 75% against electric resistance heating, for an air-source model.[12]
...
:::predict A small flat has no tank in the loft, no cylinder in the airing cupboard, and a boiler with a plastic flue. Hot water comes out of the tap within seconds at any time of day. Before reading on: which kind of boiler is it, most likely, and is it condensing?

A combi, and condensing. No cylinder and no loft tanks fits EST's description of a combi, which
heats water straight from the boiler, and EST says a plastic flue marks a condensing boiler.[1]
Hot water within seconds at any hour is what you would expect with no store to run out, but it is the
missing cylinder and tanks that settle it.
:::
...
|---|---|---|
| Worcester Bosch | "between 1 and 1.5 bar" when cool[3] | below 0.5 bar, "water has been lost from the system and must be replaced"; about 2.75 bar or more is too high[3] |
| Vaillant | "between 1 to 1.5 bar of pressure when the central heating is cold"[8] | top up if too low, following the boiler's instructions[8] |
...
small, normal losses, with air let out through automatic vents and tiny amounts escaping at valves
and joints, and says the gauge "measures the pressure within the whole central-heating circuit,
...
Not normal on Worcester Bosch's rule. The rise is 1.3 bar, and Worcester Bosch says a rise of
more than 1 bar when the heating is up to temperature means the expansion vessel may need
repressurising, which "will require a service engineer".[3] So the gauge has done its job, and the
fix is **Call someone**. Nothing about it is a householder's to adjust.
:::
...
identify the filling controls, if the hose has been removed, or if water is leaking from radiators,
...
This is the diagnosis the whole of this lesson's hands-on part rests on, and it takes a hand on
the radiator.

:::predict A radiator is hot at the bottom and cold across the top third. Another one, in a different room, is hot at the top and cold along the bottom. Before reading on: which one does bleeding fix, and what's wrong with the other?

Bleeding fixes the first. Worcester Bosch says radiators that need bleeding are "colder at the top
than at the bottom", because that's where air collects. The second is the other way round, and
Worcester Bosch says cold at the bottom and hot at the top "could mean that sludge has built up in
your radiator and you might need your system cleaned."[7] Bleeding does nothing for sludge.
:::

The mechanism, as the makers give it: air gets into a heating system over time, and Vaillant
says "Air will naturally rise as it is lighter than water", so it gathers at the top of a
radiator, where hot water can't reach.[8] Sludge is the other end of the same system. Vaillant
says the oxygen in trapped air "causes corrosion which can result in leaking and debris in your
...
2. **Heating off, radiators cool.** Worcester Bosch: "Turn off your heating system and wait for the
   radiators to cool." Vaillant says about an hour, or two to be cautious, so that hot water or
   steam can't burn you, and that the radiator valves should be fully open while you bleed.[7][8]
3. **Key in, cloth ready.** The bleed valve is at the top of the radiator, usually at one end;
   Vaillant describes it as a small round hole with a little square inside. Hold a cloth under it
   (Worcester Bosch) or a bucket beneath and a cloth against the wall (Vaillant).[7][8]
4. **Open slowly, anticlockwise.** Vaillant says a quarter to half a turn is enough, and not to
   keep opening once it hisses. The hiss is the air leaving.[8]
5. **Close when water runs.** Worcester Bosch: keep it open "until water starts to flow steadily",
   then turn the key clockwise. Vaillant says let a little water run first, and "Don't close the
   valve too tight, otherwise you might damage it." Vaillant also notes the water may be
   discoloured, and that this isn't a cause for alarm.[7][8]
6. **Check the gauge before the heating goes back on.** Vaillant says to check the pressure before
   switching back on, and Worcester Bosch says to top it up afterwards, because bleeding loses
   pressure.[7][8]
...
## Two radiators, two households

### A combi flat on Tyneside

This is the simple case. In a first-floor flat on Tyneside, the bedroom radiator is cold
across the top and warm below. The boiler is a combi, and its manual gives 1 to 1.5 bar cold. The
gauge reads 1.2 bar with the heating off.

The owner runs the heating to check the other radiators (all warm), then turns it off and waits an
hour. Key in, cloth under the valve, a quarter turn anticlockwise: a hiss, then after a while a
steady trickle of water, and the key goes back clockwise, not too tight. The gauge now reads 0.8
bar.

:::checkpoint The gauge has dropped from 1.2 to 0.8 bar. Is something wrong, and what does the owner do next?

Nothing is wrong. Bleeding lets water out with the air, and Worcester Bosch says boiler pressure
can be lost when bleeding radiators.[7] But 0.8 is below this boiler's 1 to 1.5, so the owner tops
it up by the boiler's own filling method, watching the gauge and closing the controls in range,
with the boiler off and cold as Ideal's guide says.[5] Then the heating goes back on and the
radiator should be warm all over. If the owner had found the gauge falling again within weeks,
that would be a different story: see the next case.
:::

### A system boiler in Northamptonshire, with a gap for you

This is the harder case. A 1990s detached house in Northamptonshire has a system boiler and a
cylinder in the airing cupboard. The back bedroom radiator is hot along the top and cold along the
bottom. The owner bled it anyway; nothing hissed, and water came straight out. And since October
the pressure has needed topping up about every fortnight to stay in the maker's range.

Two facts, and the temptation is to treat them as one problem. Before you open the answer, decide
what each fact means on its own, and whose job each is.
...
Worcester Bosch and Ideal call normal. Worcester Bosch says to contact your installer, and Ideal's
list of reasons to call includes pressure that "drops repeatedly over days or weeks".[3][5]
Something is losing water. Ideal says it is worth checking regularly for visible leaks, weeping
valves or wet patches along pipework, so the owner can look, but finding and fixing the leak is
**Call someone**.

Two faults, one engineer's visit. What the owner should not do is keep topping up as though that
were the fix: each top-up hides the leak for another fortnight. Vaillant's corrosion point makes
this course suspect the two may be connected, but that is the course's reading, not something the
makers say, and it is for the engineer to find out.
:::
...
EST describes the room thermostat as a switch with a target. It "turns the heating on until the
...
explanation and no maker's instructions for changing it, so it gives no setting. If you change
it, do it by your boiler's user instructions.
...
### What an efficiency rating leaves out

A furnace or boiler in the US carries an AFUE rating. DOE's archived page defines it: "An AFUE of
90% means that 90% of the energy in the fuel becomes heat for the home". It says older systems ran
at 56% to 70% and modern ones reach up to 98.5%.[11] Then comes the catch. AFUE excludes the heat
lost from the ducts, "which can be as much as 35% of the energy for output of the furnace when
ducts are located in the attic, garage, or other partially conditioned or unconditioned space."[11]
So a 95% furnace with its ducts in a cold attic could, at worst, deliver about 62% of the fuel's
energy to the rooms: 95% times 0.65, by this course's arithmetic. The rating describes the furnace,
not the house.
...
system in spring and the heating in autumn, and lists what the contractor checks, including "all
gas (or oil) connections, gas pressure, burner combustion and heat exchanger."[14] All of that is
**Call someone**.

### The filter, which is yours

One job on that list is the householder's. ENERGY STAR: "Inspect, clean, or change air filters
...
5. Slide the old one out and put the new one in with its arrows pointing the same way, towards the
   blower.
6. Close the panel and turn the system back on.

It is **Yours, on conditions**: the size your unit takes, and the filter slot or panel your
furnace's manual shows for it. Nothing else on a gas furnace comes off for this job.

## What people get wrong

**"Turning the thermostat up heats the house faster."** EST: it "won’t make your home heat any
faster!" It sets when the heating stops.[10]

**"A radiator that's cold at the bottom needs bleeding."** Cold at the top is air; cold at the
...
1. **Identify it.** UK: find the boiler and its flue (plastic or metal), and look for a cylinder in
   ...
   if you can't see it from a safe floor, write "unknown". Write down combi, system or regular, and
   vented or unvented if you have a cylinder and its label says. US: note whether you have a
   furnace, a boiler or a heat pump, and a storage or tankless water heater. Find the model name on
   each and the manual (a drawer, or the maker's website).
...
and the pressure figure from your boiler's manual. It adds to the **stop list**: anything inside
the boiler or furnace casing, a pressure that needs topping up more than twice a year, a rise of
more than 1 bar when hot, and any fault code the manual doesn't tell you to clear.
...
- **Worcester Bosch, [*System Filling Guide*](https://www.worcester-bosch.co.uk/files/news/System_filling_guide.pdf)**,
  2016, free. Read here in full. Eight pages, for Worcester Bosch's own boilers, with drawings of
...
- **ENERGY STAR, ["Maintenance Checklist"](https://www.energystar.gov/saveathome/heating-cooling/maintenance-checklist)**,
  free. Read here in full. One page listing what a US contractor's annual check-up should cover
  and the one job it leaves to you.

## Sources

1. Energy Saving Trust, ["Boilers"](https://energysavingtrust.org.uk/advice/boilers/), read from
   Internet Archive capture 20260919232017 (the live site refuses automated readers). **Read: full
   text.** The three kinds of boiler, the plastic flue, and heating and hot water as over half of
   energy bills. <!-- SOURCES Part A §1 -->
2. Vaillant, ["Hot water tank temperature"](https://www.vaillant.co.uk/advice/heating-tips/home-advice/hot-water-tank-temperature/).
   **Read: full text, 25 September 2026.** A maker's page; used only for its description of vented
   and unvented cylinders. <!-- lesson 06 gate closures -->
3. Worcester Bosch, ["How often should I need to top up the pressure in the heating system?"](https://www.worcester-bosch.co.uk/support/troubleshooting/faqs/all-faqs/how-often-should-i-need-to-top-up-the-pressure-in-the-heating-system).
   **Read: full text; re-read on the live page 25 September 2026.** A maker, about its own sealed
   systems. <!-- SOURCES Part A §5; lesson 06 gate closures -->
4. Worcester Bosch, [*System Filling Guide*](https://www.worcester-bosch.co.uk/files/news/System_filling_guide.pdf),
   dated 03/05/2016 in the file. **Read: full text, 25 September 2026.** A maker's guide for its
   own boilers. <!-- lesson 06 gate closures G-W7 -->
5. Ideal Heating, ["Topping up the pressure on your Ideal Boiler"](https://idealheating.com/tips-and-advice/topping-up-boiler-pressure).
   **Read: full text, 25 September 2026.** A maker, about its own boilers; written for combis.
   <!-- lesson 06 gate closures G-W7 -->
6. Baxi, ["What should my boiler pressure be set at?"](https://www.baxi.co.uk/help-and-advice/faqs/what-should-my-boiler-pressure-be-set-at).
   **Read: full text, 25 September 2026.** A maker, about its own boilers. <!-- lesson 06 gate closures G-W7 -->
7. Worcester Bosch, ["How to bleed a radiator"](https://www.worcester-bosch.co.uk/support/troubleshooting/faqs/all-faqs/how-to-bleed-a-radiator).
   **Read: full text; re-read on the live page 25 September 2026.** <!-- SOURCES Part A §5, Part B §3 -->
8. Vaillant, ["How to bleed a radiator"](https://www.vaillant.co.uk/advice/heating-tips/home-advice/how-to-bleed-a-radiator/).
   **Read: full text; re-read on the live page 25 September 2026.** <!-- SOURCES Part B §3; lesson 06 gate closures -->
9. Vaillant, ["Why is my radiator not working?"](https://www.vaillant.co.uk/advice/heating-tips/home-advice/why-is-my-radiator-not-working/).
    **Read: full text, 25 September 2026.** Used only for the whole-radiator-cold check.
    <!-- lesson 06 gate closures -->
10. Energy Saving Trust, ["The most economical ways to use your central heating"](https://energysavingtrust.org.uk/take-control-your-heating-home/),
    read from Internet Archive capture 20260417064839. **Read: full text.** The savings figures on
    the page are tied to a price period and are not used. <!-- SOURCES Part A §5 -->
11. US Department of Energy, Energy Saver, "Furnaces and Boilers", as archived: Internet Archive
    capture 20250102062644 (the page no longer exists on energy.gov). **Read: full text.**
    <!-- SOURCES Part A §5 -->
12. US Department of Energy, Energy Saver, "Operating and Maintaining Your Heat Pump" (capture
    20250102062920) and "Heat Pump Systems" (capture 20241231180018), as archived. **Read: full
    text of both.** <!-- SOURCES Part A §5 -->
13. US Department of Energy, Energy Saver, "Maintaining Your Air Conditioner", as archived:
    capture 20241215045250. **Read: full text.** <!-- SOURCES Part A §5 -->
14. ENERGY STAR, ["Maintenance Checklist"](https://www.energystar.gov/saveathome/heating-cooling/maintenance-checklist).
    **Read: full text; re-read on the live page 25 September 2026.** <!-- SOURCES Part A §5 -->
15. Carrier, ["Changing Furnace Filters"](https://www.carrier.com/us/en/residential/hvac-resources/furnaces/changing-furnace-filters/).
    **Read: full text, 25 September 2026.** A US maker's page, which also promotes its own
    products; used only for its filter steps. <!-- lesson 06 gate closures -->
16. US Department of Energy, Energy Saver, "Tankless or Demand-Type Water Heaters", as archived:
    capture 20250102084025. **Read: full text.** <!-- SOURCES Part A §1 -->
17. [The Gas Safety (Installation and Use) Regulations 1998 (SI 1998/2451), regulation 3](https://www.legislation.gov.uk/uksi/1998/2451/regulation/3).
...
18. Health and Safety Executive, [*Safety in the installation and use of gas systems and appliances*, L56](https://www.hse.gov.uk/pubns/priced/l56.pdf),
...
19. Health and Safety Executive, ["Gas safety: home owners"](https://www.hse.gov.uk/gas/domestic/faqownerocc.htm).
