...
objectives:
  - >-
    ...
    top three steps, the very top, side loading and three points of contact
  - >-
    Decide, using HSE's six questions, whether a task that takes both hands off a stepladder can be
    justified
  - >-
    Interpret the US ladder-injury figures by what each one counts, including what they show about
    homes, low falls and older people, and state what this course could not find for the UK
quiz:
  - q: >-
      A man in Puerto Rico wants to put a box on a high garage shelf. His stepladder is a little
      short, so he plans to stand on its very top. Taking OSHA's construction rule and HSE's guidance
      as the practice to follow, what fits them?
    options:
      - He can, provided he keeps one hand on the shelf itself while he stands up there
      - He can, provided a second person holds the stepladder's back legs while he is on it
      - He shouldn't; OSHA bars the top as a step, and HSE the top three without a handhold
      - He shouldn't; neither body allows the top at all, but the step below it is fine
    answer: 2
    explain: >-
      OSHA's rule says the top or top step of a stepladder shall not be used as a step, and HSE's
      guidance says not to stand and work on the top three steps, the very top included, unless
      there is a suitable handhold. A shelf edge isn't something either source names as a suitable
      handhold, and HSE's list of tasks where losing a handhold has to be justified includes putting
      a box on a shelf. The step just under the top is still one of HSE's top three. Someone holding
      the legs isn't in either rule. Both are workplace rules, which is why the stem calls them
      practice: at home they bind nobody.
  - q: >-
      A columnist on Guam writes: "Ladder accidents are a workplace problem. At home you're on a
  ...
  - q: >-
    ...
    options:
      ...
      - Nothing extra, since hanging paper is on HSE's list of tasks it approves for stepladders
      - Ask someone to foot the stepladder, since HSE says that makes a no-handhold task safe
      - Nothing extra, as long as she keeps off the very top step and uses the one below it
    answer: 0
    explain: >-
      HSE names hanging wallpaper as a task where losing a handhold has to be justified, not one it
      approves. It lists what to weigh: the height of the task, whether a handhold is there before
      and after, whether it's light work, whether it avoids side loading and overreaching, and
      whether the stepladder can be tied. Footing is HSE's last resort for securing a leaning ladder,
      not a way of justifying a no-handhold task, and the step below the top is still one of the top
...
This lesson carries on from lesson 15, "Ladders and working at height", which set out whose rules
...
Yes. HSE's words are "Don’t stand and work on the top three steps (including a step forming the
very top of the stepladder) unless there is a suitable handhold".[1]
:::

HSE's list for using a stepladder, from its
[web guide](https://www.hse.gov.uk/work-at-height/ladders/types-of-ladder.htm) for workplaces in
Great Britain:[1]

- check all four feet are in contact with the ground and the steps are level;
- carry only light materials and tools, and don't overreach;
- not the top three steps, the very top included, without a suitable handhold;
- locking devices engaged;
- face the work rather than working side on, where possible;
- avoid side loading, "such as side-on drilling through solid materials (eg bricks or concrete)";
  where it can't be avoided, stop the steps tipping, for example by tying them, "Otherwise, use a
  more suitable type of access equipment".
...
Three points of contact work differently on a stepladder, because you're usually standing still
and working. HSE: "two feet and one hand, or when both hands need to be free for a brief period,
two feet and the body supported by the stepladder".[1] That "brief period" is doing a lot of work,
and the next section is about what HSE says when it is not brief.

:::checkpoint A stepladder has five steps plus a flat top. Someone stands on the fourth step, knees against the top, and uses both hands to drill a hole straight into the brick wall to their left. What does HSE's guidance say about each part of that?

The fourth step of five, with the flat top counted, is one of the top three, so HSE wants a suitable
handhold, and both hands are busy.[1] The knees against the top may be HSE's "body supported by the
...
Some jobs can't be done holding on. HSE names three examples: "to put a box on a shelf, hang
wallpaper, or install a smoke detector on a ceiling". It does not ban them. It says the decision
"needs to be justified", taking into account six things:[1]

1. the height of the task;
2. whether a handhold is still available to steady yourself before and after the task;
3. whether it is light work;
4. whether it avoids side loading;
5. whether it avoids overreaching;
6. whether the stepladder can be tied, for example when working side on.

Those six are the nearest thing in the sources this course read to a test a householder can run on
a stepladder job. HSE gives no scoring and no threshold; it asks the person deciding to weigh them.
...
**Height:** a ceiling from a stepladder is a low job, but on this course's reading, a stepladder
standing near the top of a flight of stairs has a longer fall beside it than its own height. **A handhold before and after:** yes, if he can
hold the steps while he positions the alarm and after. **Light work:** yes, a small alarm.
**Side loading:** fixing something overhead is not HSE's example of side-on drilling into brick, but
the stepladder is side on to the job, which HSE says to avoid where possible. **Overreaching:** the
...
with a mean age of 53, about a quarter of patients over 65, and "the majority of cases occurred in
home settings".[7] Another, Wakim and colleagues (abstract only), found ladders the third most common
cause of lumbar spine fractures in US emergency departments from 2010 to 2018, after floors and
stairs.[8]
...
The rise is D'Souza and colleagues' finding for 1990 to 2005.[4] The abstract also says the rate per
100,000 people rose by almost 27%, less than the count, because the population grew too. A rising
count does not tell you whether ladders got more dangerous or more people used them, and the abstract
does not say which. You'd want injuries per ladder use, which no study here gives, and more recent
years.
:::

## What people get wrong

**"A stepladder stands on its own, so the top is fine."** OSHA's rule says the top or top step
"shall not be used as a step", and HSE counts the very top among the top three steps.[2][1]
...
Lesson 15, "Ladders and working at height", set out whose rules these are and how to set up and
secure a leaning ladder. Lesson 12, "Smoke alarms: where they go, and why they stay silent", is where
the alarm rules are. Lesson 20, "Walls and paint: filling, preparing and painting", comes back to
the stepladder and the ceiling. What to do for someone who has fallen, including when a fall calls
for an ambulance, is First Aid and CPR lesson 11, "Bones, joints, head and spine"; this lesson
does not teach it.

## Go deeper

- **HSE, ["Safe use of ladders and stepladders"](https://www.hse.gov.uk/work-at-height/ladders/types-of-ladder.htm)**,
...
1. Health and Safety Executive, ["Safe use of ladders and stepladders"](https://www.hse.gov.uk/work-at-height/ladders/index.htm),
   ...
   read in full the same day.** Guidance for workplaces in Great Britain. <!-- SOURCES Part B §2; lesson 12 gate closures -->
2. US Occupational Safety and Health Administration, [29 CFR 1926.1053, "Ladders"](https://www.ecfr.gov/current/title-29/part-1926/section-1926.1053),
   eCFR. **Read: the whole section, 25 September 2026.** A federal rule for employers in
   construction. <!-- SOURCES Part B §2; lesson 12 gate closures -->
3. OSHA, ["Portable Ladder Safety" QuickCard](https://www.osha.gov/sites/default/files/publications/portable_ladder_qc.pdf),
   OSHA 3246. **Read: full two-sided card, re-read 25 September 2026.** <!-- SOURCES Part B §2 -->
4. A. L. D'Souza, G. A. Smith and L. B. Trifiletti, ["Ladder-related injuries treated in emergency departments in the United States, 1990-2005"](https://pubmed.ncbi.nlm.nih.gov/17478268/),
   *American Journal of Preventive Medicine*, 2007. **Read: abstract only (PubMed).** <!-- SOURCES Part B §2 -->
5. US Consumer Product Safety Commission, [*Consumer Product-Related Injuries and Deaths in the United States: Estimated Injuries Occurring in 2020*](https://www.cpsc.gov/s3fs-public/ConsumerProductRelatedInjuriesandDeathsintheUnitedStates.pdf),
   September 2021. **Read: the whole document, with Table F read closely.** A staff analysis not
   reviewed by the Commission. <!-- SOURCES Part B §2 -->
6. US Consumer Product Safety Commission, [*Hazard Screening Report: Injuries to Persons 65 Years of Age and Older*](https://www.cpsc.gov/s3fs-public/hazard_older.pdf),
   NEISS data 1997 to 2002. **Read: the full text, with the ladder rows read closely.** <!-- SOURCES Part B §2; lesson 12 gate closures -->
7. A. Barbat and colleagues, ["Head, Face, and Neck Fractures Secondary to Ladder-Related Injuries Treated in United States Emergency Departments in 2009-2018"](https://pubmed.ncbi.nlm.nih.gov/32561108/),
   *Journal of Emergency Medicine*, 2020. **Read: abstract only.** <!-- SOURCES Part B §2 -->
8. J. Wakim and colleagues, ["Etiologies, incidence, and demographics of lumbar vertebral fractures in U.S. emergency departments"](https://pubmed.ncbi.nlm.nih.gov/35441096/),
   *Journal of Spine Surgery*, 2022. **Read: abstract only.** <!-- SOURCES Part B §2 -->
9. C. M. Socias and colleagues (NIOSH), ["Occupational Ladder Fall Injuries: United States, 2011"](https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6316a2.htm),
