...
objectives:
  - >-
    ...
    duration, and state whom the British and American ladder rules were written for
  - >-
    Apply the setting-up numbers for a leaning ladder in each country's terms: the 1-in-4 angle or a
    quarter of the working length, 1 m or 3 feet above a landing, the top three rungs, three points
    of contact, the belt buckle, and 6 m from overhead lines
  - >-
    Put the ways of securing a leaning ladder in HSE's order, and explain where a second person
    fits in HSE's guidance and in RoSPA's
  - >-
    Carry out HSE's pre-use check on a ladder, and state what a defect means for a householder
quiz:
  - q: >-
      As general information: a retired teacher on the Isles of Scilly clears moss from her own porch
      roof from a ladder, and next door a self-employed decorator paints a client's fascia from his.
      Whom does regulation 3 of the Work at Height Regulations 2005 place its requirements on?
    options:
      - Employers for work under their control, and some self-employed people, not her own DIY
      - Both of them, since the Regulations cover any use of a ladder anywhere in Great Britain
      - Neither of them, since the Regulations apply only to construction firms with employees
      - Only her, because a householder is treated as the employer of anyone working at her home
    answer: 0
    explain: >-
      Regulation 3 applies the Regulations' requirements to employers in relation to work by their
      employees and people under their control, and to certain self-employed people and others in
      relation to work under their control. It places no duty on a householder doing her own job at
  ...
  - q: >-
    ...
    options:
      - About 0.9 m, because the ladder should be one unit out for every three up the wall
      - About 1.4 m, because half the height gives a steadier base on garden ground
      - About 0.7 m, because the rule is one unit out for every four units up the wall
      - About 0.3 m, because a steeper ladder puts more of your weight straight down it
    answer: 2
    explain: >-
      HSE's rule is one space or unit out for every four up, so 2.8 m up means 0.7 m out, which is
      HSE's 75° angle. One out for every three would give about 0.9 m and a shallower ladder than
  ...
  - q: >-
      ...
      HSE's guidance, what should happen?
    options:
...
what to check before you climb. Stepladders, and what the injury figures do and don't count, are
lesson 16's.
...
Nothing in this lesson has you climb anything. The one hands-on exercise sets a ladder up on the
ground and measures it. Parts of the lesson describe British and American workplace law, and one
caution goes with them. This is general information, not legal advice. The rules differ between
England, Wales, Scotland and Northern Ireland, and between US states and cities, and they change.

## Who the ladder rules bind
...
The detailed practice comes from the Health and Safety Executive (HSE), Great Britain's workplace
safety regulator, in a [web guide](https://www.hse.gov.uk/work-at-height/ladders/index.htm), and
from a short guide the Ladder Association wrote with HSE, called
[LA455](https://ladderassociation.org.uk/la455/). LA455 says who it's for in its introduction: "This guidance is for employers on the
simple, sensible precautions they should take to keep people safe when using portable leaning
ladders and stepladders in the workplace."[2]
...
overreaching.[6] This course follows the advice. Using a ladder for a short, low-risk job at home
is **Yours, on conditions**, and the conditions are the rest of this lesson.
...
HSE's guide opens with this sentence: "Ladders and stepladders are not banned
under health and safety law." It goes on that they "can be a sensible and practical option for
low-risk, short-duration tasks, although they should not automatically be your first choice."[1]

Notice the order in that phrase: low risk first. HSE says it again, more sharply: "Short duration
is not the deciding factor in establishing whether use of a ladder is acceptable", and "you must
have first considered risk."[1] Then it gives a working guide for time: "As a guide, if your task
would require staying up a leaning ladder or stepladder for more than 30 minutes at a time, it is
recommended you use alternative equipment."[1] And a condition for place: use ladders only where
they can be used safely, "eg where the ladder will be level and stable, and can be secured (where
it is reasonably practicable to do so)."[1]

:::predict A job will take ten minutes, but the only place to stand the ladder is on a sloping, mossy path. A second job will take forty minutes on a flat patio. Before reading on: on HSE's guidance, which is a job for a ladder?
...
where, if precautions were not taken, a person could fall a distance liable to cause personal
injury", and it counts "the treads of a stepladder" as a working platform.[10] A kitchen stepladder
...
straight over. Can the job be done from the ground at all? Is there another route to it, from
inside through a window, say? Is it the kind of job for someone with the equipment?

This course read no official list of the alternatives for a home. HSE's work at height pages
describe mobile towers, and say you need to be competent to build, inspect, use and dismantle
one.[10] So when a job fails the ladder test, the course's answer is plain: a tradesperson with the
right equipment is **Call someone**, and lesson 23, "Hiring a tradesperson, and when to stop", is
how you choose one.
...
base "a quarter of the working length of the ladder from the wall".[5]

Those are two slightly different rules, and you can check how different with a calculator. Four up
and one out makes an angle whose tangent is 4, which is about 76°; HSE calls it a 75° angle. A foot set
a quarter of the ladder's length out makes an angle whose cosine is a quarter, which is about
75.5°. That is this course's arithmetic, and the two land within half a degree of each other. OSHA's
own load test for leaning ladders sets them at 75½ degrees from the horizontal, which fits.[4]
HSE calls it "the safest position to work from", and neither body explains in the pages read why
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 370" width="100%" style="max-width:420px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="ladder-title ladder-desc">
  ...
  <text x="10" y="78" font-size="15" fill="var(--text, #1a1a1a)">every 4 up (75°)</text>
  <text x="10" y="112" font-size="15" fill="var(--text, #1a1a1a)">US, OSHA: foot about</text>
  <text x="10" y="132" font-size="15" fill="var(--text, #1a1a1a)">a quarter of the</text>
  <text x="10" y="152" font-size="15" fill="var(--text, #1a1a1a)">working length out</text>
  <text x="10" y="186" font-size="15" fill="var(--text-2, #4a5260)">About 76° and 75.5°:</text>
  <text x="10" y="206" font-size="15" fill="var(--text-2, #4a5260)">this course's arithmetic</text>
  <text x="10" y="240" font-size="15" fill="var(--text-2, #4a5260)">Both written for</text>
  <text x="10" y="260" font-size="15" fill="var(--text-2, #4a5260)">workplaces</text>
  <line x1="20" y1="320" x2="410" y2="320" stroke="var(--line, #c8ccd2)" stroke-width="2"/>
  <line x1="320" y1="120" x2="320" y2="320" stroke="var(--line, #c8ccd2)" stroke-width="2"/>
  <line x1="320" y1="120" x2="410" y2="120" stroke="var(--line, #c8ccd2)" stroke-width="2"/>
  <line x1="270" y1="320" x2="330" y2="80" stroke="var(--navy, #0f2a4a)" stroke-width="5"/>
  <text x="330" y="226" font-size="15" fill="var(--text, #1a1a1a)">4 up</text>
...
secured at the top with a grab rail provided.[4]
...
navel) stays within the stiles".[1] The stiles are the two long side rails. If reaching the next bit
of the job would take your middle outside them, you climb down and move the ladder.

### Overhead power lines

HSE: "Don’t work within 6 m horizontally of any overhead power line, unless it has been made dead or
it is protected with insulation."[1] Six metres is about 20 feet, this course's conversion. HSE adds
that a non-conductive ladder (it gives fibreglass or timber) is for "any electrical work", which
this course does not teach.[1] The QuickCard's first electrical line is "Look for overhead power lines
before handling a ladder", and it says to avoid a metal ladder near power lines.[5] Look up before
you carry a long ladder out, not after you've swung it upright.

The American electrocution figures include ladders. The US Consumer Product Safety Commission
(CPSC) counted 22 electrocutions reported to it under "Ladder" from 2011 to 2020, out of its
consumer-product electrocution reports for those years.[9] Its report counts a consumer product
that comes into contact with an electrical source, "such as power lines or household current", and
leaves out work-related deaths; it says a death associated with a product was "not necessarily
...
:::predict A ladder has a working length of 6 metres, measured along it from the feet to where it rests. Before reading on: using OSHA's rule, how far from the wall should its feet be? And would HSE's rule give a noticeably different answer?

OSHA's rule puts the foot about a quarter of the working length out: 6 ÷ 4 = 1.5 m, about 4 feet
11 inches. HSE's rule is one out for four up, measured up the wall. For a 6 m ladder that works out
at about 1.46 m out and 5.82 m up (this course's arithmetic: the ladder is the long side of a
right-angled triangle whose other sides are in the ratio 1 to 4, and the square root of 17 is about
4.12). The two answers differ by under 5 centimetres, well inside how accurately anyone places a
ladder on the ground. In practice, both come to a quarter of its length out.
:::

The easier check at the foot of a ladder is usually HSE's way round, because the height is easier
to see than the working length: estimate how high up the wall the ladder rests, divide by
four, and that's the distance out.
...
Footing means having someone at the foot of the ladder to stop it moving; the pages read don't
describe how it's done. HSE puts it last, and gives no reason in the pages read, so this lesson
supplies none.

Where the ladder rests matters too. HSE wants "a strong upper resting point",
and says "do not rest it against weak upper surfaces such as glazing or plastic gutters".[1] LA455
shows one answer in a picture: its Figure 4 has a stand-off device fitted at the top of the ladder,
bearing on the wall below the gutter, captioned as the "use of a stand-off device to ensure a strong
resting point", with the instruction to follow the maker's instructions.[2] At the bottom, HSE says not to
stand a ladder on movable objects, and to level it with "proprietary levelling devices, not ad-hoc
packing such as bricks, blocks, timbers etc".[1] So a brick under a short leg on sloping ground is
exactly what not to do.

### Where a second person fits

RoSPA's home-safety advice adds something HSE's workplace list does not stress: "Consider having
another person present, especially when using leaning ladders."[6] RoSPA's case study of a man who
fell from a ladder cutting his hedge, with a punctured lung and nine broken ribs, has him say
afterwards: "It should have been a two-person job with somebody holding the ladder."[6]
...
whatever is holding the ladder, is this course's reading. What the course doesn't do is treat
someone at the bottom as what makes a ladder safe.

:::checkpoint A leaning ladder is set at 1 in 4 against a brick wall, on a clean, level patio, with its top resting on the brickwork just below a plastic gutter. A friend is available to foot it, and there's a strong fixing on the wall near the top. What would you do, in HSE's order, and what's the friend for?

Tie it first, both stiles, to the fixing: that's HSE's first choice, and a friend footing the ladder
is its last resort.[1] The top resting on brickwork, not on the plastic gutter, is right. The friend
still has a place on RoSPA's advice, which is to consider having another person present.[6]
:::

## Before you climb: the check

The pre-use check is the one piece of ladder inspection that is truly yours. HSE's list covers the
stiles ("not bent or damaged, as the ladder could buckle or collapse"), the feet ("if they are
missing, worn or damaged the ladder could slip"), the rungs ("if they are bent, worn, missing or
loose, the ladder could fail"), any locking mechanism, a stepladder's platform, and its steps or
treads, which could be slippery if contaminated or collapse if their fixings are loose.[1]

Two details in HSE's list are easy to miss. First, check the feet again "when moving from soft/dirty
ground (eg dug soil, loose sand/stone, a dirty workshop) to a smooth, solid surface (eg paving
slabs)", so that the feet themselves, not the mud on them, are touching the ground.[1] A ladder
carried from the lawn to the patio has changed ground. Second, telescopic ladders: check that the
mechanism locking each section works before every use, follow the maker's opening and closing
instructions, and "Be aware of the potential for trapping fingers between the closing sections."[1]
HSE adds that some of the important parts are inside where they can't be seen, and "If you are in
any doubt, do not use them."[1]

Beyond the pre-use check, HSE's guidance and LA455 describe "detailed visual inspections" at fixed
intervals, recorded, as "the responsibility of the employer".[1][2] That is a workplace duty with no
...
person in charge of the work."[1] At home, the person in charge is you. This course reads that as:
a ladder with a bent stile, a missing foot or a lock that won't engage is not used, and is not
patched. The sources read give no repair method for a householder, and OSHA's rule says a repaired
ladder has to be restored to "its original design criteria", which on this course's reading is not
...
**"Ladders are banned now."** They aren't: "Ladders and stepladders are not banned under health and
safety law."[1] HSE says they can suit low-risk, short-duration tasks.

**"It's only a quick job."** HSE: "Short duration is not the deciding factor", and risk comes
first.[1]

**"Someone holding the bottom makes it safe."** On HSE's order, footing is the last resort, after
tying, a stability device and wedging.[1] RoSPA still says to consider having another person present.[6]

**"If it's the right angle, it won't slip."** HSE still wants it secured, tied first, and resting on
...
In step 2, height divided by distance out should be about 4. In step 3, a quarter of the working
length should come out a few centimetres more than your distance out: for a ladder at HSE's
1-in-4, the working length is about 4.12 times the distance out, so a quarter of it is about 1.03
times (this course's arithmetic). If the two are further apart than that, re-measure; the most
likely slip is measuring the height to the top of the ladder instead of to where it rests. And if
the pre-use check found a bent stile, a missing foot or a lock that does not engage, the right
answer to step 2 was not to do it.[1]
:::


## For your plan

This lesson adds to the **calendar**: a pre-use check every time the ladder comes out, and a look
at the ladder's feet whenever it moves from soft ground to hard (HSE). It adds to the **map**: where
a ladder can stand safely at each side of the house, where any overhead lines run, and which walls
have a strong resting point rather than a plastic gutter or glass. It adds to the **stop list**: any
job within 6 m of an overhead line, any job that needs the top three rungs or steps, any job that
would keep you up a ladder for more than 30 minutes at a time, and any ladder that fails its check.
...
- **HSE, ["Safe use of ladders and stepladders"](https://www.hse.gov.uk/work-at-height/ladders/index.htm)**,
  free, eight short web pages. Read here, pages 1 to 7. Written for workplaces in Great Britain,
  and the most carefully specified ladder practice this course read.
- **The Ladder Association and HSE, [*LA455 Safe Use of Ladders and Stepladders: A brief guide*](https://ladderassociation.org.uk/la455/)**,
  free. Read here in full. Twelve pages, the same rules as HSE's web guide with the pictures that
  make them clear, including the stand-off device and a tied ladder.
- **OSHA, ["Portable Ladder Safety" QuickCard](https://www.osha.gov/sites/default/files/publications/portable_ladder_qc.pdf)**,
  free. Read here in full. Two sides, the American numbers in plain words, including three points of
  contact.

## Sources

1. Health and Safety Executive, ["Safe use of ladders and stepladders"](https://www.hse.gov.uk/work-at-height/ladders/index.htm),
   web guide. **Read: pages 1 to 6 in full, re-read on the live pages 25 September 2026, and page 7
   ("Inspecting the condition of ladders") read in full the same day. Page 8 (product standards) not
   read.** Guidance for workplaces in Great Britain. <!-- SOURCES Part B §2; lesson 12 gate closures G-H3 -->
2. The Ladder Association and HSE, [*LA455 Safe Use of Ladders and Stepladders: A brief guide*](https://ladderassociation.org.uk/la455/),
   Version 1, Rev 1, 09/26. **Read: the landing page and the whole PDF, 25 September 2026.** Written
   for employers. <!-- SOURCES Part B §2; lesson 12 gate closures -->
3. [The Work at Height Regulations 2005 (SI 2005/735), regulation 3](https://www.legislation.gov.uk/uksi/2005/735/regulation/3),
   revised text. **Read: regulation 3 in full on legislation.gov.uk, re-read 25 September 2026.**
   Extends to Great Britain. <!-- SOURCES Part B §2; lesson 12 gate closures -->
4. US Occupational Safety and Health Administration, [29 CFR 1926.1053, "Ladders"](https://www.ecfr.gov/current/title-29/part-1926/section-1926.1053),
...
7. A. L. D'Souza, G. A. Smith and L. B. Trifiletti, ["Ladder-related injuries treated in emergency departments in the United States, 1990-2005"](https://pubmed.ncbi.nlm.nih.gov/17478268/),
   *American Journal of Preventive Medicine*, 2007. **Read: abstract only (PubMed).** <!-- SOURCES Part B §2 -->
8. C. M. Socias and colleagues (NIOSH), ["Occupational Ladder Fall Injuries: United States, 2011"](https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6316a2.htm),
    *MMWR* 63(16), 2014, read from Internet Archive capture 20260907020506 (cdc.gov refuses automated
    readers). **Read: full text.** An erratum exists and was not read. <!-- SOURCES Part B §2; lesson 12 gate closures -->
9. US Consumer Product Safety Commission, [*Electrocutions Associated With Consumer Products: 2011-2020*](https://www.cpsc.gov/s3fs-public/Electrocutions-2011-to-2020.pdf),
    November 2023. **Read: executive summary and Table 5, and the scope rules, 25 September 2026.**
