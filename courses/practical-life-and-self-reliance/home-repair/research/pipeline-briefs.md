...
reviewers F and P in parallel, for lessons 6, 12 and 15), and one fixer in a further context (FIX
...
**Before a lesson is drafted, check its gates** in OUTLINE "Stage 1 gates". Lesson 4 waits for G-E5.
Lesson 15's second half ("Does licensing make work safer?") waits for G-L3 and G-N2; if they don't
close, lesson 15 is drafted as its seam's first half only. Lesson 1 needs G-N1 for the callout's two
...
- **Sixteen lessons**, numbered and titled as in OUTLINE "How many lessons, and why", with named seams
  in lessons 2, 4, 11, 12 and 15. Cross-references use the number and the title ("lesson 6, Gas: the
  smell, the valve, the law and the engineer"), so a split is a find-and-replace.
...
- **The safety callout, byte for byte, on every lesson, directly after the opening paragraph(s).** The
  ...
  teaching: lesson 6 gives each country's full leak steps.
...
- **Boundaries** (decision 14), each by name and never retaught:
  **First Aid and CPR**: lesson 2 ("power off before you touch"; the call), lesson 10 (electrical
  ...
  teaches where hazards come from and what keeps them away; no symptoms, no rescue. Lesson 7 refines
...
## Stage 4 review brief, Tier A: Home Repair and Maintenance (one reviewer; lessons other than 6, 12, 15)
...
3. **Neutrality**, where the lesson has contested or value claims (lessons 5, 11, 14 at least): sort each
...
## Stage 4 review brief, Tier B split: lessons 6, 12 and 15 (two reviewers, F and P)
...
Additionally:
- **Lesson 6:** F reads regulation 3 of the 1998 Regulations, L56 paras 52, 81, 83 and 85, and HSE's
...
- **Lesson 12:** F re-reads HSE's asbestos FAQ, EPA's asbestos and lead pages, the RRP rule's §745.82 and
...
- **Lesson 15: the full neutrality audit** (standards 3.5). F sorts every claim (established, contested
