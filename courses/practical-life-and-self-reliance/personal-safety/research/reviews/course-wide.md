# Course-wide review notes: Personal Safety

## 2026-09-25 — from lesson 03's Stage 4 fix

- **Lesson 1 must match lesson 3 on Derek and Priya.** Lesson 3 now gives Derek ONS 2018's 0.4%
  (65 to 74, violence with or without injury, England and Wales, year ending March 2018), and says
  the article excludes robbery, the crime he fears. For Priya no source read gives women of her age
  together: lesson 3 gives women 1.2% and 25 to 34 year olds 2.4% separately (ONS 2018), plus the
  2024 figures for women. Lesson 1's "the numbers for her age and sex" (around its line 404) should
  become "the figures for women and for her age group, which the sources give separately", and its
  "Lesson 3 gives the numbers for his age group" can stay.
- **Content notes should carry the Scotland and Northern Ireland lines** now that G6 is closed.
  Lesson 3's note gives Rape Crisis Scotland, Victim Support Scotland, the DSA Helpline and Victim
  Support NI (hub numbers re-read on its contact page 2026-09-25). Lesson 1's note has only Victim
  Support (England and Wales) and VictimConnect; its fixer or a later pass should add the Scotland
  and NI lines, and the "Course conventions" line in `pipeline-briefs.md` should be updated to match.
- **OUTLINE lesson 3's section carries two errors SOURCES has now corrected**: "not a significant
  difference" for NCVS male and female rates (BJS does not test it), and the misconception wording
  "measured by stranger violence, young men" (no source gives that joint figure). Also "5% in
  furtherance of theft" is "theft or gain". Not edited here; a later lesson citing US-1, UK-3 or B21
  should read the corrected SOURCES entries, not OUTLINE's summary.
