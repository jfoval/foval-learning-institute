...
objectives:
  - >-
    ...
    drying it, giving it room, preheating the pan and salting at the right time
  - >-
    Evaluate "searing seals in the juices", "bring meat to room temperature first" and "flip it only
    once" against the tests, and say what each test measured
  - >-
    Choose a pan by what its metal does with heat, and care for cast iron and nonstick, including
    what regulators, the industry and the ban's supporters each say about nonstick coatings
  - >-
    Make a pan sauce from the browned bits in the pan, and explain why cold butter holds it together
quiz:
  - q: >-
      You're browning a kilo of cubed lamb shoulder for a stew in a 24 cm frying pan. You tip it all
      in at once. After five minutes the meat is grey and sitting in a pool of liquid. What's the
      best fix for the next time?
    options:
      - Turn the heat right down so the liquid has time to soak back into the lamb before it browns
      - Pat the cubes dry, then brown them in three or four batches with space between the pieces
      - Cover the pan for the first five minutes so the lamb heats through faster, then uncover it
      - Add a spoonful of salt at the start so it pulls the liquid out and the lamb browns sooner
    answer: 1
    explain: >-
      Cold, crowded meat releases water faster than the pan can boil it off, so the surface is stuck
      near 100°C and steams. Drying the cubes and browning them in batches keeps the pan hot enough
      to drive the water off. Low heat makes it worse: the water stays and the meat just stews. A lid
      holds the steam in, which is lesson 2's onion again. And salt doesn't dry anything in a pan
      that's already wet: given a little time it draws more water to the surface, which is why the
      lesson's rule is to salt right before cooking or well ahead.
  - q: >-
      You're softening three sliced onions as the base of a curry, and you want them soft and golden
      rather than dark and crisp. Your recipe says "don't crowd the pan." What does this lesson
      suggest?
    options:
      - Follow the rule exactly, since any crowding at all will ruin onions whatever you want them for
      - Cook them in several small batches over the highest heat, so each one browns as fast as it can
      - Rinse and dry them before they go in, since onions give off too much water to soften properly
      - Crowding is fine here, since the rule protects fast browning and you want the onions soft first
    answer: 3
    explain: >-
      The course's question: what is the rule protecting, and does it apply here? "Don't crowd"
      protects a dry surface that browns fast, and its cost is paid by meat, whose inside overcooks
      while the water goes. Onions you want soft first gain from sitting in their own steam for a
      while, and nothing inside them overcooks the way meat does. Small batches on high heat would
      give you the dark, crisp result you said you didn't want, and rinsing adds water rather than
      taking it away.
  - q: >-
      A friend is making a pork loin roast and says, "I always sear it first to lock the juices in,
      then roast it." Using the test in this lesson, what can you tell them?
    options:
      - Seared-first and seared-last meat lost about the same share of its weight in the test
      - Searing first does lock juices in, but only when the oven is set low, below about 120°C
      - Searing first keeps more juice in if the meat was at room temperature when it went in
      - Searing either first or last makes the meat lose far more juice than not searing at all
    answer: 0
    explain: >-
      ATK seared one batch of rib-eyes first and the other last, took both to the same final
      temperature, and found both lost about 22 percent of their weight. The oven in that test was
      at 250°F, about 120°C, so a low oven didn't rescue the idea. Room temperature is a separate
      myth, and the test said nothing about it. And the test compared two orders of searing, not
      searing against none, so it can't support "far more juice than not searing".
  - q: >-
      You've just made a quick tomato and garlic sauce in your cast-iron skillet, about 15 minutes
      in the pan. What does the maker's guidance say to do next?
    options:
      - Leave it to soak overnight in hot water with no soap, so the seasoning isn't stripped away
      - Scrub it with coarse salt and a cloth only, because any dish soap at all removes seasoning
      - Wash it in warm soapy water, dry it completely, then rub a thin layer of oil over the pan
      - Put it through the dishwasher on its hottest cycle, then re-season it in the oven for an hour
    answer: 2
    explain: >-
      Lodge says to start with warm soapy water, dry it completely and add a thin layer of oil, and
      that today's dish soap isn't strong enough to remove seasoning. A quick tomato sauce is well
      inside its 45-minute guide for acidic food. Lodge calls soaking "a recipe for rust" and says a
      dishwasher "will remove the seasoning and likely cause rust". The salt-only rule rests on the
      old belief about soap that the maker itself rejects.
  - q: >-
      A household with a pet parrot has one nonstick frying pan in good condition. Which of these
      is best supported by the sources in this lesson?
    options:
      - Cooking in an intact nonstick pan at moderate heat puts a large dose of PFAS into the food
      - Any nonstick pan made in the US today will still have been made using the chemical PFOA
      - A pan sold as "ceramic" nonstick can be relied on to contain no PFAS whatever the brand
      - Don't heat it empty on high, since an overheated coating gives off fumes that kill birds
    answer: 3
    explain: >-
      C&EN reports that the coating breaks down above 260°C and that the fumes are fatal to birds,
      and the coating's maker warns against preheating an empty pan on high, as The New Lede
      reports. The FDA says negligible amounts migrate from an intact coating. The EPA says the
      companies in its program met its goals, which included working toward eliminating PFOA from
      products by 2015, and Chemours stopped using it that year. And an engineer quoted in C&EN
      warns that some pans sold as ceramic still carry PFAS.
  - q: >-
      You sear two pork chops in a nonstick pan, then make a pan sauce in it with stock and butter.
      The sauce tastes thin and a bit flat. What's the likeliest reason, from this lesson?
    options:
      - The butter went in cold straight from the fridge, and cold butter always gives a thin sauce
      - The nonstick surface left much less fond, and fond is where a pan sauce gets its flavour from
      - The stock simmered too gently while reducing, so too little of its flavour got concentrated
      - Pork gives off no browned bits in any pan, so only beef and chicken make a good pan sauce
    answer: 1
    explain: >-
      ATK says a nonstick skillet "will not develop fond to the same degree as a traditional
      skillet", and fond is what gives a pan sauce its depth. Cold butter is what ATK recommends: it
      makes "a sturdier emulsion that is more resistant to separation". A gentle reduction still
      concentrates flavour, just more slowly. And ATK's page names meat, poultry and fish as sources
      of fond, with nothing to single out pork.
---
...
:::predict You brown 500 g of sliced chicken breast in a big pan, first in one batch that covers the whole base, then (on another night) in two batches. Before reading on: which batch of chicken finishes browning sooner, counting from when it went in, and which night gets dinner on the table sooner?

Each of the two smaller batches browns much sooner than the single big one, because the pan keeps enough heat to drive off the water as it appears. This course hasn't read a timed test of the whole job, but two batches needn't take much longer in total, because the crowded batch spends its first several minutes boiling off a puddle before any browning starts. The difference you'd notice most is in the chicken: by the time the crowded batch has dried out and browned, the inside of each piece has been cooking all that while, and it's drier and tougher than the batch that browned fast.
:::
...
1. **Dry and salt.** Pat the thighs dry with paper towels and bin the towels. Salt them now, just before they go in. (The overnight rack above is the alternative, if you've decided it suits your fridge.)
2. **Heat the pan.** Put the pan on medium-high with a thin film of oil, and wait until the oil shimmers.
3. **Skin side down, with room.** Lay the thighs in skin side down with a gap between each. If they touch, use two pans or do two batches. You should hear a steady sizzle. If it fades to a hiss and liquid pools, the pan is too full or not hot enough.
4. **Leave the skin alone until it's brown.** Skin has fat under it that melts out and crisps the skin as it goes, so it wants time on this side, at a heat that keeps it sizzling without burning. Turn the heat down a notch if it's darkening too fast. When the skin is deep golden and lets go of the pan easily, turn the thighs.
5. **Cook to temperature, not to time.** Finish the thighs on the second side, turning the heat down to medium if the outside is getting ahead of the inside, until they're done by your country's rule from lesson 4. In the US, that is 165°F (73.9°C) in the thickest part, away from the bone.[21] In the UK, the FSA's cues are to cut into the thickest part and check "there is no pink meat left and that juices run clear", and that the meat is steaming hot.[22] Move them to a plate, skin side up. ATK suggests tenting the meat loosely with foil, and says the loose seal "will help to keep any crust that has formed from turning soggy."[3]
...
:::predict You've got a hot pan with a layer of chicken fat and brown patches stuck to the base. Before reading step 6: what would you do with the fat, and what does the fond need before it can become a sauce?

Most of the fat comes out, because a sauce built on a pool of it will be greasy, but a spoonful stays to soften the shallot. The fond is dry and stuck, so it needs liquid and scraping to lift it off and dissolve it. That's steps 6 and 7.
:::

6. **Pour off most of the fat.** Tip it into a small bowl, leaving a spoonful. Soften the shallot in it for a minute over medium heat.
7. **Deglaze.** Pour in the stock and scrape the fond up with a wooden spatula as the liquid bubbles. It dissolves into the stock and colours it. That is deglazing. Use low-salt stock if you can; ATK's reason is that "reduction can result in overwhelming saltiness."[3] Wine works here too. How much of its alcohol survives a few minutes' simmering is a question with an answer, and lesson 8 gives it.
8. **Reduce.** Let it boil until it's noticeably thicker and has shrunk well down. ATK's way of checking: pour it back into the measuring jug it came from, and "the reduced liquid can be poured back into the cup toward the end of simmering to gauge if it has been adequately reduced."[3] How far to take it is a matter of taste, so taste it.
9. **Take it off the boil and whisk in cold butter.** Turn the heat off or right down (that's this course's instruction; ATK's page doesn't give a heat for this step), and whisk in the butter a piece at a time, each piece melting before the next. ATK says to cut it in tablespoon-size chunks and gives the reason for using it cold: "Cold butter is easier to incorporate into a sauce than softened butter and it makes for a sturdier emulsion that is more resistant to separation."[3]
10. **Season and balance.** Taste. Add salt if it needs it, and a squeeze of lemon if it tastes heavy, which is lesson 3's acid doing its job against fat. Pour it over the chicken.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 300" width="100%" style="max-width:440px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="cond-title cond-desc">
  <title id="cond-title">Thermal conductivity of pan metals</title>
  <desc id="cond-desc">A horizontal bar chart of thermal conductivity in watts per metre-kelvin, from Engineering ToolBox. Copper 401. Aluminium, pure, 236. Carbon steel with 0.5 percent carbon, 54. Cast iron, 52. Stainless steel type 304, 14.4. Copper conducts about 28 times as well as stainless steel, and aluminium about 16 times.</desc>
  <text x="130" y="40" font-size="15" text-anchor="end" fill="var(--text, #111418)">Copper</text>
  <rect x="140" y="26" width="240" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="130" y="85" font-size="15" text-anchor="end" fill="var(--text, #111418)">Aluminium</text>
  <rect x="140" y="71" width="141" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="130" y="130" font-size="15" text-anchor="end" fill="var(--text, #111418)">Carbon steel</text>
  <rect x="140" y="116" width="32" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="130" y="175" font-size="15" text-anchor="end" fill="var(--text, #111418)">Cast iron</text>
  <rect x="140" y="161" width="31" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="130" y="220" font-size="15" text-anchor="end" fill="var(--text, #111418)">Stainless steel</text>
  <rect x="140" y="206" width="9" height="20" fill="var(--gold, #b08d2a)"/>
  <text x="386" y="41" font-size="15" fill="var(--text, #111418)">401</text>
  <text x="287" y="86" font-size="15" fill="var(--text, #111418)">236</text>
  <text x="178" y="131" font-size="15" fill="var(--text, #111418)">54</text>
  <text x="177" y="176" font-size="15" fill="var(--text, #111418)">52</text>
  <text x="155" y="221" font-size="15" fill="var(--text, #111418)">14.4</text>
  <line x1="140" y1="18" x2="140" y2="236" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <text x="140" y="264" font-size="15" fill="var(--text-2, #4a5260)">Thermal conductivity, W/(m·K)</text>
  <text x="140" y="286" font-size="15" fill="var(--text-2, #4a5260)">Source: Engineering ToolBox</text>
</svg>
...
**"Nonstick pans put chemicals in your food"** and its mirror, **"Nonstick is fine at any heat."** An intact coating at normal heat releases negligible amounts, by the FDA's reading; an overheated one breaks down above 260°C.[10][12] Whether it should be sold is a separate, open argument.

**"Aluminium pans cause Alzheimer's."** The Alzheimer's Society says no convincing link has been established.[17]

## Practice

:::exercise Two pans of mushrooms, and a sauce you break on purpose
...
1. Slice the mushrooms about 5 mm thick, or cut the tofu into 2 cm cubes and pat it dry. Divide into two equal batches by weight.

2. Batch A, crowded: heat the pan over medium-high with a tablespoon of oil until it shimmers, tip in the whole of batch A at once, and start the timer. Stir every minute or so. Write down, in minutes: when liquid first pools in the pan, when the pan is dry again, when most pieces show real browning, and when you'd call it done. Move it to a plate.

3. Batch B, with room: wipe the pan out carefully with a wad of paper towel (it's hot), heat it the same way with the same oil, and cook batch B in two or three smaller loads so no piece touches another. Time each load the same way, and add the load times together.

4. Compare the two batches side by side: colour, texture, how oily each tastes, and total time. Write two sentences on whether your result looks more like the crowding rule or like Arnold's test, and why you think that is. (With tofu, expect the crowding rule to hold better. Why might that be?)

5. Make a small pan sauce in the pan you used last: soften a little chopped shallot, deglaze with about 125 ml (½ cup) of stock, scrape up what's there, reduce until thicker, then take it off the heat and whisk in a tablespoon of cold butter in pieces. Taste it and season it.

6. Spoon about two tablespoons of the finished sauce into a small pan and boil it hard for a minute. Put it next to the rest. Write down what you see and taste. Then try to rescue the boiled spoonful by whisking in a teaspoon of cold water off the heat, which is the same idea as lesson 5's mayonnaise rescue, and write down whether it worked. This course hasn't read a source that tests it on a butter sauce, so your notebook is the evidence.
:::

:::checkpoint Look at your notes from step 2. If a friend cooked batch A in a smaller pan with half the oil, what do you expect would change in your four times, and which of this lesson's mechanisms predicts it?
...
- **America's Test Kitchen, [Pan Sauces 101](https://www.americastestkitchen.com/cooksillustrated/how_tos/5551-pan-sauces-101).** Read in full for this course. The whole method with the kit laid out, including the measuring-cup check for judging a reduction.
- **Dave Arnold, ["Crowded Wet Mushrooms. A Beautiful Thing."](https://cookingissues.com/2009/12/21/crowded-wet-mushrooms-a-beautiful-thing/), Cooking Issues, 2009.** Read in full, with the comments. Short, and a good model of how to test a kitchen rule: same salt, same oil, one variable changed.
- **Lan Lam, ["The Science of Stir-Frying in a Wok"](https://www.americastestkitchen.com/cooksillustrated/articles/2189-the-science-of-stir-frying-in-a-wok), America's Test Kitchen, 2020.** The public part read in full. The two zones of a wok, and a stirring test with an infrared camera.
- **Prachi Patel, ["How does nonstick cookware work, and should you switch to 'green' pans?"](https://cen.acs.org/environment/persistent-pollutants/does-nonstick-cookware-work-should/103/web/2025/04), C&EN, 2025.** Read in full. The chemistry of PTFE and ceramic coatings, with people on both sides of the argument quoted directly.
- **Lodge, [How to Clean](https://www.lodgecastiron.com/pages/how-to-clean) and [How to Season](https://www.lodgecastiron.com/pages/how-to-season).** Both read in full. The maker's own instructions, including rust removal.

## Sources

1. America's Test Kitchen, "Searing Steak", Cook's Illustrated how-to, no author or date, https://www.americastestkitchen.com/cooksillustrated/how_tos/5699-searing-steak <!-- SOURCES C1; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: the eight-steak test, its oven temperature and end temperatures, 22 percent, and the "old wives’ tale" verdict. "A crust is a dried, browned layer, not a waterproof skin" is this course's reading, as is "fits the physics".
2. America's Test Kitchen, "The Best Stainless-Steel Skillets", equipment review, dated 25 June 2025 in the page's metadata, https://www.americastestkitchen.com/equipment_reviews/1944-12-inch-stainless-steel-skillets <!-- SOURCES C6, C7; Gate closures, lesson 6 -->. **Read level: the review text, directly.** Supports: the four-steak crowding quotation, tall sides trapping condensation, clad construction, and aluminium reacting with acid.
3. America's Test Kitchen, "Pan Sauces 101", no author or date, https://www.americastestkitchen.com/cooksillustrated/how_tos/5551-pan-sauces-101 <!-- SOURCES C8f; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: fond, deglazing, reducing and butter; nonstick and crowding leaving less fond; low-sodium stock; the measuring cup; tenting loosely; well-seasoned cast iron tasting fine and poorly kept cast iron tasting metallic (Gate closures, lesson 6, and the Stage 4 note, lesson 6); cold butter. It says nothing about boiling the finished sauce or about the heat for adding butter, as the body says.
4. America's Test Kitchen, "Should You Wash Mushrooms? The Definitive Answer", no author or date, https://www.americastestkitchen.com/how_tos/11827-should-you-wash-mushrooms <!-- SOURCES C10b; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: the one-minute soak, almost no water against 25 percent, exposed gills slowing browning, most farmed mushrooms not needing cleaning, and "virtually impossible to overcook".
5. Dave Arnold, "Crowded Wet Mushrooms. A Beautiful Thing.", Cooking Issues, 21 December 2009, https://cookingissues.com/2009/12/21/crowded-wet-mushrooms-a-beautiful-thing/ <!-- SOURCES C6, C10b; Gate closures, lesson 6 -->. **Read level: full, directly, with the comments.** Supports: the test's design, the result, and his reply of 22 December 2009 on browning.
6. Audrey Wilson, "Let's Talk Food: Steaks at room temperature or not?", *Hawaii Tribune-Herald*, 19 February 2019, https://www.hawaiitribune-herald.com/2019/02/19/features/lets-talk-food-steaks-at-room-temperature-or-not/ <!-- SOURCES C3a, C10e; Gate closures, lesson 6 -->. **Read level: full, directly.** A newspaper column reporting J. Kenji López-Alt's test; López-Alt's Serious Eats original was not read. Supports: the temperature rise, blotting, drying uncovered on a rack, the salting timing (whose minutes the lesson leaves out), and Bon Appétit's opposing view as Wilson reports it.
7. Leah Colins, "For the Juiciest Steaks With the Best Crust, I Always Break This Classic Cooking Rule", Serious Eats, syndicated on Yahoo, 15 July 2026, https://www.yahoo.com/lifestyle/articles/juiciest-steaks-best-crust-always-210000151.html <!-- SOURCES C10f; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: McGee's finding and López-Alt's burger test as she reports them, the mechanism, the grey band beneath the surface (Stage 4 note, lesson 6), and the "a bit subtle" caveat. McGee's own column was not read.
8. Engineering ToolBox, "Metals, Metallic Elements and Alloys: Thermal Conductivities", https://www.engineeringtoolbox.com/thermal-conductivity-metals-d_858.html <!-- SOURCES C7; Gate closures, lesson 6 -->. **Read level: the table, directly.** Supports: every figure in the chart and the alloy range. "About a quarter" and "about a sixteenth" are this course's arithmetic from the table.
9. Lodge Cast Iron, "How to Clean", "How to Season", "3 Tips for Cooking Acidic Foods in Cast Iron" (dated 11 February 2025 in the page's metadata) and "10 Myths About Cast Iron Cookware, Busted!", https://www.lodgecastiron.com <!-- SOURCES C10g, D3b; Gate closures, lesson 6 -->. **Read level: all four, full, directly.** Supports: seasoning as polymerised oil building to a nonstick surface, soap, drying and oiling, soaking, the dishwasher, re-seasoning at 450 to 500°F, acid and new cast iron, the 45-minute guide for acid and deglazing.
10. US Food and Drug Administration, "Authorized Uses of PFAS in Food Contact Applications", content current as of 3 January 2025, https://www.fda.gov/food/process-contaminants-food/authorized-uses-pfas-food-contact-applications <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: manufacture vaporising migratable molecules, negligible migration, paper and paperboard as the only use of concern, and grease-proofers no longer sold.
11. US Environmental Protection Agency, "Risk Management for Per- and Polyfluoroalkyl Substances (PFAS) under TSCA", last updated 26 March 2026 <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: the eight companies, the goal of working toward elimination by 2015, and "All companies have met" the goals.
12. Prachi Patel, "How does nonstick cookware work, and should you switch to 'green' pans?", C&EN, 2025 <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: PTFE as a PFAS, PFOA's residual traces in older coatings, 260°C, the fumes and birds, uncommon cases, Burns's and Miller's quotations and the paraphrase of Miller on processing aids, the ceramic coatings and Golovin, and France's ban leaving out cookware as the article reported it in 2025 (Stage 4 note, lesson 6). The "short flu-like illness" is from the Shimizu case report in SOURCES D3a (abstract) and this article's "Teflon flu".
13. Cookware Sustainability Alliance, home page, https://cookwaresustainabilityalliance.org/ <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: the three quotations, and its objection to calling PTFE a "PFAS forever chemical" (its July 2026 special report on the same page; Stage 4 note, lesson 6). That it has campaigned against the bans is from The New Lede's report (note 14) and the page's own account of state laws.
14. Shannon Kelleher, "Industry, environmental groups spar over California bill to ban PFAS in cookware", The New Lede, 29 September 2025, https://www.thenewlede.org/2025/09/california-cookware-pfas-ban/ <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: Lohmann's quotation, the Los Angeles County Sanitation Districts' letter, Chemours' warning, its statement on flakes and its 2015 switch from PFOA to GenX as the journalist reports them, the 2021 EPA finding on GenX in the journalist's words, and David Andrews of the Environmental Working Group on flakes (Stage 4 note, lesson 6). Chemours' own page and the EPA assessment were not read.
15. Morgan Lewis, "State Regulation of PFAS in Consumer Products Continues to Gain Momentum in 2026", LawFlash, 21 January 2026 <!-- Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: Minnesota from 1 January 2025, and Colorado and Maine from 1 January 2026. Its Connecticut paragraph runs the July 2026 notification rule together with the list of products, and is not used; note 28 is.
16. European Food Safety Authority, "PFAS in food: EFSA assesses risks and sets tolerable intake", 17 September 2020 <!-- SOURCES D3a; Gate closures, lesson 6 -->. **Read level: full; the quoted phrase rechecked directly.** Supports: the four PFAS assessed and the foods they are most often found in.
17. Alzheimer's Society, "Metals and the risk of dementia", read through the Internet Archive's capture of 12 November 2025 <!-- SOURCES D3f; Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: the 1965 study and its doses, poor absorption, the small contradictory studies, and the conclusion.
18. Lan Lam, "The Science of Stir-Frying in a Wok", America's Test Kitchen, 1 April 2020 <!-- Gate closures, lesson 6 -->. **Read level: full, directly (the public part).** Supports: the two zones, the stirring test and its note on electric hobs, and Chao's definition with its "roughly speaking", which is quoted through Lam; Chao's book was not read.
19. America's Test Kitchen, "Technique #20: Make Superior Stir-Fries Without a Wok", 12 October 2023 <!-- Gate closures, lesson 6 -->. **Read level: full, directly.** Supports: small pieces and small amounts, cooking protein in batches, not stirring constantly, and that the page is written for a nonstick skillet with the oil heated "until just smoking". The reading of the two ATK pieces' disagreement is this course's, as the body says.
20. Nancy Honig, "The Maillard Reaction", Wild West District Extension Blog, Kansas State University Research and Extension, 15 August 2022 <!-- Gate closures, lesson 2 -->. **Read level: full, directly.** Supports: about 285°F (140°C), given as approximate, as lesson 2 gives it.
21. USDA FSIS, "Safe Minimum Internal Temperature Chart", last updated 14 April 2025, read through the Internet Archive's September 2026 capture <!-- SOURCES B1.1 -->. **Read level: full.** Supports: 165°F (73.9°C) for all poultry, thighs included.
22. Food Standards Agency, "Cooking your food", GOV.UK, https://www.gov.uk/government/publications/cooking-your-food/cooking-your-food <!-- SOURCES B3.1 -->. **Read level: full.** Supports: the visual cues for chicken and steaming hot.
23. USDA FSIS, "Danger Zone (40°F - 140°F)", last updated 28 June 2023, read through a 2026 Internet Archive capture <!-- SOURCES B1.3 -->. **Read level: full.** Supports: the 2-hour and 1-hour rules.
24. USDA FSIS, "Refrigeration and Food Safety", last updated 23 March 2015, read through the Internet Archive's 23 September 2026 capture <!-- Gate closures, lesson 4 -->. **Read level: full, directly.** Supports: the quoted wrapping rule and its stated purpose. The rack-over-a-tray arrangement is this course's, as the body says.
25. Keller and Heckman, "CA Governor Newsom Vetoes PFAS Ban in Cookware, All Food Packaging", *National Law Review*, 20 October 2025, https://natlawreview.com/article/ca-governor-newsom-vetoes-pfas-ban-cookware-all-food-packaging , and Farella Braun + Martel, note on the veto of California SB 682, 16 October 2025 <!-- SOURCES D3a; Stage 4 note, lesson 6 -->. **Read level: the first, directly, at Stage 4; the second, full at Stage 1 through a summarising fetch tool.** Supports: the veto on 13 October 2025 and the affordability reason. The governor is not quoted.
26. Arnold & Porter advisory, 27 March 2026, and Bergeson & Campbell, 31 March 2026, on the EU's universal PFAS restriction <!-- SOURCES D3a -->. **Read level: full, through a summarising fetch tool at Stage 1.** Supports: the restriction not yet adopted; SOURCES records it as not adopted on 24 September 2026. Neither was rechecked for this lesson, and neither mentions cookware by name.
27. FSA, "How to chill, freeze and defrost food safely", GOV.UK, published 18 December 2017, https://www.gov.uk/government/publications/how-to-chill-freeze-and-defrost-food-safely/how-to-chill-freeze-and-defrost-food-safely <!-- SOURCES B3.2; Stage 4 note, lesson 4 -->. **Read level: full, directly.** Supports: raw meat in its packaging or sealed containers on the bottom shelf, and four hours out during preparation.
28. Connecticut Department of Energy and Environmental Protection, "PFAS in Products", https://portal.ct.gov/deep/p2/pfas-in-products <!-- Stage 4 note, lesson 6 -->. **Read level: the page, directly, at Stage 4.** Supports: notification and labelling from 1 July 2026, and the ban on cookware with intentionally added PFAS from 1 January 2028.
