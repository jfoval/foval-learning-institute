...
objectives:
  - >-
    ...
    a given cooking method
  - >-
    Explain why temperature and the rate of heat transfer are different things, using the oven-air
    and boiling-water arithmetic, and why a thicker piece in a pot of water takes far more than
    proportionally longer
  - >-
    Explain why a wet surface can't brown, and calibrate a food thermometer and say where it goes
    and why
  - >-
    State what to do for a pan fire, an oven fire and a burn, including where US and UK fire
    services differ, and what is and isn't settled about gas hobs and indoor air
quiz:
  - q: >-
      You can sit for ten minutes in a sauna whose air is at 80°C, yet a hot tap running at 60°C
      would scald your hand within seconds. What explains the difference?
    options:
      - Sauna air is so dry that its real temperature is lower than the thermometer shows
      - Sweat forms a layer on the skin that blocks all the heat coming from the hot air
      - Air hands heat to skin far more slowly than water does, whatever the two temperatures
      - Water is denser, so at the same reading it really holds a higher temperature than air does
    answer: 2
    explain: >-
      This is the oven hand again. How fast heat reaches you depends on the medium as well as its
      temperature, and the typical heat transfer coefficients for still air sit far below those for
      water. The thermometer in a sauna isn't wrong: dry air at 80°C is at 80°C. Nothing in this lesson
      says sweat blocks heat, and the coefficients explain the difference without it.
      And density doesn't change what a temperature is; 60°C is 60°C in any medium.
  - q: >-
      A recipe simmers chunks of sweet potato about 1.5 cm across and says they're tender in 10
      minutes. You cut yours about 3 cm across. What's the best plan?
    options:
      - Expect them to need a good deal more than twice as long, and test the biggest one
      - Give them exactly 20 minutes, since twice the size needs twice the simmering time
      - Keep it at 10 minutes, but turn the heat up to a hard boil so the big ones catch up
      - Keep it at 10 minutes, since the water's temperature is what sets when they're done
    answer: 0
    explain: >-
      Heat reaches the centre by conduction from the surface, so in water the time grows faster
      than the size does; Baldwin's rule of thumb is that twice as thick takes about four times as
      long. Doubling the time assumes the relation is proportional, which is the mistake the potato
      example showed. A hard boil can't take the water past its boiling point, so it adds a few
      degrees at most and a lot of steam. And the water's temperature sets how fast heat arrives,
      not when the centre gets there, which is why you test the biggest piece rather than the clock.
  - q: >-
      In a kitchen in either country, a pan of oil catches fire. The flames are already reaching
      the cupboard above the hob. Which response fits the advice of both the US and UK sources in this lesson?
    options:
      - Carry the pan to the sink quickly and run the cold tap over it until the flames go out
      - Throw a damp tea towel over the pan, then turn off the heat and wait there for it all to cool
      - Cover the flames with flour, which smothers them faster than a lid can be found
      - Turn off the heat only if it's safe, get everyone out, shut the door, and call for help
    answer: 3
    explain: >-
      A lid slid on is the US agencies' advice for a small fire that has just started; a fire
      reaching the cupboards is past that, and here the sources agree. NFPA says "Just get out!" and
      to close the door, CPSC says to call the fire department, and the London Fire Brigade says to
      leave, close the door and call 999. Water on burning oil turns to steam and throws the oil
      about; CPSC says never water or flour; the London Fire Brigade says not to move the pan at all;
      and a UK fire service calls the damp towel "outdated advice".
  - q: >-
      You slice two onions into a frying pan over medium heat and put a lid on. After fifteen
      minutes they're soft and pale. With the lid off, a second batch browns. What's going on?
    options:
      - The lid traps so much heat that the onion gets too hot for the browning reaction to run
      - The lid holds the steam in, so the onion stays wet and can't climb much above 100°C
      - The lid shuts out the oxygen, and browning is a reaction that needs oxygen from the air
      - The lid makes the onion release its sugar into the liquid, leaving nothing to brown
    answer: 1
    explain: >-
      Water can't get hotter than its boiling point at ordinary pressure, so a surface that's wet
      sits near 100°C, well short of the roughly 140°C where browning gets going fast. With the lid
      on, the onion's water condenses and drips back; with it off, the water leaves and the surface
      can climb. The lid doesn't make things too hot, it keeps them cooler; the browning reaction
      described here is between amino acids and sugars, and nothing read says it needs air; and the
      onion's sugar doesn't vanish into the pan.
  - q: >-
      You live about 750 m (about 2,500 feet) above sea level. Your new thermometer reads 32°F in a
      glass of ice and water, and 207°F in a pan of boiling water. What should you conclude?
    options:
      - It reads 5°F low, so you should add 5°F to every temperature it shows you from now on
      - It's faulty, because a thermometer that's working properly always shows 212°F at a boil
      - It's probably reading correctly, since water boils lower at altitude than at sea level
      - The ice test must be wrong, since the boiling test is the more accurate of the two methods
    answer: 2
    explain: >-
      FSIS's high-altitude page says the boiling point drops by just under 1°F for every 500 feet,
      so at 2,500 feet water boils at about 207 or 208°F, which is what a good thermometer should
      read. The ice test doesn't depend on altitude, and it passed, which is why it's the better
      check. Adding 5°F would push every reading 5°F too high.
      212°F is the sea-level figure only.
  - q: >-
      A pot of pasta boils over and splashes boiling water across the back of someone's hand. They
      have a ring on that hand. What should they do first?
    options:
      - Hold the hand under cool running water for 20 minutes, taking off the ring if it's not stuck
      - Hold an ice pack wrapped in a cloth against the burn for ten minutes, then leave it be
      - Rinse it for a minute under the cold tap, then rub in butter or a cream to seal the skin
...
:::predict Before you see the arithmetic: in the oven-and-pot comparison, how many times faster do you think heat reaches your hand from the boiling water than from the oven air? Twice? Ten times? More?
...
:::checkpoint Name the mode that does most of the work getting heat to the surface of the food in each case: a flatbread cooked on a dry, hot pan; a dumpling in a bamboo steamer; a slice of bread under a grill; a potato in a pot of boiling water.
...
:::predict If the 1 cm slice is tender right through after a certain number of minutes, how long do you expect the 2 cm slice to need?
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 480" width="100%" style="max-width:440px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="ladder-title ladder-desc">
  <title id="ladder-title">Kitchen temperatures from US federal guidance</title>
  <desc id="ladder-desc">A vertical temperature scale from 0 to 240 degrees Celsius. At the bottom, ice water at 32 degrees Fahrenheit, 0 Celsius, used to check a thermometer. Above it, a shaded band from 60 to 74 Celsius, 140 to 165 Fahrenheit, where FSIS says most pathogens are destroyed. At 100 Celsius, 212 Fahrenheit, water boils at sea level, lower at altitude. At about 177 Celsius, 350 Fahrenheit, very hot deep-frying oil. At the top, a shaded band from 210 to 232 Celsius, 410 to 450 Fahrenheit, the approximate smoke points in the FSIS frying table. Every figure is from FSIS.</desc>
  <line x1="90" y1="60" x2="90" y2="420" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <line x1="84" y1="420" x2="90" y2="420" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <line x1="84" y1="345" x2="90" y2="345" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <line x1="84" y1="270" x2="90" y2="270" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <line x1="84" y1="195" x2="90" y2="195" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <line x1="84" y1="120" x2="90" y2="120" stroke="var(--line-strong, #0f2a4a)" stroke-width="2"/>
  <text x="78" y="425" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">0°C</text>
  <text x="78" y="350" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">50°C</text>
  <text x="78" y="275" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">100°C</text>
  <text x="78" y="200" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">150°C</text>
  <text x="78" y="125" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">200°C</text>
  <circle cx="90" cy="420" r="6" fill="var(--line-strong, #0f2a4a)"/>
  <text x="104" y="416" font-size="16" fill="var(--text, #111418)">Ice water: 32°F (0°C)</text>
  <text x="104" y="436" font-size="15" fill="var(--text-2, #4a5260)">the thermometer check</text>
  <rect x="84" y="309" width="12" height="21" fill="var(--gold, #b08d2a)"/>
  <text x="104" y="316" font-size="16" fill="var(--text, #111418)">Most pathogens destroyed</text>
  <text x="104" y="336" font-size="15" fill="var(--text-2, #4a5260)">140 to 165°F (60 to 74°C)</text>
  <circle cx="90" cy="270" r="6" fill="var(--line-strong, #0f2a4a)"/>
  <text x="104" y="266" font-size="16" font-weight="700" fill="var(--text, #111418)">Water boils: 212°F (100°C)</text>
  <text x="104" y="286" font-size="15" fill="var(--text-2, #4a5260)">at sea level; lower at altitude</text>
  <circle cx="90" cy="155" r="6" fill="var(--oxblood, #8b1e2d)"/>
  <text x="104" y="151" font-size="16" fill="var(--text, #111418)">Deep-frying oil: about 350°F</text>
  <text x="104" y="171" font-size="15" fill="var(--text-2, #4a5260)">(about 177°C)</text>
  <rect x="84" y="72" width="12" height="33" fill="var(--oxblood, #8b1e2d)"/>
  <text x="104" y="84" font-size="16" fill="var(--text, #111418)">Oil smoke points (FSIS table)</text>
  <text x="104" y="104" font-size="15" fill="var(--text-2, #4a5260)">410 to 450°F (210 to 232°C)</text>
  <text x="20" y="470" font-size="15" fill="var(--text-2, #4a5260)">Scale in °C. Figures from FSIS pages.</text>
</svg>
...
FSIS gives two checks on its [food thermometer page](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/food-thermometers).[5] The first works anywhere, and it is the one to rely on:
...
Keep the door shut and turn off the heat. The NFPA and the CPSC both say this.[12][13] The fire needs air, and opening the door gives it some.
...
The US Environmental Protection Agency's [advice](https://www.epa.gov/indoor-air-quality-iaq/strategies-improving-indoor-air-quality-while-cooking-infographic), which does not tell anyone to replace a stove: "Turn the range hood on whenever you are cooking." "Leave the range hood on for 10–20 minutes after you have finished cooking." "Cook on the back burners when possible to capture more emissions." Without a hood that vents outside, open doors and windows when it is safe, and use exhaust fans.[23] The hood itself is Home Repair and Maintenance's subject.
...
**"Put butter or ice on a burn."** Neither. Cool running water for 20 minutes.[15][16]

**"If it's boiling, it's 100°C."** Only at sea level. At altitude it boils lower,[5][24] which changes both your thermometer check and how long anything boiled takes.

## Practice

:::exercise Calibrate, time, and plan
Take 60 minutes over these. You'll need your thermometer, a large glass, ice, a pan, a potato, a ruler and a timer.

1. Calibrate your thermometer in ice water exactly as FSIS describes above: a large glass packed with ice, water stirred in, the stem at least 5 cm (2 inches) in and touching neither side nor bottom, 30 seconds, read it without lifting it out. Write down the reading. Then do the boiling-water check and write that down too. Look up your altitude (a map app will tell you), work out what FSIS's rule of just under 1°F for every 500 feet predicts, and say whether your boiling reading fits it.

2. Cut one slice about 1 cm thick and one about 2 cm thick from the same potato, measured with the ruler. Put both into the same pot of water at a rolling boil and start the timer. Every two minutes, test each with the tip of a knife; tender is when it slides into the centre with no resistance. Write down each time. Divide the thick slice's time by the thin one's. Was it closer to 2 or to 4? If it wasn't close to either, write down one reason why (your slices weren't the thickness you meant, the boil dropped when they went in, and so on).

3. Write a fire plan for your kitchen, in three lines: where the lid is that fits your biggest frying pan, the way out of the room and the house, and your emergency number. Put the lid where you'd reach it without looking.
:::

:::checkpoint A friend's recipe says to boil new potatoes whole for 15 minutes. Yours are twice the size of hers. Using this lesson, what will you do?
...
- **Douglas Baldwin, [*A Practical Guide to Sous Vide Cooking*](https://douglasbaldwin.com/sous-vide.html).** Read in full for this course. Written for water-bath cooking, but it is the clearest free explanation read here of why time and temperature work together and why the centre lags, with tables of heating times.
- **FSIS, [Food Thermometers](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/food-thermometers).** The whole page, read in full here: every thermometer type, how long each takes to read, and where to put it in different foods.
- **The [London Fire Brigade's pan fire page](https://www.london-fire.gov.uk/safety/the-home/cooking/pan-fires/) and the [NFPA's cooking safety page](https://www.nfpa.org/education-and-research/home-fire-safety/cooking).** Both read in full. Short, and worth reading side by side to see the two approaches in their own words.
...
1. Engineering ToolBox, "Convective Heat Transfer", https://www.engineeringtoolbox.com/convective-heat-transfer-d_430.html <!-- SOURCES C7; Gate closures, lesson 2 -->. **Read level: partial at Stage 1 through the fetch tool; the coefficient list rechecked against the page directly on 2026-09-24.** Supports: the ranges of heat transfer coefficients. The oven-and-water arithmetic, the choice of 10, 1,000 and 5,000 from inside those ranges, the 30°C skin figure and the fan-oven reading are this course's own, as the body says.
2. Engineering ToolBox, "Water Properties: Vaporization Heat vs. Temperature" and "Specific Heat Capacity of Water", https://www.engineeringtoolbox.com/water-properties-d_1573.html and https://www.engineeringtoolbox.com/specific-heat-capacity-water-d_660.html <!-- Gate closures, lesson 2 -->. **Read level: the tables, directly.** Supports: 2,256.4 kJ/kg to vaporise water at 100°C and a specific heat of about 4.2 kJ/kg per degree, from which the 418 kJ and "more than five times" are this course's arithmetic.
3. US Food and Drug Administration, "Microwave Ovens", content current as of 12 October 2023, https://www.fda.gov/radiation-emitting-products/resources-you-radiation-emitting-products/microwave-ovens <!-- SOURCES C10h; Gate closures, lesson 2 -->. **Read level: partial at Stage 1; the quoted passages rechecked against the page directly.** Supports: how microwaves heat, the outer-layers quotation, the nutrition statement and the super-heated water warning.
4. Douglas Baldwin, "A Practical Guide to Sous Vide Cooking", version 0.4k, last updated 25 December 2014, https://douglasbaldwin.com/sous-vide.html <!-- SOURCES B6.2 -->. **Read level: full.** Supports: "twice as thick takes about four times longer".
5. USDA Food Safety and Inspection Service, "Food Thermometers", last updated 21 March 2025, read through the Internet Archive's August 2026 capture <!-- SOURCES B1.9; Gate closures, lesson 2 -->. **Read level: full.** Supports: the calibration method, 212°F at sea level and the altitude sentence, the 2 to 4°F accuracy, placement, the size-and-distribution sentence, and 140 to 165°F for most pathogens.
6. USDA FSIS, "The Big Thaw: Safe Defrosting Methods", last updated 15 June 2013, read through a 2026 Internet Archive capture <!-- SOURCES B1.5 -->. **Read level: full.** Supports: about 50% longer from frozen.
7. Nancy Honig, "The Maillard Reaction", Wild West District Extension Blog, Kansas State University Research and Extension, posted 15 August 2022, https://blogs.k-state.edu/wildwestdistrict/2022/08/15/the-maillard-reaction/ <!-- Gate closures, lesson 2 -->. **Read level: full, directly.** Supports: the 285°F (140°C) figure, which the lesson gives as approximate. An extension page, not research, and much of its wording matches an unsigned web page the course also found, so it is not independent confirmation of that page; the review below is why the lesson calls the figure rough.
8. Leina El Hosry, Vanessa Elias, Vanessa Chamoun and colleagues, "Maillard Reaction: Mechanism, Influencing Parameters, Advantages, Disadvantages, and Food Industrial Applications: A Review", *Foods* 14(11), 2025, 1881, doi 10.3390/foods14111881 <!-- Gate closures, lesson 2 -->. **Read level: full text (Europe PMC XML), searched for temperature; the abstract, the section on temperature and the baking section read.** Supports: the reaction's reactants and influences, "The higher the temperature, the faster the reaction", and the baking phases with browning around 160°C.
9. USDA FSIS, "Doneness Versus Safety", last updated 10 July 2024, read through the Internet Archive <!-- SOURCES B1.9 -->. **Read level: full.** Supports: about 15% consistently use a thermometer.
10. USDA FSIS, "Deep Fat Frying", last updated 9 August 2024, read through the Internet Archive's September 2026 capture <!-- SOURCES D2a; Gate closures, lesson 2 -->. **Read level: full, rechecked.** Supports: oil at about 350°F, the water-and-oil quotation, the smoke-point sentence and table.
11. National Fire Protection Association, "Home Cooking Fires" research report page, data years 2017 to 2021, https://www.nfpa.org/education-and-research/research/nfpa-research/fire-statistical-reports/home-cooking-fires <!-- SOURCES D2a -->. **Read level: key findings, full.** Supports: the fire, death and injury figures (for home structure fires), unattended cooking, electric against gas ranges, and injuries to people fighting the fire. A newer edition exists and was not read.
12. NFPA, "Cooking safety", https://www.nfpa.org/education-and-research/home-fire-safety/cooking <!-- SOURCES D2a -->. **Read level: full.** Supports: the lid, "Just get out!", the oven fire and the smoke warning.
...
20. G. W. Wong and colleagues, ISAAC Phase Three, *Lancet Respiratory Medicine*, 2013, PMID 24429203 <!-- SOURCES D3c -->. **Read level: abstract.** Supports: 512,000 children, 47 countries, the open-fire and gas findings.
21. Y. Kashtan and colleagues, *Science Advances*, 3 May 2024, PMID 38701214 <!-- SOURCES D3c -->. **Read level: abstract, rechecked directly on 2026-09-24.** Supports: the method (measurements from over 100 homes, an indoor air model, epidemiological risk parameters), 4.0 ppb, 75% of the WHO guideline, the home-size difference, the Stanford affiliation and the quoted 50,000 cases.
22. Y. S. Kashtan and colleagues, *Environmental Science & Technology*, 2023, PMID 37319002 <!-- SOURCES D3c -->. **Read level: abstract, rechecked directly on 2026-09-24.** Supports: 87 homes, the benzene comparison and the induction finding.
23. US Environmental Protection Agency, "Strategies for Improving Indoor Air Quality While Cooking" (infographic, text version), dated 10 March 2026 <!-- SOURCES D3c; Gate closures, lesson 2 -->. **Read level: full, rechecked directly.** Supports: the quoted advice.
24. USDA FSIS, "High Altitude Cooking", last updated 13 August 2024, read through the Internet Archive's 23 September 2026 capture <!-- SOURCES: Stage 4 note, lesson 2 -->. **Read level: full, directly.** Supports: just under 1°F per 500 feet, 198°F at 7,500 feet, and longer cooking when boiling or simmering at altitude. The metric version of the rule is this course's arithmetic.
25. Ashley Dummer, "Safeguard Your Family from Scald Burns", Indiana University School of Medicine pediatrics blog, 5 October 2021, https://medicine.iu.edu/blogs/pediatrics/safeguard-your-family-from-scald-burns <!-- SOURCES: Stage 4 note, lesson 2 -->. **Read level: full, directly.** Supports: lifting a lid away from your arms and face. The microwave bag is this course's extension of it, as the body says.
26. Essex County Fire and Rescue Service, "Firefighters' plea after man injured in chip pan fire", 31 March 2026, https://www.essex-fire.gov.uk/incidents/firefighters-plea-after-man-injured-chip-pan-fire-2026-03-31-14-25 <!-- SOURCES: Stage 4 note, lesson 2 -->. **Read level: full, directly.** Supports: the station manager's quotation on the damp tea towel.
