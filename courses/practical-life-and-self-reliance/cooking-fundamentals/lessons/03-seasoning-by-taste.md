...
objectives:
  - >-
    ...
    another, and season by weight or by taste accordingly
  - >-
    Diagnose a dish that tastes flat, cloying or thin, and apply salt, acid, fat or a
    glutamate-rich ingredient to fix it, saying which problem each one addresses
  - >-
    Identify glutamate-rich ingredients from several cuisines, and state what the double-blind
    evidence shows about MSG, where it is settled and where it is still argued
  - >-
    Season a dish in stages by tasting, and store garlic in oil in a way that can't grow botulism,
    under US and UK guidance
quiz:
  - q: >-
      A curry recipe from a writer who cooks with a coarse, flaky sea salt calls for "1½ teaspoons
      salt" in the sauce. You only have fine table salt. What's the sensible way to follow it?
    options:
      - Add the full 1½ teaspoons as written, since the writer's kitchen has already tested that amount
      - Add 3 teaspoons, since table salt is about half as salty as the salts recipe writers use
      - Leave all the salt out until the very end, so that you only have to taste the sauce once
      - Add a good deal less than written, simmer, taste, and then add more in pinches until right
    answer: 3
    explain: >-
      A teaspoon measures volume, and fine crystals pack more salt into it than coarse flakes, so
      your table salt will be saltier spoon for spoon than the writer's. The exact difference
      depends on the two salts, which is why you add less and taste. The full 1½ teaspoons is the
      mistake the lesson warns about. Doubling it gets the direction backwards: the fine salt is
      the saltier one by volume. Salting only at the end throws away the chance to correct as the
      sauce reduces.
  - q: >-
      A pot of creamy mushroom soup is salted to taste. The first spoonful is lovely, but by the
      third it feels heavy and a bit dull, and the flavour seems to sit on your tongue. What would
      this lesson try first?
    options:
      - A squeeze of lemon juice or a splash of vinegar, stirred in, then taste the soup again
      - Another pinch of salt, since dullness is almost always the sign of an under-salted soup pot
      - A spoonful of butter stirred in at the end, to carry the mushroom flavour further through it
      - A dash of soy sauce, since mushrooms are low in glutamate and need an extra umami boost
    answer: 0
    explain: >-
      Heavy and dull after a few spoonfuls, in a dish that's already salted, is the case for acid:
      it gives the richness a contrast. More salt fixes a flat dish that's under-salted, and this
      one isn't. Butter adds more of the richness that's already the problem. Soy sauce adds salt
      to a pot that has enough, and the premise is wrong too: FSANZ names mushrooms among the
      foods with relatively high free glutamate.
  - q: >-
      A friend says they get a headache every time they eat at one particular restaurant, and it
      must be the MSG. Using the double-blind evidence in this lesson, which statement is fair?
    options:
      - The trials show the symptoms are imagined, so the friend has nothing at all wrong with them, really
      - The trials confirm a real MSG sensitivity in about 4 in every 10 of the people who report having one
      - Large doses without food caused more symptoms than placebo, but not consistently, and not with food
      - Regulators cap MSG at 3 grams a serving, so a restaurant meal can't contain enough of it to matter
    answer: 2
    explain: >-
      Geha's trial found that 5 g of MSG without food produced more reported symptoms than placebo
      in people who believed they reacted, but the responses didn't repeat on retesting and didn't
      appear when MSG was given with food. That doesn't show the friend's headaches are imagined;
      it shows the trials didn't find MSG eaten with food causing them, though FSANZ calls the
      with-food question unanswered and suggests proper clinical testing for anyone who suspects a
      sensitivity. The 38.5% who reacted to MSG only
      were a first round, and of those retested, only about half reacted the same way again.
      There's no 3 g cap: 3 g without food is the FASEB threshold the FDA reports, not a limit.
  - q: >-
      A neighbour makes Christmas gifts by warming peeled garlic cloves gently in olive oil for an
      hour, then bottling the oil with the cloves in sterilised jars to keep in the cupboard. She
      says the heat killed anything harmful. Which change makes the gift safe to keep?
    options:
      - Bottling it with the cloves only if dried garlic is used, since dry garlic has no water
      - Storing it in the fridge for no more than 4 days, or freezing it, rather than the cupboard
      - Adding a spoonful of lemon juice to each jar, since acid is what stops the bacteria growing
      - Boiling the jars for 10 minutes first, so that no bacteria are left anywhere in the bottle
    answer: 1
    explain: >-
      Heat doesn't solve it: botulism spores survive cooking, and oil keeps the air out of the
      low-acid garlic. The University of Georgia circular says even oil heated to 180°F before the
      garlic goes in must be kept in the fridge and thrown out after 4 days, or frozen. The same
      circular rules out each of the other ideas: dried garlic "still does not ensure" a safe
      product; lemon juice and vinegar "have not been tested" in place of the citric acid method;
      and sterilised jars are a starting step in every method, not a substitute for the fridge.
  - q: >-
      Per 100 g, cod holds about 2,100 mg of glutamate bound up in its protein and about 9 mg free.
      Carrots hold about 220 mg bound and about 33 mg free (FSANZ, Table 1). A cook wants a
      vegetable broth to taste more savoury. On this evidence, which is the better addition?
    options:
      - Cod, since it has roughly eight times as much glutamate as carrot does, in total by weight
      - Neither of them, since glutamate only tastes savoury once it's been bought in a jar as MSG
      - Cod, since cooking fish for longer in the pot will free up the glutamate in its protein
      - Carrot, since the free glutamate is the part FSANZ links with a flavour-enhancing effect
    answer: 3
    explain: >-
      FSANZ says glutamate "in its free form" has the flavour-enhancing effect. Bound glutamate is
      locked into protein, so the total is the wrong figure to compare. The FDA says the glutamate in MSG is chemically the same as the free
      glutamate in foods, so bought MSG isn't the only savoury source. Whether a long simmer frees
      glutamate from fish protein is a claim this course hasn't read a source for, so it isn't a
      basis for choosing.
---

Taste a spoonful of plain tomato and then the same tomato with a few grains of salt on it. The second one tastes more of tomato, not more of salt. Samin Nosrat, whose book *Salt, Fat, Acid, Heat* is built on that kind of observation, explained it [on NPR's *Fresh Air*](https://www.npr.org/transcripts/672904397): once salt goes on a slice of tomato, "some of the juices start to come out, you know? Osmosis starts." The aromatic compounds are in those watery cells, she said, so "they come to the top. They're more available for you to breathe in."[1]
...
:::predict You weigh a level teaspoon of fine table salt and a level teaspoon of a coarse flaky salt on the same scale. Before you do, which will be heavier, and roughly by how much?
...
In 1908, as the US Food and Drug Administration (FDA) tells it in [its questions and answers on MSG](https://www.fda.gov/food/food-additives-petitions/questions-and-answers-monosodium-glutamate-msg), "a Japanese professor named Kikunae Ikeda was able to extract glutamate from this broth and determined that glutamate provided the savory taste to the soup." The broth was "a glutamate-rich seaweed broth". Ikeda patented a way to produce monosodium glutamate, MSG, and commercial production began the next year.[4] MSG is the sodium salt of glutamic acid, one of the commonest amino acids in nature.[3][4]

What makes glutamate useful to a cook is that it exists in two forms. Most of it is bound into protein, and some is free. Food Standards Australia New Zealand (FSANZ), in [a safety assessment published in 2003](https://www.foodstandards.gov.au/sites/default/files/consumer/additives/msg/Documents/MSG%20Technical%20Report.pdf), says glutamate "in its free form has been shown to have a flavour enhancing effect".[3] So the total amount of glutamate in a food tells you little about how savoury it tastes. The free amount is what counts, and the FSANZ report has a table of it. In words, it names "tomatoes, mushrooms, peas and certain cheeses" as foods where free glutamate runs relatively high.[3]

:::checkpoint FSANZ's Table 1 gives beef about 2,850 mg of bound glutamate per 100 g and 33 mg free, and tomatoes about 240 mg bound and 140 mg free. Weight for weight, which adds more savouriness to a thin sauce, and why is the total the wrong figure to compare?
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 470" width="100%" style="max-width:440px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="glu-title glu-desc">
  <title id="glu-title">Free glutamate in seasonings and foods, milligrams per 100 grams</title>
  <desc id="glu-desc">Horizontal bars. Seasonings: Marmite 1960, Korean soy sauce 1264, Parmesan 1200, Thai fish sauce (nam pla) 950, oyster sauce 900, Japanese soy sauce 782. Foods: peas 200, potato 180, tomatoes 140, chicken 44, beef 33, cow's milk 2. All figures from FSANZ 2003, Tables 1 and 2.</desc>
  <text x="10" y="24" font-size="16" font-weight="700" fill="var(--text, #111418)">Free glutamate, mg per 100 g</text>
  <line x1="165" y1="40" x2="165" y2="420" stroke="var(--line-strong, #0f2a4a)" stroke-width="1.5"/>
  <text x="157" y="63" font-size="15" text-anchor="end" fill="var(--text, #111418)">Marmite</text>
  <rect x="165" y="49" width="190" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="361" y="64" font-size="15" fill="var(--text, #111418)">1,960</text>
  <text x="157" y="93" font-size="15" text-anchor="end" fill="var(--text, #111418)">Soy sauce, Korea</text>
  <rect x="165" y="79" width="123" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="294" y="94" font-size="15" fill="var(--text, #111418)">1,264</text>
  <text x="157" y="123" font-size="15" text-anchor="end" fill="var(--text, #111418)">Parmesan</text>
  <rect x="165" y="109" width="116" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="287" y="124" font-size="15" fill="var(--text, #111418)">1,200</text>
  <text x="157" y="153" font-size="15" text-anchor="end" fill="var(--text, #111418)">Fish sauce (nam pla)</text>
  <rect x="165" y="139" width="92" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="263" y="154" font-size="15" fill="var(--text, #111418)">950</text>
  <text x="157" y="183" font-size="15" text-anchor="end" fill="var(--text, #111418)">Oyster sauce</text>
  <rect x="165" y="169" width="87" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="258" y="184" font-size="15" fill="var(--text, #111418)">900</text>
  <text x="157" y="213" font-size="15" text-anchor="end" fill="var(--text, #111418)">Soy sauce, Japan</text>
  <rect x="165" y="199" width="76" height="20" fill="var(--oxblood, #8b1e2d)"/>
  <text x="247" y="214" font-size="15" fill="var(--text, #111418)">782</text>
  <line x1="10" y1="236" x2="430" y2="236" stroke="var(--text-2, #4a5260)" stroke-width="1" stroke-dasharray="4 4"/>
  <text x="157" y="263" font-size="15" text-anchor="end" fill="var(--text, #111418)">Peas</text>
  <rect x="165" y="249" width="19" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="190" y="264" font-size="15" fill="var(--text, #111418)">200</text>
  <text x="157" y="293" font-size="15" text-anchor="end" fill="var(--text, #111418)">Potato</text>
  <rect x="165" y="279" width="17" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="188" y="294" font-size="15" fill="var(--text, #111418)">180</text>
  <text x="157" y="323" font-size="15" text-anchor="end" fill="var(--text, #111418)">Tomatoes</text>
  <rect x="165" y="309" width="14" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="185" y="324" font-size="15" fill="var(--text, #111418)">140</text>
  <text x="157" y="353" font-size="15" text-anchor="end" fill="var(--text, #111418)">Chicken</text>
  <rect x="165" y="339" width="4" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="175" y="354" font-size="15" fill="var(--text, #111418)">44</text>
  <text x="157" y="383" font-size="15" text-anchor="end" fill="var(--text, #111418)">Beef</text>
  <rect x="165" y="369" width="3" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="174" y="384" font-size="15" fill="var(--text, #111418)">33</text>
  <text x="157" y="413" font-size="15" text-anchor="end" fill="var(--text, #111418)">Cow's milk</text>
  <rect x="165" y="399" width="1" height="20" fill="var(--line-strong, #0f2a4a)"/>
  <text x="172" y="414" font-size="15" fill="var(--text, #111418)">2</text>
  <text x="10" y="455" font-size="15" fill="var(--text-2, #4a5260)">Bars to one scale. Source: FSANZ 2003, Tables 1 and 2.</text>
</svg>
...
:::predict In a trial its authors called the largest to date when it was published, 130 people who believed they reacted to MSG were each given 5 g of MSG on one day and a placebo on another, both without food. What share do you expect reacted to MSG and not to the placebo?
...
:::checkpoint At stage 2 you added salt until the dal tasted right. You then leave it on a low simmer for another 20 minutes while you cook rice. What should you do before serving, and why?
...
:::predict A recipe for a tomato and chickpea stew says "season with 1 teaspoon salt and 2 tablespoons soy sauce." You have no soy sauce, so you leave it out and add the teaspoon of salt. Before you taste, what will be missing, and what would you add instead?
...
**The US says:** the [National Center for Home Food Preservation](https://nchfp.uga.edu/how/freeze/vegetable/freezing-garlic-in-oil/), whose researchers confirmed "that mixtures of garlic in oil stored at room temperature are at risk for the development of botulism", says garlic in oil "should be made fresh and stored in the refrigerator at 40°F or lower for no more than 4 days. It may be frozen for long term storage for up to several months."[8] The Georgia circular applies the same four days even to oil heated to 180°F before the garlic goes in.[9]

**The UK says:** the FSA's [page on botulism](https://www.gov.uk/government/publications/botulism-clostridium-botulinum/botulism-clostridium-botulinum) says that canning and bottling products "such as herbs or garlic in oil can be risky as it is difficult to achieve the level of control needed to destroy or prevent growth of C. botulinum spores at home", and lists "foods preserved in oil" among the foods associated with botulism.[10] The FSA page read for this course gives no day limit for homemade garlic oil. Its general advice is to keep chilled food below 5°C.[10] Keeping to the US four days in a UK fridge fits inside that advice. That is this course's suggestion, not an FSA rule.
...
**"Garlic oil is safe once the garlic's been cooked."** Botulism spores survive cooking, and heating the oil does not change what happens in the jar afterwards. Fridge, no more than 4 days (US guidance), or the freezer.[8][9][10]

## Practice

:::exercise Weigh, split and fix
