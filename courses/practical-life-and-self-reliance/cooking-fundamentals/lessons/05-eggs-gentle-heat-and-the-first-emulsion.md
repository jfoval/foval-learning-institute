---
title: "Eggs: gentle heat and the first emulsion"
minutes: 150
audio: https://pub-f7bdc2ace9904917a8238f1557b7f247.r2.dev/practical-life-and-self-reliance/cooking-fundamentals/05-eggs-gentle-heat-and-the-first-emulsion.mp3
objectives:
  - >-
    Explain why the white and the yolk set at different temperatures, and use that to boil, fry,
    poach and scramble an egg and make an omelette to the doneness you choose
  - >-
  ...
  - >-
    State the US and UK advice on runny and raw eggs, who it applies to and why the two differ, and
    choose eggs for a raw-egg dish under your own country's rule
quiz:
  - q: >-
      A cook fries eggs for a crowd in a pan that's smoking hot. The whites puff, brown at the edges
      and turn tough, while the yolks are still cold and runny on top. What went wrong, in terms of
      the proteins?
    options:
      - The yolks hold more water than the whites, so they need a hotter pan than this one to set
      - The fat was far too hot for the yolk proteins, which can only set when heat reaches them slowly
      - The whites by the pan went far past where their main protein sets, and heat hadn't reached the yolks
      - Egg whites contain sugars that brown in a very hot pan, and that browning is what makes them tough
    answer: 2
    explain: >-
      Heat goes into a fried egg from the pan face by conduction, so the white touching the pan gets
      hot first and fastest. Its main protein sets around 75 to 80°C in laboratory measurements, and a
      white driven well past that is firm and rubbery, while the yolk on top, farther from the pan,
      hasn't reached its own range yet. Yolks don't need a hotter pan than whites; they set at a
      slightly higher temperature, but they need the heat to arrive. The browning happens on the same
      overheated edge, but it's the proteins setting hard that makes the white tough.
  - q: >-
      You hard-boil a dozen eggs for a picnic and leave them sitting in the hot water while you pack.
      When you peel them the next day, every yolk has a grey-green ring. What does the ring tell you?
    options:
      - They were overcooked and cooled slowly; the ring is iron and sulphur, and harmless
      - The eggs were already old when you bought them, and the ring shows bacteria have got in
      - The water had too little salt, so sulphur from the yolk escaped into the white
      - The ring means they've been kept too long, so the whole batch should now be thrown away
    answer: 0
    explain: >-
      The ring is ferrous sulphide, formed where sulphur from the white meets iron from the yolk,
      usually because the eggs were overcooked, and sitting in hot water keeps them cooking. Both
      FSIS and the University of Nebraska say it's safe to eat. It says nothing about bacteria or
      about how long the eggs were stored, and salt in the water has nothing to do with it. Next
      time, cool them straight away in cold or iced water. Hard-cooked eggs themselves keep about a
      week in the fridge, according to FSIS, if they went in within 2 hours.
  - q: >-
      An egg bobs to the surface when you put it in a bowl of water. By the guidance on both sides of
      the Atlantic, what's the right next step?
    options:
      - Throw it out, since an egg that floats has gone off inside and is unsafe to eat
      - Crack it into a bowl and look and smell; it's old, which isn't the same as unsafe
      - Use it only in something baked, because a long hot bake makes an unsafe egg safe
      - Boil it longer than usual, because floating eggs carry more germs in the air cell
    answer: 1
    explain: >-
      An egg floats because its air cell has grown as it aged. The FSA says the test "assesses age,
      not safety", and FSIS says a floating egg is of poor quality "but it may be perfectly safe to
      use", and tells you to crack it and check its look and smell. Throwing it out wastes an egg
      that may be fine. Baking or boiling longer are answers to a safety problem the test doesn't
      show; an egg that sinks can still carry Salmonella, which is why the cooking rules apply to
      every egg.
  - q: >-
      You live in the US and are making a Caesar dressing, which uses raw egg yolk, for a dinner
      that includes your 72-year-old father. What does US federal guidance say to do?
    options:
      - Use any fresh, clean, uncracked egg that's been kept in the fridge, since those are safe raw
      - Buy eggs with a British Lion mark, which UK guidance says are safe raw for older people
      - Leave the yolk out and use extra oil, because the yolk adds only richness to the dressing
      - Use pasteurised eggs, or heat the yolk with some of the liquid to 160°F before you whisk
    answer: 3
    explain: >-
      FSIS names Caesar salad among the raw-egg foods it advises everyone against, and says to use
      pasteurised eggs for recipes that call for raw eggs, or to heat the eggs in liquid form to 160°F
      first. A clean, cold, uncracked egg can still carry Salmonella inside it, since it can get in
      before the shell forms. The Lion mark belongs to a UK scheme, and the exemption for its eggs is
      the UK regulator's advice, not the US agencies'. Dropping the yolk takes out the emulsifier, so the
      oil would separate.
  - q: >-
      You start a mayonnaise with one yolk and a little lemon, then pour in half the oil at once to
      save time. It never thickens: you get a runny yellow liquid with oil pooling on top. Which rescue fits?
    options:
      - Whisk it much harder for several minutes, since the droplets only need to be broken up again
      - Whisk a spoonful of water in a clean bowl and drizzle the broken sauce into it very slowly
      - Chill the bowl in the fridge for an hour so the oil firms up and holds its droplets apart
      - Stir in more lemon juice all at once, because the acid is what holds the droplets apart
    answer: 1
    explain: >-
      The oil arrived as a pool, faster than the whisk could break it into droplets and the yolk
      could coat them, so any droplets that formed ran together, and Anton calls that fusing
      irreversible. So you rebuild from a fresh liquid base, adding the failed sauce slowly so each new
      droplet gets coated, which is America's Test Kitchen's fix. Whisking the failed sauce alone
      gives the oil nothing new to hold it apart, and chilling doesn't make a coating either. Lemon
      juice adds flavour and a little water, but a big dose all at once repeats the oil's mistake.
  - q: >-
      A friend in London is making aioli, a garlic mayonnaise, for a guest who is pregnant. She has
      British Lion eggs. What does UK guidance say?
    options:
      - The Lion yolks may be eaten raw, including in pregnancy, unless severely immunocompromised
      - The yolks must be heated to 70°C for 2 minutes, the UK's standard for cooking any food
      - Pregnancy rules out raw yolk in the UK, so she should cook the yolks through before she starts
      - Lion eggs are safe raw only if they've been washed and dried just before she uses them
    answer: 0
    explain: >-
      The FSA's current advice is that people who are pregnant, young children and older people
      can eat raw or lightly cooked hen eggs with the British Lion mark or from the Laid in Britain
      scheme, and the NHS says the same for pregnancy. The exception is people who are severely
      immunocompromised, whose diet should come from their doctor. The 70°C for 2 minutes rule is the
      UK's standard for cooking food through, and the egg advice is what exempts these eggs from it.
      Washing isn't part of the advice: UK eggs aren't washed, and US guidance says home washing can
      pull water through the shell.
---
...
- [The American Egg Board](https://www.incredibleegg.org/professionals/manufacturers/real-egg-functionality/coagulation-thickening/), the US egg industry's promotion body, says "Egg white protein coagulates between 144° F and 149° F (62.2° C and 65° C); egg yolk protein coagulates between 149° F and 158° F (65° C and 70° C)".[1] The Egg Safety Center, which represents US egg producers, gives the same ranges.[2]
...
:::predict You put an egg, in its shell, in a water bath that you hold at exactly 64°C (147°F) for an hour, so every part of it ends up at 64°C. From the ranges above, what do you expect when you crack it?
...
:::checkpoint A recipe says to cook a baked egg custard in a low oven until "just set, with a slight wobble in the centre". Using the white-and-yolk figures, why would a much hotter oven give you a custard that is rubbery at the edges and still loose in the middle?
...
Older eggs peel more easily. The US Food Safety and Inspection Service (FSIS), in [its long page on eggs](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/eggs/shell-eggs-farm-table), explains that a new-laid white is close to neutral, "around 7.4", and becomes more alkaline as the egg ages, to "approximately 9", which loosens the white from the membrane under the shell. "For this reason, older eggs make better candidates for hard cooking."[5]

### The green ring

Overcook a hard-boiled egg and a grey-green ring forms around the yolk. [The University of Nebraska-Lincoln's extension service](https://food.unl.edu/how-avoid-green-ring-hard-boiled-egg-yolks/) explains it: "The ring is caused by a chemical reaction involving sulfur (from the egg white) and iron (from the egg yolk), which naturally react to form ferrous sulfide at the surface of the yolk." It is "unattractive, but not harmful."[6] FSIS says the same, adds that "a high amount of iron in the cooking water" can cause it too, and says "The green color is safe to consume."[5]
...
:::video https://www.youtube.com/watch?v=8e2aBVRHZdI | How To Properly Poach An Egg (Jacques Pépin, KQED Food)
...
:::video https://www.youtube.com/watch?v=X1XoCQm5JSQ | Learn Jacques Pépin's famous omelet techniques (American Masters, PBS)
...
- **Marc Anton**, a researcher at France's national agricultural research institute, in [a review of his field's work](https://www.cabi.org/Uploads/animal-science/worlds-poultry-science-association/WPSA-italy-2006/10903.pdf), credits mostly the yolk's low-density lipoproteins, tiny particles of fat wrapped in proteins and phospholipids (lecithin is one). When they reach the surface of an oil droplet they spread out, and the proteins and phospholipids form a film that both lowers the tension at the surface and gives "resistance to the rupture".[15]
...
America's Test Kitchen (ATK) publishes [a mayonnaise recipe](https://www.americastestkitchen.com/recipes/12375) that happens to solve the US raw-egg problem, so it's a good one to follow in either country.
...
:::predict You're whisking a mayonnaise by hand and it has just turned thick. You've used about a quarter of your oil. Should the next part of the oil go in faster or slower than the first few drops did?
...
**"If an egg floats, it's gone bad."** It's old, which is a different thing. The float test measures the air cell, which grows with age. The FSA says it "assesses age, not safety", and FSIS says to crack it and check it.[10][5] An egg that sinks can still carry Salmonella.

**"The green ring means the egg was bad."** It means the egg was overcooked, or cooled slowly, or cooked in water high in iron. It's iron and sulphur reacting at the yolk's surface, and both FSIS and the University of Nebraska say it is safe to eat.[5][6] Cool the eggs in cold water to prevent it.
...
:::exercise Four eggs, one mayonnaise, one rescue
...
:::checkpoint Look back at your four boiled eggs. If a friend with larger eggs, straight from a cupboard rather than the fridge, used your soft-boiled time, would she get the same egg? Why not?
...
- **[USDA FSIS, "Shell Eggs from Farm to Table"](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/eggs/shell-eggs-farm-table).** Read in full for this course. The US regulator's long page on eggs: how Salmonella gets in, grades, dates, the float test, the green ring, peeling, and a storage chart. The best single page for the US rules.
- **[America's Test Kitchen, "How to Fix Failed Mayo"](https://www.americastestkitchen.com/how_tos/13363-how-to-fix-broken-mayo).** Read in full. Two paragraphs, and the rescue method this lesson uses, with the reason a food processor batch sometimes fails.
- **[Marc Anton, "Recent advances concerning the functional properties of egg yolk low-density lipoproteins"](https://www.cabi.org/Uploads/animal-science/worlds-poultry-science-association/WPSA-italy-2006/10903.pdf).** Read in full. Eight pages by a researcher who studies how yolk holds an emulsion together. Technical in the middle, but the first page and the definitions of creaming, flocculation and coalescence are clear, and it is candid about what is not yet known.
- **[Jacques Pépin's KQED technique videos](https://www.youtube.com/playlist?list=PL1LaW-AR98H8-Hf3ft0g3sUuV5FCjvDsr).** The playlist the poaching video comes from, with his knife, vinaigrette and chicken videos. The titles were checked for this course; the videos weren't watched.

## Sources

1. American Egg Board, "Coagulation/Thickening", REAL Egg Functionality, https://www.incredibleegg.org/professionals/manufacturers/real-egg-functionality/coagulation-thickening/ , page copyright 2023 <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** The US egg industry's promotion board, writing for food manufacturers; it cites Stadelman and Cotterill, *Egg Science and Technology* (1995), which was not read. Supports: the folded-protein description, the three-dimensional network, the white, yolk and whole-egg ranges, "a number of variables", and starch slowing coagulation in custard.
2. Egg Safety Center, "What is the safe temperature to cook eggs?", https://eggsafety.org/faq/what-is-the-best-temperature-to-cook-an-egg/ <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** The page says the Center represents commercial egg producers. Supports: the same coagulation ranges; the 12, 9 and 15 minute hard-cooking method; poached eggs about 5 minutes in simmering water; the doneness wording for fried, poached and scrambled eggs (its table groups scrambled with fried) and for omelettes and frittatas. Rechecked at Stage 4 against the live page, which corrected the research file's attribution of the omelette wording to scrambled eggs.
3. Institute of Food Science and Technology, "Protein: coagulation", Love Food Love Science teaching resources, https://www.ifst.org/lovefoodlovescience/resources/protein-coagulation <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** A schools resource from the UK professional body. Supports: 60°C, 65°C and 70°C, and "Coagulation is irreversible".
4. Jian Kuang, Pascaline Hamon, Valérie Lechevalier and Rémi Saurel, "Thermal Behavior of Pea and Egg White Protein Mixtures", *Foods* 12(13), 2023, 2528, https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10340197/ , CC BY <!-- Gate closures, lesson 5 -->. **Read level: the egg white passages of the full text; the pea results were not read.** Supports: ovalbumin about 54% and ovotransferrin about 12% of egg white protein; their measured peaks near 63°C and 76°C; "many studies" finding peaks around 65 and 80°C; gelling at about 60 and 75°C. The link from these laboratory figures to the texture of a cooked white is this course's inference, and the lesson says so where it's made.
5. USDA Food Safety and Inspection Service, "Shell Eggs from Farm to Table", last updated 20 November 2024, read through the Internet Archive's capture of 29 August 2026 <!-- Gate closures, lesson 5 -->. **Read level: full.** Supports: Salmonella Enteritidis in clean, uncracked eggs and how it gets in; the carton statement; the raw-egg foods everyone is advised against and the vulnerable groups; pasteurised shell eggs and why they can't be made at home; the 160°F method for raw-egg recipes; the FDA Egg Safety Rule; grades, thinner whites with age, and the best eggs for poaching; sweating and 2 hours out of the fridge; coldest part, not the door; not washing eggs; cracks; hard-cooked eggs within 2 hours and a week; albumen pH and peeling; the green ring and the greenish cast on scrambled eggs; the float test; "Scrambled eggs should not be runny."
6. Alice Henneman, "How to Avoid a Green Ring on Hard-Boiled Egg Yolks", University of Nebraska-Lincoln Extension, reviewed and updated 2024, https://food.unl.edu/how-avoid-green-ring-hard-boiled-egg-yolks/ <!-- SOURCES C8b; Gate closures, lesson 5 -->. **Read level: full, directly, on recheck.** Supports: the ferrous sulphide explanation, "unattractive, but not harmful", iron in the water, and cooling in cold or iced water.
7. Julie Garden-Robinson, "Prairie Fare: Are Runny Eggs Safe to Eat?", NDSU Extension, 7 April 2011, https://www.ag.ndsu.edu/news/columns/prairie-fare/prairie-fare-are-runny-eggs-safe-to-eat/ <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** Supports: the USDA recipe's 15-minute simmer and cold rinse. The column's coagulation figures repeat the Egg Safety Center's, so it isn't cited for them.
8. foodsafety.gov, "Cook to a Safe Minimum Internal Temperature" (last reviewed 21 November 2024) and "4 Steps to Food Safety", read through 2026 Internet Archive captures <!-- SOURCES B1.2, B1.8 -->. **Read level: full.** Supports: "Cook until yolk and white are firm"; egg dishes to 160°F (71°C); eggs "in their original carton", "not in the door."
9. USDA FSIS, "Washing Food: Does it Promote Food Safety?", last updated 7 February 2024, read through the Internet Archive <!-- SOURCES B1.6 -->. **Read level: full.** Supports: commercial washing removes the shell's natural coating, replaced with mineral oil, and eggs from the shop are not to be washed.
10. Food Standards Agency, "Home food fact checker", GOV.UK, first published 2 June 2020, updated 21 August 2026, https://www.gov.uk/government/publications/home-food-fact-checker <!-- SOURCES B3.5 -->. **Read level: full.** Supports: the groups who "can now safely eat raw or lightly cooked hen eggs" with the British Lion mark or from Laid in Britain; the severely immunocompromised exception; the float test "assesses age, not safety".
11. NHS, "Foods to avoid in pregnancy", last reviewed 15 June 2026, https://www.nhs.uk/pregnancy/keeping-well/foods-to-avoid/ <!-- Gate closures, lesson 4 -->. **Read level: full, directly.** Supports: British Lion or Laid in Britain eggs "can be eaten raw, partially cooked (runny yolk), or well-cooked", and other hen eggs "should only be eaten well-cooked".
12. Food Standards Agency, "New advice on eating runny eggs", food.gov.uk, 11 October 2017, read through the Internet Archive's capture of 17 October 2017, https://web.archive.org/web/20171017232923/https://www.food.gov.uk/news-updates/news/2017/16597/new-advice-on-eating-runny-eggs ; also reproduced by the Institute of Food Science and Technology, https://www.ifst.org/news/new-advice-eating-runny-eggs-fsa-0 <!-- Gate closures, lesson 5; Stage 4 note, lesson 5 -->. **Read level: full, directly, both copies; the text matches.** Supports: the ACMSF expert group and its July 2016 report; salmonella "dramatically reduced"; the Lion scheme's measures, including vaccinating hens; "More than 90% of UK eggs" when the advice changed; the severely immunocompromised exception; non-Lion, non-hen and imported eggs cooked thoroughly for vulnerable groups; storing eggs "in a cool dry place such as the fridge".
13. US Food and Drug Administration, *Food Code 2026*, § 3-401.11 and Annex 3, https://www.fda.gov/media/194741/download <!-- SOURCES B2.1 -->. **Read level: the sections cited, searched in the full PDF.** Supports: raw eggs broken for immediate service to "63°C (145°F) or above for 15 seconds"; the 3-log reduction of Salmonella Enteritidis that the Annex attributes to 15 seconds at that temperature; raw or undercooked eggs on consumer request with an advisory, not for highly susceptible populations.
14. American Egg Board, "Emulsification", REAL Egg Functionality, https://www.incredibleegg.org/professionals/manufacturers/real-egg-functionality/emulsification/ , page copyright 2023 <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** Supports: the *Food Technology* definition of an emulsion; lecithin's two ends and lowered interfacial tension; the coating as a barrier; the viscous continuous phase; oil added slowly so the droplets can be coated.
15. Marc Anton, "Recent advances concerning the functional properties of egg yolk low-density lipoproteins", INRA Nantes, World's Poultry Science Association conference paper, https://www.cabi.org/Uploads/animal-science/worlds-poultry-science-association/WPSA-italy-2006/10903.pdf <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** Supports: yolk's emulsifying properties "principally attributed to its LDL"; the film of proteins and phospholipids and its "resistance to the rupture"; "still used empirically"; flocculation and creaming as reversible and coalescence as the irreversible fusion that destroys an emulsion.
16. Lan Lam, "Make-Ahead Homemade Mayonnaise", America's Test Kitchen, 5 January 2020, https://www.americastestkitchen.com/recipes/12375 <!-- Gate closures, lesson 5 -->. **Read level: full, directly, the public part of the page.** Supports: the ingredients and quantities; heating the yolk base to 160 to 165°F in 1 to 2 minutes; the base kept fluid by water and lemon; oil cooling the base and breaking into droplets; the slow drizzle over about 2 minutes; one month in the fridge, which is ATK's claim for its recipe.
17. America's Test Kitchen, "How to Fix Failed Mayo", https://www.americastestkitchen.com/how_tos/13363-how-to-fix-broken-mayo <!-- Gate closures, lesson 5 -->. **Read level: full, directly.** Supports: 4 teaspoons of water, about ½ cup of the broken mixture drizzled in very slowly, then the rest, and the slightly looser result.
18. Advisory Committee on the Microbiological Safety of Food, Ad Hoc Group on Eggs, "An update on the microbiological risk from shell eggs and their products", July 2016, read through the Internet Archive's capture of 20 December 2016, https://web.archive.org/web/20161220073347/https://www.food.gov.uk/sites/default/files/acmsf-egg-reportv1.pdf <!-- Stage 4 note, lesson 5 -->. **Read level: the overall risk assessment and key recommendation (pages 8 and 9) and paragraph 5.47 on egg washing, searched in the full text; the rest of the report was not read.** Supports: "VERY LOW" risk for Lion eggs "or under demonstrably-equivalent comprehensive schemes" and "LOW" for other shell eggs; such eggs "can be served raw or lightly cooked to all groups in society, including those that are more vulnerable"; washing Class A table eggs "is not permitted in the UK".

The two embedded videos, Jacques Pépin's "How To Properly Poach An Egg" (KQED Food) and "Learn Jacques Pépin's famous omelet techniques" (American Masters, PBS), were checked for title, channel, length and description only <!-- SOURCES A4; Gate closures, lesson 5 -->. Nothing in the lesson is attributed to what they show.
