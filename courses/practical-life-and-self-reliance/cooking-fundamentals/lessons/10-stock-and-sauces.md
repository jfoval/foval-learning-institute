...
objectives:
  - >-
    ...
    boil comes out clearer than one boiled hard
  - >-
    Cool a large pot of stock, soup or stew under US and UK guidance, and explain what Clostridium
    perfringens does in a pot left to cool slowly
  - >-
    Thicken a sauce with a roux or a starch slurry, choose a proportion from a recipe you trust, and
    explain the thickening as starch granules swelling in hot liquid
  - >-
    Build a vinaigrette from a 3:1 ratio, adjust it by taste, and say what mustard or mayonnaise does
    to it
quiz:
  - q: >-
      It's 2 pm and you've just made about 5 litres of split pea and ham soup. You're going out for
      the afternoon. Which step do both the US and the UK guidance read in this lesson agree on?
    options:
      - Put the whole covered pot straight in the fridge, as it's safest to chill it hot
      - Leave the lid on and the pot on the hob until evening, since the lid keeps germs out
      - Stand the pot in a sink of cold water, lid on, and leave it there until you're home
      - Split it into shallow containers so it cools fast, and have it chilled within 2 hours
    answer: 3
    explain: >-
      FSIS says a large pot of soup or stew "should be divided into small portions and put in
      shallow containers before being refrigerated", and the FSA says to cool leftovers within 2
      hours, separating them into smaller portions to cool faster. Straight into the fridge is what
      FSIS allows for hot food in general, not what the FSA says, and a covered deep pot cools
      slowly wherever it sits. A lid on the hob all afternoon is the slow cooling Clostridium
      perfringens needs. A cold-water bath helps, but a covered pot left for hours in water that has
      warmed up is still a deep, covered mass cooling slowly.
  - q: >-
      A café's cooling log for a tray of chilli reads 135°F at noon, 72°F at 3 pm and 40°F at 5 pm.
      Judged against the FDA Food Code's cooling rule, what's the verdict?
    options:
      - It passes, because it reached 41°F or below inside the six hours the code allows
      - It passes, because the second stage took only two hours, well inside the four left
      - It fails, because it took three hours to get near 70°F, and the first stage allows two
      - It fails, because food must reach 41°F or below within two hours of leaving the heat
    answer: 2
    explain: >-
      The code has two limits, and the first is the one that matters most: 135°F to 70°F within two
      hours, then down to 41°F within six in total. The FDA's own notes give almost this case, a food
      that makes the six hours but takes three to reach 70°F, as one where the hazards "may not be
      adequately controlled". Passing the total
      doesn't rescue a slow first stage, because the first stage is where the food sits in the
      range where germs grow fastest. No stage requires 41°F in two hours.
  - q: >-
      A friend boiled a pot of beef stock hard for four hours. It's cloudy and a little greasy, and
      she wants to throw it out because "cloudy means it's gone off". What does this lesson say?
    options:
      - Cloudiness comes from boiling fat and proteins into it; safety is set by time and cooling
      - Cloudiness is from bacteria growing in it during the boil, so she's right to throw it out
      - Cloudiness shows the gelatin has broken down, so it's safe but won't set in the fridge
      - Cloudiness means the scum wasn't skimmed, and the scum is what makes a stock unsafe
    answer: 0
    explain: >-
      ATK's explanation is that boiling emulsifies soluble proteins and rendered fat into the liquid,
      and that a simmer keeps the stock clearer. That's about how it was cooked. Nothing grows at a
      boil, and whether a stock is safe to keep is decided by how fast it was cooled and how long
      it's been in the fridge (lesson 4), which you can't see or smell. No source here links
      cloudiness to gelatin or to skimming as a safety step.
  - q: >-
      You thicken a pot of stew with a cornstarch slurry and it's lovely. You then leave it simmering
      for another hour and a half while guests are late, and it goes thin. Which explanation fits
      what ATK found?
    options:
      - Starch only thickens at room temperature, so the stew will thicken again as it cools down
      - Cornstarch loses its thickening power with long heating, which a flour roux does far less
      - The slurry was mixed with cold water, which ATK says makes cornstarch go thin in the end
      - Cornstarch needs more heat than a simmer, so a full boil will bring the thickness back
    answer: 1
    explain: >-
      ATK says cornstarch-thickened sauces "break down more quickly than flour-thickened ones", and
      that cornstarch "loses its thickening ability with prolonged exposure to heat". So add it near
      the end, or use flour for something that will sit on the heat. Starch thickens in hot liquid,
      which is the whole mechanism, and a cold slurry is ATK's instruction, not the fault. Boiling it
      harder is more of what thinned it.
  - q: >-
      You've squeezed 50 ml of lime juice for a dressing. Using the 3:1 ratio and ATK's method, what
      do you do next?
    options:
      - Whisk in about 17 ml of oil all at once, so the dressing stays sharp and bright
      - Pour in 200 ml of oil, since 3:1 means three parts oil in every four in the jar
      - Whisk in about 150 ml of oil in a slow stream, then taste it and adjust to suit
      - Shake in 150 ml of oil, then leave it an hour so that the oil and juice can settle
    answer: 2
    explain: >-
      Three parts oil to one of acid: 50 ml of juice takes about 150 ml of oil. ATK drizzles the oil
      in slowly while whisking, and the ratio is a starting point you taste and adjust. 17 ml turns
      the ratio upside down. 200 ml is four times the juice, which would be 4:1. And a vinaigrette
      left to settle separates; ATK says an ordinary one "never stays emulsified for long".
  - q: >-
      You make a pot of chicken stock from wings and a pot of konbu dashi on the same day, and chill
      both. Next morning the chicken stock wobbles like jelly and the dashi pours like water. Why?
    options:
      - The chicken stock has gelatin from the collagen in the wings; konbu yields almost none
      - The dashi was taken off the heat too soon, so its gelatin hasn't had time to dissolve
      - The dashi has more glutamate, and glutamate stops a stock from setting when it's cold
      - Seaweed stocks set only if they're boiled hard, and a dashi is kept below the boil
    answer: 0
    explain: >-
      A chicken stock's body is gelatin, from collagen in skin, bones and connective tissue, and
      gelatin sets when cold. Konbu is a seaweed, with no skin or bone to give gelatin; Mouritsen and colleagues describe konbu dashi as
      having "a fluidity similar to that of pure water". Dashi's strength is its glutamate, which is
      taste, not body, and nothing read here says glutamate stops a gel. And boiling konbu makes
      dashi bitter; it doesn't make it set.
---
...
1. Break up the carcass and put it in a pot with any wings, necks or trimmings you've saved (raw or roasted; lesson 4's raw chicken routine applies to raw ones). Weigh it if you can. At ATK's proportion a kilogram of bones takes about 1.8 litres of water; at Ruhlman's, about 1.4. In practice, add cold water just to cover.
2. Bring it up slowly and skim off the grey foam as it rises, as ATK does.[1] Then turn it down until the surface barely moves. Check the liquid with your thermometer: you want lesson 8's simmer or a little below, about 82 to 88°C.
3. Leave it. ATK simmers its broth for 3 hours, then adds an onion and bay leaves for 2 hours more.[1] Ruhlman adds his vegetables for the last part too.[4] Do not salt it much, or at all. You'll reduce it later for sauces, and lesson 6's point about low-salt stock applies: reduction concentrates salt.
4. Strain it through a sieve into a clean pot. Let it settle a few minutes and skim the fat off the top, as ATK does.[1]
5. Now cool it, which is the next section, and the one part of this that is a safety step.

:::predict You strain 3 litres of hot stock into one tall pot, put the lid on so nothing falls in, and leave it on the counter to cool before it goes in the fridge. Before reading on: which part of the pot is the problem, and what would you change?
...
The FDA's [Bad Bug Book](https://www.fda.gov/media/83271/download), its handbook on foodborne germs, gives the story in three steps.[6]
...
Now the rule makes sense. The [FDA Food Code](https://www.fda.gov/food/fda-food-code/food-code-2026), the model code US states adopt for restaurants and shops, says cooked food must be cooled from 57°C (135°F) to 21°C (70°F) within two hours, and to 5°C (41°F) or below within six hours in total.[7] Why two limits instead of one?
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 370" width="100%" style="max-width:440px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="cool-title cool-desc">
  <title id="cool-title">The FDA Food Code's two-stage cooling rule, with its two worked examples</title>
  <desc id="cool-desc">Temperature in degrees Fahrenheit from 30 to 140 against hours after cooking from 0 to 6. A pale band from 70 to 125 degrees marks the range the FDA calls ideal for bacterial growth, and a darker strip at 109 to 113 degrees marks where the FDA says C. perfringens reaches harmful levels fastest. Two gold squares mark the limits: 70 degrees by 2 hours and 41 degrees by 6 hours. Two example foods start at 135 degrees. One reaches 70 degrees at 1 hour, passing, and is drawn reaching 41 degrees at the 6-hour limit. The other reaches 70 degrees at 3 hours and 41 degrees at 6 hours, failing the first limit. The FDA gives only these points; the lines between them are drawn straight for reading.</desc>
  <line x1="20" y1="24" x2="46" y2="24" stroke="var(--line-strong, #0f2a4a)" stroke-width="3"/>
  <text x="54" y="29" font-size="15" fill="var(--text, #111418)">Passes: 70°F at 1 hour</text>
  <line x1="20" y1="48" x2="46" y2="48" stroke="var(--oxblood, #8b1e2d)" stroke-width="3" stroke-dasharray="6 4"/>
  <text x="54" y="53" font-size="15" fill="var(--text, #111418)">Fails: 70°F at 3 hours</text>
  <rect x="70" y="110" width="340" height="110" fill="var(--gold, #b08d2a)" fill-opacity="0.15"/>
  <rect x="70" y="134" width="340" height="8" fill="var(--oxblood, #8b1e2d)" fill-opacity="0.35"/>
  <text x="405" y="129" font-size="15" text-anchor="end" fill="var(--text, #111418)">C. perfringens: 109 to 113°F</text>
  <text x="405" y="182" font-size="15" text-anchor="end" fill="var(--text, #111418)">Ideal growth range,</text>
  <text x="405" y="200" font-size="15" text-anchor="end" fill="var(--text, #111418)">70 to 125°F</text>
  <line x1="70" y1="300" x2="410" y2="300" stroke="var(--line-strong, #0f2a4a)" stroke-width="1.5"/>
  <line x1="70" y1="80" x2="70" y2="300" stroke="var(--line-strong, #0f2a4a)" stroke-width="1.5"/>
  <text x="64" y="95" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">135</text>
  <text x="64" y="225" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">70</text>
  <text x="64" y="283" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">41</text>
  <text x="64" y="76" font-size="15" text-anchor="end" fill="var(--text-2, #4a5260)">°F</text>
  <text x="70" y="320" font-size="15" text-anchor="middle" fill="var(--text-2, #4a5260)">0</text>
  <text x="183" y="320" font-size="15" text-anchor="middle" fill="var(--text-2, #4a5260)">2</text>
  <text x="297" y="320" font-size="15" text-anchor="middle" fill="var(--text-2, #4a5260)">4</text>
  <text x="410" y="320" font-size="15" text-anchor="middle" fill="var(--text-2, #4a5260)">6</text>
  <text x="240" y="345" font-size="15" text-anchor="middle" fill="var(--text, #111418)">Hours after cooking</text>
  <polyline points="70,90 127,220 410,278" fill="none" stroke="var(--line-strong, #0f2a4a)" stroke-width="3"/>
  <polyline points="70,90 240,220 410,278" fill="none" stroke="var(--oxblood, #8b1e2d)" stroke-width="3" stroke-dasharray="6 4"/>
  <rect x="177" y="214" width="12" height="12" fill="var(--gold, #b08d2a)"/>
  <rect x="404" y="272" width="12" height="12" fill="var(--gold, #b08d2a)"/>
  <text x="183" y="258" font-size="15" text-anchor="middle" fill="var(--text, #111418)">70°F by 2 h</text>
  <text x="400" y="293" font-size="15" text-anchor="end" fill="var(--text, #111418)">41°F by 6 h</text>
</svg>
...
:::checkpoint Your thermometer log for one container reads 88°C when it goes into the ice bath, 35°C after 40 minutes and 12°C after 90 minutes. Measured against the Food Code's two stages, how did you do, and what would you change next time?
...
Then the week. In the US, FSIS gives leftovers 3 to 4 days in the fridge; the FSA says eat them within 48 hours or freeze them.[10][13] So a stew made on Sunday reaches Wednesday or Thursday in the US and Tuesday in the UK. Freeze the portions you won't reach in time, on the day you make it; lesson 12 plans a week around that. When you reheat, FSIS says to bring "sauces, soups and gravies" to "a rolling boil"; the FSA says steaming hot, and "only ever reheat once", which is another reason to freeze in single-meal portions.[10][13]

:::predict Your neighbour says she's made stew this way for thirty years: pot on the hob, lid on, overnight, then fridge in the morning, and nobody's ever been ill. What would you say, using this lesson?

That her pot spends most of the night in the warm band, lid on, deep, which is the exact setting the Food Code's two stages exist to prevent, and far past both countries' limits: in the fridge within 2 hours in the US, and cooled and in the fridge within 2 hours in the UK.[10][12] Thirty years without illness is real, and this course's reading is that it's also what you'd expect even from a risky habit: illness needs a very large number of cells, and whether a given pot gets there depends on things she can't see, like how many spores were in the meat to begin with. A habit that usually works isn't the same as a safe one, and the harm, when it comes, lands on whoever eats it. The fix costs her ten minutes: two shallow tins.
:::
...
*From Ruhlman's gravy, croque madame and moussaka recipes.[15][16][17] A US tablespoon is about 15 ml and a cup about 240 ml. These are one cook's recipe quantities, not tested ratios, and flour measured by the spoon varies.*
...
Cornstarch has one weakness, and it is the reason to know both methods. ATK: "cornstarch-thickened sauces break down more quickly than flour-thickened ones", and "Cornstarch loses its thickening ability with prolonged exposure to heat."[19][20] So a slurry suits a sauce made at the end, like a stir-fry's, and a roux suits a gravy or a stew that will sit on the heat. ATK also found that cornstarch needs to simmer "for a couple of minutes to achieve maximum thickness", so give a slurry that long before you judge it.[21]

:::checkpoint You're making a gravy from a cup and a half of roasting juices and stock, and you want it to pour thickly. You have flour and butter, or cornstarch. Using the table and ATK's advice, what would you use, how much, and how would you add it?
...
A vinaigrette is oil and an acid, and it is lesson 5's emulsion in a weaker form. The starting ratio is Ruhlman's: "Vinaigrette is 3:1, or 3 parts oil to 1 part vinegar".[23] (His book's ratios are by weight; ATK's recipes use 3 to 1 by volume, which comes out a little less oily than his, since oil is lighter than vinegar.) ATK's [foolproof version](https://www.americastestkitchen.com/recipes/4887-foolproof-vinaigrette) uses 1 tablespoon of wine vinegar to 3 tablespoons of olive oil, and its make-ahead version a quarter-cup of vinegar to three-quarters of a cup of oil.[24][25]

:::video https://www.youtube.com/watch?v=-BJfsqzmeYg | How to Make Vinaigrette Salad Dressing: Jacques Pépin Techniques (KQED Food)
About two and a half minutes from Pépin's KQED technique series. This course has checked the title, channel and length, not watched it for you, so watch for how he builds it in the bowl and take the ratio from this lesson.
:::
...
**"Leave the pot on the stove to cool overnight."** That is the slow cooling C. perfringens needs, and it's far past both countries' limits.[6][10][12] Divide it into shallow containers.
...
**"Cornstarch and flour are interchangeable, spoon for spoon."** Cornstarch is stronger and thins with long heating; flour is weaker and holds up.[19][20]
...
:::exercise A stock, a cooling log, a sauce and a dressing
...
1. Make a stock. Chicken: cover the bones with cold water, bring it up, skim, and hold it at a simmer or just under for 3 to 4 hours, adding the onion for the last hour. Meat-free: soak the konbu and shiitake in 2 litres of cold water for half an hour, heat it until it steams and just before it simmers, and lift out the konbu. Taste both a little way through, and write down what you notice.

2. Cool it with a log. Strain it into shallow containers no more than 5 cm deep. Stand them in iced water. Write down the temperature in the middle of one when it goes in, then every 20 minutes, until it is below 21°C (70°F). Then fridge it under your country's rule. The next morning, write down whether the chicken stock set, and how firmly.

3. Thicken a cup of it two ways. Take two portions of 240 ml each. Thicken one with a roux of 1½ tablespoons of flour cooked in a little less butter than flour (Ruhlman's 3:2 by weight, or by eye), and the other with 1 tablespoon of cornstarch slurried in 2 tablespoons of cold water. Bring both to a simmer, note the look and the texture, then leave both on a low simmer for 30 minutes and note them again.

4. Make a vinaigrette at 3:1. Measure 2 tablespoons of vinegar or lemon juice, whisk in ½ teaspoon of mustard, then 6 tablespoons of oil in a slow stream. Taste it on a leaf. Adjust it until you like it, measuring what you add, and write down the ratio you end at. Leave a spoonful without mustard in a glass beside one with it, and look at both after an hour.
:::

:::checkpoint Look at your notes. What did the cooling log, the two thickened stocks after 30 minutes, and the two glasses of dressing each show, and which part of this lesson predicts it?
...
- **FDA, [*Food Code 2026*](https://www.fda.gov/food/fda-food-code/food-code-2026), Annex 3 notes on § 3-501.14 and § 3-501.15.** The code itself is for restaurants, but its public-health notes on cooling are a few pages of plain explanation of why the two stages exist and why depth and lids matter. This course read those sections, not the whole code.
...
- **Ole G. Mouritsen and colleagues, ["Seaweeds for umami flavour in the New Nordic Cuisine"](https://flavourjournal.biomedcentral.com/articles/10.1186/2044-7248-1-4), *Flavour*, 2012.** Read in full for this course, and free to read. A readable account of dashi, umami synergy and konbu, by scientists who then tried to make dashi from Nordic seaweeds.
- **Michael Ruhlman, ["Holiday Classic: Gravy & Cranberry Sauce"](https://ruhlman.com/gravy-cranberry/), 2015.** Read in full for this course. A short, opinionated case for flour-thickened sauces, with the roux explained in a paragraph. His book *Ratio* is the natural next step for cooking from proportions; this course has read only its catalogue contents and the publisher's description.

## Sources

1. America's Test Kitchen, "Classic Chicken Broth", recipe, https://www.americastestkitchen.com/recipes/9481-classic-chicken-broth <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: 4 lb of backs and wings to 3½ quarts of water, skimming, 3 hours then 2 more with the onion, skimming the fat, and the quoted sentence on gelatin and body. The water-to-bones ratio is this course's arithmetic, as the body says.
2. America's Test Kitchen, "Body Builder for Pan Sauces", Cook's Illustrated how-to, https://www.americastestkitchen.com/cooksillustrated/how_tos/9823-body-builder-for-pan-sauces <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: collagen in broth breaking down to gelatin, and adding gelatin to sauces made from bought broth.
3. America's Test Kitchen, "For a Clearer Stock, Simmer; Don't Boil", no author or date, https://www.americastestkitchen.com/how_tos/9260-for-a-clearer-stock-simmer-dont-boil <!-- SOURCES C8e; Gate closures, lesson 8 -->. **Read level: full, directly, in the recheck recorded for lesson 8.** Supports: the quoted sentence on boiling, emulsifying and clarity, and that the page's test was on pot-au-feu. That the page says nothing about safety or taste is this course's reading of it.
4. Michael Ruhlman, "Easy Turkey Stock", ruhlman.com, 18 November 2020, and "Turkey Stock", 22 November 2013 <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: 2 to 3 kg of turkey pieces covered with 3 to 4 litres of water, the oven at 180 to 200°F (80 to 90°C), "hot but not simmering", vegetables added later, and keeping the fat for a roux. The book's 3:2 stock ratio was not found on any page read, as the body says.
5. Ole G. Mouritsen, Lars Williams, Rasmus Bjerregaard and Lars Duelund, "Seaweeds for umami flavour in the New Nordic Cuisine", *Flavour* 1, article 4, 2012, doi 10.1186/2044-7248-1-4, CC BY 2.0, read through the Internet Archive's August 2025 capture <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: every statement about dashi, konbu, katsuobushi, the classic method, bitterness, 60°C, synergy and Kuninaka, the temple kitchen's shiitake, the Western pairings, and konbu dashi's thinness. The description of katsuobushi as dried, smoked, fermented skipjack is not from this paper; the paper calls it "a particular, highly processed fish product" and elsewhere "fermented", and the rest is this course's gloss.
6. US FDA, *Bad Bug Book*, 2nd edition, 2012, chapter "Clostridium perfringens", https://www.fda.gov/media/83271/download <!-- SOURCES B5.3; Gate closures, lesson 10 -->. **Read level: full chapter, directly.** Supports: temperature abuse as the usual cause, spores surviving boiling with the source's qualifier, the doubling time with its qualifier <!-- Stage 4 note, lesson 10 -->, 109 to 113°F, more than a million cells or spores per gram, onset about 16 hours, 12 to 24 hours, institutions, and the foods. The doubling arithmetic is this course's, as the body says.
7. US FDA, *Food Code 2026*, released 17 September 2026, § 3-501.14, § 3-501.15 and their Annex 3 notes, https://www.fda.gov/media/194741/download <!-- SOURCES B2.4, B2.5; Gate closures, lesson 10 -->. **Read level: the PDF, those sections read in full.** Supports: the two stages, "ideal bacterial incubation temperatures" of 21 to 52°C (70 to 125°F), the critical first stage and its two examples, spore-formers surviving cooking, reducing volume, the ice water bath method, loose covers and tight lids, and commercial refrigeration. That a home fridge behaves the same way is this course's reading, as the body says.
8. N. Koreen, W. C. Baldwin and D. W. Schaffner, "Cooling Uncovered Foods at a Depth of ∼5.1 cm (2 in.) or Less Poses Little Risk of Pathogen Growth", *Journal of Food Protection* 87(10), 2024, 100356, PMID 39241915 <!-- Gate closures, lesson 10; Stage 4 note, lesson 10 -->. **Read level: abstract, directly.** Supports: the authors' affiliations, 224 recipes logged by Minneapolis inspectors in 2018 and 2019, depth and ice as significant, covered or warm-held foods cooling slowly, modelled rather than measured growth, and the quoted conclusion.
9. USDA FSIS, "Refrigeration and Food Safety", last updated 23 March 2015, read through the Internet Archive's 23 September 2026 capture <!-- Gate closures, lesson 4 -->. **Read level: full.** Supports: hot food directly into the fridge or an ice bath first, and dividing a large pot of soup or stew into shallow containers.
10. USDA FSIS, "Leftovers and Food Safety", last updated 31 July 2020, read through the Internet Archive <!-- SOURCES B1.4 -->. **Read level: full.** Supports: the 2-hour rule, 3 to 4 days, and reheating sauces, soups and gravies to a rolling boil.
11. FSA, "How to chill, freeze and defrost food safely", GOV.UK, published 18 December 2017 <!-- SOURCES B3.2 -->. **Read level: full.** Supports: not putting hot food in the fridge, and refrigerating within one to two hours.
12. FSA, "Clostridium perfringens", GOV.UK, published 25 June 2026, https://www.gov.uk/government/publications/clostridium-perfringens/clostridium-perfringens <!-- SOURCES B3.6; Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: batch cooking at home, cooling within 2 hours in smaller portions, and 4 hours as the most food should be left out.
13. FSA, "Cooking your food", GOV.UK, published 18 December 2017 <!-- SOURCES B3.1 -->. **Read level: full.** Supports: leftovers within 48 hours or freeze them, and "only ever reheat once".
14. City & Guilds, Level 2 Diploma in Professional Cookery (7100-12), qualification handbook v1.6, February 2023, unit 707 <!-- SOURCES A3.6 -->. **Read level: the handbook, directly.** Supports: "ice water bath" among the chilling methods and "chill to below 5°C within 90 minutes", as a professional training standard.
15. Michael Ruhlman, "Holiday Classic: Gravy & Cranberry Sauce", ruhlman.com, 25 November 2015, https://ruhlman.com/gravy-cranberry/ <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: the roux ideal of 3 parts flour to 2 of fat, coating the granules, cooking out the raw taste, browning reducing thickening power, the gravy quantities, and "Gravy is nothing more than flour-thickened stock."
16. Michael Ruhlman, "Le Creuset Technique: Béchamel Sauce & the Croque Madame", ruhlman.com, 27 August 2013 <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: 2 oz butter, 3 tablespoons flour, 2 cups milk, and 15 to 45 minutes on a low heat.
17. Michael Ruhlman, "Moussaka", ruhlman.com, 6 May 2022 <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: ¾ cup flour and a stick of butter to a quart of milk, with cheese and yolks.
18. Michael Ruhlman, "Egg Foo Young", ruhlman.com, 19 March 2021 <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: the sauce's origin as stock, soy and cornstarch, the slurry, the quantities and the minute or two of cooking. The tablespoon-per-cup figure is this course's arithmetic.
19. America's Test Kitchen, "Getting to Know: Thickeners", no author or date, https://www.americastestkitchen.com/how_tos/9126-getting-to-know-thickeners <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: cornstarch as pure starch and flour as 75 percent, cornstarch breaking down faster, the cold slurry, beurre manié, and butter losing its body at around 160 degrees. The page gives no unit; reading it as Fahrenheit is this course's, as the body says <!-- Stage 4 note, lesson 10 -->.
20. America's Test Kitchen, "Thickeners", no author or date, https://www.americastestkitchen.com/how_tos/6187-thickeners <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: cooking the roux, browning losing thickening power, adding liquid gradually, cornstarch losing thickening with prolonged heat, and gelatin as the basis of Jell-O. That a stock sets for the same reason is this course's reading, as the body says.
21. America's Test Kitchen, "Can Potato Starch be Substituted for Cornstarch to Thicken Sauces?", no author or date <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: granules swelling and restricting flow, and cornstarch needing a couple of minutes' simmer. That cornstarch sets clear is not from this page; see the note below.
22. W. S. Ratnayake and D. S. Jackson, "Starch gelatinization", *Advances in Food and Nutrition Research* 55, 2009, 221-268, PMID 18772106 <!-- Gate closures, lesson 10 -->. **Read level: abstract, directly.** Supports: granules breaking down into polymers in solution, and no theory fully explaining the sequence.
23. Michael Ruhlman, *Ratio: The Simple Codes Behind the Craft of Everyday Cooking* (Scribner, 2009), the publisher's description on Goodreads <!-- SOURCES A1.4; Gate closures, lesson 10 -->. **Read level: catalogue contents and publisher's description only.** Supports: the 3:1 vinaigrette.
24. America's Test Kitchen, "Foolproof Vinaigrette", recipe, https://www.americastestkitchen.com/recipes/4887-foolproof-vinaigrette <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: 1 tablespoon vinegar to 3 of oil, half a teaspoon each of mayonnaise and mustard, mayonnaise as an emulsifier, and the slow drizzle.
25. America's Test Kitchen, "Keep Vinaigrette Emulsified With. . . Molasses?", and the "Make-Ahead Vinaigrette" recipe <!-- Gate closures, lesson 10 -->. **Read level: full, directly.** Supports: a vinaigrette never staying emulsified for long, mustard and mayonnaise as emulsifiers, molasses and viscosity, and the quarter-cup to three-quarters proportion.
