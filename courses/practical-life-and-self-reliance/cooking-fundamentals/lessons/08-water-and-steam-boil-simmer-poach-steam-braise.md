...
objectives:
  - >-
    ...
    steaming for a food, telling a simmer from a boil by sight and by thermometer
  - >-
    Explain why a tough cut needs long, moist heat rather than more heat, and build a braise
  - >-
    State how much of the alcohol added to a dish remains after a given method and time, from the
    USDA table, and work it out for a recipe
  - >-
    Evaluate "salt makes water boil faster", "start with hot water from the tap" and "put it in the
    slow cooker frozen", with the size of each effect or the rule that answers it
quiz:
  - q: >-
      At a dinner party the host pours brandy into a pan of peppercorn sauce, sets it alight, lets
      the flames die, and serves straight away. "Don't worry," he says, "the flames burn the alcohol
      off." What does the USDA's table say?
    options:
      - Flaming removes nearly all of it, since the flame burns until no alcohol is left in the pan
      - About half remains, the same as for alcohol simmered in a sauce for fifteen minutes or so
      - Flaming leaves less than simmering the sauce for two hours would, because it's much hotter
      - About three quarters of the alcohol he poured in is still there, by the table's figure for it
    answer: 3
    explain: >-
      The USDA's table gives 75% retained for alcohol that was flamed. The flame goes out while most
      of the alcohol is still in the sauce. Simmering for 15 minutes leaves 40%, less than flaming,
      and two hours of simmering leaves 10%, far less. The flame is hot, but it lasts seconds, and
      in this table time is what takes the alcohol away.
  - q: >-
      Your flatmate tips two big spoonfuls of salt into a pot of cold water "so it boils sooner and
      cooks the potatoes hotter". Roughly what does the salt do to the water's boiling point?
    options:
      - It raises it by a fraction of a degree, so the pot boils fractionally later and no hotter to taste
      - It lowers it by a degree or two, so the water comes to the boil sooner but cooks a little cooler
      - It raises it by about five degrees, so the potatoes cook noticeably faster once the pot boils
      - It has no effect of any kind on the boiling point, since salt changes only how the water tastes
    answer: 0
    explain: >-
      Dissolved salt raises the boiling point, it doesn't lower it, and at cooking strength the rise
      is tiny: under a fifth of a degree Celsius at 1% salt by weight and about a third of a degree
      at 2%. So the water has slightly further to go and boils slightly later, at a temperature no
      one could taste the difference of. "No effect of any kind" is wrong in the other direction:
      there is an effect, it's just too small to matter.
  - q: >-
      You've braised a pork shoulder in stock, covered, at a gentle simmer for 45 minutes. It's
      cooked through but still tough and springy. What does this lesson suggest?
    options:
      - It's overcooked, so take it out now, slice it thinly across the grain and serve it as it is
      - Turn the heat up to a hard boil for twenty minutes so the connective tissue breaks down faster
      - Keep it covered at the same gentle heat for longer, and test it with a fork every half hour
      - Uncover it and let the liquid boil away, because the meat can only soften once the pot is dry
    answer: 2
    explain: >-
      A tough cut is tough because of its connective tissue, and the research this lesson read shows
      that tissue giving way slowly over hours at a steady temperature. Time is what it needs.
      Forty-five minutes is simply too early. A hard boil adds agitation and dries the outside,
      and no source read here says it saves enough time to be worth that. Boiling the pot dry takes
      away the water that keeps the meat at a steady, gentle temperature.
  - q: >-
      You set a slow cooker going with a chicken stew on low before work. When you get home the
      clock on the oven is blinking: the power was off for some of the day. The stew looks cooked.
      What does FSIS say?
    options:
      - Throw it away, even if it looks done, because you weren't home for the whole cooking time
      - Bring it to a rolling boil on the hob, since that will make it safe to eat whatever happened
      - Eat it if it's still warm to the touch, since that shows the power wasn't off for very long
      - Keep it if it's been less than two hours since it finished cooking, then chill the leftovers
    answer: 0
    explain: >-
      FSIS: if you aren't at home during the whole slow-cooking process and the power goes out,
      "throw away the food even if it looks done." You can't know how long it sat at a warm,
      growing temperature, and warmth to the touch doesn't tell you. The two-hour allowance is for
      food that was completely cooked before the power went out while you were at home. Reboiling
      isn't in FSIS's answer for this case.
  - q: >-
      You want green beans for a salad that are cooked just past raw, bright green and still crisp.
      Which method fits best, and why?
    options:
      - A long, gentle simmer, because low heat is what keeps the colour of green vegetables bright
      - Drop them into a pot of fully boiling water for a short time, then lift them out to cool
      - A covered braise in a little stock, because the lid holds in steam and keeps the beans crisp
      - Start them in cold water and bring it slowly up to the boil, so they heat evenly all through
    answer: 1
    explain: >-
      This is what ATK calls blanching: flash-cooking vegetables in boiling water so they "lose their
      raw edge while retaining their flavor and bright color." Boiling water hands heat over fast, so
      the outside cooks in moments and you stop before the centre softens. A long simmer or a braise
      gives the beans time, which softens them, and starting from cold gives the same slow heating
      from the other end.
  - q: >-
      A relative who lives at 2,000 metres says her electric pressure cooker is "the only way I can
      get beans soft up here". Which is the best explanation, from this lesson?
    options:
      - Pressure cookers heat food with steam, and steam cooks food far faster than water in any pot
      - The sealed pot keeps the steam from escaping, so the beans absorb far more water than usual
      - At altitude open water boils below 100°C, and a sealed pot raises the boiling point again
      - Altitude has no effect on an open pot; the pressure cooker simply puts in more heat per minute
    answer: 2
    explain: >-
      FSIS says water boils lower as you go up, so food boiled or simmered there cooks at a lower
      temperature and takes longer. A sealed pot lets pressure build, and as USU Extension puts it,
      "Steam temperature rises as the pressure is increased." Steam in an ordinary steamer is at the
      boiling point too, so steam alone isn't the answer. More heat under an open pot only makes it
      boil harder, not hotter, which is lesson 2's ceiling.
---
...
:::checkpoint A friend poaches chicken breasts at a fast boil because "it's quicker, and it gets to 165 anyway". Using this section, what does she lose, and what doesn't she gain?
...
:::predict A recipe for braised beef cheeks says "2½ hours". You're short of time, so you turn the pot up from a gentle simmer to a hard boil, hoping to finish in an hour and a half. Before reading on: what do you expect at the ninety-minute mark?
...
:::checkpoint Lesson 6 said its pan sauce could be deglazed with wine. Say you do that and reduce it for a few minutes. Using the table, roughly how much of that wine's alcohol is left, and why can't the table give you an exact figure?
...
A slow cooker is a braise on a timer, and [FSIS's page on them](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/slow-cookers-and-food-safety) is clear about how it works and where it can go wrong. It cooks at a low temperature, "generally between 170° and 280° F", about 77 to 138°C, and "The direct heat from the pot, lengthy cooking and steam created within the tightly-covered container combine to destroy bacteria and make the slow cooker a safe process for cooking foods."[7] Its rules follow from the one weakness in that design: the pot heats slowly.
...
It does the opposite, by an amount too small to notice. Salt dissolved in water raises its boiling point, and chemists calculate the rise from three numbers: a constant for the solvent, which for water is 0.513°C per mole of dissolved particles in each kilogram of water, from LibreTexts' reference table; the amount of salt; and the number of particles each unit of salt splits into, which for sodium chloride is two.[11][12]
...
**"Salt makes water boil faster."** It raises the boiling point by a fraction of a degree, so it boils a moment later.[11][12]

**"Start with hot tap water."** It's quicker, and the EPA says not to, because of lead.[13]

**"A hard boil is the way to hurry a braise."** It adds 12 to 18°C at most and a lot of agitation, and dries the outside. The research read here shows time doing most of the work at a steady temperature, and gives no figure for how much a boil would save.[6][19]
...
:::exercise A braise, a simmer, and a sum
...
:::checkpoint Look at your texture log. Suppose a friend braised the same cut in pieces twice the size of yours, at the same simmer. What would you expect in her log, and which parts of this lesson and lesson 2 predict it?
...
- **America's Test Kitchen, ["Cooking Class: Boil versus Simmer"](https://www.americastestkitchen.com/cooksillustrated/how_tos/10660-cooking-class-boil-versus-simmer).** Short enough to read in two minutes, with the two definitions and ATK's reasons for choosing each.
- **USDA, [*Table of Nutrient Retention Factors*, Release 6](https://www.ars.usda.gov/ARSUserFiles/80400530/pdf/retn06.pdf) (2007).** The whole table was read for this course. The alcohol rows are in food group 14; the rest of the table does the same job for vitamins and minerals, if you want to see how the US government estimates what cooking removes.
- **USDA FSIS, ["Slow Cookers and Food Safety"](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/slow-cookers-and-food-safety).** Read in full. One page, every rule above, with the reasons FSIS gives.
- **Utah State University Extension, ["Why Electric Pressure Cookers Are Not Pressure Canners"](https://extension.usu.edu/preserve-the-harvest/research/why-electric-pressure-cookers-are-not-pressure-canners).** Read in full. What the pressure numbers mean, and why cooking and canning ask different things of them.

## Sources

1. America's Test Kitchen, "Cooking Class: Boil versus Simmer", Cook's Illustrated how-to, no author or date, https://www.americastestkitchen.com/cooksillustrated/how_tos/10660-cooking-class-boil-versus-simmer <!-- Gate closures, lesson 8 -->. **Read level: full, directly.** Supports: the boil and simmer definitions with their temperatures and bubbles, when ATK boils (blanching, grains, pasta), and its three reasons for simmering. The Celsius conversions and the poaching description are this course's, as the body says.
2. Engineering ToolBox, "Convective Heat Transfer", https://www.engineeringtoolbox.com/convective-heat-transfer-d_430.html <!-- SOURCES C7; Gate closures, lesson 2 -->. **Read level: the coefficient list, directly.** Supports: the ranges for air, boiling water and condensing steam.
3. USDA FSIS, "High Altitude Cooking", last updated 13 August 2024, read through the Internet Archive's capture of 23 September 2026 <!-- Stage 4 note, lesson 2 -->. **Read level: full.** Supports: the drop of just under 1°F per 500 feet and the slower cooking of boiled and simmered food.
4. USDA Agricultural Research Service, Nutrient Data Laboratory, *USDA Table of Nutrient Retention Factors*, Release 6, December 2007, https://www.ars.usda.gov/ARSUserFiles/80400530/pdf/retn06.pdf <!-- SOURCES C4 -->. **Read level: full (PDF text extracted).** Supports: every figure in the alcohol table and the quoted description of what was tested. The underlying study is cited through this table; this course did not read it. The arithmetic for the braise, the 13.5% strength and six servings are this course's; the point about pot width and lids is this course's reading, as the body says.
5. E. Tornberg, "Effects of heat on meat proteins - Implications on structure and quality of meat products", *Meat Science* 70(3), 2005, 493-508, doi 10.1016/j.meatsci.2004.11.021 <!-- Gate closures, lesson 8 -->. **Read level: abstract only, directly.** Supports: the sarcoplasmic and myofibrillar protein ranges, the collagen denaturation range, shrinkage, and dissolving into gelatine. The reading that the muscle fibres have set before the collagen gives way is this course's, as the body says.
6. M. E. Latorre, M. I. Palacio, D. E. Velázquez and P. P. Purslow, "Specific effects on strength and heat stability of intramuscular connective tissue during long time low temperature cooking", *Meat Science* 153, 2019, 109-116, doi 10.1016/j.meatsci.2019.03.016 <!-- Gate closures, lesson 8 -->. **Read level: abstract only, directly.** Supports: cooking at 60°C for up to 24 hours, strength falling with time, the slow and gradual increase in denatured collagen, and the easily destabilised and more resistant fractions.
7. USDA FSIS, "Slow Cookers and Food Safety", last updated 8 August 2013, read through the Internet Archive's capture of 23 September 2026 <!-- SOURCES B1.10; Gate closures, lesson 8 -->. **Read level: full, directly.** Supports: the temperature range, tender leaner cuts, the safety of the process, the slow start and the head start, thawing, the first hour on high, the lid, the power-cut rules (including finishing the cooking another way when you're home), reheating, holding at 140°F, and refrigerating leftovers within two hours. That the thawing rule rests on the slow start is this course's reading, as the body says.
8. USDA FSIS, "Safe Minimum Internal Temperature Chart", last updated 14 April 2025, read through the Internet Archive's September 2026 capture <!-- SOURCES B1.1 -->. **Read level: full.** Supports: 165°F (73.9°C) for all poultry.
9. Food Standards Agency, "Cooking your food", GOV.UK, https://www.gov.uk/government/publications/cooking-your-food/cooking-your-food <!-- SOURCES B3.1 -->. **Read level: full.** Supports: 70°C for 2 minutes in the middle of the food, and the visual cues for chicken.
10. foodsafety.gov, "Cook to a Safe Minimum Internal Temperature", last reviewed 21 November 2024, read through a 2026 Internet Archive capture <!-- SOURCES B1.2 -->. **Read level: full.** Supports: fish at 145°F (63°C) or until no longer translucent and flaking with a fork.
11. LibreTexts, "B5: Ebullioscopic (Boiling Point Elevation) Constants", Chemistry LibreTexts reference tables, public domain <!-- Gate closures, lesson 8 -->. **Read level: the table, directly.** Supports: water's constant, 0.513.
12. LibreTexts, *Introductory Chemistry*, 13.9, "Freezing Point Depression and Boiling Point Elevation" <!-- Gate closures, lesson 8 -->. **Read level: the relevant section, directly.** Supports: the formula and sodium chloride splitting into two particles. The 1% and 2% figures are this course's arithmetic, as the body says.
13. US Environmental Protection Agency, "Why can't I use hot water from the tap for drinking, cooking, or making baby formula?", last updated 28 October 2025 <!-- SOURCES C3h; Gate closures, lesson 8 -->. **Read level: the answer, directly.** Supports: the quotation. The heating-time comparison is this course's arithmetic, as the body says.
14. Instant Pot, "Frequently Asked Questions", https://instantpot.com/pages/frequently-asked-questions <!-- Gate closures, lesson 8 -->. **Read level: the pressure-cooking answers, directly.** A manufacturer's page. Supports: the pressure levels, the working temperature for one model, the fill lines, quick and natural release, and frozen meat.
15. National Center for Home Food Preservation, "Ensuring Safe Canned Foods", https://nchfp.uga.edu/how/can/general-information/ensuring-safe-canned-foods/ <!-- Gate closures, lesson 8 -->. **Read level: full, directly.** Supports: 240 to 250°F at 10 to 15 PSIG, and raising time or pressure at altitude.
16. Cathy Merrill, Karin Allen and others, "Why Electric Pressure Cookers Are Not Pressure Canners", Utah State University Extension <!-- Gate closures, lesson 8 -->. **Read level: full, directly.** Supports: steam temperature rising with pressure, the altitude finding and its limited relevance to cooking, and the difference between cookers and canners.
17. Food Standards Agency, home food fact checker, GOV.UK <!-- SOURCES B3.5 -->. **Read level: full.** Supports: not slow-cooking raw red kidney beans. The statement that the FSA pages read give no other slow-cooker rule is about this course's reading, not the FSA's.
18. US Food and Drug Administration, *Bad Bug Book*, 2nd edition, 2012, chapter "Phytohaemagglutinin (kidney bean lectin)", https://www.fda.gov/media/83271/download <!-- SOURCES B5.1 -->. **Read level: full chapter.** Supports: slow-cooker casseroles often reaching only 75°C or less, and white kidney beans carrying about a third of red kidney beans' toxin. That cannellini are white kidney beans rests on University of Illinois Extension, Lisa Peterson, "Kidney Beans and Slow Cookers", 29 February 2024, https://extension.illinois.edu/blogs/live-well-eat-well/2024-02-29-kidney-beans-and-slow-cookers, which writes of "Raw white (cannellini) kidney beans" (read level: the sentence quoted, directly; lesson 9 cites it in full).
19. P. P. Purslow, "Intramuscular connective tissue and its role in meat quality", *Meat Science* 70(3), 2005, 435-447, doi 10.1016/j.meatsci.2004.06.028 <!-- Stage 4 note, lesson 8 -->. **Read level: abstract only, directly.** Supports: the amount of connective tissue varying with muscle position and animal age, its long-recognised effect on the tenderness of cooked meat, and its contribution falling at higher temperatures and longer cooking times. That shoulder, shin and cheek are among the cuts with more of it is this course's general knowledge, not the abstract's.
