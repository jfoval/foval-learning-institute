...
## Stage 4 note, lesson 12

*2026-09-24, fresh-context review. Each item below was read direct at this review (GOV.UK through
the Content API; FSIS and foodsafety.gov through Internet Archive 2026 captures, curl and local text
extraction). The lines below add to "Gate closures, lesson 12".*

- **FSIS, "Leftovers and Food Safety"**, re-read. On frozen leftovers: "Safe ways to thaw leftovers include the refrigerator, cold water and the microwave oven." "After thawing, the food should be used within 3 to 4 days or can be refrozen." "Foods thawed by the cold water method should be cooked before refreezing." "It is safe to reheat frozen leftovers without thawing". So the US gives thawed leftovers a fresh 3 to 4 days; a lesson must not say the freezer merely pauses the original clock.
- **FSIS, "Freezing and Food Safety"**, re-read (capture 20260923031306). The reason for the foods that freeze badly is on the same page, under "Freeze Rapidly": "Slow freezing creates large, disruptive ice crystals. During thawing, they damage the cells and dissolve emulsions." "Emulsions such as mayonnaise or cream will separate and appear curdled." So the emulsion reading of mayonnaise and cream sauce is FSIS's own, not an inference. Also: "Freeze food as fast as possible to maintain its quality."
- **FSA, "How to chill, freeze and defrost food safely"**, re-read. On cooked meat: "when you have cooked meat and you’re not going to eat it straight away, cool it and then put it in the fridge or freezer within 1-2 hours". On thawing: "we advise that the safest way to defrost food is in the fridge overnight"; "When defrosting food in the fridge use a container big enough to catch any drips. If this isn’t possible, use a microwave on the defrost setting directly before cooking." (the microwave is offered as the alternative when fridge thawing isn't possible, not as a rescue for a slow thaw; a lesson that uses it that way labels it). "Check the guidance on food packaging and allow enough time for your food to defrost properly." The page gives no thawing time and no rule on reheating a dish from frozen. Section 1 repeats "Eat leftovers within 48 hours or freeze them if you think this won’t be possible."
