...
objectives:
  ...
  - >-
    Identify the hazards of a lead-acid battery (hydrogen, acid, a short circuit) and say why an
    electric shock from a 12 V battery is not among them
quiz:
  - q: >-
      A retired teacher drives her car only to the post office, a mile and a half each way, three
      times a week, and it stands idle in between. The battery has started to struggle. Which change
      do the sources in this lesson support most directly?
    options:
      - Let the engine idle on the drive for a few minutes after each trip home
      - Fit a new battery straight away, since one that struggles is always worn out
      - Nothing, since short trips put less strain on a battery than long ones do
  ...
  - q: >-
    ...
    options:
      ...
      - An electric shock through the body, since the battery's voltage is low
      - A burn from acid, since sealed batteries hold their acid safely inside them
      - A short circuit through a metal tool, since tools have insulated handles
    answer: 1
    explain: >-
      HSE says "Most batteries produce quite low voltages, and so there is little risk of electric
      shock." It treats the other three as real: hydrogen and oxygen from charging can explode, and
      "Many explosions happen when batteries are being connected or disconnected"; the acid can
      "permanently damage the eyes"; and an uninsulated spanner across the terminals gets "very hot
      very quickly". Not every tool is insulated, which is why HSE warns about spanners. The low shock
      risk is about 12 V batteries; the high-voltage battery in a hybrid or electric car is lesson
      14's, and there shocks are the danger.
  - q: >-
  ...
  - q: >-
    ...
    options:
      - Acid leaking from the battery, which can mean it's near failure
      - A normal film from road salt, which a damp cloth will wipe off
      - Coolant that has splashed across from the reservoir next to it
  ...
  - q: >-
    ...
    options:
      ...
      - The battery isn't getting enough charge, because of all the short journeys
      - It's the cold alone, since the AA says batteries only fail in winter weather
...
The cable clause matters here because the word "battery" means two different things in a hybrid or
an electric car, and this lesson is about the small one only. Nothing in it asks you to touch the
battery, its terminals or anything near the high-voltage system. It uses UK words with the US word
once (bonnet, or hood; petrol, or gasoline), and miles, because the American sources give their
figures in miles.

## What the small battery does, in each kind of car

Start with a petrol or diesel car. The US Department of Energy's
...
they don't get the chance to recharge properly", and "You can halve the battery's lifetime by not
fully charging it regularly."[8] Among the commonest reasons for a dead battery it lists "The car
hasn't been used for a while" and "The car's only used for short or stop-start journeys".[8] Nissan's
handbook gives the same warning for an electric car, in its list of what can lead to a flat 12 V
battery: "Installation or extended use of electronic accessories that consume battery power when the
EV system is not running (Phone chargers, GPS, DVD players, etc.)" and "Vehicle is not driven
regularly and/or only driven short distances."[6]

Notice what none of these sources says. None gives the amount of charge one start takes, or how
long a given car must drive to replace it. The 5 miles and the 30 minutes are rules of thumb from a
government fuel-economy site and two motoring organisations, and your car may need more or less. The
sources agree on the direction, and that is what you can act on.
...
Here is the case in full. A hatchback in Kirkwall is used for two-mile trips all winter, to work and
back, and nothing longer. One dark morning in January it won't start: the dashboard lights flicker
and the engine turns over slowly, then not at all.

**Step 1: the pattern of use.** Two miles is well under fueleconomy.gov's 5 miles between starts,
and no trip is anywhere near AAA's 30-minute stretch. So on this course's reading of the sources, every
weekday the starts took out more than the drives put back. The AA's list names this exact car: one "only used for
short or stop-start journeys".

**Step 2: the season.** AAA explains why winter is when it shows up. The battery "generates
electricity using lead-acid technology to create a chemical reaction", and "Cold weather can slow
this chemical reaction. This, coupled with the fact that starting a car in the winter requires more
power, puts additional stress on the battery."[3] fueleconomy.gov adds that "Battery performance
decreases in cold weather, making it harder for your alternator to keep your battery charged."[9] So
the cold made each start harder and each short drive refill less. The two causes add together.

**Step 3: what came first.** AAA again: "while winter weather is most likely to cause your battery to
fail, it's actually hot weather that does most of the damage, which becomes evident when the
temperature drops and more power is required to get the car started."[3] So on AAA's account, damage done
...
- **Dim lights.** Headlights and interior lights dimmer than usual.
- **Battery age.** The "3 to 5 years" test point above.
- **Needed a jump.** Check the battery afterwards.
- **Leaking or swollen battery.** "If your battery leaks acid, you'll see a green or blue powdery
  substance on the terminals." And: "Leaking or a swollen battery can often indicate your battery is
  near failure."
...
that there are no loose connections, cracks, or loose clamps."[11] Looking is **Yours**; the
exercise below says how.
...
**What to do.** Here the sources split:
...
result in a break down caused by a sudden power failure."[13] Put those beside AAA's line that the
battery "doesn't provide continual power (that's the job of the alternator)", and this course's
...
Now a case with a gap for you to fill. On the same morning near Juneau, two neighbours' charge lights
come on as they drive to work. One drives a 2024 Nissan LEAF; the other a 2024 Ford Maverick with the
...
The Health and Safety Executive, Great Britain's workplace safety regulator, says in its leaflet
[*Using electric storage batteries safely*](https://www.hse.gov.uk/pubns/indg139.pdf) that the
12 V battery in nearly every car is lead-acid: "Lead/acid batteries are the most common large-capacity rechargeable batteries. There is one in almost
every car, motorcycle and wagon on the road."[15] The leaflet was revised in 2011 and is written for
workplaces, "aimed at supervisors, technicians, safety professionals and others", including "motor
vehicle repair and maintenance". It is the most thorough official account of these hazards the course
read, so this section uses it, with that label on it. It names three hazards, and it rules out a
fourth.
...
produced more quickly as the battery gets close to being fully charged." And the moment of greatest
risk is a connection: "Many explosions happen when batteries are being connected or disconnected."[15]
...
skin."[15] Toyota's handbook says the same for its car: "The battery contains poisonous and corrosive
sulfuric acid and may produce hydrogen gas which is flammable and explosive." Its instructions for
anyone near it include "Wear protective safety glasses when working near the battery." and "Keep
children away from the battery."[11] Acid on skin or in an eye is first aid, and First Aid and CPR
lesson 10, "Burns, cuts and small injuries", teaches it under chemical burns and a splash in the eye.

**A short circuit.** HSE: a battery's stored energy can be released very quickly "when the terminals
are short-circuited, for example with an uninsulated metal spanner or screwdriver." Then "a large
amount of electricity flows through the metal object, making it very hot very quickly."[15] Its list of
...
of the other kind: "Serious electric shocks and burns are common in accidents involving high-voltage
battery packs."[15] That is the battery that drives a hybrid or electric car, and the orange cables in
the callout. Lesson 14, "High voltage: hybrid and EV safety, charging at home, fire and flood", is
about it.

What does this mean for an owner? Looking at a battery is **Yours**, with the engine off and nothing
in your hands. Everything this course teaches that involves touching one, the jump start, is in lesson
13 with its conditions. HSE's leaflet and Toyota's handbook both describe connecting, disconnecting
and recharging batteries; this course doesn't teach those, as its own scope decision, and your
handbook is where your maker's method is, if it gives one.
...
shock". The dangers are gas, acid and short circuits.

## Practice

:::exercise Your battery, your driving, your handbook
Take 15 minutes over these. Part 1 is on paper. Parts 2 and 3 use your own car's handbook and, if you want, the car itself, if it's yours or its keeper agrees.

1. For one ordinary week, write down each journey you make in the car anyway (don't drive for the exercise): the distance or the time. At the end of the week, count how many trips were under 5 miles, and whether any single drive lasted 30 minutes or more. Compare the week with fueleconomy.gov's 5 miles and AAA's 30 minutes, and write one line on what you'd change, if anything.
...
Add to the page lesson 4 started in your car file: where the 12 V battery or its jump points are;
the handbook's words for the charge warning light, marked "stop now" or "check soon"; the battery's
age and last test, if known; and a line on your driving pattern from the week's log, with the change
you'll make if most trips are short. Lesson 11, "Dashboard warning lights", puts this light on your
card with the others.

## Connections

Lesson 4, "Hybrids and electric cars: how they work", introduced the DC/DC converter and the 12 V
battery that every car still has; this lesson has taken that battery further. Lesson 11 sets the
charge light beside the other lights on the dashboard and explains the colour code. Lesson 13, "A
flat battery and jump-starting", teaches the jump start, where the hydrogen and the final clamp from
this lesson come back. Lesson 15, "Winter and summer", returns to the cold. First Aid and CPR lesson
10, "Burns, cuts and small injuries", is where the acid goes if it ever reaches skin or an eye.
...
- **Halderman and Ward, *Automotive Technology: Principles, Diagnosis, and Service*, 7th edition
  ...
  read only its table of contents, so it can say where the alternator is explained but not vouch
  for what the chapters say.

## Sources

1. The AA (a motoring organisation that sells breakdown cover and repairs; not an official body),
   ["10 essential car maintenance tips"](https://www.theaa.com/breakdown-cover/advice/car-maintenance-tips),
   published 29 March 2016, updated 10 July 2025. **Read: full text, re-read 26 September 2026.**
   <!-- SOURCES Part B §2; lesson 05 gate closures -->
2. Alternative Fuels Data Center (US Department of Energy), ["How Do Gasoline Cars Work?"](https://afdc.energy.gov/vehicles/how-do-gasoline-cars-work).
   **Read: full text, re-read 26 September 2026.** No page date. <!-- SOURCES Part A §1 -->
3. AAA Mountain West Group (a regional US motoring club that sells roadside assistance; not an
   official body), ["How Cold Weather Impacts Your Battery"](https://mwg.aaa.com/via/car/how-cold-weather-impacts-battery).
   **Read: full text, re-read 26 September 2026.** No date shown. <!-- SOURCES Part B §4; lesson 05 gate closures -->
4. NHTSA, ["Electric and Hybrid Vehicles"](https://www.nhtsa.gov/vehicle-safety/electric-and-hybrid-vehicles),
   read from Internet Archive capture 20260924154857 (nhtsa.gov refuses automated readers; the live
   page is linked). **Read: full text.** <!-- SOURCES Part B §4 -->
5. Alternative Fuels Data Center, ["How Do Hybrid Electric Cars Work?"](https://afdc.energy.gov/vehicles/how-do-hybrid-electric-cars-work).
...
6. Nissan North America, *2024 LEAF Owner's Manual and Maintenance Information* (US market), PDF.
   **Read in full: pages EV-7 to EV-8, CH-2, CH-12, 2-15 to 2-23, 6-10 to 6-12, 8-2, 8-5 to 8-8, 9-3
   to 9-4; p. 2-16 re-read 26 September 2026.** Used here: p. 2-16 (the 12-volt battery charge
   warning light), p. 6-10 (a frozen battery) and p. 9-4 (causes of a flat 12 V battery). A maker's handbook for its own car.
   <!-- SOURCES Part B §3, §4; lesson 05 gate closures -->
7. fueleconomy.gov (US Department of Energy and EPA), ["Driving More Efficiently"](https://www.fueleconomy.gov/feg/driveHabits.jsp).
   **Read: full body text, re-read 26 September 2026.** The 5-mile line is in a list the page credits
   to a 2015 Argonne National Laboratory study, which this course did not read. <!-- SOURCES Part A §6; lesson 05 gate closures -->
8. The AA, ["What to do if your car has a flat battery"](https://www.theaa.com/breakdown-cover/advice/flat-battery),
   last updated 11 January 2024. A motoring organisation, as above; the page sells the AA's own
   battery service. **Read: full text, re-read 26 September 2026.** <!-- SOURCES Part B §4; lesson 05 gate closures -->
...
12. The Highway Code (Department for Transport and DVSA), ["Annex 6. Vehicle maintenance, safety and security"](https://www.gov.uk/guidance/the-highway-code/annex-6-vehicle-maintenance-safety-and-security),
    updated 29 January 2022. Great Britain. **Read: full text, re-read 26 September 2026 through the
    GOV.UK content API.** The charge-light line is advice, not a MUST rule. <!-- SOURCES Part B §3, Part C §4; lesson 05 gate closures -->
13. RAC (a motoring organisation that sells breakdown cover and repairs; not an official body),
    ["Dashboard warning lights guide: red, amber and green symbols explained"](https://www.rac.co.uk/drive/advice/know-how/car-dashboard-warning-lights-meaning/),
    dated 18 August 2026. **Read: full text; the battery section re-read 26 September 2026.**
    <!-- SOURCES Part B §3; lesson 05 gate closures -->
