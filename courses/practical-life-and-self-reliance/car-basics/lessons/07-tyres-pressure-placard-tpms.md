...
objectives:
  - >-
    ...
    explain why the figure moulded on the sidewall is the tyre's maximum and not a target
  - >-
...
quiz:
  - q: >-
    ...
    options:
      - At 28.5 psi, since the standard's trigger is 25 per cent below the carmaker's cold figure
      - At about 36 psi, since any tyre two psi below its placard figure must set off the warning
      - At 19 psi, since the warning is only required once a tyre has lost half of its pressure
      - At 34.2 psi, since the standard sets the warning at ten per cent below the placard figure
    answer: 0
    explain: >-
  ...
  - q: >-
      After an hour on the motorway, a driver stops for fuel and checks the tyres with her own gauge.
      The handbook's cold figure is 2.4 bar and a front tyre reads 2.6 bar. What do the sources this
      lesson read point her to?
    options:
      - Let air out now until the gauge shows 2.4 bar, because that's the handbook's own figure
      - Add air now, since warm tyres always lose pressure on the road and 2.6 bar is too little
      - Ignore the gauge entirely and rely on the TPMS light, since it corrects for the tyre's heat
      - Leave it, and check again cold, since a warm tyre reads higher than it will when it cools
    answer: 3
    explain: >-
  ...
  - q: >-
    ...
    options:
      - In July 2019, since the first two digits give the month and the last two the year
      - In 2017, in the nineteenth week of that year, from the last two digits and the first
      - In the seventeenth week of 2019, from the first two digits and then the last two
      - On the 17th of some month in 2019, since the two pairs give the day and then the year
    answer: 2
    explain: >-
      49 CFR 574.5 says the date code is four digits: the first two are the week of the year and the
      last two the year of manufacture, and its own example reads 0109 as the first full week of
      2009. So 1719 is the 17th week of 2019. There's no month or day in the code, and reading the
      pairs the other way round gives a year that the code doesn't say. The code may be on one side
      only, NHTSA warns, so look at both.
  - q: >-
      As general information: a driver in Wales has the tyres at the handbook's figures for a car
      with two people in it. Her handbook gives higher figures for a fully loaded car, and she's
      about to load it for a long trip. What does Annex 6's MUST rule on pressure point her to?
    options:
  ...
  - q: >-
    ...
    options:
      ...
      - The system is just checking its own bulb, which it does on every start, so it can be ignored
      - The tyres are cold after the night, and the light will go out once they warm up on the road
    answer: 1
    explain: >-
  ...
  - q: >-
    ...
    options:
      ...
      - Wheels out of alignment, which on AAA's account wears both edges of a tyre at once
...
or no check at all because a light on the dashboard seems to have it covered. This lesson is about the right number, the right moment, what the light is and isn't
required to do, and how to read the writing on the side of a tyre (the tire, in the US).
...
## Two numbers, and whose each one is

Lesson 1, "What a car is made of, and why the handbook comes first", set out the two numbers: the
carmaker's cold pressure on the placard or in the handbook, and the tyre maker's maximum moulded on
the sidewall. NHTSA's rule of thumb from that lesson stands: "the correct pressure for your tire is
what the vehicle manufacturer has listed, NOT what is listed on the tire itself."[1] This lesson
starts from why the two numbers differ, because that's what lets you handle the cases the rule of
thumb doesn't cover.

The sidewall figure answers a question about the tyre. The US federal standard for new car tyres,
[FMVSS 139](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.139),
defines it as "the maximum cold inflation pressure to which a tire may be inflated".[4] It's the
same whatever car the tyre is fitted to.

The placard figure answers a question about the car. The US standard that requires the placard,
[FMVSS 110](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.110),
ties the carmaker's pressure to the weight the car puts on each tyre. It says the car's maximum load
on a tyre "shall not be greater than the applicable maximum load rating as marked on the sidewall",
and that the car's normal load on a tyre "shall not be greater than 94 percent of the load rating at
the vehicle manufacturer's recommended cold inflation pressure for that tire".[3] On this course's
reading, that means the carmaker chooses a pressure at which each tyre can carry what that car puts
on it, with a margin. The same
placard also carries the car's seating capacity and a line about weight: "The combined weight of
occupants and cargo should never exceed XXX kilograms or XXX pounds", with the car's own figure in
place of the X's.[3]

[TyreSafe](https://www.tyresafe.org/the-checks/check-your-pressures/), a UK tyre safety charity
backed by tyre makers, carmakers and retailers, lists what pressure affects: "the tyre's speed
capability, load carrying capacity, handling response, wear rate and overall safety."[10] Annex 6 of
the Highway Code, the part of Great Britain's Code on looking after a vehicle, says "Your brakes and
steering will be adversely affected by under-inflated or over-inflated tyres."[7] Neither page
explains how pressure produces those effects in a tyre, and this course read no source that does.
What the federal standard says about the consequences is in the section on the warning light below.

### Where the carmaker's figure is

In the US, FMVSS 110 requires the information "on a placard permanently affixed to the driver's
side B-pillar", the upright post the driver's door closes against; for a car with no B-pillar it
names other places nearby, starting with the edge of a door.[3] NHTSA says the label gives the pressure in both kPa
...
One car can have more than one figure. Lesson 1 showed Toyota's handbook for the 2023 Corolla sold
in the US listing its pressures by tyre type, four types in all, and not one pressure for them all. Annex 6's wording, "for the load being
carried", matters for the same reason: where a handbook gives one figure for normal use and a
higher one for a fully loaded car, the Great Britain rule points at the one for the load you're
carrying. That last step is this course's reading of the rule's words; no handbook this course read
was checked for a laden figure, so look in yours.

:::checkpoint Two friends compare their cars. One says the pillar label is "the garage's advice" and the sidewall figure is "the real one, because it's the tyre maker's". Using what FMVSS 110 and FMVSS 139 say, what's wrong with that?

The sidewall figure is real, but it's a limit, not a setting: FMVSS 139 defines it as the most the
tyre may be inflated to when cold, on any car. The pillar label is not a garage's advice. It's the
carmaker's recommended cold pressure for that car, which FMVSS 110 requires on the placard, and the
standard links it to the load the car puts on each tyre, at no more than 94 per cent of the tyre's
load rating at that pressure for the normal load. If you said "the placard wins" but couldn't say
why, the load link is the reason.
:::
...
The weather moves the reading too. NHTSA's winter page: "As the outside temperature drops, so does
tire inflation pressure."[12] Neither source gives a figure per degree, so this course gives none.
On this course's reading, that means a tyre set right in September can read low by December
without a leak, which is one reason to check through the year rather than once. Lesson 15, "Winter and summer",
comes back to it.

### How often

The sources agree on cold, and disagree on how often.
...
That's the simple case, and the fix is to add 4 psi and write it down. The case that catches
people is the next one.

### A warm reading in Morpeth

A driver fills up at a forecourt in Morpeth after a 40-mile drive. While she's there she checks
the tyres with her own gauge. The handbook's cold figure for her car is 32 psi (2.2 bar, again a
figure for the example). The front tyres read 35 psi. Her first thought is that the tyres are
over-inflated and she should let 3 psi out.

Work through it before you read on. What's the reading a reading of? What does each source say to
do with it? And what would she find the next morning if she let the air out now?
...
obtain a cold reading".[1] Reading the two together, a warm reading isn't a reason to let air out
down to the cold figure, and a warm tyre that reads low is topped up to it; that is this course's reading of NHTSA
and AAA side by side, not a sentence either one writes. If she'd used the forecourt's gauge instead
of her own, AAA's warning about those gauges is a second reason not to act on the number.
:::
...
this feature."[1] The rule is [FMVSS 138](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.138),
which phased it in from 5 October 2005 and, with limited exceptions, applied it to every new vehicle
it covers built from 1 September 2007.[2] NHTSA describes two ways a system can work: sensors in the tyres ("direct"), or
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 330" width="100%" style="max-width:420px;display:block;margin:1.5em auto;font-family:system-ui,sans-serif" role="img" aria-labelledby="tpms-title tpms-desc">
  ...
  <text x="110" y="106" font-size="15" fill="var(--text-2, #4a5260)">light by 22.5 psi</text>
  <text x="8" y="134" font-size="15" fill="var(--text, #1a1a1a)">Placard 33</text>
  <rect x="110" y="118" width="173" height="22" fill="var(--oxblood, #8b1e2d)"/>
  <rect x="283" y="118" width="58" height="22" fill="var(--gold, #b08d2a)"/>
  <text x="110" y="158" font-size="15" fill="var(--text-2, #4a5260)">light by 24.75 psi</text>
  <text x="8" y="186" font-size="15" fill="var(--text, #1a1a1a)">Placard 36</text>
  <rect x="110" y="170" width="189" height="22" fill="var(--oxblood, #8b1e2d)"/>
  <rect x="299" y="170" width="63" height="22" fill="var(--gold, #b08d2a)"/>
  <text x="110" y="210" font-size="15" fill="var(--text-2, #4a5260)">light by 27 psi</text>
...
under-inflation has not reached the level to trigger illumination of the TPMS low tire pressure
...
NHTSA says that when the symbol comes on, "at least one of your tires is significantly
underinflated", and to inspect the tyres and check the pressure "as soon as possible".[1] The
federal manual text says "you should stop and check your tires as soon as possible".[2] Neither
says how to decide where to stop; lesson 16, "When the car stops: where, who stands where, and the
call", does that.

Two other patterns mean something different, and NHTSA explains both.
...
- **Flashing, then steady.** "A system malfunction may be indicated by a flashing of the TPMS symbol
  ...
  system inspection."[1] The standard's manual text adds that while the malfunction light is on,
  "the system may not be able to detect or signal low tire pressure as intended", and that new tyres
  or wheels can be the cause.[2] Until it's fixed, the gauge is the only check you have.

Take a car in Pueblo whose TPMS symbol flashes for about a minute every morning and then stays on.
...
This course read no UK law that requires a car to be fitted with a TPMS. A motoring organisation's
...
regulation's own words don't name the maker's figure; the Highway Code's paraphrase does, and it
tells you where the number comes from. Using a car whose tyres break a construction and use
requirement is an offence under section 41A of the Road Traffic Act 1988, which covers "brakes,
...
This course read no US federal or state law that sets the pressure a driver must run. The federal
standards read here are rules for how cars are built and labelled: the placard (FMVSS 110) and the
warning system (FMVSS 138). On this course's reading they bind the carmaker, and what they say to the
driver comes as the owner's-manual text quoted above. One state's inspection shows the difference.
New York's inspection reports pressure outside the maker's figure, and the DMV's page says: "This is
an advisement only, and not cause for rejection."[13] Your own state's rules are on its DMV or
state police pages; lesson 22, "The US: state inspections, emissions tests and tread law", goes
through five states.

## Reading a sidewall

The side of a tyre carries more than its maximum pressure. Four things are worth being able to read.

**The size.** DVSA's manual uses an example to explain one part of it: "a 215/55R15 has an aspect
ratio of 55%".[9] The manual does not decode the rest of the string, and this course read no source
that does, so it won't either. What you need is simpler: the whole size, copied exactly, matched
against the sizes your handbook lists. The size matters because, as lesson 1 showed with Toyota's
tyre types, the pressure you want can depend on it.

**The maximum pressure.** FMVSS 139 requires it on each sidewall, and it's the figure you don't
inflate to.[4]

**The date code.** In the US the tyre identification number (TIN) follows the letters DOT. The rule
is [49 CFR 574.5](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-574/section-574.5):
"The date code, consisting of four numerical symbols, is the final group. The date code must
identify the week and year of manufacture." The first two digits are the week and the last two the
year, and the rule's own example is "0109 means the tire was manufactured in the first full calendar
week of 2009".[5] NHTSA adds a practical point: "Look on both sides of the tire. The TIN may not be
on both sides."[1] DVSA's manual, reading the same kind of code on tyres in Great Britain, says
"Tyres with a three-digit code will be more than 10 years old."[9] What a tyre's age means for
replacing it is lesson 8's question.
...
Uniform Tire Quality Grading standard, [49 CFR 575.104](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-575/section-575.104):
TREADWEAR (a number), TRACTION ("AA, A, B, or C") and TEMPERATURE (A, B or C). The rule's own words
limit what each means. Treadwear "is a comparative rating based on the wear rate of the tire when
tested under controlled conditions on a specified government test course", and "The relative
...
- **Worn on both edges**: under-inflation. "Too little air pressure causes mostly the tire's outer
...
at is **Call someone**, and lesson 6, "Brakes, steering and suspension", has the signs that go
with them.
...
says real wear "may depart significantly from the norm".[6]

## Practice

:::exercise Four tyres, a spare, and your car's trigger point
Take 15 minutes over these, one morning. You need a tyre pressure gauge, the handbook for a car that is yours or whose keeper agrees, and a pen. The car must have stood for at least three hours (overnight is best), parked off the road on level ground, engine or motor off, parking brake on, key or fob away from the car. You don't lift the car, loosen anything or reach under it. If the spare is carried under the car rather than inside it, leave the spare out of this: nobody goes under a car in this course. Don't do any of this at a roadside or on a hard shoulder.
...
Add the tyre page to your car file: the cold pressures (front, rear, spare, and any loaded figures)
with where each came from; your trigger point; the tyre size; each tyre's date code, read as week
and year; and a checks log with the date, the time the car had stood, each reading and what you did.
Put the interval you've chosen at the top of the log, and whose advice it is.

## Connections

Lesson 1 set out the two numbers, the placard and the sidewall; this lesson is how they're used.
Lesson 8, "Tyres II: tread, damage, age, and when to replace", reads the rest of the tyre: the
tread, damage and age, and the argument about when to replace. Lesson 12, "Fuel economy: what
maintenance buys, and the figures that were withdrawn", comes back to what pressure does for fuel,
and lesson 15, "Winter and summer", to what cold does to pressure. Lesson 18, "A flat tyre: the
decision, and spare, space saver, sealant or run-flat", returns to the spare this lesson had you
check.

## Go deeper

- **NHTSA, ["Tires"](https://www.nhtsa.gov/vehicle-safety/tires)**, free: the US regulator's pages
  on pressure, the TPMS symbols and what each pattern means, and the tyre grades. This course read
...
1. NHTSA, ["Tires"](https://www.nhtsa.gov/vehicle-safety/tires). **Read: full page, from Internet
   Archive capture 20260924154655** (nhtsa.gov refuses automated readers), re-read 26 September
   2026; no later capture with different content exists. The live page is linked. US federal. <!-- SOURCES Part B §1, Part D §3; lesson 07 gate closures G-T6 -->
2. [49 CFR 571.138, FMVSS No. 138](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.138),
   "Tire pressure monitoring systems". **Read: full section text**, eCFR, re-read 26 September 2026
   (version of 24 September 2026), including S4.2, S4.4, S4.5, S7 and Table 1. US federal law. <!-- SOURCES Part B §1, Part D §3; lesson 07 gate closures -->
3. [49 CFR 571.110, FMVSS No. 110](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.110),
   "Tire selection and rims". **Read: full section text**; S4.2.1 and S4.3 re-read 26 September
   2026 (version of 24 September 2026). US federal law. <!-- SOURCES Part D §3; lesson 07 gate closures -->
4. [49 CFR 571.139, FMVSS No. 139](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.139),
   "New pneumatic radial tires for light vehicles". **Read: S1 to S5.5; test procedures skimmed**;
   S3 and S5.4 re-read 26 September 2026. US federal law. <!-- SOURCES Part D §3; lesson 07 gate closures -->
5. [49 CFR 574.5](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-574/section-574.5),
   "Tire identification requirements". **Read: full section**, re-read 26 September 2026. US federal
   law. <!-- SOURCES Part D §3; lesson 07 gate closures -->
6. [49 CFR 575.104](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-575/section-575.104),
   "Uniform tire quality grading standards". **Read: (a) to (d) and the Figure 2 consumer text;
   test procedures skimmed**; (c) and the Figure 2 text re-read 26 September 2026. US federal law. <!-- SOURCES Part D §3; lesson 07 gate closures -->
7. The Highway Code, ["Annex 6. Vehicle maintenance, safety and security"](https://www.gov.uk/guidance/the-highway-code/annex-6-vehicle-maintenance-safety-and-security).
...
8. [The Road Vehicles (Construction and Use) Regulations 1986, regulation 27](https://www.legislation.gov.uk/uksi/1986/1078/regulation/27),
   as amended. **Read: the whole regulation on the live page**, 26 September 2026. England, Wales
   and Scotland. <!-- SOURCES "The tread rule, stated exactly", Part C §3; lesson 07 gate closures -->
9. DVSA, [MOT inspection manual: cars and passenger vehicles, section 5](https://www.gov.uk/guidance/mot-inspection-manual-for-private-passenger-and-light-commercial-vehicles/5-axles-wheels-tyres-and-suspension),
   "Axles, wheels, tyres and suspension". **Read: 5.2.1 to 5.2.3 in full**, 26 September 2026;
   manual updated 1 June 2026. England, Scotland and Wales. <!-- SOURCES Part C §1; lesson 07 gate closures G-T3 -->
10. TyreSafe, ["Check your pressures"](https://www.tyresafe.org/the-checks/check-your-pressures/).
    **Read: full text**, re-read 26 September 2026; last updated 16 September 2026. A UK tyre safety
    charity backed by tyre makers, carmakers and retailers. <!-- SOURCES Part B §1; lesson 07 gate closures G-G3 -->
11. AAA Exchange, ["Tire Safety and Maintenance"](https://exchange.aaa.com/automotive/car-care-repair-and-maintenance/tire-safety-and-maintenance/).
    **Read: full text**, re-read 26 September 2026; undated. A US motoring club that sells roadside
    assistance and runs a repair network. <!-- SOURCES Part B §1; lesson 07 gate closures -->
12. NHTSA, ["Winter Weather Driving Tips"](https://www.nhtsa.gov/winter-driving-tips). **Read: full
    text, from Internet Archive capture 20260812080428**; the tyre section re-read from the same
    capture 26 September 2026. US federal. <!-- SOURCES Part B §6; lesson 07 gate closures -->
13. New York State DMV, ["New York State Vehicle Safety/Emissions Inspection Program"](https://dmv.ny.gov/new-york-state-vehicle-safetyemissions-inspection-program).
...
14. The Highway Code, ["Introduction"](https://www.gov.uk/guidance/the-highway-code/introduction).
