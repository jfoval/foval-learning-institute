...
quiz:
  - q: >-
      A friend has bought an imported hybrid. With the bonnet up and the car switched off, she can't
...
battery pack apart. What this lesson is for is the rest of it: knowing the high-voltage parts when
you see them, opening the bonnet of a car that can start by itself, charging at home without
starting a fire, and knowing what to do when the car has been hit, is burning, or has been in a
flood.
...
the UK word is RCD; Home Repair and Maintenance lesson 5 taught both.
...
then, in the next paragraph, "It is considered best practice when testing these vehicles to avoid
touching any high voltage components and wiring."[6] That's a trained tester, in a test bay, told to
keep their hands off. The handbooks' own words for owners are stricter: Ford says "Do not come in
contact with these components", and Nissan says "Follow the warning labels that are attached to the
vehicle."[1][4]
...
|---|---|---|
| Nissan | Handbook, 2024 LEAF, US | "The vehicle high voltage system has no user serviceable parts." Never disassemble, remove or replace high-voltage parts, cables or connectors. |
| Ford | Handbook, 2024 Maverick hybrid, US and Canada | "This battery pack should only be serviced by an authorized electric vehicle technician." |
| NFPA | US fire-safety standards body, tip sheet for owners | "Battery maintenance should be performed by the manufacturer." |
| NHTSA | US road-safety regulator, advice for owners | "You should never try to service the traction battery without proper training and specialized equipment." |

Sources: [1][4][5][7].

In this course's labels, everything on the high-voltage system is **Call someone**, every time,
...
Routine Maintenance Activities" through Level 3 (system repair and replacement) to Level 4
(diagnosis, testing and repair). This course didn't read what each level lets a technician do, so it
says only this much: high-voltage work is graded by training, and none of it is owner work.
TechSafe is not compulsory. In May 2026 the IMI and others were calling on government "to mandate its
use", and the IMI said its data "shows that just over a third of technicians have some level of
qualification to work on electric vehicles".[8] That's the IMI's own figure, from a body with an
interest in the answer. Lesson 24, "Choosing a garage, servicing and warranties", comes back to what
to ask a garage.
...
Charging at home is where the sources in this course disagree most, so the agreement comes
first.

**In the UK**, [Electrical Safety First](https://www.electricalsafetyfirst.org.uk/safety-advice/products-and-appliances/transport/electric-vehicles/), a UK electrical safety charity: "The safest way to charge at
home is with a dedicated EVCP" (an EV charge point), and "A home charging point must be installed by
a registered and competent electrician, trained and qualified to install electric vehicle charge
points".[9] The "must" is ESF's. It explains why an ordinary socket isn't the same thing: "The
extended load and duration of charging an EV are likely to exceed what a standard socket-outlet and
standard wiring is designed for." Sockets made for it are "marked 'BS1363/EV' to identify them", and
"They should be supplied by dedicated circuits."[9]

**In the US**, NFPA's tip sheet says that before charging at home you should have a qualified
electrician "Check your electrical system to see if it can handle charging." and "Install a new
circuit just for your charging device." For the slowest kind of charging, from a household socket,
it adds "Make sure charger or outlet has GFCI protection." and "Use only a dedicated circuit to
charge."[5] Nissan's handbook for the US LEAF says its 120 V cable "draws 12 amps continuously", and
not to plug it into any circuit "unless it is inspected by a licensed electrician to confirm that
the electrical circuit can accept a 12 amp draw."[1] It lists the conditions that make a circuit
likelier to be compromised, including "Do not use the EVSE in structures more than 40 years old."
and "Do not use the EVSE in structures using fuse-based circuit protection."[1] (EVSE is Nissan's
word for its charging cable and unit.) Those are Nissan's, for its car in the US market; this course
read no UK handbook's version.

So on the main point the two countries' sources agree: a circuit meant for charging, checked or put
in by an electrician. Getting that done is **Call someone** in both.

### Where they differ: the extension lead

| Source | Whose, and where | What it says about extension leads |
|---|---|---|
| NFPA | US standards body, tip sheet, 2024 | "Do not use extension cords with the charger." |
| Nissan | Handbook, 2024 LEAF, US | "Never use extension cords or plug adapters with EVSE." Elsewhere: "Do not use extension cords or adapters unless they are Genuine NISSAN parts." |
| Electrical Safety First | UK charity, press release, May 2019 | "Never use a domestic multi socket extension lead when charging your electric vehicle. If you do need to use an extension lead only ever use one that is suitable for outdoor use such as a reel cable." And: "Never 'daisy-chain' extension leads." |
...
**Stop if it's hot or smells.** Nissan: "Discontinue EVSE use immediately if plug or outlet becomes
hot to the touch or if you notice any unusual odors."[1] And from the car itself: "If you notice an
unusual odor, smoke or abnormal noises coming from the vehicle, stop charging immediately."[1]

**Rain isn't a reason not to charge.** [NHTSA](https://www.nhtsa.gov/vehicle-safety/electric-and-hybrid-vehicles) answers the question directly: "Is it OK to charge my
EV in the rain? Yes, plug-in electric vehicle chargers are weather-resistant."[7] NFPA's sheet still
asks you to "Cover charging station outlet to keep water out", and Nissan says not to touch the plug
"if they are wet or with wet hands", or to touch the car and its charging equipment "when there is
lightning".[1][5]

**Where to charge.** [Derbyshire Fire and Rescue Service](https://www.ddfire.gov.uk/electric-vehicle-safety-advice), a UK fire service: "Where possible, charge
your car on your drive rather than in a garage. Fit a smoke detector in your garage if this is your
primary charging location."[11] Nissan asks anyone with an implanted pacemaker or defibrillator to
check with its maker "concerning the effects that charging may have on implanted devices before
starting the charge operation."[1]
...
In Haverfordwest, a plug-in hybrid is charged overnight in a detached
garage from a wall socket, through a four-way domestic extension lead, because the car's charging
cable is a metre short. The lead's other sockets run a freezer and a battery charger for a
lawnmower.

**What the UK source says.** [ESF's 2019 advice](https://www.electricalsafetyfirst.org.uk/media-centre/press-releases/2019/05/driven-to-danger-electric-vehicle-drivers-charging-dangerously-due-to-lack-of-public-infrastructure/): never use a domestic multi-socket extension lead
for charging.[10] Its current page says an ordinary socket and wiring aren't designed for the load
and duration, and that a dedicated charge point is the safest way to charge at home.[9]

**What the others add.** NFPA and Nissan, writing for the US, say no extension leads at all. NFPA
wants a circuit that is only for charging,[5] and Nissan's list includes "Do not use the EVSE if
other devices are plugged into the same circuit."[1] Derbyshire, in the UK, says that if you charge
from a 13A socket at home, "ensure the wiring in your property has been checked prior to doing
so."[11] Its preference is the drive rather than the garage, and a smoke alarm in the garage if
that's where the charging happens.[11]

**What the owner does.** Stops using the lead today. Reads the car's own handbook on what it allows.
Asks a registered electrician, trained to fit charge points, about a dedicated charge point or a
dedicated circuit, and fits a smoke alarm in the garage in the meantime. Home Repair lesson 12,
"Smoke alarms: where they go, and why they stay silent", covers the alarm. The government's chargepoint
grants for households were "available until 31 March 2027" when this course read the page, for
renters, flat owners and some on-street households, with conditions; money is Personal Finance's
subject, so this is only a pointer to GOV.UK's page.[13]

## After a crash, or a bump
...
**Small bumps count.** Derbyshire Fire and Rescue Service: "If you have any accidents, even small
bumps that only appear to cause cosmetic damage, have the vehicle battery inspected by an EV
...
The sources agree on the shape: get out, get away, call, say what kind of car it is, and don't try to
fight it.

Ford: "As with any vehicle, call emergency assistance immediately if you see sparks, smoke or flames
coming from the vehicle. Remain a safe distance from the vehicle and try to stay clear of the
smoke." Then: "1. Exit the vehicle immediately." "2. Advise emergency assistance that an electric or
hybrid-electric vehicle is involved." And "do not inhale smoke, vapors or gas from the vehicle".[4]

**In the UK**, Derbyshire Fire and Rescue Service: "If your vehicle does unfortunately catch fire,
get to a point of safety and call 999. Do not attempt to try and extinguish the fire yourself as this
is unlikely to be effective."[11] The Highway Code's advice for any car in Great Britain: "If your
vehicle catches fire, get the occupants out of the vehicle quickly and to a safe place. Do not attempt
to extinguish a fire in the engine compartment, as opening the bonnet will make the fire flare. Call
the fire brigade."[15]

**In the US**, NHTSA: "If an emergency such as a fire occurs, contact 911 immediately."[7]

A battery fire can come back. AFDC tells responders to be aware of "the potential for delayed ignition
of a damaged vehicle or reignition of a battery fire, even after it is believed to be
extinguished".[14] Ford says physical damage "could result in immediate or delayed release of toxic,
flammable gases and fire".[4] So a car that has stopped smoking hasn't stopped being dangerous.

Do electric cars catch fire more often than petrol ones? This course found no data that answers
...
give a distance, each its own:

| Source | Whose, and where | What it says |
|---|---|---|
| Ford | Handbook, 2024 Maverick, US and Canada | "Do not store a severely damaged vehicle with a lithium-ion battery inside a structure or within 49 ft (15 m) of any structure or vehicle." |
| NHTSA | US regulator, its flood answer | "Do not park a damaged vehicle with a lithium-ion battery in a garage or within 50 feet of your house, other structure, vehicle, or combustibles." |
...
**"Charging to 80% prevents fires."** It's on one fire service's list. No handbook read calls it a
fire-safety measure, and your handbook's charging advice governs your car.

**"A heavy-duty extension lead is fine."** NFPA and Nissan say no extension cords at all; ESF says
never a domestic multi-socket lead and allows an outdoor-rated one only as a fallback.

**"You can put out an EV fire with an extinguisher."** Derbyshire Fire and Rescue Service says it is
"unlikely to be effective"; get out, get away and call.

**"If there's no orange, there's no high voltage."** The MOT manual says some imports use another
colour, and mild hybrids' 48 V wiring may be blue and should still be avoided.
...
Lesson 4, "Hybrids and electric cars: how they work", set out the high-voltage system and the colour
code. Lesson 5 showed that the 12 V battery's dangers are different. Lesson 9, "Under the bonnet:
oil, coolant, brake fluid and screenwash", gave the preparation that this lesson has extended.
Lesson 13, "A flat battery and jump-starting", kept every clamp on the 12 V side. Home Repair and
Maintenance lessons 5 and 6, "Electricity: what trips, and why" and "Plugs, leads and electrical
fires", cover the house's circuits, RCDs and extension leads. First Aid and CPR
lesson 2 covers the danger to you at any scene, and lesson 10, "Burns, cuts and small injuries",
covers electrical burns. Lesson 16 takes the damaged car to the roadside and the recovery truck.
...
- **Halderman and Ward, *Automotive Technology: Principles, Diagnosis, and Service*, 7th edition
  (Pearson, 2025)**, whose Section X has a chapter titled "Hybrid and Electric Vehicle Safety". This
  course saw the book's contents list and nothing more, so it can point to the chapter but can't
  vouch for it.
...
3. ASE Education Foundation, ["Automobile Program Standards"](https://www.aseeducationfoundation.org/wp-content/uploads/2024-Automobile-Program-Standards-1.pdf),
   effective 1 July 2024. Standards for US technician training programmes. **Read: the supplemental
   task lists and the glossary; the high-voltage safety task and the definition re-read 26
   September 2026.** <!-- SOURCES Part A §4; lesson 13/14 gate closures -->
4. Ford Motor Company, *2024 Maverick Owner's Manual*, edition 202307, US and Canada, read from
...
6. DVSA, ["MOT inspection manual: cars and passenger vehicles"](https://www.gov.uk/guidance/mot-inspection-manual-for-private-passenger-and-light-commercial-vehicles),
   Introduction, section 20, "Testing electric and hybrid vehicles". Manual updated 1 June 2026;
   applies to England, Scotland and Wales. **Read: the Introduction in full, re-read 26 September
   2026 through the GOV.UK content API.** Written for testers. <!-- SOURCES Part C §1; lesson 01 gate closures; lesson 13/14 gate closures -->
7. NHTSA, ["Electric and Hybrid Vehicles"](https://www.nhtsa.gov/vehicle-safety/electric-and-hybrid-vehicles),
...
8. Institute of the Motor Industry (the UK professional body for the motor industry; it also awards
   ...
   qualification pages' detail on what each level permits was not read. <!-- SOURCES Part B §5; lesson 13/14 gate closures -->
9. Electrical Safety First (a UK electrical safety charity), ["Electric vehicles"](https://www.electricalsafetyfirst.org.uk/safety-advice/products-and-appliances/transport/electric-vehicles/).
   No date shown. **Read: full text, re-read 26 September 2026.** <!-- SOURCES Part B §5; lesson 13/14 gate closures -->
10. Electrical Safety First, ["Driven to danger: Electric Vehicle drivers charging dangerously due to lack of public infrastructure"](https://www.electricalsafetyfirst.org.uk/media-centre/press-releases/2019/05/driven-to-danger-electric-vehicle-drivers-charging-dangerously-due-to-lack-of-public-infrastructure/),
    press release, May 2019, with its notes on the Censuswide survey. **Read: full text, re-read 26
    September 2026.** <!-- SOURCES Part B §5; lesson 13/14 gate closures -->
11. Derbyshire Fire and Rescue Service (a UK fire and rescue service), ["Electric Vehicle Safety Advice"](https://www.ddfire.gov.uk/electric-vehicle-safety-advice).
    No date shown. **Read: full text, re-read 26 September 2026.** <!-- SOURCES Part B §5; lesson 13/14 gate closures -->
12. NHTSA, ["Winter Weather Driving Tips"](https://www.nhtsa.gov/winter-driving-tips), read from
    Internet Archive capture 20260812080428 (the live page is linked). **Read: full text** (as
    recorded for lesson 4; not re-read for this lesson). <!-- SOURCES Part B §6; lesson 01 gate closures; lesson 04 Stage 4 note -->
13. GOV.UK (Office for Zero Emission Vehicles), ["Electric vehicle chargepoint grants"](https://www.gov.uk/guidance/electric-vehicle-chargepoint-grants),
    updated 1 April 2026. **Read: full text, re-read 26 September 2026 through the GOV.UK content
    API.** <!-- SOURCES Part B §5; lesson 13/14 gate closures -->
14. Alternative Fuels Data Center (US Department of Energy), ["Maintenance and Safety of Electric Vehicles"](https://afdc.energy.gov/vehicles/electric-maintenance).
    No date shown. **Read: full text, re-read 26 September 2026.** <!-- SOURCES Part A §2; lesson 13/14 gate closures -->
15. The Highway Code, ["Annex 6. Vehicle maintenance, safety and security"](https://www.gov.uk/guidance/the-highway-code/annex-6-vehicle-maintenance-safety-and-security),
    updated 29 January 2022. Great Britain. **Read: full text, re-read 26 September 2026 through the
    GOV.UK content API.** The fire paragraph is advice, not a MUST rule. <!-- SOURCES Part B §5, Part E §1 -->
