...
quiz:
  - q: "A council report says three engineers who inspected a footbridge found it safe, and adds that two of the three work for the firm that built it. A resident says the report should be thrown out because of who paid the engineers. Using this lesson, which response is best?"
    options:
      - "The resident commits the ad hominem fallacy outright, because who paid the engineers has no bearing at all on whether the bridge is actually safe"
      - "The funding bears on the trustworthiness question, so it justifies weighing the report less and checking its evidence, not calling the bridge unsafe"
      - "The resident is right, because a report whose authors were paid by an interested party is fallacious, so its conclusion should be treated as false"
      - "The report is a cogent appeal to authority, because the engineers are experts in the right field, so the objection fails all six critical questions"
    answer: 1
    explain: "Walton's fourth critical question asks whether the expert is personally reliable, and a payment from an interested party is exactly the kind of fact that question exists for. So option A is wrong to call the objection irrelevant. But relevance to one question is not a verdict. The sugar industry case in the lesson shows the right shape: the funding justified reopening the review and reading its methods, and the researchers who found the documents recommended giving industry-funded studies less weight, not none. Option C jumps from a weak argument to a false conclusion, which is the fallacy fallacy. Option D ignores the question the funding fails."
  - q: "A school memo argues: if we allow calculators in Year 7 maths, then by Year 11 none of our students will be able to add. How should you evaluate it?"
    options:
      - "As weak unless a mechanism is shown for each step; ask for evidence that calculator use at eleven removes arithmetic by sixteen"
      - "As fallacious by its form, because every slippery slope argument treats the first step as though it forced the last one to happen"
      - "As strong, because the chain has only a few steps and each of them is plausible on its own, which is all a slippery slope needs"
      - "As fallacious because it's really an appeal to fear; the memo is using a frightening outcome in the place of a real argument"
    answer: 0
    explain: "A slippery slope is an inductive argument about a chain of consequences, and its strength depends entirely on whether each link has a mechanism and evidence behind it. Feynman's account of Flight Readiness Reviews is a documented slope that was strong, because each acceptance of erosion visibly reset the standard for the next. The school memo gives no mechanism at all, so the right move is to ask for one, which is option A. Option B convicts by form, which Massey's asymmetry says you cannot do. Option C confuses a short chain with a supported one. Option D swaps one label for another without testing either."
  - q: "Two claims share the words 'nobody has shown the additive is harmful, so it's safe.' In the first, the additive was approved last month and no safety studies exist. In the second, it has been in use for fifteen years and several large cohort studies have looked for harm and found none. Which is right?"
    options:
      - "Both are arguments from ignorance and both are fallacious, because absence of evidence is never evidence of absence"
      - "Both are strong, because in each case the burden of proof lies with whoever alleges harm, and nobody has met it"
      - "The first is strong and the second weak, because an early clean record is a cleaner signal than years of mixed data"
      - "The first is weak and the second strong, because only in the second would harm likely have shown up if it existed"
    answer: 3
    explain: "Lesson 6's likelihood ratio decides this. Ask how much more likely 'no evidence of harm' is if the additive is safe than if it is harmful. When nobody has looked, the answer is 'about equally likely either way', so the evidence barely moves you and the argument is weak. After large studies that would have found harm if it were there, 'nothing found' is much more likely under safety, and the same words make a strong argument. That is option D. Option A treats the pattern as always bad, which is the mistake the lesson warns against. Option B ignores that a burden of proof can be met by looking. Option C has the two cases backwards."
  - q: "A columnist writes: my critics say we should never repair old buildings and simply knock them all down; that is absurd, since some old buildings are treasures. The critics had in fact argued that this one building was unsafe to repair. Which description is best?"
    options:
      - "The columnist has begged the question by assuming that old buildings are treasures, which is the very point in dispute"
      - "The columnist has argued cogently, because the critics' position, followed to its logical end, does imply demolishing them all"
      - "The columnist has attacked a straw man; the check is to reconstruct the critics' actual claim and answer that one instead"
      - "The columnist has committed the fallacy fallacy, treating the critics' poor reasoning as proof that the building is sound"
    answer: 2
    explain: "The critics made a claim about one building; the columnist answered a claim about all of them. That is the straw man, the failure of lesson 7's charity, and the Wisconsin court in Wolf v. American Family named exactly this move when a party refuted a position the other side never held. Option A is wrong because 'some old buildings are treasures' is not the disputed point. Option B extends the critics' view for them, which is the straw man again. Option D names a different pattern that isn't present; the columnist never argued from the critics' reasoning to a conclusion about the building."
  - q: "A report says that regions with more coffee shops per head have higher average incomes, and concludes that people who go to coffee shops earn more than people who don't. What is the main problem?"
    options:
      - "Hasty generalisation, because a handful of regions is too small a sample to support any claim about individual people"
      - "Division: a correlation between regional averages need not hold between individuals, as Robinson's 1930 census data showed"
      - "Composition: a property of individuals, their income, has been wrongly transferred up to the region taken as a whole"
      - "False cause: the argument assumes that coffee shops raise incomes, when the causal arrow could just as well run the other way"
    answer: 1
    explain: "The premise is about regions and the conclusion is about people, and the move from one to the other is what Robinson tested. In his 1930 data the correlation between foreign birth and illiteracy was 0.619 across census divisions and 0.118 across individuals; the group-level pattern did not survive the trip down. That is division, option B. Option C runs the wrong way; composition goes from parts to whole. Option A misdiagnoses the flaw as sample size when the units are the problem. Option D raises a real question about cause, but the conclusion here isn't causal; it is a claim about which individuals earn more, and it fails before cause comes into it."
  - q: "A friend says the town's new bypass reduced accidents, and his only evidence is that accidents fell the year after it opened. You point out that this is post hoc reasoning and he agrees. What do you now know?"
    options:
      - "Only that this argument fails; the bypass may well have reduced accidents, and a proper comparison could still show that it did"
      - "That the bypass probably didn't reduce accidents, since the best argument someone can offer usually reflects whether the claim is true"
      - "That the claim is false, because a claim that is supported by a fallacious argument should be rejected until it is properly proven"
      - "That the claim cannot be tested until someone runs a controlled experiment with a matched town that didn't build a bypass"
    answer: 0
    explain: "Showing an argument bad tells you about the argument, not the claim. The Lancet retraction in the lesson makes the point: it showed the 1998 paper's argument rested on false premises, and what showed the MMR claim itself false was a separate body of large studies. So option A is right. Option B and option C are two strengths of the fallacy fallacy. Option D is too strong in the other direction; a before-and-after comparison against similar towns, or accident trends elsewhere, is evidence short of an experiment, and lesson 5's methods apply."
---

In January 2007 the UK's Advertising Standards Authority ruled on a poster you may have seen a version of. It said "More than 80% of dentists recommend Colgate". Two members of the public complained, the ASA opened its own inquiry, and the ruling went against the advertiser. The survey behind the poster had let each dentist recommend several brands at once. Most of them had. The ruling noted that another competitor's brand was recommended by dentists almost as much as Colgate was. Nobody had asked the dentists to pick one.[1]
...
:::checkpoint A friend says "the argument for the new timetable is fallacious: it's an appeal to authority, because it just cites the head of department." Which fact about the head of department would you need before you could agree?
...
Run the Colgate poster through them. Expertise: dentists, fine. Field: toothpaste, fine. Opinion: here it falls over. The dentists asserted "I'd recommend Colgate, among others"; the poster asserted "dentists recommend Colgate over other brands". Trustworthiness: the survey was commissioned by Colgate, and the ruling criticised the poster for not saying so, which is a reason to look closely rather than a conviction. Consistency: another brand scored almost as high, so the experts were not lined up behind one answer. Backup evidence: not really at issue. Verdict: weak here, and it fails on question 3.[1] Notice how much more you now know than "it's an appeal to authority". You know which question it fails, which means you know what a fixed version of the poster would have to say.
...
:::predict Which of Walton's six critical questions does the 1 in 73 million figure fail? Decide before you open this.
...
:::checkpoint An economist with a good record on inflation is quoted on a poster saying a new bridge design is unsafe. Which critical question fails, and which pass?
...
**Case B.** This one is hypothetical, because I could not find a documented instance I could present fairly, and the outline for this course says not to invent one and pass it off. A plumber tells you your boiler's heat exchanger is cracked and needs replacing. You later learn she was rude to a neighbour and once had a parking fine. You conclude the boiler is fine.

:::predict Which of these is the fallacy? And what is the difference between them?
...
:::video https://www.youtube.com/watch?v=qBkj-AYYg7w | CRITICAL THINKING - Fallacies: Ad Hominem
...
So: does the payment show the review's conclusions were false? Take a moment with that before you read on.
...
:::checkpoint A friend dismisses a study because its lead author has a patent on the treatment it tested. Is that relevant, and is it decisive?
...
:::checkpoint You're about to reply to a colleague's proposal. What one thing do you write before your reply, and what fallacy does it prevent?
...
**Division.** In 1950 the sociologist W. S. Robinson took the 1930 US census and computed, for the nine census divisions, the correlation between the percentage of residents who were foreign-born and the percentage who were illiterate. It was 0.619. Then he computed the same correlation across individuals: is a foreign-born person more likely to be illiterate? That was 0.118. On a state-by-state basis the group figure was 0.526; the individual figure hadn't changed.[18] The foreign-born were concentrated in the divisions where illiteracy was lowest, so the group correlation said something about where immigrants lived, not about immigrants. Concluding from "regions with F have G" to "people with F have G" is division, and epidemiologists still call it the ecological fallacy, after this paper.
...
:::predict Think of the last few real arguments you read or heard: a news column, a work email, a debate. How often do you think the patterns above appeared in their fallacious form? Once a paragraph? Once a week? Almost never? The people who study this disagree with each other.
...
In 1970 Charles Hamblin published *Fallacies*, and it is the reason a lesson like this one exists. He looked at what he called the standard treatment, "the typical or average account as it appears in the typical short chapter or appendix of the average modern textbook", and wrote: "what we find in most cases, I think it should be admitted, is as debased, worn-out and dogmatic a treatment as could be imagined: incredibly tradition bound, yet lacking in logic and in historical sense alike, and almost without connection to anything else in modern Logic at all."[3] His complaint was that textbooks defined a fallacy as "an argument that seems valid but is not", then listed items, like appeal to pity or begging the question, that aren't invalid at all. Begging the question is valid: p, therefore p, has no counterexample. The definition and the list had never been reconciled, and nobody had noticed for centuries.
...
**The defenders and reformers** don't dispute the fork so much as build around it. Walton keeps the names and redefines a fallacy as a misuse of an argumentation scheme in a particular kind of dialogue, judged by the critical questions; a move that's fine in a negotiation may be a fallacy in an inquiry.[7][3] The pragma-dialectical school in Amsterdam, van Eemeren and Grootendorst, rebuilt the whole subject as ten rules for a critical discussion (you may not prevent the other party from advancing a standpoint; whoever advances one must defend it if asked; and so on), and defined a fallacy as any violation of a rule. That covers the traditional list and adds moves it missed.[3] Johnson and Blair, who founded the informal-logic movement in Canada, sort fallacies as failures of one of three conditions on a cogent argument: acceptability, relevance, sufficiency,[3] which you met in lesson 7 as Govier's ARG. On that view the list is a set of common ways to fail one of three tests, and the tests are what you actually run.
...
:::checkpoint You've shown that a colleague's argument for the new rota is circular: her premise was the conclusion in other words. What do you now know about whether the new rota is a good idea?
...
**"Any appeal to authority is a fallacy."** Most of what you know came from authorities and you were right to accept it. The fallacy is the appeal to an authority who is out of field, or against the consensus, or misquoted, or compromised. Run the six questions.[6][7]

**"Ad hominem is always a fallacy."** *Davis v. Alaska* is the answer. When a claim rests on someone's word, their motives are the evidence.[10][11]

**"Slippery slope and appeal to ignorance are always fallacies."** They are inductive arguments. Feynman's Flight Readiness Reviews were a real slope with a mechanism; the Danish cohort is a real absence of evidence that is strong evidence of absence. The likelihood ratio decides, not the name.[13][14]
...
**"Spotting the name settles it."** Massey: you cannot convict an argument on logical grounds by matching it to a form. Boudry: nearly every named fallacy has a cogent twin. IEP: the name "cannot substitute for a detailed examination".[3][20][6]
...
**"The list is complete, coherent, and ancient in its current form."** It began as thirteen items for a debating game, grew by accretion, has never had a definition that fits all its members, and the field disagrees about whether to keep it at all.[2][3]

**"I spot fallacies quickly, so I'm good at this."** You spot them quickly on the other side. Lesson 2's belief bias predicts that you'll check the link on arguments whose conclusions you dislike and check the conclusion on arguments you like. If a fallacy diagnosis arrives in under ten seconds, that speed is information about you, and the right response is to run the check on your own side's argument too.

## Practice

:::exercise Do it now: twelve real passages
...
9. Across nine census divisions the correlation between the share of foreign-born residents and the share of illiterate residents is 0.619; therefore foreign-born individuals are much more likely to be illiterate. (The inference Robinson, 1950, warned against.)
...
:::checkpoint Answers to the twelve
...
9. Division; fallacious. The individual correlation in the same data was 0.118.
...
- Hans Hansen, ["Fallacies"](https://plato.stanford.edu/entries/fallacies/), *Stanford Encyclopedia of Philosophy* (rev. 2024): the map of the whole subject, including the history and every position in the debate above, in about the length of this lesson.
- Bradley Dowden, ["Fallacies"](https://iep.utm.edu/fallacy/), *Internet Encyclopedia of Philosophy*: 231 names with examples; the reference to consult when you meet a name you don't know, and it carries the same warning about names that this lesson does.
- Boudry, Paglieri and Pigliucci, ["The Fake, the Flimsy, and the Fallacious"](https://philarchive.org/rec/BOUTFT), *Argumentation* 29 (2015): the Fallacy Fork paper, free on PhilArchive, and the strongest case for dropping the names altogether. Read it after this lesson and decide for yourself.
...
- Richard Feynman, ["Personal Observations on the Reliability of the Shuttle"](https://www.nasa.gov/history/rogersrep/v2appf.htm), Appendix F to the Rogers Commission report (1986): five pages, free, and the best short document I know on how good people accept bad arguments under pressure.
- Wireless Philosophy's [Critical Thinking: Fallacies](https://www.khanacademy.org/partner-content/wi-phi/wiphi-critical-thinking/wiphi-fallacies) series on Khan Academy: short videos with practice exercises on the individual patterns.

## Sources

1. Advertising Standards Authority, adjudication on Colgate-Palmolive (UK) Ltd, January 2007, as reported by Osborne Clarke, ["Colgate's '80% of dentists recommend' claim under fire"](https://marketinglaw.osborneclarke.com/retailing/colgates-80-of-dentists-recommend-claim-under-fire/), 31 January 2007. The poster claim "More than 80% Of Dentists recommend Colgate"; two consumer complaints and an ASA-initiated inquiry; the survey allowed dentists to recommend several brands; "another competitor's brand was recommended by dentists almost as much"; the undisclosed commissioning; complaints upheld. The 2007 adjudication itself is no longer on the ASA site, so this is cited via the law firm's contemporaneous report.
2. Aristotle, *On Sophistical Refutations*, trans. W. A. Pickard-Cambridge, sec. 4 to 5, [MIT Classics](http://classics.mit.edu/Aristotle/sophist_refut.1.1.html). The six fallacies depending on language and the seven independent of it, quoted as translated.
3. Hans V. Hansen, ["Fallacies"](https://plato.stanford.edu/entries/fallacies/), *Stanford Encyclopedia of Philosophy* (2015, rev. Aug 2024). Sec. 1: the working definition "an argument that seems to be better than it really is". Sec. 2: Aristotle's thirteen (2.1), Locke's three ad arguments (2.4), Whately (2.7), Mill (2.8). Sec. 3: Hamblin 1970 p. 12 on the standard treatment; Finocchiaro on "fallacious arguments"; Massey's asymmetry and "no argument can be convicted of being a fallacy on logical grounds"; Johnson and Blair's acceptability, relevance, sufficiency; pragma-dialectics' ten rules; Walton's dialogue types.
4. Patrick J. Hurley (with Lori Watson), *A Concise Introduction to Logic*, 13th ed. (Cengage, 2018), ch. 3. Twenty-two informal fallacies in five groups: relevance, weak induction, presumption, ambiguity, illicit transference.
...
8. Royal Statistical Society, ["Royal Statistical Society concerned by issues raised in Sally Clark case"](https://rss.org.uk/RSS/media/File-library/Membership/Sections/2020/Sally-Clark-RSS-statement-2001.pdf), news release, 23 October 2001. "A medical expert witness"; the squaring to 1 in 73 million; "statistically invalid"; "very strong a priori reasons for supposing that the assumption will be false"; "statistics remains a specialised area"; the call for statistical evidence to be given by "appropriately qualified statistical experts".
9. *Daubert v. Merrell Dow Pharmaceuticals, Inc.*, [509 U.S. 579 (1993)](https://www.law.cornell.edu/supct/html/92-102.ZO.html). The factors for scientific testimony (testability, peer review and publication, known or potential rate of error, general acceptance); "The focus, of course, must be solely on principles and methodology, not on the conclusions that they generate"; "Vigorous cross examination, presentation of contrary evidence, and careful instruction on the burden of proof are the traditional and appropriate means of attacking shaky but admissible evidence."
10. *Davis v. Alaska*, [415 U.S. 308 (1974)](https://www.law.cornell.edu/supremecourt/text/415/308), decided 27 February 1974, Burger C.J., with Stewart J. concurring and White and Rehnquist JJ. dissenting. The witness Richard Green on juvenile probation for burglary; the protective order; "the exposure of a witness' motivation in testifying is a proper and important function of the constitutionally protected right of cross-examination"; the jurors "were entitled to have the benefit of the defense theory before them"; the "more particular attack on the witness' credibility ... directed toward revealing possible biases, prejudices, or ulterior motives".
...
12. Cristin E. Kearns, Laura A. Schmidt and Stanton A. Glantz, ["Sugar Industry and Coronary Heart Disease Research: A Historical Analysis of Internal Industry Documents"](https://pmc.ncbi.nlm.nih.gov/articles/PMC5099084/), *JAMA Internal Medicine* 176(11), 2016, 1680 to 1685. The 1965 project; $6,500 ($48,900 in 2016 dollars) paid for the review; the review "singled out fat and cholesterol as the dietary causes of CHD and downplayed evidence that sucrose consumption was also a risk factor"; "The SRF set the review's objective, contributed articles for inclusion, and received drafts. The SRF's funding and role was not disclosed"; the recommendation to give "less weight to food industry-funded studies". The review is McGandy, Hegsted and Stare, *New England Journal of Medicine*, 1967.
13. R. P. Feynman, ["Personal Observations on the Reliability of the Shuttle"](https://www.nasa.gov/history/rogersrep/v2appf.htm), Appendix F to the *Report of the Presidential Commission on the Space Shuttle Challenger Accident*, vol. 2 (1986). The estimates "from roughly 1 in 100 to 1 in 100,000", engineers high and management low, and "one could put a Shuttle up each day for 300 years expecting to lose only one"; "certification criteria used in Flight Readiness Reviews often develop a gradually decreasing strictness. The argument that the same risk was flown before without failure is often accepted as an argument for the safety of accepting it again"; the seals passage with "Russian roulette"; flight 51-L, flight 51-C, erosion "only one-third of the radius", "a safety factor of three", and "This is a strange use of the engineer's term, 'safety factor.'" The twenty-flight likelihood calculation in the text is the lesson's own arithmetic on Feynman's two figures (0.99 to the power 20 is about 0.82), not a figure from the appendix.
14. Anders Hviid, Jørgen Vinsløv Hansen, Morten Frisch and Mads Melbye, ["Measles, Mumps, Rubella Vaccination and Autism: A Nationwide Cohort Study"](https://doi.org/10.7326/M18-2101), *Annals of Internal Medicine* 170(8), 2019, 513 to 520. 657,461 children born in Denmark 1999 to 2010; adjusted hazard ratio 0.93 (95% CI 0.85 to 1.02); no increased risk in subgroups or time periods; "strongly supports that MMR vaccination does not increase the risk for autism".
15. *Wolf v. American Family Mutual Insurance Co.*, [2015 WI App 36](https://www.wicourts.gov/ca/opinion/DisplayDocument.html?content=html&seqNo=136448), 361 Wis. 2d 756, Wisconsin Court of Appeals, decided 4 March 2015 (Brown C.J., Neubauer P.J., Reilly J.), para. 15. The elasticity clause; "Of course they are. However, her contention attacks a straw man. American Family does not contend the elasticity clause is unenforceable ..." The dash in the original is rendered as a semicolon in the quotation above.
16. A. J. Wakefield et al., ["Ileal-lymphoid-nodular hyperplasia, non-specific colitis, and pervasive developmental disorder in children"](https://doi.org/10.1016/S0140-6736(97)11096-0), *Lancet* 351(9103), 1998, 637 to 641 (retracted). From the summary: "12 children (mean age 6 years [range 3-10], 11 boys)"; "Onset of behavioural symptoms was associated, by the parents, with measles, mumps, and rubella vaccination in eight of the 12 children"; "generally associated in time with possible environmental triggers".
17. The Editors of the *Lancet*, ["Retraction: Ileal-lymphoid-nodular hyperplasia, non-specific colitis, and pervasive developmental disorder in children"](https://doi.org/10.1016/S0140-6736(10)60175-4), *Lancet* 375(9713), 2010, 445. "Following the judgment of the UK General Medical Council's Fitness to Practise Panel on Jan 28, 2010, it has become clear that several elements of the 1998 paper by Wakefield et al are incorrect ... the claims in the original paper that children were 'consecutively referred' and that investigations were 'approved' by the local ethics committee have been proven to be false. Therefore we fully retract this paper from the published record."
18. W. S. Robinson, "Ecological Correlations and the Behavior of Individuals", *American Sociological Review* 15(3), 1950, 351 to 357; reprinted in [*International Journal of Epidemiology* 38(2), 2009, 337 to 341](https://doi.org/10.1093/ije/dyn357), which is the text read. 1930 census data; foreign birth and illiteracy: individual correlation 0.118, ecological correlation 0.619 across the nine census divisions and 0.526 across the 48 states; colour and illiteracy: individual 0.203, ecological 0.946 (divisions) and 0.773 (states).
19. Advertising Standards Authority, ruling on Plusnet plc, 9 March 2016 (ref. A15-292223), listed on the ASA's [guidance on "unlimited" claims](https://www.asa.org.uk/advice-online/broadband-and-telecoms-unlimited-claims.html) and reported with quotations by ISPreview, ["ASA Ban PlusNet Advert for Misleading 'Totally Unlimited' Broadband Claim"](https://www.ispreview.co.uk/index.php/2016/03/asa-ban-plusnet-advert-misleading-totally-unlimited-broadband-claim.html), 9 March 2016. "A 'totally unlimited' claim was stronger, and that consumers would understand it to mean that the service was free from any provider-imposed limitations"; the traffic prioritisation leaving some traffic a minimum of 5% of line capacity; the instruction to use "totally unlimited" only where there were no provider-imposed limitations.
20. Maarten Boudry, Fabio Paglieri and Massimo Pigliucci, ["The Fake, the Flimsy, and the Fallacious: Demarcating Arguments in Real Life"](https://philarchive.org/rec/BOUTFT), *Argumentation* 29(4), 2015, 431 to 456. The Fallacy Fork as stated in the abstract; "almost every known type of fallacy is a close neighbor to sound inferences or acceptable moves in a debate".
