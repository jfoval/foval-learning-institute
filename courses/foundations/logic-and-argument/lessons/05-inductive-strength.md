...
quiz:
  ...
  - q: A town council notices that streets with more trees have lower burglary rates. One councillor argues that planting trees on the bare streets will cut burglary. Before spending the money, what is the most important rival reading to rule out, and what would rule it out?
    options:
      - Reverse causation, that low burglary somehow causes trees to grow; ruled out by checking whether the trees came before or after the burglary figures were kept
      - A common cause, that wealthier streets have both more trees and less burglary; ruled out by comparing similar-wealth streets or planting on some bare streets only
      - Chance, that the pattern is a coincidence in this year's data; ruled out by collecting the same figures for a second year to see whether the correlation holds up
      - Nothing needs ruling out, since Mill's fifth canon says that when two things vary together one of them causes the other, so the councillor is already right
    answer: 1
    explain: This is a plainly hypothetical case, but the shape is the one you will meet most often. Streets differ in many ways at once, and wealth is a likely common cause of both the trees and the low burglary. The test is the method of difference done properly, hold everything else steady and vary the one thing, either by comparing like with like or by planting trees on some bare streets and leaving others as they are. Option A names a real reading but a far-fetched one here, and the test it offers would not separate common cause from tree-causes-safety. Option C is worth doing but does not touch the common-cause reading; the correlation would hold up next year too if wealth drives both. Option D misreads Mill, whose fifth canon says the two are causally connected "in some other manner" or as cause and effect, and who says in the same passage that concomitant variation alone cannot tell you which.
...
And yet it isn't a bad argument. Three out of three is real evidence. If you told my friend "that's invalid" she'd rightly say "I never claimed it was certain; I claimed it was likely." She's making a different kind of claim about the link, and it needs a different test. That test is this lesson, and it's the one you'll use far more often than validity, because almost everything you know about the world, from whether the bus will come to whether the bridge will hold, reached you by an argument of this kind.

## Strong, weak, and cogent

An argument is deductive when the premises are claimed to guarantee the conclusion, and inductive when they're claimed only to make it probable. That's the distinction Hurley's textbook draws at the start of its first chapter, and it's a distinction about what the arguer claims for the link, not about whether the argument goes from general to particular or the other way round (Hurley, 2018).[1] Lesson 2 warned you off the "general to particular" myth; here's the spaced repeat. "All humans are mortal, so Socrates is" goes from general to particular and is deductive. "This coin came up heads a thousand times, so the next toss will probably be heads" goes from particular to particular and is inductive. The difference is in what's claimed, nothing else.

For a deductive argument, step 4 asks: is it valid? For an inductive one, step 4 asks: is it strong? An inductive argument is strong when, if the premises were true, the conclusion would probably be true. It's weak when the premises, even if true, don't make the conclusion probable. And, matching "sound" from lesson 2, an inductive argument is cogent when it's strong and its premises are in fact true (Hurley, 2018).[1] The Stanford Encyclopedia's entry on inductive logic puts the same idea in terms of degree: the premises of a good inductive argument "support the truth of its conclusion to some appropriate degree" (SEP, 2025).[2] Degree is the word to hold on to. Validity is all or nothing. Strength comes in amounts.
...
The informal-logic literature sorts arguments into four kinds by the link they claim: deductive, inductive, conductive, and abductive (SEP, Groarke).[3] You've met the first. The next four sections cover the inductive families that a general reader needs, then the abductive kind under its plainer name, then the conductive kind, which is the shape of most decisions you'll ever make.

:::callout One word, two sizes
"Inductive" is used in a narrow sense (generalising from cases, as in the coin and the cars) and a broad sense (any argument whose premises are claimed to make the conclusion probable rather than certain). Hurley uses the broad sense, so analogy, cause, and best explanation all count as inductive for him.[1] This lesson does the same, because the test is the same: strong or weak, by coverage. When someone tells you induction is "just" generalising, they're using the narrow sense.
:::
...
First, size. Twelve is small enough that ten-out-of-twelve could easily happen by chance among people whose real rate is nearer half. Suppose you give it to a hundred people. Now eighty say yes. Better. The premise now covers more of the ground the conclusion is about.
...
Your turn before I go on. Say you fix representativeness as well: you set up a stall at a Saturday market, strangers try the sauce, and 160 of 200 say they'd buy it. Before reading the next paragraph, name the weakness that's still there.

Here's mine. "Said they'd buy it" is not "bought it". The premise is about a stated intention with a free taste in their mouth and the maker smiling at them; the conclusion you actually care about is what people will do at a shelf with a price on it. The sample can be large and representative of market-goers and still not cover the case you're arguing about, because it measures the wrong thing. If you then say "and the market-goers on a Saturday morning aren't everyone either", you've got the idea: every sample is representative of something, and the question is always whether that something is the population in the conclusion.

Weston's chapter on arguments by example makes the same three demands of any generalisation: more than one example, representative examples, and background information about the rate you'd expect anyway (Weston, 2018).[4] When you meet a survey in the news, the questions to ask are the ones you just asked: how many, chosen how, asked what, and compared with what. Statistics for Citizens teaches the arithmetic of sampling properly; this course only needs you to see that the arithmetic is answering the coverage question.
...
That's the whole test, and it's the coverage idea again. An analogy is strong to the degree that the shared features are the ones that produce the feature in the conclusion (Govier, 2013; Copi, Cohen & McMahon, 2011).[5][6] Irrelevant similarities add nothing however many there are. And one relevant difference can sink an analogy that has a dozen similarities going for it. If the neighbours' extension was built in a dry summer and yours is starting in November, that one difference may matter more than everything the two projects share.

:::checkpoint Two cases share ten features and differ in one. Can the argument from analogy still be weak?
Yes, in two ways. If the ten shared features are irrelevant to the conclusion, they give no support however many there are. And if the one difference is the thing that produces the feature you're arguing about, it outweighs all ten. Count relevance, not features. The question is never "how similar are they?" but "are they similar in the way that matters for this conclusion?"
:::

Weston adds a fair point about how analogies are used: they're often given to make an unfamiliar case vivid rather than to prove anything, and you should ask which job the analogy is doing before you attack it (Weston, 2018).[4] If someone says a proposed change is "like rearranging the deckchairs", they're not offering an argument, they're offering a picture, and the reply is to ask what the picture is claiming.

## Family three: cause

The most consequential inductive arguments you'll meet claim that one thing causes another. This drug lowers blood pressure. The new timetable reduced lateness. Eating late gives me bad sleep. The tools for checking a causal claim were written down in 1843 by John Stuart Mill, and they're still the bones of every experiment. Mill states them as canons. I'll give you two of the five, in Jonathan Bennett's modernised wording of Mill's text, because those two are the ones you'll use.

### The method of difference

Here's Mill's own example. "When a man is shot through the heart, the Method of Difference shows us that it was the gunshot that killed him: he was in the fullness of life immediately before, all circumstances being the same as after except the wound" (Mill, 1843).[7] Mill says this is the logical process behind "almost all the inductive conclusions we draw in daily life".[7] The canon reads: "If an instance where the phenomenon y under investigation occurs and an instance where it doesn't occur have every circumstance in common except for one x that occurs only in the former, x is the effect or the cause or an indispensable part of the cause of y."[7]
...
That, in 1843, is the whole content of the slogan "correlation isn't causation". And notice what Mill actually says. He does not say a correlation tells you nothing. He says it tells you the two are causally connected in some manner, and that this method alone can't tell you which. The slogan, as people use it now, is a conversation-ender: someone offers a correlation, someone else says "correlation isn't causation", and everyone nods as if the matter were closed. Mill's version is a conversation-starter: the correlation is evidence of some connection, and the work is to find out which. There are four readings of any correlation between A and B:
...
Now the gap. Suppose the owners wanted to test reading 3 against reading 1 properly. Using the method of difference, what single comparison would do it? Write it down before reading on.
...
One more pattern to name, since you'll meet it weekly. Post hoc reasoning ("after this, therefore because of this") is a causal argument from a single sequence: I did X, then Y happened, so X caused Y. It's the method of difference with the "every other circumstance in common" clause quietly dropped. You started the new supplement on Monday and slept badly on Tuesday. Also on Monday: a stressful meeting, a late dinner, a change in the weather. Hurley files post hoc under the fallacy of false cause, and Weston's chapter on causes gives the same warning; the fix is always the same question: what else changed? (Hurley, 2018; Weston, 2018).[1][4]
...
Nothing here is a sample. Nothing is an analogy. It isn't a correlation. What you've done is take a set of facts and pick the hypothesis that best explains them. The philosopher Gilbert Harman gave this pattern its usual name in 1965: inference to the best explanation, and he argued that it's a basic kind of reasoning in its own right, not reducible to generalising from cases (Harman, 1965).[8] Groarke's survey lists it, under the name abduction, as the fourth kind of argument alongside deductive, inductive, and conductive (SEP, Groarke).[3]
...
One more shape, and it's the one that most of your real decisions take. Trudy Govier's textbook gives it a name the other books mostly skip: the conductive argument, in which several independent reasons support a conclusion and are weighed against counter-considerations that pull the other way (Govier, 2013).[5]
...
**"Correlation isn't causation" as the end of the discussion.** It's the beginning. Mill's fifth canon says two things that vary together are causally connected in some manner; the work is which of the four readings.[7] A person who says the slogan and stops has done none of it.
...
4. Analogy. Middling. Same landlord and same street are relevant to damp (maintenance habits; the local building stock); same size isn't. It's strong only if damp in the old flat was a landlord-and-building problem rather than a one-off. Ask about the cause of the old damp before trusting the analogy.
...
- Mill, *A System of Logic*, Book III, chapter 8, in Jonathan Bennett's modernised text at earlymoderntexts.com: about fifteen pages, free, and the five canons in the author's own voice, with the hedge on concomitant variation that the slogan leaves out. Chapter 9 gives his worked scientific examples.
- Weston, *A Rulebook for Arguments* (5th ed., 2018), chapters II, III, and V: the shortest good treatment of examples, analogies, and causes, written for people who have to build arguments rather than grade them.
- Govier, *A Practical Study of Argument* (7th ed.), chapter 12 on conductive arguments: the one chapter in the standard textbooks on the argument form you'll use for most real decisions.
- Harman, "The Inference to the Best Explanation", *Philosophical Review* 74 (1965): eight pages, the paper that named the pattern and argued it's basic. Dense in places, but you now have what you need to read it.
- The Stanford Encyclopedia of Philosophy entry "Inductive Logic": for readers who want to see what happens when you try to make "degree of support" precise, and why that project is harder than it looks.

## Sources

1. Hurley, P. J., *A Concise Introduction to Logic*, 13th ed. (Cengage, 2018), chs. 1, 3, and 10. Deductive versus inductive as a matter of what the premises are claimed to do, not direction of travel; strong/weak and cogent/uncogent; the broad sense of "inductive" covering analogy, cause, and explanation (ch. 1); post hoc under the fallacy of false cause (ch. 3); Mill's methods (ch. 10).
2. Stanford Encyclopedia of Philosophy, "Inductive Logic" (rev. Feb 2025). A good inductive argument's premises "support the truth of its conclusion to some appropriate degree"; degree of support as the core notion.
3. Groarke, L., "Informal Logic", Stanford Encyclopedia of Philosophy. The four argument kinds, deductive, inductive, conductive, and abductive.
4. Weston, A., *A Rulebook for Arguments*, 5th ed. (Hackett, 2018), chs. II (arguments by example), III (arguments by analogy), V (arguments about causes). More than one example, representative examples, background rates; analogies as illustration versus argument; causal claims and what else might explain the correlation.
5. Govier, T., *A Practical Study of Argument*, 7th ed. (Cengage, 2013), chs. 9 to 12. Inductive arguments; causal inductive arguments; analogies and relevant similarity; conductive arguments with counter-considerations.
6. Copi, I. M., Cohen, C. & McMahon, K., *Introduction to Logic*, 14th ed. (Pearson, 2011), chs. 11 to 12. Analogical reasoning and the relevance criterion; causal reasoning.
7. Mill, J. S., *A System of Logic* (1843), Book III, ch. 8, "Of the Four Methods of Experimental Inquiry", in the modernised text by Jonathan Bennett (earlymoderntexts.com, 2017), pp. 191 to 199 of that edition. Verified at draft time against Bennett's PDF: the man shot through the heart ("he was in the fullness of life immediately before, all circumstances being the same as after except the wound"); "almost all the inductive conclusions we draw in daily life"; the second canon (method of difference) and fifth canon (concomitant variation) as quoted; the method of difference as "more particularly a method of artificial experiment" and agreement as "what we use when experimentation is impossible"; and the sentence following the fifth canon on two effects of a common cause, which "this method alone can't tell us" apart from cause and effect.
8. Harman, G., "The Inference to the Best Explanation", *Philosophical Review* 74(1), 1965, 88 to 95. Names and defends the inference: from a set of facts, infer the hypothesis that would best explain them, as a basic form of non-deductive reasoning. Cited here for the name and the claim; the criteria given in the lesson (explains more, more simply, fits what else is known) are the standard textbook gloss and are not quoted from Harman.
