...
quiz:
  - q: >-
      A neighbour writes on the residents' board, "It's common knowledge that the new bins are too small for a family, and the council clearly never asked anyone who lives here. So the old bins should come back." You have five minutes. Where does a close analysis tell you to spend them?
    options:
      - >-
  ...
  - q: >-
    ...
    options:
      ...
      - >-
        Both survive, because a single false premise never sinks an argument that still has one true premise left
      - >-
        The second survives, because a timetable argument is deductive and deductive arguments are not weakened by new information
      - >-
...
None of this is evaluation yet. It's a map of where the writer feels strong and where they feel weak, drawn by the writer. Assurances mark the weak spots. Guards mark the claims they've measured. Discounts mark the objections they know about. Read the map, then rebuild.

:::checkpoint "Everyone knows the trains here are unreliable, and although the new operator has promised improvements, they'll probably be late again on Monday." Sort the three marked terms, and say which claim you'd check first.
"Everyone knows" is assuring; it sits on the claim that the trains are unreliable, which is offered with no figures. "Although the new operator has promised improvements" is discounting; the promise is mentioned so it can be set aside. "Probably" is guarding; the writer is only committing to a likelihood. Check the assured claim first: what is the punctuality figure, and is it actually bad? The guarded conclusion is the honest part, and the discounted promise is the objection the writer would rather you didn't weigh.
:::
...
In lesson 1 you met Harry. "Harry was born in Bermuda, so Harry is a British subject." You found the missing premise, a general rule about people born in Bermuda, and you saw that writing it down made its exceptions visible. Now here's the full machine that example came from.
...
## Worked example with a wrinkle: the boiler

Here's a message of the kind a person might send to the family group chat. It's made up, so nothing in it needs to be true, and that's the point: you're testing the argument, not the boiler.
...
So the full reconstruction adds:
...
That last case is the one people get wrong most. Take the café: "It's closed on Mondays, so let's go Tuesday." You could make that valid by adding "[Tuesday is the only day it opens]". Nobody believes that. You could add "[Tuesday is the next day that suits us both]", which makes the argument strong rather than valid and is exactly what the speaker meant. Charity says take the second. Lesson 1 gave you the rule as "the most plausible thing the arguer would accept"; here's the reason behind it. If you reconstruct an argument nobody holds, your refutation refutes nobody. You've done the work and nothing has changed, because the argument you demolished was never in the room.
...
Dennett's stated reason is practical: following the rules turns your opponent into a more receptive audience for your criticism.[6] There's a second reason that matters more for this course. You can't do rule 1 without doing the reconstruction properly. To restate someone's position so well that they'd thank you, you have to have found their conclusion, their premises, the rule they're relying on, and the strength they're claiming. Rule 1 is the whole of this lesson, tested by the one judge who knows the answer.

Let me model it on one of the disagreements from the list below, the family dog. Suppose I'm against getting one and my sister is for it. Her case, restated by me under rule 1:
...
Rule 2: I agree that the children are indoors too much and that our previous fixes have failed. Rule 3: I hadn't thought about the youngest and responsibility; that's a real point and I learned it from her. Rule 4, only now: I think the daily walking will land on one adult, not on the children, and the case depends on the children doing it. That objection is aimed at the version she actually holds, and she'll know it.

Compare what I'd have said without the rules. "Dogs are a lot of work and the kids will lose interest in a week." True, possibly, and useless, because she never claimed the kids wouldn't lose interest; her case rests on something else.
...
Now you have the whole six-step check. Find the conclusion. Find the premises. Supply what's missing, charitably. Test the link (grounds). Test the premises (acceptability, and relevance to this conclusion). Only then consult your opinion of the conclusion. Lesson 8 will hand you a list of fallacy names, and every one of them is a shortcut to a failure of one of these conditions. You'll be able to say which, which is more than the name tells you.
...
**"Relevance is obvious."** It's the condition most real arguments fail, and showing the failure takes work, because an irrelevant premise is usually a true one on the same subject. The test is to state the conclusion precisely and then ask what this premise adds to it. If the honest answer is "nothing, but it's true", you've found the failure.
...
**"Guarding is weaselling."** A guard is a measurement. "Probably" says how strong the claim is. Hold the arguer to the guarded claim and don't let them cash it later as the bold one, but don't punish the honest writer for telling you the strength. The suspect words are the assurances, not the guards.

## Practice

:::exercise Do it now
**1. Two passages, reconstructed.** Take each of the following, mark the assuring, guarding, and discounting terms, write it in standard form with missing premises in brackets, draw the diagram (which premises are linked, which convergent), and give an ARG verdict naming the condition that fails, if one does. Both are made up.
...
(b) "You can't trust that review site. It's owned by a company that sells the same products it reviews, and although the reviews look thorough, they nearly always rate the parent company's products highest."

**2. Toulmin on your own argument.** Take the argument in your folder from lesson 1 and lay it out in the six slots. The warrant will be your old bracketed premise. Fill the rebuttal slot with at least two "unless" cases you can think of, then ask which of them the arguer would have to answer.

**3. Rapoport in the open.** Pick a disagreement from this list where you have a view: whether children should have homework; whether a town should build more cycle lanes; whether a family should get a dog; whether a household should keep a car. Write the other side's case under rule 1, in a paragraph they'd thank you for. Then rules 2 and 3 in a sentence each. Then, and only then, your best objection. If you can, show the first paragraph to someone who holds the view and write down their reaction. "That's not quite it" is the useful answer; ask what's missing and rewrite.

**4. Your project's first draft.** Go to the folder argument you most disagree with. Write its steelman: the reconstruction the arguer would sign, in standard form, with a diagram and its warrant named. Don't evaluate it yet. That paragraph is the first draft of the course project, and the evaluation comes after lesson 8.
:::

Now close the page and write down, from memory: the three kinds of terms close analysis looks for; the difference between linked and convergent support and why it matters; Toulmin's six slots; Rapoport's four rules; and the three ARG conditions, with one sentence on what each asks. Then check. Reread only what you missed.

## Connections

This lesson completes the six-step check. Steps 1 to 3 came from lesson 1, and the missing premise you learned to bracket there is what Toulmin calls a warrant. Step 4 is the grounds condition, which is lessons 2 to 4 for deductive links and lessons 5 and 6 for inductive ones; the likelihood ratio from lesson 6 is one way to put a number on how much a premise supports a conclusion. Step 5 is the acceptability and relevance conditions you met today. Step 6 is where belief bias, from lesson 2, waits for you, and the only defence is to keep it sixth.
