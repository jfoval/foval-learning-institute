...
quiz:
  - q: A student and a historian are handed the same unfamiliar document. What does the research say each one does first, and what follows from the difference?
    options:
      - Both start at the first word, but the historian reads faster and so finishes with more
      - The historian looks at the attribution first, so every sentence arrives already placed
      - The student checks the attribution and the historian reads for the argument first
      - Both check the attribution, and the difference is in how much background each brings
    answer: 1
    explain: The behavioural finding is that historians went to the attribution immediately while students started at the first word and read to the last, so B, and reading the attribution first changes what every following sentence is taken to be doing. A makes it a difference of speed, which is lesson 4's territory and not this one's. C reverses the finding. D describes a real difference in background that is not the one the study measured.
  - q: You have two accounts of the same small event, written a day apart, each by a commander whose own conduct is in question, and they agree on everything except the point that matters. What is the useful output of comparing them?
    options:
      - A judgement about which commander is more likely to be telling the truth
      - The agreed facts, set aside, and the disputed point marked as unresolved by these two
      - What each account is evidence of, which may not be what either one is about
      - An average of the two, since the truth usually lies between two interested accounts
    answer: 2
    explain: Two interested accounts can be poor evidence of the event and excellent evidence of what each side needed on the record, which is a different and often more answerable question, so C. A asks a question neither document can settle. B is a real and useful step, and it is the first half of C rather than the whole of it. D treats averaging as a method, which it is not when both accounts have the same incentive in opposite directions.
  - q: A document turns out to have been written fifty years after the event it describes, at the request of someone with a stake in how it came out. What does that do to its value?
    options:
      - It changes what the document is evidence of, from the event to the time it was written in
      - It disqualifies the document, since a memory that old cannot be relied on at all
      - It leaves the document's value unchanged, since eyewitness status is what matters
      - It makes the document more valuable, since distance from the event reduces partisanship
    answer: 0
    explain: Lateness and commissioning are sourcing facts rather than disqualifications, and what they do is move the document from evidence about the event to evidence about the moment it was produced in, so A. B throws away a good source for a later question. C ignores both facts. D inverts the relation, since a commissioned account written into a live dispute is more partisan, not less.
  - q: A textbook and an eyewitness deposition disagree about an event. A reader says the textbook is more reliable because it was written later, by a scholar, with everything available. What is wrong with that reasoning?
    options:
  ...
  - q: A company's internal report on an outage and the regulator's letter about the same outage each put the decisive failure on the other side. A reader concludes the truth is unknowable and stops. What has gone wrong?
    options:
      - Nothing, since when two interested accounts conflict there is no way to choose between them
      - Stopping at the disputed point, when the two agree about a great deal that is worth having
      - The reader should have counted the accounts on each side and gone with the majority
      - The reader should have preferred whichever account was written closer to the event
    answer: 1
    explain: Two conflicting accounts normally establish a good deal in common, and the uncontradicted material plus a precisely located disagreement is a result rather than a failure, so B. A turns one unanswered question into a verdict about the whole. C counts documents, which measures how many were collected rather than what happened. D makes a sourcing fact into an automatic rule, when proximity is one consideration among several.
---
...
And the behavioural finding, in Wineburg's own words: "In almost every opportunity to do so, historians, when first given a document, looked immediately to its attribution, whereas students usually began with the first word in the upper left and never stopped until they reached the last word on the bottom right."[1] That opening phrase is his and it is worth keeping. He is reporting a strong tendency, not a law.
...
A document is not a window onto an event. It is an act, performed by a person, for a purpose, at a moment.
...
Notice also the one thing Parker swears that does not help him, and it is in his own first clause: he "ordered our Militia to meet on the Common in said Lexington". In April 1775 that assembly is itself the fact a Crown lawyer would have wanted, and it is in the document because Parker put it there.

Be careful with the rest of the same sentence, though. That he ordered them "to disperse and not to fire" is not a concession. It is the exculpation the deposition exists to deliver, and reading it as an admission against interest is the mistake this lesson exists to prevent.
...
Keep it separate from what follows. His claim about the Common, that men who had jumped the wall fired four or five shots, is his own, from about a hundred yards, and does not lean on those two officers at all.

The second is "from some quarter or other". Read it carefully and see what it attaches to. Not the four or five shots, which he assigns without hesitation to men who had jumped the wall, but his own horse's two wounds, which he cannot place. The comma is doing that work, and an eighteenth-century comma is not always load-bearing, so read the clause twice before you lean on it. He is certain about the accusation and uncertain about the injury to himself. Notice the unevenness, and do not turn it into a verdict. A man writing fast about a confused few minutes would produce it, and so would a man who had already decided which part of the story mattered.
...
What the sourcing move buys you is not a way to dissolve that. It is a precise statement of what each man was in a position to know. Parker swears he had ordered his company to disperse and not to fire, and his sentence is a claim about his own company's conduct, sworn six days later into a legal brief. Pitcairn was mounted at the head of the advance, writing seven days later to the man who needed a version for London. His account of what happened on the Common is first hand; the earlier musket that flashed in the pan, out on the road, he has at second hand from two officers he does not name.
...
Pitcairn is strong evidence of what the British command needed to be true, and, in the phrase "without any order or regularity ... contrary to the repeated orders", of a loss of fire discipline that a commander does not usually volunteer about his own men. Weigh that credit carefully, though, because it is not free: unordered firing is the version that clears him and his superiors of having begun a war, so the admission costs him less than it looks. He is weak evidence of the first provocation, because he was not there for it and says so.
...
Here is a third document, and it is the one worth the lesson.
...
One sentence earlier Wood has Parker's men "dispersing and leaping over the wall" as the British second platoon fired. That is the same wall Pitcairn says four or five shots came from. It settles nothing, and a document of 1826 could not settle it anyway, but it is the kind of overlap corroboration exists to find, and it is a reason to read past the sentence you came for.
...
**"A textbook is more reliable than a document from the period."** The historians in Wineburg's study put the textbook last, below a novel, and the reason is not that textbooks are bad. It is that a textbook gives you nothing to source: no author, no purpose, no position. What reads as neutrality is the absence of the information you need to judge.

**"Primary sources are unbiased because they were there."** Being there is a reason to read someone. It is not a reason to believe them. Both men above were there, both were interested, and both had a superior to satisfy.
...
**"Contextualizing is background colour."** It decides what the author could have known. Pitcairn writing on 26 April did not know what the Provincial Congress had sworn on the 25th. Wood in 1826 knew about a dispute that did not exist in 1775. Neither of those is scene-setting; each one changes what the document can mean.

## Practice

:::exercise Four moves on something you can reach today
Find one document you can get at without a library. A letter, the minutes of a meeting, a press release, a photograph with its caption, a job advertisement, a planning notice. It does not have to be old and it is better if it is not.
...
Lesson 3 explains why a document from another period is hard, and it is not the words. It is the relations that everyone at the time supplied without noticing: what a notary's certificate was for, why a meeting house was on the Common, what the Provincial Congress was.
...
- **[Captain John Parker's deposition](https://catalog.archives.gov/id/595246), 25 April 1775.** The manuscript and a transcript, at the National Archives. Unrestricted for access and use, and worth looking at as an image: the handwriting is part of the source.
- **[Major Pitcairn's report to Gage](https://teachingamericanhistory.org/document/report-on-the-battles-of-lexington-and-concord/), 26 April 1775.** Free, and read it against the caveat above about its provenance.
- **[Wineburg, "Probing the Depths of Students' Historical Knowledge"](https://www.historians.org/perspectives-article/probing-the-depths-of-students-historical-knowledge/).** Free, short, and his own account of the study this lesson rests on.
- **[The Digital Inquiry Group's document lessons](https://www.inquirygroup.org/history-lessons).** Free and openly licensed, built on this research, and the place to go for more documents already prepared with questions.

## Sources

1. Sam Wineburg, "Historical Problem Solving: A Study of the Cognitive Processes Used in the Evaluation of Documentary and Pictorial Evidence", *Journal of Educational Psychology* 83(1), 1991. **Read through Wineburg's own account of it** in ["Probing the Depths of Students' Historical Knowledge"](https://www.historians.org/perspectives-article/probing-the-depths-of-students-historical-knowledge/), *Perspectives on History*, 1992; the journal article itself was not fetched, and nothing here goes beyond that account. Eight historians and eight strong high-school seniors, eight documents on the Lexington confrontation, the textbook ranked last for trustworthiness below a novel, the students' phrases "the facts", "straight information" and "objective", and the quoted behavioural finding about attributions. Sourcing, contextualization and corroboration originate with this study; close reading is the fourth move the Stanford curriculum adds.
