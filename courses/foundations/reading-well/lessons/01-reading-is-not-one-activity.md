...
**"A summary is as good as the book."** Bacon answered this in 1625, and he was not gentle. Some books "may be read by deputy, and extracts made of them by others; but that would be only in the less important arguments, and the meaner sort of books, else distilled books are like common distilled waters, flashy things."[1] He is describing the book-summary industry, the executive briefing, and asking a machine what a book says. Note that he is also ranking books by worth there, which is his judgement and not a claim this lesson makes; the part to take is what a distillation costs you, not which books deserve one. The last lesson comes back to it.
