...
quiz:
  ...
  - q: A grant application runs to forty pages of guidance. Most of it describes the funder and its history, and two pages set out what makes an application ineligible. How should the forty pages be read?
    options:
      - All forty analytically, because the money at stake makes the document important
      - All forty inspectionally, because guidance is padded and repeats itself
      - Syntopically against other funders' guidance, because that shows the pattern
      - Mostly inspectionally, with the two eligibility pages read analytically
    answer: 3
    explain: The level is chosen per passage rather than per document, so D is right. A treats the document as the unit and spends the same attention on the funder's history as on the pages that decide whether you can apply at all. B makes the opposite error and skims the two pages that could disqualify you. C names a real level answering a different question, which is what funders have in common rather than whether you are eligible for this one.
  ...
  - q: Bacon sorts books into those to be tasted, swallowed, and chewed and digested. Adler uses the same line but attaches the choice to something Bacon does not. What does Adler add?
    options:
      ...
      - That tasting a book is usually enough, so most books need no more than a taste
...
Francis Bacon first published his *Essays* in 1597 and kept enlarging them; the 1625 edition is the last and fullest he published. One of them, ["Of Studies"](https://www.gutenberg.org/cache/epub/575/pg575.txt), is about a page long, and it contains a sentence that people quote constantly and almost always cut in half:
...
**"A summary is as good as the book."** Bacon answered this in 1625, and he was not gentle. "Some books also may be read by deputy, and extracts made of them by others; but that would be only in the less important arguments, and the meaner sort of books, else distilled books are like common distilled waters, flashy things."[1] He is describing the book-summary industry, the executive briefing, and asking a machine what a book says. Note that he is also ranking books by worth there, which is his judgement and not a claim this lesson makes; the part to take is what a distillation costs you, not which books deserve one. The last lesson comes back to it.
...
2. Mortimer J. Adler and Charles Van Doren, *How to Read a Book*, revised edition (1972), chapters 1 and 2. The four levels; the sentence on why they are levels and not kinds; readers who "plow steadily through" a book; the description of inspectional reading and its emphasis on time, quoted to the end of Adler's own sentence; the pair of definitions contrasting inspectional and analytical reading; analytical reading as "preeminently for the sake of understanding"; Adler's own quotation of Bacon; and syntopical reading as constructing an analysis "that may not be in any of the books". Adler's separate views about which books are worth reading are not taught here. The text consulted for this course was a scanned copy at the Internet Archive; because that upload carries no licence and the book is in copyright, this lesson points readers at libraries and Open Library instead of at the scan.
3. Ronald Carver's five reading gears (1992), and the test of them, both from Marc Brysbaert, "How many words do we read per minute? A review and meta-analysis of reading rate", *Journal of Memory and Language* 109 (2019), 104047. Carver's own papers were not read for this lesson, so the gears, their figures and the account of where his 300 words a minute came from are all Brysbaert's reporting. Brysbaert tests the model and largely rejects it: his general discussion is headed "There is no evidence for reading gears except for the distinction between reading and scanning", and he reports failing to find a distinction between reading for recognition and reading out of interest, finding no bimodal curve that would have saved the theory, and finding that reading for recall is slower not as a separate mode but through "an increased structuring and organization of text information" visible as "many regressions and rereadings". On the 300 figure he writes that Carver's estimate "was influenced by Buswell and S. E. Taylor... but was also established independently", from Carver's earlier work on compressed speech. The same paper supplies the corrected rate of about 238 words a minute for silent reading of non-fiction, from 190 studies and 18,573 participants, describing adult native English speakers reading for comprehension and staying on task.
