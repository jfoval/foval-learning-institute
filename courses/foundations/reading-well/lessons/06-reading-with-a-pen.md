...
Try that on a chapter with nothing in your hand and you will lose most of it before the chapter ends. A term you settled on page 40 is needed on page 300. An objection you formed in the second paragraph is gone by the fourth. This lesson is about the thing that makes lesson 5 possible, which is a pen.
...
|---|---|---|
| a vertical line in the margin | this is the claim, or a part of the structure | you will want the skeleton without the decoration |
...
Marks live in the margin of one book. A reading record is the page you write when you close it, and it is what you will actually consult.
...
Two things make this work rather than being a chore. Write the page number *first*, before the thought, because a thought written without one is a thought you cannot place. And keep the same five symbols, so the sheet reads the way a margin would.
...
Lesson 3's three obstacles are three different marks. A word you can point at is one thing, a relation you cannot see is another, and a sentence that will not resolve is a third, and marking them the same way throws away the diagnosis.
