...
If you know how the Commons works, you have just read a small story with a beginning and an end, and it is not the story the words appear to tell.
...
Now notice what did not cause the difficulty. There is no unfamiliar word in that passage. Present, counted, adjourned, Members, House. Two items need a gloss and neither is hard: *hon.* is short for *honourable*, and a *Baronet* is a title.
...
:::predict Before the study: think of a text that defeated you recently. Was it that you did not know the words, or that you knew the words and could not see what they added up to?
...
The Hansard lines are not free of the problem. They make the harder version of it. Two of their phrases are terms of art, as the sixth paragraph of this lesson says, but both are built from words you know, so nothing warns you and the definition test comes back clean. That is the case worth learning, and it is the case the baseball studies did not test. If you want the same shape in a domain you have no history with at all, the checkpoint at the end of the next section is the cleanest version.
...
<text x="26" y="252" font-size="15" fill="var(--text-2, #4a5260)">One sentence will not resolve. Find</text>
...
Find the main clause first. Strip out everything that interrupts and what is left is *the clause ... was not*, which is a sentence with a hole in it. The missing word is not further on. It is behind you, in *believed sufficient*, and English lets you drop a repeated complement, so *was not* means *was not sufficient*. That is the whole claim. Everything else is there to tell you which clause.
...
Notice what you did not have to learn. Nothing about tenancies, nothing about schedules. You were untangling, not learning, and that is the whole difference between this obstacle and the last one.
:::

That is the distinction worth carrying: with missing background, more time on this page will not help, because what you need is not on this page. With syntax, more time on this page is exactly what helps.
...
So the fix is not to reread it, and it is not the dictionary either. It is to read something that explains how those three move together, and then come back. Fifteen minutes elsewhere buys you this sentence and every sentence like it.
:::
...
Surveying tells you whether the easier book has what you need, in about half an hour, before you commit to it. That is what lesson 2's procedure is for, and this is its most common use.
...
**"Looking things up as I go is the responsible approach."** On a second pass, yes. On a first pass it is how people spend a month on chapter 1 and abandon the book, which is the behaviour Adler's rule exists to prevent.
...
1. Reread one paragraph of it and write down which of the three obstacles you hit. Be specific: name the words you did not know, or the relation you could not see, or the sentence that would not resolve.
