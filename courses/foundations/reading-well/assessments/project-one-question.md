...
**Say what you would do differently depending on the answer.** If nothing changes either way, you have a topic and you will drift. This is lesson 10's first move and it is the one that governs everything after it.

**Check that nobody has written the book.** If one book answers your question directly, read it, and pick a different question for this project. The whole method exists for questions that sit between books.
...
1. What kind of text is this, and what is it about?
...
## Step 2: read two properly

Take the two most useful and read them analytically, per lessons 5 and 7. For each, produce:
...
Three-pass the research paper, per lesson 8.

**First pass**, ten minutes with a timer, then the five Cs in five sentences.

**Second pass**, up to an hour in its own sitting. Stop at every figure and ask whether the axes are labelled with units and whether error bars are shown. Read the methods and write down what the design can and cannot support, which is often narrower than the abstract.

Then the test: write the paragraph you could say aloud to somebody else, main thrust with the evidence attached.
...
Write the translations out. Four authors, one paragraph each, in your words.

**If two authors turn out never to have been disagreeing, that is the best result this project can produce.** Say so, and say what the word was doing in each mouth.

## Step 6: state the issues
...
**A reading file of 1,200 to 1,800 words**, plus your working papers, which are the surveys, the outlines, the marks and the translations. Hand in both. The working papers are where most of the method is visible.

The file itself is:

1. The question, and what turns on the answer.
2. What you read, what you skipped, and why.
3. The terms, and the translation of each author into them.
4. The issues, with what would settle each.
5. Your answer, and the grounds.
6. **What you did not read fully, named.**
