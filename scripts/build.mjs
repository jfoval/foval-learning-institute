...
// shape check passes, and the site renders options through String(), which turns
// an object into the literal text "[object Object]". One published lesson shipped
// that way. Check the types, not just the shape.
