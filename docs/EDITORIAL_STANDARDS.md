...
- **Nothing sponsored, ever.** No advertisement, sponsor slot, affiliate link, or paid placement appears in a lesson, an assessment, or a review card. This is value 1 and it is not a matter of taste: a sponsor sitting beside a fact-checked claim changes how that claim reads, and the reader has no way to tell which sentences were bought. A link earns its place because it is the best source, and for no other reason. If the institute ever carries sponsorship, it lives on pages that teach nothing.
