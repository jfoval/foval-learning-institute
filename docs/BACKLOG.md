...
**The Bible: What It Is and How to Read It** (`courses/christian-studies/bible-basics`, `standpoint: christian`): research done, outline done (12 lessons), lessons 1–8 drafted. Lessons 9–12 were relaunched at the end of the 2026-09-05 session; check whether `lessons/09-*.md` through `12-*.md` exist and validate. No reviews yet. Assessments not yet drafted. Decision pending: split lesson 4 into "Covenant made: reading the law" / "Covenant enforced: reading the prophets" (drafter recommends it; seam is the heading "What a prophet was"). Running verse count for the ESV 500-verse permission: lesson 1: 6; lesson 2: 21; lesson 3: 18; lesson 4: 21; lesson 5: 22–29; lesson 6: 22; lesson 7: 24–30; lesson 8: 6 (+2 NRSVue). Roughly 140–155 so far; lessons 9–12 will add more; keep it under 500 or switch overflow quotations to the NET Bible.
