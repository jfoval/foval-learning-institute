...
- **Current lesson:** 1 to 4 are through Stage 4, all four largely rewritten. 5 is next.
...
- **Next action:** `/review-lesson courses/communication-and-people/clear-writing 5`. If fal has
...
1. **Writing Clearly: Stage 4 on all nine lessons, then the voice pass.** Drafted, assessments
   exist. **Lessons 1 to 4 done 2026-09-10**, all mostly rewritten. Five to go.
   ...
   **Read `research/reviews/course-wide.md` before reviewing lesson 5.** Four rounds have shown
   ...
   limits it. Four or five of those recurred in every one of lessons 1 to 4. It also records
   ...
   **And measure every quiz both ways after rewriting it.** Three rounds running, the rewrite
   introduced a tell the draft did not have.
...
| Writing Clearly | T1 | 9 | 3,935 | 4 | 2 | 0 of 9 | Stage 4 on 5, voice pass, 9 episodes |
