...
- **Current lesson:** voice pass done on lessons 1 to 6 (2026-09-17); lesson 7 is next.
- **Current stage:** the voice pass, lesson by lesson (6 of 9 done), then nine episodes.
