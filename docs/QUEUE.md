...
- **Note-Taking and Personal Knowledge is through Stage 2**, with 4,600 words of research and a
  ...
  the course. T2, fifth in the term on running yourself. **Lessons 1 and 2 are drafted and both owe
  their Stage 4 reviews; lessons 3 to 8 and both assessments are still to write.**
