...
- **Current lesson:** 1 to 5 are through Stage 4, all five largely rewritten. 6 is next.
...
- **Next action:** `/review-lesson courses/communication-and-people/clear-writing 6`. If fal has
...
1. **Writing Clearly: Stage 4 on all nine lessons, then the voice pass.** Drafted, assessments
   exist. **Lessons 1 to 5 done 2026-09-10**, all mostly rewritten. Four to go.
   ...
   **Read `research/reviews/course-wide.md` before reviewing lesson 6.** Five rounds have shown
   ...
   limits it. Four or five of those recurred in every one of lessons 1 to 5, and the Gopen and Swan caveat was missing from four lessons in a row. It also records
...
| Writing Clearly | T1 | 9 | 4,058 | 5 | 2 | 0 of 9 | Stage 4 on 4, voice pass, 9 episodes |
