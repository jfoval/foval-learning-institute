...
- **Current lesson:** voice pass done on lessons 1 to 3 (2026-09-17); lesson 4 is next.
- **Current stage:** the voice pass, lesson by lesson (3 of 9 done), then nine episodes.
