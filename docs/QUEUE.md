...
- **Current lesson:** voice pass done on lessons 1 to 7 (2026-09-17); lesson 8 is next.
- **Current stage:** the voice pass, lesson by lesson (7 of 9 done), then nine episodes.
